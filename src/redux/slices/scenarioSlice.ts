...
export const executeScenario = createAsyncThunk(
    ...
    async (params: {
        ...
        try {
            ...
            console.log('Execute scenario response:', response.data);
            ...
            if (error.response?.status === 400 && error.response?.data) {
                ...
                console.log('Execute scenario validation error:', errorMessage);
...
const scenarioSlice = createSlice({
    ...
    reducers: {
        ...
        updateFieldValue: (state, action: PayloadAction<{
            ...
            console.log('🔄 Redux updateFieldValue:', {
                componentName,
                fieldName,
                fieldKey,
                value,
                previousValue: state.execution.fieldValues[fieldKey]
            });
