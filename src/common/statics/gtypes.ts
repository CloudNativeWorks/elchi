...
export enum GTypes {
    ...
    QuicUpstreamTransport = "envoy.extensions.transport_sockets.quic.v3.QuicUpstreamTransport",
    ProxyProtocolUpstreamTransport = "envoy.extensions.transport_sockets.proxy_protocol.v3.ProxyProtocolUpstreamTransport",
    RawBufferTransport = "envoy.extensions.transport_sockets.raw_buffer.v3.RawBuffer",
    ...
    AppleDnsResolver = "envoy.extensions.network.dns_resolver.apple.v3.AppleDnsResolverConfig",
    CaresDnsResolver = "envoy.extensions.network.dns_resolver.cares.v3.CaresDnsResolverConfig",
    GetAddrInfoDnsResolver = "envoy.extensions.network.dns_resolver.getaddrinfo.v3.GetAddrInfoDnsResolverConfig",
}
...
export const resourceMapping: Record<string, GTypes> = {
    ...
    'transport-socket': GTypes.DownstreamTlsContext,
    ...
    dns_resolver: GTypes.AppleDnsResolver,
...
const gtypeFieldMap: Record<GTypes, GTypeFieldsBase> = {
    ...
    [GTypes.DownstreamTlsContext]: {
        ...
        createPath: '/create/transport-socket',
        prettyName: 'Downstream TLS',
        groupPrettyName: 'Transport Socket',
        listPage: '/resource/transport-socket',
        collection: "tls",
        type: "tls",
    ...
    [GTypes.ProxyProtocolUpstreamTransport]: {
        backendPath: `${XDS_PATH}/tls`,
        createPath: '/create/transport-socket',
    ...
    [GTypes.AppleDnsResolver]: {
        backendPath: 'eo/extensions/extensions/dns_resolver',
        createPath: '/create/dns_resolver',
        prettyName: 'Apple',
        groupPrettyName: 'DNS Resolver',
        listPage: '/extensions/dns_resolver',
        collection: "extensions",
        type: "dns_resolver",
        canonicalName: "envoy.network.dns_resolver",
        module: 'extension/dns-resolver/DnsResolver',
        initialValue: {},
        category: "envoy.network.dns_resolver",
        availableVersions: AVAILABLE_VERSIONS,
        metadata: METADATA_DEFAULT
    },
    [GTypes.CaresDnsResolver]: {
        backendPath: 'eo/extensions/extensions/dns_resolver',
        createPath: '/create/dns_resolver',
        prettyName: 'C-Ares',
        groupPrettyName: 'DNS Resolver',
    ...
    [GTypes.GetAddrInfoDnsResolver]: {
        backendPath: 'eo/extensions/extensions/dns_resolver',
        createPath: '/create/dns_resolver',
        prettyName: 'GetAddrInfo',
        groupPrettyName: 'DNS Resolver',
        listPage: '/extensions/dns_resolver',
        collection: "extensions",
        type: "dns_resolver",
