...
const Resources: React.FC = () => {
    ...
    return (
        <>
            ...
            >
                {resource !== 'listener' ?
                    <CustomDataTable path={`${resourceStatic.backendPath}?project=${project}`} filters={filters} /> :
                    <CustomListenerDataTable path={`${resourceStatic.backendPath}?project=${project}`} filters={filters} />
                }
            </Card>
        </>
    );
