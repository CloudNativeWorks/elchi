...
export const DOWNSTREAM_CONNECTION_ACCEPTED_PER_SOCKET_EVENT_METRICS_DESCRIPTION = `**🔄 Downstream Connections Accepted Per Socket Event**
...
**Tips:**
- 🧠 Low values during high load might mean OS-level throttling or exhaustion.
- 🧪 Useful for low-level performance tuning or capacity planning.`;
