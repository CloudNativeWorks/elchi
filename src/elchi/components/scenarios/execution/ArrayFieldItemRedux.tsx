        ...
        switch (fieldDef.type) {
            ...
            case 'array':
                ...
                if (fieldDef.properties && typeof fieldDef.properties === 'object') {
                    ...
                    return (
                        <div style={{ border: '1px dashed var(--border-default)', padding: '8px', borderRadius: '4px' }}>
                                ...
                                arrayValue.map((item: Record<string, any>, itemIndex: number) => (
                                    <div key={itemIndex} style={{
                                        ...
                                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '6px' }}>
                                            <Text style={{ fontSize: '9px', fontWeight: 500, color: 'var(--text-tertiary)' }}>
                                                Item #{itemIndex + 1}
                                            </Text>
                                            <Button
                                                type="text"
                ...
                return (
                    <div>
                        ...
                        {selectedOption && selectedOptionConfig && fieldDef.properties && fieldDef.properties[selectedOption] && (
                            <div style={{ marginTop: '8px', paddingLeft: '8px', borderLeft: '2px solid var(--border-default)' }}>
                                <Text style={{ fontSize: '10px', color: 'var(--text-secondary)', fontWeight: 600, display: 'block', marginBottom: '6px' }}>
                                ...
                                .map(([propName, propDef]: [string, any]) => {
                                    ...
                                    return (
                                        <div key={propName} className="object-field-item">
                                            <Text style={{ fontSize: '10px', fontWeight: 500, display: 'block', marginBottom: '2px', color: 'var(--text-secondary)' }}>
                                                {propDef.label || propName}
                                                {propDef.required && <span style={{ color: 'var(--color-error)' }}> *</span>}
                                            </Text>
                                            <NestedArrayItemRenderer
                                                fieldName={propName}
                                                fieldDef={propDef}
