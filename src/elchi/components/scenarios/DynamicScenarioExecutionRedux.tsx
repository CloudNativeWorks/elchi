        ...
        <div style={{ padding: '24px' }}>
            ...
            {managed && (
                <Alert
                    ...
                    description="Elchi will handle full deployment: saves configs to database, deploys to managed clients, and automatically manages IP addresses and networking."
                    type="info"
                    showIcon
