...
import { Steps, Card, message, Spin, Alert, Button } from 'antd';
...
const DynamicScenarioWizard: React.FC = () => {
    ...
    useEffect(() => {
        if (existingScenario && isEditMode) {
            console.log('Loading existing scenario:', existingScenario);
            setBasicInfo({
            ...
            console.log('Components set:', existingScenario.components);
        }
                                ...
                                description={
                                    <div>
                                        {(() => {
                                            ...
                                            console.log('Displaying create error:', errorMessage);
