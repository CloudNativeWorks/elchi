...
import { Card, Button, Typography, Space, Divider, Drawer, message } from 'antd';
        ...
        >
            <>
                ...
                <Space direction="vertical" size="middle" style={{ width: '100%' }}>
                    <Card title="Method 1: Running with func-e" variant={'borderless'}>
                        <Paragraph>
                    ...
                    <Card title="Method 2: Running with Envoy Binary" variant={'borderless'}>
                        <Paragraph>
                    ...
                    <Card title="Method 3: Running as an Envoy Pod on Kubernetes" variant={'borderless'}>
                        <Paragraph>
