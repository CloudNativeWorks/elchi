...
import { RouteMapNode as RouteMapNodeType } from '../types';
 ...
 */
const RouteMapNode: React.FC<NodeProps<RouteMapNodeType>> = ({ data, selected }) => {
...
export default memo(RouteMapNode);
