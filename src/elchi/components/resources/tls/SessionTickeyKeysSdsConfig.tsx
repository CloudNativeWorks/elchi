...
const ComponentSessionTicketKeysSdsConfig: React.FC<GeneralProps> = ({ veri }) => {
    ...
    const { data: queryData } = useCustomGetQuery({
        queryKey: "custom_secrets_session_ticket_keys_sds",
        enabled: true,
        path: `custom/resource_list?collection=secrets&gtype=envoy.extensions.transport_sockets.tls.v3.TlsSessionTicketKeys&version=${veri.version}&project=${project}`
    });
