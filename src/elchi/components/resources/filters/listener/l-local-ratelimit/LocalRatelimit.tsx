...
import CommonComponentTokenBucket from '@/elchi/components/resources/common/TokenBucket/TokenBucket';
...
const ComponentLocalRateLimit: React.FC<GeneralProps> = ({ veri }) => {
    const GType = useGTypeFields(GTypes.ListenerLocalRateLimit);
