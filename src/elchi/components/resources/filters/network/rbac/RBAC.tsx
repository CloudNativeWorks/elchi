...
import { modtag_r_rbac, modtag_rbac } from "./_modtag_";
...
const ComponentNetworkRBAC: React.FC<GeneralProps> = ({ veri }) => {
    const GType = useGTypeFields(GTypes.NetworkRBAC);
...
export default React.memo(ComponentNetworkRBAC);