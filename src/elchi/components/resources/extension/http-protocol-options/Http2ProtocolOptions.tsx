...
const ComponentHttp2ProtocolOptions: React.FC<GeneralProps> = ({ veri }) => {
    ...
    const { vModels } = useModels(veri.version, modtag_http2_protocol_options);
    ...
    return (
        <ECard 
            title="Http2 Protocol Options"
            reduxStore={veri.reduxStore}
            ctype="http2_protocol_options"
            toJSON={vModels.h2po?.Http2ProtocolOptions?.toJSON}
