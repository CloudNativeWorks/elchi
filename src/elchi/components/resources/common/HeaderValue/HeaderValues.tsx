...
import CommonComponentHeaderValue from "./HeaderValue";
import { handleChangeResources } from "@/redux/dispatcher";
import { ActionType, ResourceType } from "@/redux/reducer-helpers/common";
import { useDispatch } from "react-redux";
import { DeleteTwoTone, TagsOutlined } from "@ant-design/icons";
...
const CommonComponentHeaderValues: React.FC<GeneralProps> = ({ veri }) => {
                            ...
                            description={
                                <div style={{ marginTop: 16 }}>
                                    ...
                                    <p style={{
                                        ...
                                        Click the + button above to add your first header value
                                    </p>
                                </div>
                            }
                        />
                            ...
                            veri.reduxStore?.map((data: any, index: number) => (
                                {
                                    ...
                                    children:
                                        <CommonComponentHeaderValue veri={{
...
export default memorizeComponent(CommonComponentHeaderValues, compareVeri);
