...
import { Col, Divider, Upload, Button, UploadProps, message } from 'antd';
    ...
    const props: UploadProps = {
        ...
        onChange(info) {
            if (info.file.status === 'done') {
                successMessage(messageApi, 'file uploaded successfully');
            } else if (info.file.status === 'error') {
                errorMessage(messageApi, 'file not uploaded!');
            }
        },
    };
