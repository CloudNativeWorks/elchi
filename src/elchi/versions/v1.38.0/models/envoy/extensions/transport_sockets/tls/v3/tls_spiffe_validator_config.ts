...
export interface SPIFFECertValidatorConfig_TrustDomain {
   ...
   */
  workload_trust_domain?: string | undefined;
}
...
> = {
  ...
  encode(message: SPIFFECertValidatorConfig_TrustDomain, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.workload_trust_domain !== undefined && message.workload_trust_domain !== "") {
      writer.uint32(26).string(message.workload_trust_domain);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.workload_trust_domain = reader.string();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): SPIFFECertValidatorConfig_TrustDomain {
    return {
      ...
      workload_trust_domain: isSet(object.workload_trust_domain)
        ? globalThis.String(object.workload_trust_domain)
        : undefined,
    };
  },
  ...
  toJSON(message: SPIFFECertValidatorConfig_TrustDomain): unknown {
    ...
    if (message.workload_trust_domain !== undefined) {
      obj.workload_trust_domain = message.workload_trust_domain;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<SPIFFECertValidatorConfig_TrustDomain>, I>>(
    ...
    message.trust_bundle = (object.trust_bundle !== undefined && object.trust_bundle !== null)
      ...
      : undefined;
    message.workload_trust_domain = object.workload_trust_domain ?? undefined;
    return message;
  },
};
