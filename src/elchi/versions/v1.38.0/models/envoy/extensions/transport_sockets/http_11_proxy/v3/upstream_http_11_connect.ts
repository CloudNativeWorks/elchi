...
export interface Http11ProxyUpstreamTransport {
   ...
   */
  default_proxy_address?: Address | undefined;
}
...
> = {
  ...
  encode(message: Http11ProxyUpstreamTransport, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.default_proxy_address !== undefined) {
      Address.encode(message.default_proxy_address, writer.uint32(18).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.default_proxy_address = Address.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Http11ProxyUpstreamTransport {
    return {
      ...
      default_proxy_address: isSet(object.default_proxy_address)
        ? Address.fromJSON(object.default_proxy_address)
        : undefined,
    };
  },
  ...
  toJSON(message: Http11ProxyUpstreamTransport): unknown {
    ...
    if (message.default_proxy_address !== undefined) {
      obj.default_proxy_address = Address.toJSON(message.default_proxy_address);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Http11ProxyUpstreamTransport>, I>>(object: I): Http11ProxyUpstreamTransport {
    ...
    message.transport_socket = (object.transport_socket !== undefined && object.transport_socket !== null)
      ...
      : undefined;
    message.default_proxy_address =
      (object.default_proxy_address !== undefined && object.default_proxy_address !== null)
        ? Address.fromPartial(object.default_proxy_address)
        : undefined;
    return message;
  },
};
