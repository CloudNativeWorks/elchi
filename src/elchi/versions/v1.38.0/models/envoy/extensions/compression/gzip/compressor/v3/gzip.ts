...
export enum Gzip_CompressionStrategy {
  ...
  /** FILTERED - Filtered compression strategy, designed for data produced by a filter or predictor. */
  FILTERED = "FILTERED",
  /** HUFFMAN_ONLY - Huffman-only compression strategy, which uses Huffman encoding only. */
  HUFFMAN_ONLY = "HUFFMAN_ONLY",
  /** RLE - Run-length encoding (RLE) compression strategy, designed for image data. */
  RLE = "RLE",
  /** FIXED - Fixed compression strategy, which prevents the use of dynamic Huffman codes. */
  FIXED = "FIXED",
}
...
export enum Gzip_CompressionLevel {
  /** DEFAULT_COMPRESSION - Default compression level, equivalent to ``COMPRESSION_LEVEL_6``. */
  DEFAULT_COMPRESSION = "DEFAULT_COMPRESSION",
  /** BEST_SPEED - Fastest compression with minimal compression ratio, equivalent to ``COMPRESSION_LEVEL_1``. */
  BEST_SPEED = "BEST_SPEED",
  /** COMPRESSION_LEVEL_1 - Compression level 1 (fastest). */
  COMPRESSION_LEVEL_1 = "COMPRESSION_LEVEL_1",
  /** COMPRESSION_LEVEL_2 - Compression level 2. */
  COMPRESSION_LEVEL_2 = "COMPRESSION_LEVEL_2",
  /** COMPRESSION_LEVEL_3 - Compression level 3. */
  COMPRESSION_LEVEL_3 = "COMPRESSION_LEVEL_3",
  /** COMPRESSION_LEVEL_4 - Compression level 4. */
  COMPRESSION_LEVEL_4 = "COMPRESSION_LEVEL_4",
  /** COMPRESSION_LEVEL_5 - Compression level 5. */
  COMPRESSION_LEVEL_5 = "COMPRESSION_LEVEL_5",
  /** COMPRESSION_LEVEL_6 - Compression level 6. */
  COMPRESSION_LEVEL_6 = "COMPRESSION_LEVEL_6",
  /** COMPRESSION_LEVEL_7 - Compression level 7. */
  COMPRESSION_LEVEL_7 = "COMPRESSION_LEVEL_7",
  /** COMPRESSION_LEVEL_8 - Compression level 8. */
  COMPRESSION_LEVEL_8 = "COMPRESSION_LEVEL_8",
  /** COMPRESSION_LEVEL_9 - Compression level 9 (best compression). */
  COMPRESSION_LEVEL_9 = "COMPRESSION_LEVEL_9",
  /** BEST_COMPRESSION - Best compression ratio with highest latency, equivalent to ``COMPRESSION_LEVEL_9``. */
