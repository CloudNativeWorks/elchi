...
export interface RedisClusterConfig {
   ...
   */
  enable_zone_discovery?: boolean | undefined;
}
...
> = {
  ...
  encode(message: RedisClusterConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.enable_zone_discovery !== undefined) {
      BoolValue.encode(
        { $type: "google.protobuf.BoolValue", value: message.enable_zone_discovery! },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.enable_zone_discovery = BoolValue.decode(reader, reader.uint32()).value;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): RedisClusterConfig {
    return {
      ...
      host_degraded_refresh_threshold: isSet(object.host_degraded_refresh_threshold)
        ...
        : undefined,
      enable_zone_discovery: isSet(object.enable_zone_discovery) ? Boolean(object.enable_zone_discovery) : undefined,
    };
  },
  ...
  toJSON(message: RedisClusterConfig): unknown {
    ...
    if (message.enable_zone_discovery !== undefined) {
      obj.enable_zone_discovery = message.enable_zone_discovery;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<RedisClusterConfig>, I>>(object: I): RedisClusterConfig {
    ...
    message.enable_zone_discovery = object.enable_zone_discovery ?? undefined;
    return message;
  },
};
