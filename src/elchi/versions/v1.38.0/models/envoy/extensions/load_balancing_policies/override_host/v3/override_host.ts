...
> = {
  ...
  encode(message: OverrideHost, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.selected_host_key !== undefined) {
      MetadataKey.encode(message.selected_host_key, writer.uint32(18).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.selected_host_key = MetadataKey.decode(reader, reader.uint32());
          continue;
        }
        case 3: {
          if (tag !== 26) {
  ...
  fromJSON(object: any): OverrideHost {
    return {
      ...
      override_host_sources: globalThis.Array.isArray(object?.override_host_sources)
        ...
        : undefined,
      selected_host_key: isSet(object.selected_host_key) ? MetadataKey.fromJSON(object.selected_host_key) : undefined,
  ...
  toJSON(message: OverrideHost): unknown {
    ...
    if (message.selected_host_key !== undefined) {
      obj.selected_host_key = MetadataKey.toJSON(message.selected_host_key);
    }
    if (message.fallback_policy !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<OverrideHost>, I>>(object: I): OverrideHost {
    ...
    message.selected_host_key = (object.selected_host_key !== undefined && object.selected_host_key !== null)
      ? MetadataKey.fromPartial(object.selected_host_key)
      : undefined;
