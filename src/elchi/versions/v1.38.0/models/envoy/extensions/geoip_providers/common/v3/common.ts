...
> = {
  ...
  encode(
    ...
    if (message.asn_org !== undefined && message.asn_org !== "") {
      writer.uint32(106).string(message.asn_org);
    }
  ...
  fromJSON(object: any): CommonGeoipProviderConfig_GeolocationHeadersToAdd {
    return {
      ...
      asn_org: isSet(object.asn_org) ? globalThis.String(object.asn_org) : undefined,
  ...
  toJSON(message: CommonGeoipProviderConfig_GeolocationHeadersToAdd): unknown {
    ...
    if (message.asn_org !== undefined) {
      obj.asn_org = message.asn_org;
    }
  ...
  fromPartial<I extends Exact<DeepPartial<CommonGeoipProviderConfig_GeolocationHeadersToAdd>, I>>(
    ...
    message.asn_org = object.asn_org ?? undefined;
...
> = {
  ...
  encode(
    ...
    if (message.asn_org !== undefined && message.asn_org !== "") {
      writer.uint32(98).string(message.asn_org);
    }
    if (message.anon !== undefined && message.anon !== "") {
