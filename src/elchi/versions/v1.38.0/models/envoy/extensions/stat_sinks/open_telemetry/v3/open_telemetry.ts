...
export interface SinkConfig_DropAction {
  $type: "envoy.extensions.stat_sinks.open_telemetry.v3.SinkConfig.DropAction";
}
...
export const SinkConfig: MessageFns<SinkConfig, "envoy.extensions.stat_sinks.open_telemetry.v3.SinkConfig"> = {
  ...
  encode(message: SinkConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    switch (message.protocol_specifier?.$case) {
      case "grpc_service":
        ...
        break;
      case "http_service":
        HttpService.encode(message.protocol_specifier.http_service, writer.uint32(74).fork()).join();
        break;
    }
  ...
  toJSON(message: SinkConfig): unknown {
    ...
    if (message.protocol_specifier?.$case === "http_service") {
      obj.http_service = HttpService.toJSON(message.protocol_specifier.http_service);
    }
  ...
  fromPartial<I extends Exact<DeepPartial<SinkConfig>, I>>(object: I): SinkConfig {
    ...
    if (
      object.protocol_specifier?.$case === "http_service" &&
      object.protocol_specifier?.http_service !== undefined &&
      object.protocol_specifier?.http_service !== null
    ) {
      message.protocol_specifier = {
        $case: "http_service",
        http_service: HttpService.fromPartial(object.protocol_specifier.http_service),
      };
    }
...
function createBaseSinkConfig_DropAction(): SinkConfig_DropAction {
  return { $type: "envoy.extensions.stat_sinks.open_telemetry.v3.SinkConfig.DropAction" };
}

export const SinkConfig_DropAction: MessageFns<
  SinkConfig_DropAction,
  "envoy.extensions.stat_sinks.open_telemetry.v3.SinkConfig.DropAction"
> = {
  $type: "envoy.extensions.stat_sinks.open_telemetry.v3.SinkConfig.DropAction" as const,

  encode(_: SinkConfig_DropAction, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SinkConfig_DropAction {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSinkConfig_DropAction();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
  ...
  fromJSON(_: any): SinkConfig_DropAction {
    return { $type: SinkConfig_DropAction.$type };
  },

  toJSON(_: SinkConfig_DropAction): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<SinkConfig_DropAction>, I>>(base?: I): SinkConfig_DropAction {
    return SinkConfig_DropAction.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SinkConfig_DropAction>, I>>(_: I): SinkConfig_DropAction {
    const message = createBaseSinkConfig_DropAction();
    return message;
  },
};

messageTypeRegistry.set(SinkConfig_DropAction.$type, SinkConfig_DropAction);
