...
export interface GrpcJsonTranscoder_PrintOptions {
   ...
   */
  stream_sse_style_delimited?: boolean | undefined;
}
...
> = {
  ...
  encode(message: GrpcJsonTranscoder_PrintOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.stream_sse_style_delimited !== undefined && message.stream_sse_style_delimited !== false) {
      writer.uint32(48).bool(message.stream_sse_style_delimited);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.stream_sse_style_delimited = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): GrpcJsonTranscoder_PrintOptions {
    return {
      ...
      stream_newline_delimited: isSet(object.stream_newline_delimited)
        ...
        : undefined,
      stream_sse_style_delimited: isSet(object.stream_sse_style_delimited)
        ? globalThis.Boolean(object.stream_sse_style_delimited)
        : undefined,
    };
  },
  ...
  toJSON(message: GrpcJsonTranscoder_PrintOptions): unknown {
    ...
    if (message.stream_sse_style_delimited !== undefined) {
      obj.stream_sse_style_delimited = message.stream_sse_style_delimited;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GrpcJsonTranscoder_PrintOptions>, I>>(
    ...
    message.stream_sse_style_delimited = object.stream_sse_style_delimited ?? undefined;
    return message;
  },
};
