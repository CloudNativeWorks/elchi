...
export interface Router {
   ...
   */
  reject_connect_request_early_data?: boolean | undefined;
}
...
export const Router: MessageFns<Router, "envoy.extensions.filters.http.router.v3.Router"> = {
  ...
  encode(message: Router, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.reject_connect_request_early_data !== undefined) {
      BoolValue.encode(
        { $type: "google.protobuf.BoolValue", value: message.reject_connect_request_early_data! },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10: {
          ...
          message.reject_connect_request_early_data = BoolValue.decode(reader, reader.uint32()).value;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Router {
    return {
      ...
      upstream_http_filters: globalThis.Array.isArray(object?.upstream_http_filters)
        ...
        : undefined,
      reject_connect_request_early_data: isSet(object.reject_connect_request_early_data)
        ? Boolean(object.reject_connect_request_early_data)
        : undefined,
    };
  },
  ...
  toJSON(message: Router): unknown {
    ...
    if (message.reject_connect_request_early_data !== undefined) {
      obj.reject_connect_request_early_data = message.reject_connect_request_early_data;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Router>, I>>(object: I): Router {
    ...
    message.reject_connect_request_early_data = object.reject_connect_request_early_data ?? undefined;
    return message;
  },
};
