...
export const protobufPackage = "envoy.extensions.filters.common.fault.v3";
...
function createBaseFaultDelay(): FaultDelay {
  return { $type: "envoy.extensions.filters.common.fault.v3.FaultDelay", fault_delay_secifier: undefined };
}

export const FaultDelay: MessageFns<FaultDelay, "envoy.extensions.filters.common.fault.v3.FaultDelay"> = {
  $type: "envoy.extensions.filters.common.fault.v3.FaultDelay" as const,
...
function createBaseFaultDelay_HeaderDelay(): FaultDelay_HeaderDelay {
  return { $type: "envoy.extensions.filters.common.fault.v3.FaultDelay.HeaderDelay" };
}
...
> = {
  $type: "envoy.extensions.filters.common.fault.v3.FaultDelay.HeaderDelay" as const,
...
function createBaseFaultRateLimit(): FaultRateLimit {
  return { $type: "envoy.extensions.filters.common.fault.v3.FaultRateLimit", limit_type: undefined };
}

export const FaultRateLimit: MessageFns<FaultRateLimit, "envoy.extensions.filters.common.fault.v3.FaultRateLimit"> = {
  $type: "envoy.extensions.filters.common.fault.v3.FaultRateLimit" as const,
...
function createBaseFaultRateLimit_FixedLimit(): FaultRateLimit_FixedLimit {
  return { $type: "envoy.extensions.filters.common.fault.v3.FaultRateLimit.FixedLimit" };
}
...
> = {
  $type: "envoy.extensions.filters.common.fault.v3.FaultRateLimit.FixedLimit" as const,
...
function createBaseFaultRateLimit_HeaderLimit(): FaultRateLimit_HeaderLimit {
  return { $type: "envoy.extensions.filters.common.fault.v3.FaultRateLimit.HeaderLimit" };
}
...
> = {
  $type: "envoy.extensions.filters.common.fault.v3.FaultRateLimit.HeaderLimit" as const,
