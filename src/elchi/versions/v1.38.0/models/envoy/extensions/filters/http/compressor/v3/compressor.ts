...
export interface Compressor_ResponseDirectionConfig {
   ...
   */
  status_header_enabled?: boolean | undefined;
}
...
export interface CompressorOverrides {
   ...
   */
  compressor_library?: TypedExtensionConfig | undefined;
}
...
> = {
  ...
  encode(message: Compressor_ResponseDirectionConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.weaken_etag_on_compress !== undefined && message.weaken_etag_on_compress !== false) {
      writer.uint32(48).bool(message.weaken_etag_on_compress);
    }
    if (message.remove_accept_encoding_header !== undefined && message.remove_accept_encoding_header !== false) {
      writer.uint32(24).bool(message.remove_accept_encoding_header);
    }
    if (message.uncompressible_response_codes !== undefined && message.uncompressible_response_codes.length !== 0) {
      writer.uint32(34).fork();
      for (const v of message.uncompressible_response_codes) {
        writer.uint32(v);
      }
      writer.join();
    }
    if (message.status_header_enabled !== undefined && message.status_header_enabled !== false) {
      writer.uint32(40).bool(message.status_header_enabled);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.weaken_etag_on_compress = reader.bool();
          continue;
        }
        case 3: {
          if (tag !== 24) {
        ...
        case 4: {
          if (tag === 32) {
            if (message.uncompressible_response_codes === undefined) {
              message.uncompressible_response_codes = [];
            }
            message.uncompressible_response_codes!.push(reader.uint32());
        ...
        case 5: {
          ...
          message.status_header_enabled = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Compressor_ResponseDirectionConfig {
    return {
      ...
      disable_on_etag_header: isSet(object.disable_on_etag_header)
        ? globalThis.Boolean(object.disable_on_etag_header)
        : undefined,
      weaken_etag_on_compress: isSet(object.weaken_etag_on_compress)
        ? globalThis.Boolean(object.weaken_etag_on_compress)
        : undefined,
      remove_accept_encoding_header: isSet(object.remove_accept_encoding_header)
        ? globalThis.Boolean(object.remove_accept_encoding_header)
        : undefined,
      uncompressible_response_codes: globalThis.Array.isArray(object?.uncompressible_response_codes)
        ? object.uncompressible_response_codes.map((e: any) => globalThis.Number(e))
        : undefined,
      status_header_enabled: isSet(object.status_header_enabled)
        ? globalThis.Boolean(object.status_header_enabled)
        : undefined,
    };
  },
  ...
  toJSON(message: Compressor_ResponseDirectionConfig): unknown {
    ...
    if (message.weaken_etag_on_compress !== undefined) {
      obj.weaken_etag_on_compress = message.weaken_etag_on_compress;
    }
    if (message.remove_accept_encoding_header !== undefined) {
      obj.remove_accept_encoding_header = message.remove_accept_encoding_header;
    }
    if (message.uncompressible_response_codes?.length) {
      obj.uncompressible_response_codes = message.uncompressible_response_codes.map((e) => Math.round(e));
    }
    if (message.status_header_enabled !== undefined) {
      obj.status_header_enabled = message.status_header_enabled;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Compressor_ResponseDirectionConfig>, I>>(
    ...
    message.common_config = (object.common_config !== undefined && object.common_config !== null)
      ...
      : undefined;
    message.disable_on_etag_header = object.disable_on_etag_header ?? undefined;
    message.weaken_etag_on_compress = object.weaken_etag_on_compress ?? undefined;
    message.remove_accept_encoding_header = object.remove_accept_encoding_header ?? undefined;
    message.uncompressible_response_codes = object.uncompressible_response_codes?.map((e) => e) || undefined;
    message.status_header_enabled = object.status_header_enabled ?? undefined;
    return message;
  },
};
...
> = {
  ...
  encode(message: CompressorOverrides, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.compressor_library !== undefined) {
      TypedExtensionConfig.encode(message.compressor_library, writer.uint32(18).fork()).join();
    }
    return writer;
  },
