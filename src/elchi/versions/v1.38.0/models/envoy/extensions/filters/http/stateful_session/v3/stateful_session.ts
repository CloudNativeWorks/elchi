...
export interface StatefulSession {
   ...
   */
  status_on_strict_destination_not_found?: number | undefined;
}
...
> = {
  ...
  encode(message: StatefulSession, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (
      message.status_on_strict_destination_not_found !== undefined &&
      message.status_on_strict_destination_not_found !== 0
    ) {
      writer.uint32(32).uint32(message.status_on_strict_destination_not_found);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.status_on_strict_destination_not_found = reader.uint32();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): StatefulSession {
    return {
      ...
      status_on_strict_destination_not_found: isSet(object.status_on_strict_destination_not_found)
        ? globalThis.Number(object.status_on_strict_destination_not_found)
        : undefined,
    };
  },
  ...
  toJSON(message: StatefulSession): unknown {
    ...
    if (message.status_on_strict_destination_not_found !== undefined) {
      obj.status_on_strict_destination_not_found = Math.round(message.status_on_strict_destination_not_found);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<StatefulSession>, I>>(object: I): StatefulSession {
    ...
    message.status_on_strict_destination_not_found = object.status_on_strict_destination_not_found ?? undefined;
    return message;
  },
};
