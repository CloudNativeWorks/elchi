...
export enum RedisProxy_ConnPoolSettings_ReadPolicy {
  ...
  ANY = "ANY",
  /**
   * LOCAL_ZONE_AFFINITY - Read from replicas in the same availability zone as the Envoy proxy. If no replicas
   ...
   */
  LOCAL_ZONE_AFFINITY = "LOCAL_ZONE_AFFINITY",
  /**
   * LOCAL_ZONE_AFFINITY_REPLICAS_AND_PRIMARY - Similar to LOCAL_ZONE_AFFINITY, but also considers the primary node for same-zone routing.
   ...
   */
  LOCAL_ZONE_AFFINITY_REPLICAS_AND_PRIMARY = "LOCAL_ZONE_AFFINITY_REPLICAS_AND_PRIMARY",
}
...
export function redisProxy_ConnPoolSettings_ReadPolicyFromJSON(object: any): RedisProxy_ConnPoolSettings_ReadPolicy {
  switch (object) {
    ...
    case 5:
    case "LOCAL_ZONE_AFFINITY":
      return RedisProxy_ConnPoolSettings_ReadPolicy.LOCAL_ZONE_AFFINITY;
    case 6:
    case "LOCAL_ZONE_AFFINITY_REPLICAS_AND_PRIMARY":
      return RedisProxy_ConnPoolSettings_ReadPolicy.LOCAL_ZONE_AFFINITY_REPLICAS_AND_PRIMARY;
    default:
...
export function redisProxy_ConnPoolSettings_ReadPolicyToJSON(object: RedisProxy_ConnPoolSettings_ReadPolicy): string {
  switch (object) {
    ...
    case RedisProxy_ConnPoolSettings_ReadPolicy.ANY:
      return "ANY";
    case RedisProxy_ConnPoolSettings_ReadPolicy.LOCAL_ZONE_AFFINITY:
      return "LOCAL_ZONE_AFFINITY";
    case RedisProxy_ConnPoolSettings_ReadPolicy.LOCAL_ZONE_AFFINITY_REPLICAS_AND_PRIMARY:
      return "LOCAL_ZONE_AFFINITY_REPLICAS_AND_PRIMARY";
    default:
      throw new globalThis.Error(
        "Unrecognized enum value " + object + " for enum RedisProxy_ConnPoolSettings_ReadPolicy",
      );
...
export interface RedisProtocolOptions {
   ...
   */
  credentials?: RedisProtocolOptions_Credential[] | undefined;
}

export interface RedisProtocolOptions_Credential {
  $type: "envoy.extensions.filters.network.redis_proxy.v3.RedisProtocolOptions.Credential";
...
export interface AwsIam {
  $type: "envoy.extensions.filters.network.redis_proxy.v3.AwsIam";
...
> = {
  ...
  encode(message: RedisProtocolOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.aws_iam !== undefined) {
      AwsIam.encode(message.aws_iam, writer.uint32(26).fork()).join();
    }
    if (message.credentials !== undefined && message.credentials.length !== 0) {
      for (const v of message.credentials) {
        RedisProtocolOptions_Credential.encode(v!, writer.uint32(34).fork()).join();
      }
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          const el = RedisProtocolOptions_Credential.decode(reader, reader.uint32());
          if (el !== undefined) {
  ...
  fromJSON(object: any): RedisProtocolOptions {
    return {
      ...
      credentials: globalThis.Array.isArray(object?.credentials)
        ? object.credentials.map((e: any) => RedisProtocolOptions_Credential.fromJSON(e))
        : undefined,
    };
  },
  ...
  toJSON(message: RedisProtocolOptions): unknown {
    ...
    if (message.credentials?.length) {
      obj.credentials = message.credentials.map((e) => RedisProtocolOptions_Credential.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<RedisProtocolOptions>, I>>(object: I): RedisProtocolOptions {
    ...
    message.aws_iam = (object.aws_iam !== undefined && object.aws_iam !== null)
      ...
      : undefined;
    message.credentials = object.credentials?.map((e) => RedisProtocolOptions_Credential.fromPartial(e)) || undefined;
    return message;
  },
};
...
function createBaseRedisProtocolOptions_Credential(): RedisProtocolOptions_Credential {
  return { $type: "envoy.extensions.filters.network.redis_proxy.v3.RedisProtocolOptions.Credential" };
}

export const RedisProtocolOptions_Credential: MessageFns<
  RedisProtocolOptions_Credential,
  "envoy.extensions.filters.network.redis_proxy.v3.RedisProtocolOptions.Credential"
> = {
  $type: "envoy.extensions.filters.network.redis_proxy.v3.RedisProtocolOptions.Credential" as const,

  encode(message: RedisProtocolOptions_Credential, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.address !== undefined) {
      Address.encode(message.address, writer.uint32(10).fork()).join();
    }
    if (message.auth_password !== undefined) {
      DataSource.encode(message.auth_password, writer.uint32(18).fork()).join();
    }
    if (message.auth_username !== undefined) {
      DataSource.encode(message.auth_username, writer.uint32(26).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RedisProtocolOptions_Credential {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRedisProtocolOptions_Credential();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): RedisProtocolOptions_Credential {
    return {
      $type: RedisProtocolOptions_Credential.$type,
  ...
  toJSON(message: RedisProtocolOptions_Credential): unknown {
    const obj: any = {};
    if (message.address !== undefined) {
  ...
  create<I extends Exact<DeepPartial<RedisProtocolOptions_Credential>, I>>(base?: I): RedisProtocolOptions_Credential {
    return RedisProtocolOptions_Credential.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RedisProtocolOptions_Credential>, I>>(
    object: I,
  ): RedisProtocolOptions_Credential {
    const message = createBaseRedisProtocolOptions_Credential();
...
messageTypeRegistry.set(RedisProtocolOptions_Credential.$type, RedisProtocolOptions_Credential);

function createBaseAwsIam(): AwsIam {
  return { $type: "envoy.extensions.filters.network.redis_proxy.v3.AwsIam" };
}

export const AwsIam: MessageFns<AwsIam, "envoy.extensions.filters.network.redis_proxy.v3.AwsIam"> = {
  $type: "envoy.extensions.filters.network.redis_proxy.v3.AwsIam" as const,

  encode(message: AwsIam, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.credential_provider !== undefined) {
      AwsCredentialProvider.encode(message.credential_provider, writer.uint32(10).fork()).join();
    }
    if (message.cache_name !== undefined && message.cache_name !== "") {
      writer.uint32(18).string(message.cache_name);
    }
    if (message.service_name !== undefined && message.service_name !== "") {
      writer.uint32(26).string(message.service_name);
    }
    if (message.region !== undefined && message.region !== "") {
      writer.uint32(34).string(message.region);
    }
    if (message.expiration_time !== undefined) {
      Duration.encode(message.expiration_time, writer.uint32(42).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AwsIam {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseAwsIam();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.cache_name = reader.string();
          continue;
        }
        case 3: {
          if (tag !== 26) {
  ...
  toJSON(message: AwsIam): unknown {
    const obj: any = {};
    if (message.credential_provider !== undefined) {
      obj.credential_provider = AwsCredentialProvider.toJSON(message.credential_provider);
    }
    if (message.cache_name !== undefined) {
      obj.cache_name = message.cache_name;
    }
  ...
  create<I extends Exact<DeepPartial<AwsIam>, I>>(base?: I): AwsIam {
    return AwsIam.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<AwsIam>, I>>(object: I): AwsIam {
    const message = createBaseAwsIam();
    message.credential_provider = (object.credential_provider !== undefined && object.credential_provider !== null)
      ...
      : undefined;
    message.cache_name = object.cache_name ?? undefined;
...
messageTypeRegistry.set(AwsIam.$type, AwsIam);
