...
export interface ProtoApiScrubberConfig {
  ...
  scrub_unknown_fields?: boolean | undefined;
}
...
export interface Restrictions {
   ...
   */
  message_restrictions?: Map<string, MessageRestrictions> | undefined;
}
...
export interface Restrictions_MessageRestrictionsEntry {
  $type: "envoy.extensions.filters.http.proto_api_scrubber.v3.Restrictions.MessageRestrictionsEntry";
  key: string;
  value?: MessageRestrictions | undefined;
}
...
export interface MethodRestrictions {
   ...
   */
  method_restriction?: RestrictionConfig | undefined;
}
...
export interface MessageRestrictions {
  $type: "envoy.extensions.filters.http.proto_api_scrubber.v3.MessageRestrictions";
  /**
   ...
   */
  field_restrictions?: Map<string, RestrictionConfig> | undefined;
}

export interface MessageRestrictions_FieldRestrictionsEntry {
  $type: "envoy.extensions.filters.http.proto_api_scrubber.v3.MessageRestrictions.FieldRestrictionsEntry";
  key: string;
  value?: RestrictionConfig | undefined;
}
...
> = {
  ...
  encode(message: ProtoApiScrubberConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.scrub_unknown_fields !== undefined && message.scrub_unknown_fields !== false) {
      writer.uint32(32).bool(message.scrub_unknown_fields);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.scrub_unknown_fields = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ProtoApiScrubberConfig {
    return {
      ...
      filtering_mode: isSet(object.filtering_mode)
        ...
        : undefined,
      scrub_unknown_fields: isSet(object.scrub_unknown_fields)
        ? globalThis.Boolean(object.scrub_unknown_fields)
        : undefined,
    };
  },
  ...
  toJSON(message: ProtoApiScrubberConfig): unknown {
    ...
    if (message.scrub_unknown_fields !== undefined) {
      obj.scrub_unknown_fields = message.scrub_unknown_fields;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ProtoApiScrubberConfig>, I>>(object: I): ProtoApiScrubberConfig {
    ...
    message.scrub_unknown_fields = object.scrub_unknown_fields ?? undefined;
    return message;
  },
};
...
> = {
  ...
  encode(message: Restrictions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    (message.message_restrictions || new Map()).forEach((value, key) => {
      Restrictions_MessageRestrictionsEntry.encode({
        $type: "envoy.extensions.filters.http.proto_api_scrubber.v3.Restrictions.MessageRestrictionsEntry",
        key: key as any,
        value,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          const entry2 = Restrictions_MessageRestrictionsEntry.decode(reader, reader.uint32());
          if (entry2.value !== undefined) {
            if (message.message_restrictions === undefined) {
              message.message_restrictions = new Map();
            }
            message.message_restrictions!.set(entry2.key, entry2.value);
          }
          continue;
        }
      }
  ...
  fromJSON(object: any): Restrictions {
    return {
      ...
      method_restrictions: isObject(object.method_restrictions)
        ...
        : undefined,
      message_restrictions: isObject(object.message_restrictions)
        ? Object.entries(object.message_restrictions).reduce<Map<string, MessageRestrictions>>((acc, [key, value]) => {
          acc.set(key, MessageRestrictions.fromJSON(value));
          return acc;
        }, new Map())
        : undefined,
    };
  ...
  toJSON(message: Restrictions): unknown {
    ...
    if (message.message_restrictions?.size) {
      obj.message_restrictions = {};
      message.message_restrictions.forEach((v, k) => {
        obj.message_restrictions[k] = MessageRestrictions.toJSON(v);
      });
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Restrictions>, I>>(object: I): Restrictions {
    ...
    message.message_restrictions = (object.message_restrictions === undefined || object.message_restrictions === null)
      ? undefined
      : (() => {
        const m = new Map();
        (object.message_restrictions as Map<string, MessageRestrictions> ?? new Map()).forEach((value, key) => {
          if (value !== undefined) {
            m.set(key, MessageRestrictions.fromPartial(value));
          }
        });
        return m;
      })();
...
function createBaseRestrictions_MessageRestrictionsEntry(): Restrictions_MessageRestrictionsEntry {
  return {
    $type: "envoy.extensions.filters.http.proto_api_scrubber.v3.Restrictions.MessageRestrictionsEntry",
    key: "",
  };
...
export const Restrictions_MessageRestrictionsEntry: MessageFns<
  Restrictions_MessageRestrictionsEntry,
  "envoy.extensions.filters.http.proto_api_scrubber.v3.Restrictions.MessageRestrictionsEntry"
> = {
  $type: "envoy.extensions.filters.http.proto_api_scrubber.v3.Restrictions.MessageRestrictionsEntry" as const,

  encode(message: Restrictions_MessageRestrictionsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      MessageRestrictions.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): Restrictions_MessageRestrictionsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRestrictions_MessageRestrictionsEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.value = MessageRestrictions.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Restrictions_MessageRestrictionsEntry {
    return {
      $type: Restrictions_MessageRestrictionsEntry.$type,
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? MessageRestrictions.fromJSON(object.value) : undefined,
    };
  },

  toJSON(message: Restrictions_MessageRestrictionsEntry): unknown {
    const obj: any = {};
    if (message.key !== undefined) {
      obj.key = message.key;
    }
    if (message.value !== undefined) {
      obj.value = MessageRestrictions.toJSON(message.value);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<Restrictions_MessageRestrictionsEntry>, I>>(
    base?: I,
  ): Restrictions_MessageRestrictionsEntry {
    return Restrictions_MessageRestrictionsEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Restrictions_MessageRestrictionsEntry>, I>>(
    object: I,
  ): Restrictions_MessageRestrictionsEntry {
    const message = createBaseRestrictions_MessageRestrictionsEntry();
    message.key = object.key ?? "";
    message.value = (object.value !== undefined && object.value !== null)
      ? MessageRestrictions.fromPartial(object.value)
      : undefined;
    return message;
  },
};

messageTypeRegistry.set(Restrictions_MessageRestrictionsEntry.$type, Restrictions_MessageRestrictionsEntry);
...
> = {
  ...
  encode(message: MethodRestrictions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.method_restriction !== undefined) {
      RestrictionConfig.encode(message.method_restriction, writer.uint32(26).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.method_restriction = RestrictionConfig.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): MethodRestrictions {
    return {
      ...
      response_field_restrictions: isObject(object.response_field_restrictions)
        ...
        : undefined,
      method_restriction: isSet(object.method_restriction)
        ? RestrictionConfig.fromJSON(object.method_restriction)
        : undefined,
    };
  },
  ...
  toJSON(message: MethodRestrictions): unknown {
    ...
    if (message.method_restriction !== undefined) {
      obj.method_restriction = RestrictionConfig.toJSON(message.method_restriction);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<MethodRestrictions>, I>>(object: I): MethodRestrictions {
    ...
    message.method_restriction = (object.method_restriction !== undefined && object.method_restriction !== null)
      ? RestrictionConfig.fromPartial(object.method_restriction)
      : undefined;
    return message;
  },
};
...
function createBaseMessageRestrictions(): MessageRestrictions {
  return { $type: "envoy.extensions.filters.http.proto_api_scrubber.v3.MessageRestrictions" };
}

export const MessageRestrictions: MessageFns<
  MessageRestrictions,
  "envoy.extensions.filters.http.proto_api_scrubber.v3.MessageRestrictions"
> = {
  $type: "envoy.extensions.filters.http.proto_api_scrubber.v3.MessageRestrictions" as const,

  encode(message: MessageRestrictions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.config !== undefined) {
      RestrictionConfig.encode(message.config, writer.uint32(10).fork()).join();
    }
    (message.field_restrictions || new Map()).forEach((value, key) => {
      MessageRestrictions_FieldRestrictionsEntry.encode({
        $type: "envoy.extensions.filters.http.proto_api_scrubber.v3.MessageRestrictions.FieldRestrictionsEntry",
        key: key as any,
        value,
      }, writer.uint32(18).fork()).join();
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MessageRestrictions {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMessageRestrictions();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.config = RestrictionConfig.decode(reader, reader.uint32());
          continue;
        }
        case 2: {
          if (tag !== 18) {
          ...
          const entry2 = MessageRestrictions_FieldRestrictionsEntry.decode(reader, reader.uint32());
          if (entry2.value !== undefined) {
            if (message.field_restrictions === undefined) {
              message.field_restrictions = new Map();
            }
            message.field_restrictions!.set(entry2.key, entry2.value);
          }
          continue;
        }
      }
  ...
  fromJSON(object: any): MessageRestrictions {
    return {
      $type: MessageRestrictions.$type,
      config: isSet(object.config) ? RestrictionConfig.fromJSON(object.config) : undefined,
      field_restrictions: isObject(object.field_restrictions)
        ? Object.entries(object.field_restrictions).reduce<Map<string, RestrictionConfig>>((acc, [key, value]) => {
          acc.set(key, RestrictionConfig.fromJSON(value));
          return acc;
        }, new Map())
        : undefined,
  ...
  toJSON(message: MessageRestrictions): unknown {
    const obj: any = {};
    if (message.config !== undefined) {
      obj.config = RestrictionConfig.toJSON(message.config);
    }
    if (message.field_restrictions?.size) {
      obj.field_restrictions = {};
      message.field_restrictions.forEach((v, k) => {
        obj.field_restrictions[k] = RestrictionConfig.toJSON(v);
      });
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<MessageRestrictions>, I>>(base?: I): MessageRestrictions {
    return MessageRestrictions.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MessageRestrictions>, I>>(object: I): MessageRestrictions {
    const message = createBaseMessageRestrictions();
    message.config = (object.config !== undefined && object.config !== null)
      ? RestrictionConfig.fromPartial(object.config)
      : undefined;
    message.field_restrictions = (object.field_restrictions === undefined || object.field_restrictions === null)
      ? undefined
      : (() => {
        const m = new Map();
        (object.field_restrictions as Map<string, RestrictionConfig> ?? new Map()).forEach((value, key) => {
          if (value !== undefined) {
            m.set(key, RestrictionConfig.fromPartial(value));
          }
        });
...
messageTypeRegistry.set(MessageRestrictions.$type, MessageRestrictions);

function createBaseMessageRestrictions_FieldRestrictionsEntry(): MessageRestrictions_FieldRestrictionsEntry {
  return {
    $type: "envoy.extensions.filters.http.proto_api_scrubber.v3.MessageRestrictions.FieldRestrictionsEntry",
    key: "",
  };
...
export const MessageRestrictions_FieldRestrictionsEntry: MessageFns<
  MessageRestrictions_FieldRestrictionsEntry,
  "envoy.extensions.filters.http.proto_api_scrubber.v3.MessageRestrictions.FieldRestrictionsEntry"
> = {
  $type: "envoy.extensions.filters.http.proto_api_scrubber.v3.MessageRestrictions.FieldRestrictionsEntry" as const,

  encode(message: MessageRestrictions_FieldRestrictionsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MessageRestrictions_FieldRestrictionsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMessageRestrictions_FieldRestrictionsEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): MessageRestrictions_FieldRestrictionsEntry {
    return {
      $type: MessageRestrictions_FieldRestrictionsEntry.$type,
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? RestrictionConfig.fromJSON(object.value) : undefined,
    };
  },

  toJSON(message: MessageRestrictions_FieldRestrictionsEntry): unknown {
    const obj: any = {};
    if (message.key !== undefined) {
      obj.key = message.key;
    }
  ...
  create<I extends Exact<DeepPartial<MessageRestrictions_FieldRestrictionsEntry>, I>>(
    base?: I,
  ): MessageRestrictions_FieldRestrictionsEntry {
    return MessageRestrictions_FieldRestrictionsEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MessageRestrictions_FieldRestrictionsEntry>, I>>(
    object: I,
  ): MessageRestrictions_FieldRestrictionsEntry {
    const message = createBaseMessageRestrictions_FieldRestrictionsEntry();
    message.key = object.key ?? "";
...
messageTypeRegistry.set(MessageRestrictions_FieldRestrictionsEntry.$type, MessageRestrictions_FieldRestrictionsEntry);
