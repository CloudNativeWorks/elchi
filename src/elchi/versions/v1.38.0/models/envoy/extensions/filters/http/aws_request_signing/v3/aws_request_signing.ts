...
export interface AwsRequestSigning {
   ...
   */
  match_included_headers?: StringMatcher[] | undefined;
}
...
> = {
  ...
  encode(message: AwsRequestSigning, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.match_included_headers !== undefined && message.match_included_headers.length !== 0) {
      for (const v of message.match_included_headers) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9: {
          ...
          if (message.match_included_headers === undefined) {
            message.match_included_headers = [];
          }
          const el = StringMatcher.decode(reader, reader.uint32());
          if (el !== undefined) {
            message.match_included_headers!.push(el);
          }
          continue;
        }
      }
  ...
  fromJSON(object: any): AwsRequestSigning {
    return {
      ...
      credential_provider: isSet(object.credential_provider)
        ...
        : undefined,
      match_included_headers: globalThis.Array.isArray(object?.match_included_headers)
        ? object.match_included_headers.map((e: any) => StringMatcher.fromJSON(e))
        : undefined,
    };
  },
  ...
  toJSON(message: AwsRequestSigning): unknown {
    ...
    if (message.match_included_headers?.length) {
      obj.match_included_headers = message.match_included_headers.map((e) => StringMatcher.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<AwsRequestSigning>, I>>(object: I): AwsRequestSigning {
    ...
    message.credential_provider = (object.credential_provider !== undefined && object.credential_provider !== null)
      ...
      : undefined;
    message.match_included_headers = object.match_included_headers?.map((e) => StringMatcher.fromPartial(e)) ||
      undefined;
    return message;
  },
};
