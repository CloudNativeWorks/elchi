 ...
 * [#not-implemented-hide:]
 */
export interface CompositePerRoute {
  $type: "envoy.extensions.filters.http.composite.v3.CompositePerRoute";
...
export const Composite: MessageFns<Composite, "envoy.extensions.filters.http.composite.v3.Composite"> = {
  ...
  encode(message: Composite, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.matcher !== undefined) {
      Matcher.encode(message.matcher, writer.uint32(18).fork()).join();
    }
    return writer;
  },
...
function createBaseCompositePerRoute(): CompositePerRoute {
  return { $type: "envoy.extensions.filters.http.composite.v3.CompositePerRoute" };
}

export const CompositePerRoute: MessageFns<
  CompositePerRoute,
  "envoy.extensions.filters.http.composite.v3.CompositePerRoute"
> = {
  $type: "envoy.extensions.filters.http.composite.v3.CompositePerRoute" as const,

  encode(message: CompositePerRoute, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.matcher !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CompositePerRoute {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCompositePerRoute();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CompositePerRoute {
    return {
      $type: CompositePerRoute.$type,
      matcher: isSet(object.matcher) ? Matcher.fromJSON(object.matcher) : undefined,
    };
  },

  toJSON(message: CompositePerRoute): unknown {
    const obj: any = {};
    if (message.matcher !== undefined) {
      obj.matcher = Matcher.toJSON(message.matcher);
    }
  ...
  create<I extends Exact<DeepPartial<CompositePerRoute>, I>>(base?: I): CompositePerRoute {
    return CompositePerRoute.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CompositePerRoute>, I>>(object: I): CompositePerRoute {
    const message = createBaseCompositePerRoute();
    message.matcher = (object.matcher !== undefined && object.matcher !== null)
      ? Matcher.fromPartial(object.matcher)
      : undefined;
...
messageTypeRegistry.set(CompositePerRoute.$type, CompositePerRoute);
