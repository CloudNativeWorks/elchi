...
export interface ReverseTunnel {
   ...
   */
  required_cluster_name?: string | undefined;
}
...
export const Validation: MessageFns<Validation, "envoy.extensions.filters.network.reverse_tunnel.v3.Validation"> = {
  ...
  encode(message: Validation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.tenant_id_format !== undefined && message.tenant_id_format !== "") {
      writer.uint32(42).string(message.tenant_id_format);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.tenant_id_format = reader.string();
          continue;
        }
        case 3: {
          if (tag !== 24) {
  ...
  fromJSON(object: any): Validation {
    return {
      ...
      tenant_id_format: isSet(object.tenant_id_format) ? globalThis.String(object.tenant_id_format) : undefined,
  ...
  toJSON(message: Validation): unknown {
    ...
    if (message.tenant_id_format !== undefined) {
      obj.tenant_id_format = message.tenant_id_format;
    }
  ...
  fromPartial<I extends Exact<DeepPartial<Validation>, I>>(object: I): Validation {
    ...
    message.tenant_id_format = object.tenant_id_format ?? undefined;
...
> = {
  ...
  encode(message: ReverseTunnel, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.required_cluster_name !== undefined && message.required_cluster_name !== "") {
      writer.uint32(50).string(message.required_cluster_name);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.required_cluster_name = reader.string();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ReverseTunnel {
    return {
      ...
      required_cluster_name: isSet(object.required_cluster_name)
        ? globalThis.String(object.required_cluster_name)
        : undefined,
    };
  },
  ...
  toJSON(message: ReverseTunnel): unknown {
    ...
    if (message.required_cluster_name !== undefined) {
      obj.required_cluster_name = message.required_cluster_name;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ReverseTunnel>, I>>(object: I): ReverseTunnel {
    ...
    message.validation = (object.validation !== undefined && object.validation !== null)
      ...
      : undefined;
    message.required_cluster_name = object.required_cluster_name ?? undefined;
    return message;
  },
};
