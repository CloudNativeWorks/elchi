...
export enum UpstreamConnectMode {
  /**
   * IMMEDIATE - Establish the upstream connection immediately when the downstream connection is accepted.
   * This is the default behavior and provides the lowest latency.
   */
  IMMEDIATE = "IMMEDIATE",
  /**
   * ON_DOWNSTREAM_DATA - Wait for initial data from the downstream connection before establishing the upstream connection.
   ...
   */
  ON_DOWNSTREAM_DATA = "ON_DOWNSTREAM_DATA",
  /**
   * ON_DOWNSTREAM_TLS_HANDSHAKE - Wait for the downstream TLS handshake to complete before establishing the upstream connection.
   ...
   */
  ON_DOWNSTREAM_TLS_HANDSHAKE = "ON_DOWNSTREAM_TLS_HANDSHAKE",
}

export function upstreamConnectModeFromJSON(object: any): UpstreamConnectMode {
  switch (object) {
    case 0:
    case "IMMEDIATE":
      return UpstreamConnectMode.IMMEDIATE;
    case 1:
    case "ON_DOWNSTREAM_DATA":
      return UpstreamConnectMode.ON_DOWNSTREAM_DATA;
    case 2:
    case "ON_DOWNSTREAM_TLS_HANDSHAKE":
      return UpstreamConnectMode.ON_DOWNSTREAM_TLS_HANDSHAKE;
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum UpstreamConnectMode");
  }
}

export function upstreamConnectModeToJSON(object: UpstreamConnectMode): string {
  switch (object) {
    case UpstreamConnectMode.IMMEDIATE:
      return "IMMEDIATE";
    case UpstreamConnectMode.ON_DOWNSTREAM_DATA:
      return "ON_DOWNSTREAM_DATA";
    case UpstreamConnectMode.ON_DOWNSTREAM_TLS_HANDSHAKE:
      return "ON_DOWNSTREAM_TLS_HANDSHAKE";
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum UpstreamConnectMode");
  }
}

export function upstreamConnectModeToNumber(object: UpstreamConnectMode): number {
  switch (object) {
    case UpstreamConnectMode.IMMEDIATE:
      return 0;
    case UpstreamConnectMode.ON_DOWNSTREAM_DATA:
 ...
 */
export enum ProxyProtocolTlvMergePolicy {
  /**
   * ADD_IF_ABSENT - Add configured TLVs only if no PROXY protocol state exists (e.g., no downstream TLVs).
   * If state exists, ignore configured TLVs and use only the existing TLVs.
   * This is the default for backward compatibility.
   */
  ADD_IF_ABSENT = "ADD_IF_ABSENT",
  /**
   * OVERWRITE_BY_TYPE_IF_EXISTS_OR_ADD - Overwrite existing TLVs (e.g., downstream TLVs) by type with configured TLVs.
   ...
   */
  OVERWRITE_BY_TYPE_IF_EXISTS_OR_ADD = "OVERWRITE_BY_TYPE_IF_EXISTS_OR_ADD",
  /**
   * APPEND_IF_EXISTS_OR_ADD - Append configured TLVs to existing TLVs (e.g., downstream TLVs), preserving all TLVs
...
export function proxyProtocolTlvMergePolicyFromJSON(object: any): ProxyProtocolTlvMergePolicy {
  switch (object) {
    case 0:
    case "ADD_IF_ABSENT":
      return ProxyProtocolTlvMergePolicy.ADD_IF_ABSENT;
    case 1:
    case "OVERWRITE_BY_TYPE_IF_EXISTS_OR_ADD":
      return ProxyProtocolTlvMergePolicy.OVERWRITE_BY_TYPE_IF_EXISTS_OR_ADD;
    case 2:
    case "APPEND_IF_EXISTS_OR_ADD":
      return ProxyProtocolTlvMergePolicy.APPEND_IF_EXISTS_OR_ADD;
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum ProxyProtocolTlvMergePolicy");
  }
}

export function proxyProtocolTlvMergePolicyToJSON(object: ProxyProtocolTlvMergePolicy): string {
  switch (object) {
    case ProxyProtocolTlvMergePolicy.ADD_IF_ABSENT:
      return "ADD_IF_ABSENT";
    case ProxyProtocolTlvMergePolicy.OVERWRITE_BY_TYPE_IF_EXISTS_OR_ADD:
      return "OVERWRITE_BY_TYPE_IF_EXISTS_OR_ADD";
    case ProxyProtocolTlvMergePolicy.APPEND_IF_EXISTS_OR_ADD:
...
export function proxyProtocolTlvMergePolicyToNumber(object: ProxyProtocolTlvMergePolicy): number {
  switch (object) {
    case ProxyProtocolTlvMergePolicy.ADD_IF_ABSENT:
      return 0;
    case ProxyProtocolTlvMergePolicy.OVERWRITE_BY_TYPE_IF_EXISTS_OR_ADD:
...
export interface TcpProxy {
   ...
   */
  max_early_data_bytes?: number | undefined;
}
...
export interface TcpProxy_TcpAccessLogOptions {
  ...
  flush_access_log_on_start?: boolean | undefined;
}
...
export const TcpProxy: MessageFns<TcpProxy, "envoy.extensions.filters.network.tcp_proxy.v3.TcpProxy"> = {
  ...
  encode(message: TcpProxy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (
      message.proxy_protocol_tlv_merge_policy !== undefined &&
      message.proxy_protocol_tlv_merge_policy !== ProxyProtocolTlvMergePolicy.ADD_IF_ABSENT
    ) {
      writer.uint32(184).int32(proxyProtocolTlvMergePolicyToNumber(message.proxy_protocol_tlv_merge_policy));
    }
    if (
      message.upstream_connect_mode !== undefined && message.upstream_connect_mode !== UpstreamConnectMode.IMMEDIATE
    ) {
      writer.uint32(168).int32(upstreamConnectModeToNumber(message.upstream_connect_mode));
    }
    if (message.max_early_data_bytes !== undefined) {
      UInt32Value.encode(
        { $type: "google.protobuf.UInt32Value", value: message.max_early_data_bytes! },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 23: {
          ...
          message.proxy_protocol_tlv_merge_policy = proxyProtocolTlvMergePolicyFromJSON(reader.int32());
          continue;
        }
        case 21: {
          if (tag !== 168) {
          ...
          message.upstream_connect_mode = upstreamConnectModeFromJSON(reader.int32());
          continue;
        }
        case 22: {
          if (tag !== 178) {
          ...
          message.max_early_data_bytes = UInt32Value.decode(reader, reader.uint32()).value;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): TcpProxy {
    return {
      ...
      proxy_protocol_tlvs: globalThis.Array.isArray(object?.proxy_protocol_tlvs)
        ...
        : undefined,
      proxy_protocol_tlv_merge_policy: isSet(object.proxy_protocol_tlv_merge_policy)
        ? proxyProtocolTlvMergePolicyFromJSON(object.proxy_protocol_tlv_merge_policy)
        : undefined,
      upstream_connect_mode: isSet(object.upstream_connect_mode)
        ? upstreamConnectModeFromJSON(object.upstream_connect_mode)
        : undefined,
      max_early_data_bytes: isSet(object.max_early_data_bytes) ? Number(object.max_early_data_bytes) : undefined,
    };
  },
  ...
  toJSON(message: TcpProxy): unknown {
    ...
    if (message.proxy_protocol_tlv_merge_policy !== undefined) {
      obj.proxy_protocol_tlv_merge_policy = proxyProtocolTlvMergePolicyToJSON(message.proxy_protocol_tlv_merge_policy);
    }
    if (message.upstream_connect_mode !== undefined) {
      obj.upstream_connect_mode = upstreamConnectModeToJSON(message.upstream_connect_mode);
    }
    if (message.max_early_data_bytes !== undefined) {
      obj.max_early_data_bytes = message.max_early_data_bytes;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<TcpProxy>, I>>(object: I): TcpProxy {
    ...
    message.proxy_protocol_tlv_merge_policy = object.proxy_protocol_tlv_merge_policy ?? undefined;
    message.upstream_connect_mode = object.upstream_connect_mode ?? undefined;
    message.max_early_data_bytes = object.max_early_data_bytes ?? undefined;
    return message;
  },
};
...
> = {
  ...
  encode(message: TcpProxy_TcpAccessLogOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.flush_access_log_on_start !== undefined && message.flush_access_log_on_start !== false) {
      writer.uint32(24).bool(message.flush_access_log_on_start);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.flush_access_log_on_start = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): TcpProxy_TcpAccessLogOptions {
    return {
      ...
      flush_access_log_on_connected: isSet(object.flush_access_log_on_connected)
        ? globalThis.Boolean(object.flush_access_log_on_connected)
        : undefined,
      flush_access_log_on_start: isSet(object.flush_access_log_on_start)
        ? globalThis.Boolean(object.flush_access_log_on_start)
        : undefined,
    };
  },
  ...
  toJSON(message: TcpProxy_TcpAccessLogOptions): unknown {
    ...
    if (message.flush_access_log_on_start !== undefined) {
      obj.flush_access_log_on_start = message.flush_access_log_on_start;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<TcpProxy_TcpAccessLogOptions>, I>>(object: I): TcpProxy_TcpAccessLogOptions {
    ...
    message.access_log_flush_interval =
      (object.access_log_flush_interval !== undefined && object.access_log_flush_interval !== null)
        ...
        : undefined;
    message.flush_access_log_on_connected = object.flush_access_log_on_connected ?? undefined;
    message.flush_access_log_on_start = object.flush_access_log_on_start ?? undefined;
    return message;
  },
};
