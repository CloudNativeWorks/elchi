...
> = {
  ...
  encode(message: RateLimitDescriptor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.hits_addend !== undefined) {
      UInt64Value.encode(
        { $type: "google.protobuf.UInt64Value", value: message.hits_addend! },
        writer.uint32(26).fork(),
      ).join();
    }
    if (message.is_negative_hits !== undefined && message.is_negative_hits !== false) {
      writer.uint32(32).bool(message.is_negative_hits);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.hits_addend = UInt64Value.decode(reader, reader.uint32()).value;
          continue;
        }
        case 4: {
          if (tag !== 32) {
  ...
  fromJSON(object: any): RateLimitDescriptor {
    return {
      ...
      hits_addend: isSet(object.hits_addend) ? Number(object.hits_addend) : undefined,
  ...
  toJSON(message: RateLimitDescriptor): unknown {
    ...
    if (message.hits_addend !== undefined) {
      obj.hits_addend = message.hits_addend;
    }
...
> = {
  ...
  encode(message: LocalRateLimitDescriptor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.shadow_mode !== undefined && message.shadow_mode !== false) {
      writer.uint32(24).bool(message.shadow_mode);
    }
    return writer;
  },
