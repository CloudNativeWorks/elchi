...
export const protobufPackage = "envoy.data.cluster.v2alpha";
...
export interface OutlierDetectionEvent {
  $type: "envoy.data.cluster.v2alpha.OutlierDetectionEvent";
...
function createBaseOutlierDetectionEvent(): OutlierDetectionEvent {
  return { $type: "envoy.data.cluster.v2alpha.OutlierDetectionEvent", event: undefined };
}

export const OutlierDetectionEvent: MessageFns<
  OutlierDetectionEvent,
  "envoy.data.cluster.v2alpha.OutlierDetectionEvent"
> = {
  $type: "envoy.data.cluster.v2alpha.OutlierDetectionEvent" as const,
...
function createBaseOutlierEjectSuccessRate(): OutlierEjectSuccessRate {
  return { $type: "envoy.data.cluster.v2alpha.OutlierEjectSuccessRate" };
}
...
> = {
  $type: "envoy.data.cluster.v2alpha.OutlierEjectSuccessRate" as const,
...
function createBaseOutlierEjectConsecutive(): OutlierEjectConsecutive {
  return { $type: "envoy.data.cluster.v2alpha.OutlierEjectConsecutive" };
}
...
> = {
  $type: "envoy.data.cluster.v2alpha.OutlierEjectConsecutive" as const,
...
function createBaseOutlierEjectFailurePercentage(): OutlierEjectFailurePercentage {
  return { $type: "envoy.data.cluster.v2alpha.OutlierEjectFailurePercentage" };
}
...
> = {
  $type: "envoy.data.cluster.v2alpha.OutlierEjectFailurePercentage" as const,
