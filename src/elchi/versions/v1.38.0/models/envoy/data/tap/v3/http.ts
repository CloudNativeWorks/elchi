...
export interface HttpBufferedTrace {
  ...
  downstream_connection?:
    ...
    | undefined;
  /** upstream connection */
  upstream_connection?: Connection | undefined;
}
...
export const HttpBufferedTrace: MessageFns<HttpBufferedTrace, "envoy.data.tap.v3.HttpBufferedTrace"> = {
  ...
  encode(message: HttpBufferedTrace, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.upstream_connection !== undefined) {
      Connection.encode(message.upstream_connection, writer.uint32(34).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.upstream_connection = Connection.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): HttpBufferedTrace {
    return {
      ...
      downstream_connection: isSet(object.downstream_connection)
        ...
        : undefined,
      upstream_connection: isSet(object.upstream_connection)
        ? Connection.fromJSON(object.upstream_connection)
        : undefined,
    };
  },
  ...
  toJSON(message: HttpBufferedTrace): unknown {
    ...
    if (message.upstream_connection !== undefined) {
      obj.upstream_connection = Connection.toJSON(message.upstream_connection);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<HttpBufferedTrace>, I>>(object: I): HttpBufferedTrace {
    ...
    message.downstream_connection =
      (object.downstream_connection !== undefined && object.downstream_connection !== null)
        ...
        : undefined;
    message.upstream_connection = (object.upstream_connection !== undefined && object.upstream_connection !== null)
      ? Connection.fromPartial(object.upstream_connection)
      : undefined;
    return message;
  },
};
