...
export interface TraceWrapper {
  $type: "envoy.data.tap.v3.TraceWrapper";
  trace?:
    | //
...
function createBaseTraceWrapper(): TraceWrapper {
  return { $type: "envoy.data.tap.v3.TraceWrapper", trace: undefined };
}

export const TraceWrapper: MessageFns<TraceWrapper, "envoy.data.tap.v3.TraceWrapper"> = {
  $type: "envoy.data.tap.v3.TraceWrapper" as const,
