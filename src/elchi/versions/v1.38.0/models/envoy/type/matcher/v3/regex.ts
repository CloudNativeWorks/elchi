...
function createBaseRegexMatcher(): RegexMatcher {
  return { $type: "envoy.type.matcher.v3.RegexMatcher", engine_type: undefined };
}

export const RegexMatcher: MessageFns<RegexMatcher, "envoy.type.matcher.v3.RegexMatcher"> = {
  $type: "envoy.type.matcher.v3.RegexMatcher" as const,
...
function createBaseRegexMatcher_GoogleRE2(): RegexMatcher_GoogleRE2 {
  return { $type: "envoy.type.matcher.v3.RegexMatcher.GoogleRE2" };
}

export const RegexMatcher_GoogleRE2: MessageFns<
  RegexMatcher_GoogleRE2,
  "envoy.type.matcher.v3.RegexMatcher.GoogleRE2"
> = {
  $type: "envoy.type.matcher.v3.RegexMatcher.GoogleRE2" as const,
...
function createBaseRegexMatchAndSubstitute(): RegexMatchAndSubstitute {
  return { $type: "envoy.type.matcher.v3.RegexMatchAndSubstitute" };
}
...
> = {
  $type: "envoy.type.matcher.v3.RegexMatchAndSubstitute" as const,
