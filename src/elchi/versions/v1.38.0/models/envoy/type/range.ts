...
function createBaseInt64Range(): Int64Range {
  return { $type: "envoy.type.Int64Range" };
}

export const Int64Range: MessageFns<Int64Range, "envoy.type.Int64Range"> = {
  $type: "envoy.type.Int64Range" as const,
...
function createBaseInt32Range(): Int32Range {
  return { $type: "envoy.type.Int32Range" };
}

export const Int32Range: MessageFns<Int32Range, "envoy.type.Int32Range"> = {
  $type: "envoy.type.Int32Range" as const,
...
function createBaseDoubleRange(): DoubleRange {
  return { $type: "envoy.type.DoubleRange" };
}

export const DoubleRange: MessageFns<DoubleRange, "envoy.type.DoubleRange"> = {
  $type: "envoy.type.DoubleRange" as const,
