...
export interface SocketOption {
   ...
   */
  ip_version?: SocketOption_SocketIpVersion | undefined;
}
 ...
 * socket option to.
 */
export enum SocketOption_SocketIpVersion {
  /** SOCKET_IP_VERSION_UNSPECIFIED - Apply the socket option to all socket IP versions. */
  SOCKET_IP_VERSION_UNSPECIFIED = "SOCKET_IP_VERSION_UNSPECIFIED",
  /** SOCKET_IP_VERSION_IPV4 - Apply the socket option to the IPv4 socket type. */
  SOCKET_IP_VERSION_IPV4 = "SOCKET_IP_VERSION_IPV4",
  /** SOCKET_IP_VERSION_IPV6 - Apply the socket option to the IPv6 socket type. */
  SOCKET_IP_VERSION_IPV6 = "SOCKET_IP_VERSION_IPV6",
}

export function socketOption_SocketIpVersionFromJSON(object: any): SocketOption_SocketIpVersion {
  switch (object) {
    case 0:
    case "SOCKET_IP_VERSION_UNSPECIFIED":
      return SocketOption_SocketIpVersion.SOCKET_IP_VERSION_UNSPECIFIED;
    case 1:
    case "SOCKET_IP_VERSION_IPV4":
      return SocketOption_SocketIpVersion.SOCKET_IP_VERSION_IPV4;
    case 2:
    case "SOCKET_IP_VERSION_IPV6":
      return SocketOption_SocketIpVersion.SOCKET_IP_VERSION_IPV6;
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum SocketOption_SocketIpVersion");
  }
}

export function socketOption_SocketIpVersionToJSON(object: SocketOption_SocketIpVersion): string {
  switch (object) {
    case SocketOption_SocketIpVersion.SOCKET_IP_VERSION_UNSPECIFIED:
      return "SOCKET_IP_VERSION_UNSPECIFIED";
    case SocketOption_SocketIpVersion.SOCKET_IP_VERSION_IPV4:
      return "SOCKET_IP_VERSION_IPV4";
    case SocketOption_SocketIpVersion.SOCKET_IP_VERSION_IPV6:
      return "SOCKET_IP_VERSION_IPV6";
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum SocketOption_SocketIpVersion");
  }
}

export function socketOption_SocketIpVersionToNumber(object: SocketOption_SocketIpVersion): number {
  switch (object) {
    case SocketOption_SocketIpVersion.SOCKET_IP_VERSION_UNSPECIFIED:
      return 0;
    case SocketOption_SocketIpVersion.SOCKET_IP_VERSION_IPV4:
...
export const SocketOption: MessageFns<SocketOption, "envoy.config.core.v3.SocketOption"> = {
  ...
  encode(message: SocketOption, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (
      message.ip_version !== undefined &&
      message.ip_version !== SocketOption_SocketIpVersion.SOCKET_IP_VERSION_UNSPECIFIED
    ) {
      writer.uint32(64).int32(socketOption_SocketIpVersionToNumber(message.ip_version));
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8: {
          ...
          message.ip_version = socketOption_SocketIpVersionFromJSON(reader.int32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): SocketOption {
    return {
      ...
      ip_version: isSet(object.ip_version) ? socketOption_SocketIpVersionFromJSON(object.ip_version) : undefined,
    };
  },
  ...
  toJSON(message: SocketOption): unknown {
    ...
    if (message.ip_version !== undefined) {
      obj.ip_version = socketOption_SocketIpVersionToJSON(message.ip_version);
    }
    return obj;
  },
