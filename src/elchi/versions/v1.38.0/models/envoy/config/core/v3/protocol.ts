...
export interface QuicProtocolOptions {
   ...
   */
  enable_scone?: boolean | undefined;
}
...
export interface Http2ProtocolOptions {
   ...
   * obs-text = %x80-FF
   */
  disallow_obs_text?: boolean | undefined;
}
...
export const QuicProtocolOptions: MessageFns<QuicProtocolOptions, "envoy.config.core.v3.QuicProtocolOptions"> = {
  ...
  encode(message: QuicProtocolOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.memory_reduction_timeout !== undefined) {
      Duration.encode(message.memory_reduction_timeout, writer.uint32(98).fork()).join();
    }
    if (message.enable_scone !== undefined) {
      BoolValue.encode({ $type: "google.protobuf.BoolValue", value: message.enable_scone! }, writer.uint32(106).fork())
        .join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 12: {
          ...
          message.memory_reduction_timeout = Duration.decode(reader, reader.uint32());
          continue;
        }
        case 13: {
          if (tag !== 106) {
          ...
          message.enable_scone = BoolValue.decode(reader, reader.uint32()).value;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): QuicProtocolOptions {
    return {
      ...
      connection_migration: isSet(object.connection_migration)
        ...
        : undefined,
      memory_reduction_timeout: isSet(object.memory_reduction_timeout)
        ? Duration.fromJSON(object.memory_reduction_timeout)
        : undefined,
      enable_scone: isSet(object.enable_scone) ? Boolean(object.enable_scone) : undefined,
    };
  },
  ...
  toJSON(message: QuicProtocolOptions): unknown {
    ...
    if (message.memory_reduction_timeout !== undefined) {
      obj.memory_reduction_timeout = Duration.toJSON(message.memory_reduction_timeout);
    }
    if (message.enable_scone !== undefined) {
      obj.enable_scone = message.enable_scone;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<QuicProtocolOptions>, I>>(object: I): QuicProtocolOptions {
    ...
    message.connection_migration = (object.connection_migration !== undefined && object.connection_migration !== null)
      ...
      : undefined;
    message.memory_reduction_timeout =
      (object.memory_reduction_timeout !== undefined && object.memory_reduction_timeout !== null)
        ? Duration.fromPartial(object.memory_reduction_timeout)
        : undefined;
    message.enable_scone = object.enable_scone ?? undefined;
    return message;
  },
};
...
export const Http2ProtocolOptions: MessageFns<Http2ProtocolOptions, "envoy.config.core.v3.Http2ProtocolOptions"> = {
  ...
  encode(message: Http2ProtocolOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.max_header_field_size_kb !== undefined) {
      UInt32Value.encode(
        { $type: "google.protobuf.UInt32Value", value: message.max_header_field_size_kb! },
        writer.uint32(154).fork(),
      ).join();
    }
    if (message.disallow_obs_text !== undefined) {
      BoolValue.encode(
        { $type: "google.protobuf.BoolValue", value: message.disallow_obs_text! },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 19: {
          ...
          message.max_header_field_size_kb = UInt32Value.decode(reader, reader.uint32()).value;
          continue;
        }
        case 20: {
          if (tag !== 162) {
          ...
          message.disallow_obs_text = BoolValue.decode(reader, reader.uint32()).value;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Http2ProtocolOptions {
    return {
      ...
      enable_huffman_encoding: isSet(object.enable_huffman_encoding)
        ...
        : undefined,
      max_header_field_size_kb: isSet(object.max_header_field_size_kb)
        ? Number(object.max_header_field_size_kb)
        : undefined,
      disallow_obs_text: isSet(object.disallow_obs_text) ? Boolean(object.disallow_obs_text) : undefined,
    };
  },
  ...
  toJSON(message: Http2ProtocolOptions): unknown {
    ...
    if (message.max_header_field_size_kb !== undefined) {
      obj.max_header_field_size_kb = message.max_header_field_size_kb;
    }
    if (message.disallow_obs_text !== undefined) {
      obj.disallow_obs_text = message.disallow_obs_text;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Http2ProtocolOptions>, I>>(object: I): Http2ProtocolOptions {
    ...
    message.max_header_field_size_kb = object.max_header_field_size_kb ?? undefined;
    message.disallow_obs_text = object.disallow_obs_text ?? undefined;
    return message;
  },
};
