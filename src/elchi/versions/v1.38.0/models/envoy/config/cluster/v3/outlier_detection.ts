...
export interface OutlierDetection {
   ...
   * Defaults to false.
   */
  detect_degraded_hosts?: boolean | undefined;
}
...
export const OutlierDetection: MessageFns<OutlierDetection, "envoy.config.cluster.v3.OutlierDetection"> = {
  ...
  encode(message: OutlierDetection, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.detect_degraded_hosts !== undefined) {
      BoolValue.encode(
        { $type: "google.protobuf.BoolValue", value: message.detect_degraded_hosts! },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 26: {
          ...
          message.detect_degraded_hosts = BoolValue.decode(reader, reader.uint32()).value;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): OutlierDetection {
    return {
      ...
      detect_degraded_hosts: isSet(object.detect_degraded_hosts) ? Boolean(object.detect_degraded_hosts) : undefined,
    };
  },
  ...
  toJSON(message: OutlierDetection): unknown {
    ...
    if (message.detect_degraded_hosts !== undefined) {
      obj.detect_degraded_hosts = message.detect_degraded_hosts;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<OutlierDetection>, I>>(object: I): OutlierDetection {
    ...
    message.detect_degraded_hosts = object.detect_degraded_hosts ?? undefined;
    return message;
  },
};
