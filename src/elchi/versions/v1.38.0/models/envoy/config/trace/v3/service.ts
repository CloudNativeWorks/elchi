...
export interface TraceServiceConfig {
  $type: "envoy.config.trace.v3.TraceServiceConfig";
  /** The upstream gRPC cluster that hosts the metrics service. */
  grpc_service?: GrpcService | undefined;
}

function createBaseTraceServiceConfig(): TraceServiceConfig {
  return { $type: "envoy.config.trace.v3.TraceServiceConfig" };
}

export const TraceServiceConfig: MessageFns<TraceServiceConfig, "envoy.config.trace.v3.TraceServiceConfig"> = {
  $type: "envoy.config.trace.v3.TraceServiceConfig" as const,
