...
export interface LightstepConfig {
  $type: "envoy.config.trace.v3.LightstepConfig";
...
function createBaseLightstepConfig(): LightstepConfig {
  return { $type: "envoy.config.trace.v3.LightstepConfig" };
}

export const LightstepConfig: MessageFns<LightstepConfig, "envoy.config.trace.v3.LightstepConfig"> = {
  $type: "envoy.config.trace.v3.LightstepConfig" as const,
  ...
  encode(message: LightstepConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.access_token !== undefined) {
      DataSource.encode(message.access_token, writer.uint32(34).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.access_token = DataSource.decode(reader, reader.uint32());
          continue;
        }
        case 3: {
          if (tag === 24) {
  ...
  fromJSON(object: any): LightstepConfig {
    return {
      ...
      access_token: isSet(object.access_token) ? DataSource.fromJSON(object.access_token) : undefined,
  ...
  toJSON(message: LightstepConfig): unknown {
    ...
    if (message.access_token !== undefined) {
      obj.access_token = DataSource.toJSON(message.access_token);
    }
  ...
  fromPartial<I extends Exact<DeepPartial<LightstepConfig>, I>>(object: I): LightstepConfig {
    ...
    message.access_token = (object.access_token !== undefined && object.access_token !== null)
      ? DataSource.fromPartial(object.access_token)
      : undefined;
