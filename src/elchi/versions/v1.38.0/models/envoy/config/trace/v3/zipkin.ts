...
export interface ZipkinConfig {
   ...
   */
  timestamp_trace_ids?: boolean | undefined;
}
...
export const ZipkinConfig: MessageFns<ZipkinConfig, "envoy.config.trace.v3.ZipkinConfig"> = {
  ...
  encode(message: ZipkinConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.timestamp_trace_ids !== undefined && message.timestamp_trace_ids !== false) {
      writer.uint32(80).bool(message.timestamp_trace_ids);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10: {
          ...
          message.timestamp_trace_ids = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ZipkinConfig {
    return {
      ...
      timestamp_trace_ids: isSet(object.timestamp_trace_ids)
        ? globalThis.Boolean(object.timestamp_trace_ids)
        : undefined,
    };
  },
  ...
  toJSON(message: ZipkinConfig): unknown {
    ...
    if (message.timestamp_trace_ids !== undefined) {
      obj.timestamp_trace_ids = message.timestamp_trace_ids;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ZipkinConfig>, I>>(object: I): ZipkinConfig {
    ...
    message.collector_service = (object.collector_service !== undefined && object.collector_service !== null)
      ...
      : undefined;
    message.timestamp_trace_ids = object.timestamp_trace_ids ?? undefined;
    return message;
  },
};
