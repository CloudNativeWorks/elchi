...
export const protobufPackage = "envoy.config.filter.http.grpc_stats.v2alpha";

/** gRPC statistics filter configuration */
export interface FilterConfig {
  $type: "envoy.config.filter.http.grpc_stats.v2alpha.FilterConfig";
  /**
...
export interface FilterObject {
  $type: "envoy.config.filter.http.grpc_stats.v2alpha.FilterObject";
...
function createBaseFilterConfig(): FilterConfig {
  return { $type: "envoy.config.filter.http.grpc_stats.v2alpha.FilterConfig", per_method_stat_specifier: undefined };
}

export const FilterConfig: MessageFns<FilterConfig, "envoy.config.filter.http.grpc_stats.v2alpha.FilterConfig"> = {
  $type: "envoy.config.filter.http.grpc_stats.v2alpha.FilterConfig" as const,
...
function createBaseFilterObject(): FilterObject {
  return { $type: "envoy.config.filter.http.grpc_stats.v2alpha.FilterObject" };
}

export const FilterObject: MessageFns<FilterObject, "envoy.config.filter.http.grpc_stats.v2alpha.FilterObject"> = {
  $type: "envoy.config.filter.http.grpc_stats.v2alpha.FilterObject" as const,
