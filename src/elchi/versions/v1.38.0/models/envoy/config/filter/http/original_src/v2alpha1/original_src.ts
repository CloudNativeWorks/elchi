...
export const protobufPackage = "envoy.config.filter.http.original_src.v2alpha1";
...
export interface OriginalSrc {
  $type: "envoy.config.filter.http.original_src.v2alpha1.OriginalSrc";
  /**
...
function createBaseOriginalSrc(): OriginalSrc {
  return { $type: "envoy.config.filter.http.original_src.v2alpha1.OriginalSrc" };
}

export const OriginalSrc: MessageFns<OriginalSrc, "envoy.config.filter.http.original_src.v2alpha1.OriginalSrc"> = {
  $type: "envoy.config.filter.http.original_src.v2alpha1.OriginalSrc" as const,
