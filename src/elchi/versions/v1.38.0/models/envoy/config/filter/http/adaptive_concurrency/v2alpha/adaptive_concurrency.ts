...
export const protobufPackage = "envoy.config.filter.http.adaptive_concurrency.v2alpha";

/** Configuration parameters for the gradient controller. */
export interface GradientControllerConfig {
  $type: "envoy.config.filter.http.adaptive_concurrency.v2alpha.GradientControllerConfig";
...
export interface GradientControllerConfig_MinimumRTTCalculationParams {
  $type: "envoy.config.filter.http.adaptive_concurrency.v2alpha.GradientControllerConfig.MinimumRTTCalculationParams";
...
export interface AdaptiveConcurrency {
  $type: "envoy.config.filter.http.adaptive_concurrency.v2alpha.AdaptiveConcurrency";
   ...
   */
  enabled?: RuntimeFeatureFlag | undefined;
}

function createBaseGradientControllerConfig(): GradientControllerConfig {
  return { $type: "envoy.config.filter.http.adaptive_concurrency.v2alpha.GradientControllerConfig" };
}
...
> = {
  $type: "envoy.config.filter.http.adaptive_concurrency.v2alpha.GradientControllerConfig" as const,
...
> = {
  $type:
    "envoy.config.filter.http.adaptive_concurrency.v2alpha.GradientControllerConfig.ConcurrencyLimitCalculationParams" as const,
...
> = {
  $type:
    "envoy.config.filter.http.adaptive_concurrency.v2alpha.GradientControllerConfig.MinimumRTTCalculationParams" as const,
...
> = {
  $type: "envoy.config.filter.http.adaptive_concurrency.v2alpha.AdaptiveConcurrency" as const,
