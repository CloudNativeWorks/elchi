...
function createBaseUpstreamLocalityStats(): UpstreamLocalityStats {
  return { $type: "envoy.config.endpoint.v3.UpstreamLocalityStats" };
}

export const UpstreamLocalityStats: MessageFns<
  UpstreamLocalityStats,
  "envoy.config.endpoint.v3.UpstreamLocalityStats"
> = {
  $type: "envoy.config.endpoint.v3.UpstreamLocalityStats" as const,
  ...
  encode(message: UpstreamLocalityStats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.total_active_connections !== undefined && message.total_active_connections !== 0) {
      writer.uint32(72).uint64(message.total_active_connections);
    }
    if (message.total_new_connections !== undefined && message.total_new_connections !== 0) {
      writer.uint32(80).uint64(message.total_new_connections);
    }
    if (message.total_fail_connections !== undefined && message.total_fail_connections !== 0) {
      writer.uint32(88).uint64(message.total_fail_connections);
    }
    if (message.cpu_utilization !== undefined) {
      UnnamedEndpointLoadMetricStats.encode(message.cpu_utilization, writer.uint32(98).fork()).join();
    }
    if (message.mem_utilization !== undefined) {
      UnnamedEndpointLoadMetricStats.encode(message.mem_utilization, writer.uint32(106).fork()).join();
    }
    if (message.application_utilization !== undefined) {
      UnnamedEndpointLoadMetricStats.encode(message.application_utilization, writer.uint32(114).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9: {
          ...
          message.total_active_connections = longToNumber(reader.uint64());
          continue;
        }
        case 10: {
          if (tag !== 80) {
          ...
          message.total_new_connections = longToNumber(reader.uint64());
          continue;
        }
        case 11: {
          if (tag !== 88) {
          ...
          message.total_fail_connections = longToNumber(reader.uint64());
          continue;
        }
        case 12: {
          if (tag !== 98) {
          ...
          message.cpu_utilization = UnnamedEndpointLoadMetricStats.decode(reader, reader.uint32());
          continue;
        }
        case 13: {
          if (tag !== 106) {
          ...
          message.mem_utilization = UnnamedEndpointLoadMetricStats.decode(reader, reader.uint32());
          continue;
        }
        case 14: {
          if (tag !== 114) {
          ...
          message.application_utilization = UnnamedEndpointLoadMetricStats.decode(reader, reader.uint32());
          continue;
        }
        case 5: {
          if (tag !== 42) {
  ...
  fromJSON(object: any): UpstreamLocalityStats {
    return {
      ...
      total_issued_requests: isSet(object.total_issued_requests)
        ...
        : undefined,
      total_active_connections: isSet(object.total_active_connections)
        ? globalThis.Number(object.total_active_connections)
        : undefined,
      total_new_connections: isSet(object.total_new_connections)
        ? globalThis.Number(object.total_new_connections)
        : undefined,
      total_fail_connections: isSet(object.total_fail_connections)
        ? globalThis.Number(object.total_fail_connections)
        : undefined,
      cpu_utilization: isSet(object.cpu_utilization)
        ? UnnamedEndpointLoadMetricStats.fromJSON(object.cpu_utilization)
        : undefined,
      mem_utilization: isSet(object.mem_utilization)
        ? UnnamedEndpointLoadMetricStats.fromJSON(object.mem_utilization)
        : undefined,
      application_utilization: isSet(object.application_utilization)
        ? UnnamedEndpointLoadMetricStats.fromJSON(object.application_utilization)
        : undefined,
  ...
  toJSON(message: UpstreamLocalityStats): unknown {
    ...
    if (message.total_active_connections !== undefined) {
      obj.total_active_connections = Math.round(message.total_active_connections);
    }
    if (message.total_new_connections !== undefined) {
      obj.total_new_connections = Math.round(message.total_new_connections);
    }
    if (message.total_fail_connections !== undefined) {
      obj.total_fail_connections = Math.round(message.total_fail_connections);
    }
    if (message.cpu_utilization !== undefined) {
      obj.cpu_utilization = UnnamedEndpointLoadMetricStats.toJSON(message.cpu_utilization);
    }
    if (message.mem_utilization !== undefined) {
      obj.mem_utilization = UnnamedEndpointLoadMetricStats.toJSON(message.mem_utilization);
    }
    if (message.application_utilization !== undefined) {
      obj.application_utilization = UnnamedEndpointLoadMetricStats.toJSON(message.application_utilization);
    }
  ...
  fromPartial<I extends Exact<DeepPartial<UpstreamLocalityStats>, I>>(object: I): UpstreamLocalityStats {
    ...
    message.total_active_connections = object.total_active_connections ?? undefined;
    message.total_new_connections = object.total_new_connections ?? undefined;
    message.total_fail_connections = object.total_fail_connections ?? undefined;
    message.cpu_utilization = (object.cpu_utilization !== undefined && object.cpu_utilization !== null)
      ? UnnamedEndpointLoadMetricStats.fromPartial(object.cpu_utilization)
      : undefined;
    message.mem_utilization = (object.mem_utilization !== undefined && object.mem_utilization !== null)
      ? UnnamedEndpointLoadMetricStats.fromPartial(object.mem_utilization)
      : undefined;
    message.application_utilization =
      (object.application_utilization !== undefined && object.application_utilization !== null)
        ? UnnamedEndpointLoadMetricStats.fromPartial(object.application_utilization)
        : undefined;
...
function createBaseUpstreamEndpointStats(): UpstreamEndpointStats {
  return { $type: "envoy.config.endpoint.v3.UpstreamEndpointStats" };
}

export const UpstreamEndpointStats: MessageFns<
  UpstreamEndpointStats,
  "envoy.config.endpoint.v3.UpstreamEndpointStats"
> = {
  $type: "envoy.config.endpoint.v3.UpstreamEndpointStats" as const,
...
function createBaseEndpointLoadMetricStats(): EndpointLoadMetricStats {
  return { $type: "envoy.config.endpoint.v3.EndpointLoadMetricStats" };
}
...
> = {
  $type: "envoy.config.endpoint.v3.EndpointLoadMetricStats" as const,
...
function createBaseUnnamedEndpointLoadMetricStats(): UnnamedEndpointLoadMetricStats {
  return { $type: "envoy.config.endpoint.v3.UnnamedEndpointLoadMetricStats" };
}

export const UnnamedEndpointLoadMetricStats: MessageFns<
  UnnamedEndpointLoadMetricStats,
  "envoy.config.endpoint.v3.UnnamedEndpointLoadMetricStats"
> = {
  $type: "envoy.config.endpoint.v3.UnnamedEndpointLoadMetricStats" as const,

  encode(message: UnnamedEndpointLoadMetricStats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.num_requests_finished_with_metric !== undefined && message.num_requests_finished_with_metric !== 0) {
      writer.uint32(8).uint64(message.num_requests_finished_with_metric);
    }
    if (message.total_metric_value !== undefined && message.total_metric_value !== 0) {
      writer.uint32(17).double(message.total_metric_value);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): UnnamedEndpointLoadMetricStats {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseUnnamedEndpointLoadMetricStats();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): UnnamedEndpointLoadMetricStats {
    return {
      $type: UnnamedEndpointLoadMetricStats.$type,
      num_requests_finished_with_metric: isSet(object.num_requests_finished_with_metric)
        ? globalThis.Number(object.num_requests_finished_with_metric)
        : undefined,
      total_metric_value: isSet(object.total_metric_value) ? globalThis.Number(object.total_metric_value) : undefined,
  ...
  toJSON(message: UnnamedEndpointLoadMetricStats): unknown {
    const obj: any = {};
    if (message.num_requests_finished_with_metric !== undefined) {
      obj.num_requests_finished_with_metric = Math.round(message.num_requests_finished_with_metric);
    }
  ...
  create<I extends Exact<DeepPartial<UnnamedEndpointLoadMetricStats>, I>>(base?: I): UnnamedEndpointLoadMetricStats {
    return UnnamedEndpointLoadMetricStats.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<UnnamedEndpointLoadMetricStats>, I>>(
    object: I,
  ): UnnamedEndpointLoadMetricStats {
    const message = createBaseUnnamedEndpointLoadMetricStats();
    message.num_requests_finished_with_metric = object.num_requests_finished_with_metric ?? undefined;
...
messageTypeRegistry.set(UnnamedEndpointLoadMetricStats.$type, UnnamedEndpointLoadMetricStats);

function createBaseClusterStats(): ClusterStats {
  return { $type: "envoy.config.endpoint.v3.ClusterStats" };
}

export const ClusterStats: MessageFns<ClusterStats, "envoy.config.endpoint.v3.ClusterStats"> = {
  $type: "envoy.config.endpoint.v3.ClusterStats" as const,
...
function createBaseClusterStats_DroppedRequests(): ClusterStats_DroppedRequests {
  return { $type: "envoy.config.endpoint.v3.ClusterStats.DroppedRequests" };
}
...
> = {
  $type: "envoy.config.endpoint.v3.ClusterStats.DroppedRequests" as const,
