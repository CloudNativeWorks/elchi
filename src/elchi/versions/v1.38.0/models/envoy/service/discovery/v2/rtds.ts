...
export interface RtdsDummy {
  $type: "envoy.service.discovery.v2.RtdsDummy";
}

/** RTDS resource type. This describes a layer in the runtime virtual filesystem. */
export interface Runtime {
  $type: "envoy.service.discovery.v2.Runtime";
  /**
...
function createBaseRtdsDummy(): RtdsDummy {
  return { $type: "envoy.service.discovery.v2.RtdsDummy" };
}

export const RtdsDummy: MessageFns<RtdsDummy, "envoy.service.discovery.v2.RtdsDummy"> = {
  $type: "envoy.service.discovery.v2.RtdsDummy" as const,
...
function createBaseRuntime(): Runtime {
  return { $type: "envoy.service.discovery.v2.Runtime" };
}

export const Runtime: MessageFns<Runtime, "envoy.service.discovery.v2.Runtime"> = {
  $type: "envoy.service.discovery.v2.Runtime" as const,
...
export const RuntimeDiscoveryServiceServiceName = "envoy.service.discovery.v2.RuntimeDiscoveryService";
