...
export interface AttributeContext {
  $type: "envoy.service.auth.v3.AttributeContext";
  /**
...
export interface AttributeContext_Peer {
  $type: "envoy.service.auth.v3.AttributeContext.Peer";
  /**
...
export interface AttributeContext_Request {
  $type: "envoy.service.auth.v3.AttributeContext.Request";
...
export interface AttributeContext_HttpRequest {
  $type: "envoy.service.auth.v3.AttributeContext.HttpRequest";
  /**
...
function createBaseAttributeContext(): AttributeContext {
  return { $type: "envoy.service.auth.v3.AttributeContext" };
}

export const AttributeContext: MessageFns<AttributeContext, "envoy.service.auth.v3.AttributeContext"> = {
  $type: "envoy.service.auth.v3.AttributeContext" as const,
...
function createBaseAttributeContext_Peer(): AttributeContext_Peer {
  return { $type: "envoy.service.auth.v3.AttributeContext.Peer" };
}

export const AttributeContext_Peer: MessageFns<AttributeContext_Peer, "envoy.service.auth.v3.AttributeContext.Peer"> = {
  $type: "envoy.service.auth.v3.AttributeContext.Peer" as const,
...
function createBaseAttributeContext_Peer_LabelsEntry(): AttributeContext_Peer_LabelsEntry {
  return { $type: "envoy.service.auth.v3.AttributeContext.Peer.LabelsEntry", key: "", value: "" };
}
...
> = {
  $type: "envoy.service.auth.v3.AttributeContext.Peer.LabelsEntry" as const,
...
function createBaseAttributeContext_Request(): AttributeContext_Request {
  return { $type: "envoy.service.auth.v3.AttributeContext.Request" };
}
...
> = {
  $type: "envoy.service.auth.v3.AttributeContext.Request" as const,
...
function createBaseAttributeContext_HttpRequest(): AttributeContext_HttpRequest {
  return { $type: "envoy.service.auth.v3.AttributeContext.HttpRequest" };
}
...
> = {
  $type: "envoy.service.auth.v3.AttributeContext.HttpRequest" as const,
...
function createBaseAttributeContext_HttpRequest_HeadersEntry(): AttributeContext_HttpRequest_HeadersEntry {
  return { $type: "envoy.service.auth.v3.AttributeContext.HttpRequest.HeadersEntry", key: "", value: "" };
}
...
> = {
  $type: "envoy.service.auth.v3.AttributeContext.HttpRequest.HeadersEntry" as const,
...
function createBaseAttributeContext_TLSSession(): AttributeContext_TLSSession {
  return { $type: "envoy.service.auth.v3.AttributeContext.TLSSession" };
}

export const AttributeContext_TLSSession: MessageFns<
  AttributeContext_TLSSession,
  "envoy.service.auth.v3.AttributeContext.TLSSession"
> = {
  $type: "envoy.service.auth.v3.AttributeContext.TLSSession" as const,
  ...
  fromJSON(object: any): AttributeContext_TLSSession {
    return {
      $type: AttributeContext_TLSSession.$type,
...
messageTypeRegistry.set(AttributeContext_TLSSession.$type, AttributeContext_TLSSession);

function createBaseAttributeContext_ContextExtensionsEntry(): AttributeContext_ContextExtensionsEntry {
  return { $type: "envoy.service.auth.v3.AttributeContext.ContextExtensionsEntry", key: "", value: "" };
}
...
> = {
  $type: "envoy.service.auth.v3.AttributeContext.ContextExtensionsEntry" as const,
