...
import { ClusterStats } from "../../../config/endpoint/v3/load_report";

export const protobufPackage = "envoy.service.load_stats.v3";

/** A load report Envoy sends to the management server. */
export interface LoadStatsRequest {
  $type: "envoy.service.load_stats.v3.LoadStatsRequest";
...
export interface LoadStatsResponse {
  $type: "envoy.service.load_stats.v3.LoadStatsResponse";
  /**
...
function createBaseLoadStatsRequest(): LoadStatsRequest {
  return { $type: "envoy.service.load_stats.v3.LoadStatsRequest" };
}

export const LoadStatsRequest: MessageFns<LoadStatsRequest, "envoy.service.load_stats.v3.LoadStatsRequest"> = {
  $type: "envoy.service.load_stats.v3.LoadStatsRequest" as const,
...
function createBaseLoadStatsResponse(): LoadStatsResponse {
  return { $type: "envoy.service.load_stats.v3.LoadStatsResponse" };
}

export const LoadStatsResponse: MessageFns<LoadStatsResponse, "envoy.service.load_stats.v3.LoadStatsResponse"> = {
  $type: "envoy.service.load_stats.v3.LoadStatsResponse" as const,
...
export const LoadReportingServiceServiceName = "envoy.service.load_stats.v3.LoadReportingService";
