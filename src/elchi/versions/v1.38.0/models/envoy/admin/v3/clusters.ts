...
export const HostHealthStatus: MessageFns<HostHealthStatus, "envoy.admin.v3.HostHealthStatus"> = {
  ...
  encode(message: HostHealthStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (
      message.failed_degraded_outlier_detection !== undefined && message.failed_degraded_outlier_detection !== false
    ) {
      writer.uint32(72).bool(message.failed_degraded_outlier_detection);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 9: {
          ...
          message.failed_degraded_outlier_detection = reader.bool();
          continue;
        }
        case 3: {
          if (tag !== 24) {
  ...
  fromJSON(object: any): HostHealthStatus {
    return {
      ...
      failed_degraded_outlier_detection: isSet(object.failed_degraded_outlier_detection)
        ? globalThis.Boolean(object.failed_degraded_outlier_detection)
        : undefined,
  ...
  toJSON(message: HostHealthStatus): unknown {
    ...
    if (message.failed_degraded_outlier_detection !== undefined) {
      obj.failed_degraded_outlier_detection = message.failed_degraded_outlier_detection;
    }
  ...
  fromPartial<I extends Exact<DeepPartial<HostHealthStatus>, I>>(object: I): HostHealthStatus {
    ...
    message.failed_degraded_outlier_detection = object.failed_degraded_outlier_detection ?? undefined;
