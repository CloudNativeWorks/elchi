...
export interface ServerInfo {
  $type: "envoy.admin.v3.ServerInfo";
  /** Server version. */
  version?:
    | string
    | undefined;
  ...
  hot_restart_initializing?: boolean | undefined;
}
...
export enum CommandLineOptions_DrainStrategy {
  /** Gradual - Gradually discourage connections over the course of the drain period. */
  Gradual = "Gradual",
  /** Immediate - Discourage all connections for the duration of the drain sequence. */
  Immediate = "Immediate",
}

export function commandLineOptions_DrainStrategyFromJSON(object: any): CommandLineOptions_DrainStrategy {
  switch (object) {
    case 0:
    case "Gradual":
      return CommandLineOptions_DrainStrategy.Gradual;
    case 1:
    case "Immediate":
      return CommandLineOptions_DrainStrategy.Immediate;
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum CommandLineOptions_DrainStrategy");
  }
}

export function commandLineOptions_DrainStrategyToJSON(object: CommandLineOptions_DrainStrategy): string {
  switch (object) {
    case CommandLineOptions_DrainStrategy.Gradual:
      return "Gradual";
    case CommandLineOptions_DrainStrategy.Immediate:
      return "Immediate";
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum CommandLineOptions_DrainStrategy");
  }
...
export function commandLineOptions_DrainStrategyToNumber(object: CommandLineOptions_DrainStrategy): number {
  switch (object) {
    case CommandLineOptions_DrainStrategy.Gradual:
      return 0;
    case CommandLineOptions_DrainStrategy.Immediate:
...
function createBaseServerInfo(): ServerInfo {
  return { $type: "envoy.admin.v3.ServerInfo" };
}

export const ServerInfo: MessageFns<ServerInfo, "envoy.admin.v3.ServerInfo"> = {
  $type: "envoy.admin.v3.ServerInfo" as const,
  ...
  encode(message: ServerInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.node !== undefined) {
      Node.encode(message.node, writer.uint32(58).fork()).join();
    }
    if (message.hot_restart_initializing !== undefined && message.hot_restart_initializing !== false) {
      writer.uint32(64).bool(message.hot_restart_initializing);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8: {
          ...
          message.hot_restart_initializing = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ServerInfo {
    return {
      ...
      hot_restart_initializing: isSet(object.hot_restart_initializing)
        ? globalThis.Boolean(object.hot_restart_initializing)
        : undefined,
    };
  },
  ...
  toJSON(message: ServerInfo): unknown {
    ...
    if (message.hot_restart_initializing !== undefined) {
      obj.hot_restart_initializing = message.hot_restart_initializing;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ServerInfo>, I>>(object: I): ServerInfo {
    ...
    message.hot_restart_initializing = object.hot_restart_initializing ?? undefined;
    return message;
  },
};
...
function createBaseCommandLineOptions(): CommandLineOptions {
  return { $type: "envoy.admin.v3.CommandLineOptions" };
}

export const CommandLineOptions: MessageFns<CommandLineOptions, "envoy.admin.v3.CommandLineOptions"> = {
  $type: "envoy.admin.v3.CommandLineOptions" as const,
  ...
  encode(message: CommandLineOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.use_dynamic_base_id !== undefined && message.use_dynamic_base_id !== false) {
      writer.uint32(248).bool(message.use_dynamic_base_id);
    }
    if (message.skip_hot_restart_on_no_parent !== undefined && message.skip_hot_restart_on_no_parent !== false) {
      writer.uint32(312).bool(message.skip_hot_restart_on_no_parent);
    }
    if (message.skip_hot_restart_parent_stats !== undefined && message.skip_hot_restart_parent_stats !== false) {
      writer.uint32(320).bool(message.skip_hot_restart_parent_stats);
    }
    if (message.base_id_path !== undefined && message.base_id_path !== "") {
      writer.uint32(258).string(message.base_id_path);
    }
    ...
    if (message.ignore_unknown_dynamic_fields !== undefined && message.ignore_unknown_dynamic_fields !== false) {
      writer.uint32(240).bool(message.ignore_unknown_dynamic_fields);
    }
    if (message.skip_deprecated_logs !== undefined && message.skip_deprecated_logs !== false) {
      writer.uint32(328).bool(message.skip_deprecated_logs);
    }
    ...
    if (message.file_flush_min_size !== undefined && message.file_flush_min_size !== 0) {
      writer.uint32(336).uint32(message.file_flush_min_size);
    }
    if (message.drain_time !== undefined) {
      Duration.encode(message.drain_time, writer.uint32(138).fork()).join();
    }
    if (message.drain_strategy !== undefined && message.drain_strategy !== CommandLineOptions_DrainStrategy.Gradual) {
      writer.uint32(264).int32(commandLineOptions_DrainStrategyToNumber(message.drain_strategy));
    }
    ...
    if (message.enable_fine_grain_logging !== undefined && message.enable_fine_grain_logging !== false) {
      writer.uint32(272).bool(message.enable_fine_grain_logging);
    }
    if (message.socket_path !== undefined && message.socket_path !== "") {
      writer.uint32(282).string(message.socket_path);
    }
    if (message.socket_mode !== undefined && message.socket_mode !== 0) {
      writer.uint32(288).uint32(message.socket_mode);
    }
    if (message.enable_core_dump !== undefined && message.enable_core_dump !== false) {
      writer.uint32(296).bool(message.enable_core_dump);
    }
    if (message.stats_tag !== undefined && message.stats_tag.length !== 0) {
      for (const v of message.stats_tag) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 31: {
          ...
          message.use_dynamic_base_id = reader.bool();
          continue;
        }
        case 39: {
          if (tag !== 312) {
          ...
          message.skip_hot_restart_on_no_parent = reader.bool();
          continue;
        }
        case 40: {
          if (tag !== 320) {
          ...
          message.skip_hot_restart_parent_stats = reader.bool();
          continue;
        }
        case 32: {
          if (tag !== 258) {
          ...
          message.base_id_path = reader.string();
          continue;
        }
        case 2: {
          if (tag !== 16) {
        ...
        case 30: {
          ...
          message.ignore_unknown_dynamic_fields = reader.bool();
          continue;
        }
        case 41: {
          if (tag !== 328) {
          ...
          message.skip_deprecated_logs = reader.bool();
          continue;
        }
        case 6: {
          if (tag !== 50) {
        ...
        case 42: {
          ...
          message.file_flush_min_size = reader.uint32();
          continue;
        }
        case 17: {
          if (tag !== 138) {
        ...
        case 33: {
          ...
          message.drain_strategy = commandLineOptions_DrainStrategyFromJSON(reader.int32());
          continue;
        }
        case 18: {
          if (tag !== 146) {
        ...
        case 34: {
          ...
          message.enable_fine_grain_logging = reader.bool();
          continue;
        }
        case 35: {
          if (tag !== 282) {
          ...
          message.socket_path = reader.string();
          continue;
        }
        case 36: {
          if (tag !== 288) {
          ...
          message.socket_mode = reader.uint32();
          continue;
        }
        case 37: {
          if (tag !== 296) {
          ...
          message.enable_core_dump = reader.bool();
          continue;
        }
        case 38: {
          if (tag !== 306) {
          ...
          if (message.stats_tag === undefined) {
            message.stats_tag = [];
          }
          const el = reader.string();
          if (el !== undefined) {
            message.stats_tag!.push(el);
          }
          continue;
        }
      }
  ...
  fromJSON(object: any): CommandLineOptions {
    return {
      ...
      use_dynamic_base_id: isSet(object.use_dynamic_base_id)
        ? globalThis.Boolean(object.use_dynamic_base_id)
        : undefined,
      skip_hot_restart_on_no_parent: isSet(object.skip_hot_restart_on_no_parent)
        ? globalThis.Boolean(object.skip_hot_restart_on_no_parent)
        : undefined,
      skip_hot_restart_parent_stats: isSet(object.skip_hot_restart_parent_stats)
        ? globalThis.Boolean(object.skip_hot_restart_parent_stats)
        : undefined,
      base_id_path: isSet(object.base_id_path) ? globalThis.String(object.base_id_path) : undefined,
      ...
      reject_unknown_dynamic_fields: isSet(object.reject_unknown_dynamic_fields)
        ...
        : undefined,
      ignore_unknown_dynamic_fields: isSet(object.ignore_unknown_dynamic_fields)
        ? globalThis.Boolean(object.ignore_unknown_dynamic_fields)
        : undefined,
      skip_deprecated_logs: isSet(object.skip_deprecated_logs)
        ? globalThis.Boolean(object.skip_deprecated_logs)
        : undefined,
      ...
      file_flush_interval: isSet(object.file_flush_interval)
        ...
        : undefined,
      file_flush_min_size: isSet(object.file_flush_min_size)
        ? globalThis.Number(object.file_flush_min_size)
        : undefined,
      drain_time: isSet(object.drain_time) ? Duration.fromJSON(object.drain_time) : undefined,
      drain_strategy: isSet(object.drain_strategy)
        ? commandLineOptions_DrainStrategyFromJSON(object.drain_strategy)
        : undefined,
      ...
      disabled_extensions: globalThis.Array.isArray(object?.disabled_extensions)
        ...
        : undefined,
      enable_fine_grain_logging: isSet(object.enable_fine_grain_logging)
        ? globalThis.Boolean(object.enable_fine_grain_logging)
        : undefined,
      socket_path: isSet(object.socket_path) ? globalThis.String(object.socket_path) : undefined,
      socket_mode: isSet(object.socket_mode) ? globalThis.Number(object.socket_mode) : undefined,
      enable_core_dump: isSet(object.enable_core_dump) ? globalThis.Boolean(object.enable_core_dump) : undefined,
      stats_tag: globalThis.Array.isArray(object?.stats_tag)
        ? object.stats_tag.map((e: any) => globalThis.String(e))
        : undefined,
    };
  },
  ...
  toJSON(message: CommandLineOptions): unknown {
    ...
    if (message.use_dynamic_base_id !== undefined) {
      obj.use_dynamic_base_id = message.use_dynamic_base_id;
    }
    if (message.skip_hot_restart_on_no_parent !== undefined) {
      obj.skip_hot_restart_on_no_parent = message.skip_hot_restart_on_no_parent;
    }
    if (message.skip_hot_restart_parent_stats !== undefined) {
      obj.skip_hot_restart_parent_stats = message.skip_hot_restart_parent_stats;
    }
    if (message.base_id_path !== undefined) {
      obj.base_id_path = message.base_id_path;
    }
    ...
    if (message.ignore_unknown_dynamic_fields !== undefined) {
      obj.ignore_unknown_dynamic_fields = message.ignore_unknown_dynamic_fields;
    }
    if (message.skip_deprecated_logs !== undefined) {
      obj.skip_deprecated_logs = message.skip_deprecated_logs;
    }
    ...
    if (message.file_flush_min_size !== undefined) {
      obj.file_flush_min_size = Math.round(message.file_flush_min_size);
    }
    if (message.drain_time !== undefined) {
      obj.drain_time = Duration.toJSON(message.drain_time);
    }
    if (message.drain_strategy !== undefined) {
      obj.drain_strategy = commandLineOptions_DrainStrategyToJSON(message.drain_strategy);
    }
    if (message.parent_shutdown_time !== undefined) {
    ...
    if (message.enable_fine_grain_logging !== undefined) {
      obj.enable_fine_grain_logging = message.enable_fine_grain_logging;
    }
    if (message.socket_path !== undefined) {
      obj.socket_path = message.socket_path;
    }
    if (message.socket_mode !== undefined) {
      obj.socket_mode = Math.round(message.socket_mode);
    }
    if (message.enable_core_dump !== undefined) {
      obj.enable_core_dump = message.enable_core_dump;
    }
    if (message.stats_tag?.length) {
      obj.stats_tag = message.stats_tag;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<CommandLineOptions>, I>>(object: I): CommandLineOptions {
    ...
    message.use_dynamic_base_id = object.use_dynamic_base_id ?? undefined;
    message.skip_hot_restart_on_no_parent = object.skip_hot_restart_on_no_parent ?? undefined;
    message.skip_hot_restart_parent_stats = object.skip_hot_restart_parent_stats ?? undefined;
    message.base_id_path = object.base_id_path ?? undefined;
    ...
    message.ignore_unknown_dynamic_fields = object.ignore_unknown_dynamic_fields ?? undefined;
    message.skip_deprecated_logs = object.skip_deprecated_logs ?? undefined;
    ...
    message.file_flush_interval = (object.file_flush_interval !== undefined && object.file_flush_interval !== null)
      ...
      : undefined;
    message.file_flush_min_size = object.file_flush_min_size ?? undefined;
    message.drain_time = (object.drain_time !== undefined && object.drain_time !== null)
      ? Duration.fromPartial(object.drain_time)
      : undefined;
    message.drain_strategy = object.drain_strategy ?? undefined;
    ...
    message.enable_fine_grain_logging = object.enable_fine_grain_logging ?? undefined;
    message.socket_path = object.socket_path ?? undefined;
    message.socket_mode = object.socket_mode ?? undefined;
    message.enable_core_dump = object.enable_core_dump ?? undefined;
    message.stats_tag = object.stats_tag?.map((e) => e) || undefined;
    return message;
  },
};
