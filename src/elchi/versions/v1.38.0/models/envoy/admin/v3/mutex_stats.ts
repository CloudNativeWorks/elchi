...
export interface MutexStats {
  $type: "envoy.admin.v3.MutexStats";
...
function createBaseMutexStats(): MutexStats {
  return { $type: "envoy.admin.v3.MutexStats" };
}

export const MutexStats: MessageFns<MutexStats, "envoy.admin.v3.MutexStats"> = {
  $type: "envoy.admin.v3.MutexStats" as const,
