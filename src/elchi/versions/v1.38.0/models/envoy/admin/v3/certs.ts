...
export interface Certificates {
  $type: "envoy.admin.v3.Certificates";
  /** List of certificates known to an Envoy. */
  certificates?: Certificate[] | undefined;
}

export interface Certificate {
  $type: "envoy.admin.v3.Certificate";
...
export interface CertificateDetails {
  ...
  ocsp_details?: CertificateDetails_OcspDetails | undefined;
}
...
function createBaseCertificates(): Certificates {
  return { $type: "envoy.admin.v3.Certificates" };
}

export const Certificates: MessageFns<Certificates, "envoy.admin.v3.Certificates"> = {
  $type: "envoy.admin.v3.Certificates" as const,
...
function createBaseCertificate(): Certificate {
  return { $type: "envoy.admin.v3.Certificate" };
}

export const Certificate: MessageFns<Certificate, "envoy.admin.v3.Certificate"> = {
  $type: "envoy.admin.v3.Certificate" as const,
...
function createBaseCertificateDetails(): CertificateDetails {
  return { $type: "envoy.admin.v3.CertificateDetails" };
}

export const CertificateDetails: MessageFns<CertificateDetails, "envoy.admin.v3.CertificateDetails"> = {
  $type: "envoy.admin.v3.CertificateDetails" as const,
  ...
  encode(message: CertificateDetails, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.ocsp_details !== undefined) {
      CertificateDetails_OcspDetails.encode(message.ocsp_details, writer.uint32(58).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.ocsp_details = CertificateDetails_OcspDetails.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): CertificateDetails {
    return {
      ...
      ocsp_details: isSet(object.ocsp_details)
        ? CertificateDetails_OcspDetails.fromJSON(object.ocsp_details)
        : undefined,
    };
  },
  ...
  toJSON(message: CertificateDetails): unknown {
    ...
    if (message.ocsp_details !== undefined) {
      obj.ocsp_details = CertificateDetails_OcspDetails.toJSON(message.ocsp_details);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<CertificateDetails>, I>>(object: I): CertificateDetails {
    ...
    message.ocsp_details = (object.ocsp_details !== undefined && object.ocsp_details !== null)
      ? CertificateDetails_OcspDetails.fromPartial(object.ocsp_details)
      : undefined;
    return message;
  },
};
...
function createBaseCertificateDetails_OcspDetails(): CertificateDetails_OcspDetails {
  return { $type: "envoy.admin.v3.CertificateDetails.OcspDetails" };
}

export const CertificateDetails_OcspDetails: MessageFns<
  CertificateDetails_OcspDetails,
  "envoy.admin.v3.CertificateDetails.OcspDetails"
> = {
  $type: "envoy.admin.v3.CertificateDetails.OcspDetails" as const,

  encode(message: CertificateDetails_OcspDetails, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.valid_from !== undefined) {
      Timestamp.encode(toTimestamp(message.valid_from), writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CertificateDetails_OcspDetails {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCertificateDetails_OcspDetails();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CertificateDetails_OcspDetails {
    return {
      $type: CertificateDetails_OcspDetails.$type,
      valid_from: isSet(object.valid_from) ? fromJsonTimestamp(object.valid_from) : undefined,
      expiration: isSet(object.expiration) ? fromJsonTimestamp(object.expiration) : undefined,
    };
  },

  toJSON(message: CertificateDetails_OcspDetails): unknown {
    const obj: any = {};
    if (message.valid_from !== undefined) {
      obj.valid_from = message.valid_from.toISOString();
    }
  ...
  create<I extends Exact<DeepPartial<CertificateDetails_OcspDetails>, I>>(base?: I): CertificateDetails_OcspDetails {
    return CertificateDetails_OcspDetails.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CertificateDetails_OcspDetails>, I>>(
    object: I,
  ): CertificateDetails_OcspDetails {
    const message = createBaseCertificateDetails_OcspDetails();
    message.valid_from = object.valid_from ?? undefined;
...
messageTypeRegistry.set(CertificateDetails_OcspDetails.$type, CertificateDetails_OcspDetails);

function createBaseSubjectAlternateName(): SubjectAlternateName {
  return { $type: "envoy.admin.v3.SubjectAlternateName", name: undefined };
}

export const SubjectAlternateName: MessageFns<SubjectAlternateName, "envoy.admin.v3.SubjectAlternateName"> = {
  $type: "envoy.admin.v3.SubjectAlternateName" as const,
