...
export enum ClientResourceStatus {
  ...
  NACKED = "NACKED",
  /**
   * RECEIVED_ERROR - Client received an error from the control plane. The attached config
   * dump is the most recent accepted one. If no config is accepted yet,
   * the attached config dump will be empty.
   */
  RECEIVED_ERROR = "RECEIVED_ERROR",
  /** TIMEOUT - Client timed out waiting for the resource from the control plane. */
  TIMEOUT = "TIMEOUT",
}
...
export function clientResourceStatusFromJSON(object: any): ClientResourceStatus {
  switch (object) {
    ...
    case 5:
    case "RECEIVED_ERROR":
      return ClientResourceStatus.RECEIVED_ERROR;
    case 6:
    case "TIMEOUT":
