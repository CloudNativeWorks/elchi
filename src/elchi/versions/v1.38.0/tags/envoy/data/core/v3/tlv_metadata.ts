...
export const TlvsMetadata: OutType = { "TlvsMetadata": [
  {
    ...
    "enums": null,
    "comment": "Typed metadata for `Proxy protocol filter`, that represents a map of TLVs. Each entry in the map consists of a key which corresponds to a configured `rule key` and a value (TLV value in bytes). `Proxy protocol filter` populates both typed and untyped metadata.",
    "notImp": false
  }
] };
