...
export const Policy: OutType = { "Policy": [
  ...
  },
  {
    ...
    "enums": null,
    "comment": "CEL expression configuration that modifies the evaluation behavior of the ``condition`` field. If specified, string conversion, concatenation, and manipulation functions may be enabled for the CEL expression. See `CelExpressionConfig` for more details.",
    "notImp": false
  }
] };
...
export const Permission: OutType = { "Permission": [
  ...
  },
  {
    ...
    "enums": null,
    "comment": "A header (or pseudo-header such as ``:path`` or ``:method``) on the incoming HTTP request. Only available for HTTP request.\n\n:::note\n\nThe pseudo-header ``:path`` includes the query and fragment string. Use the ``url_path`` field if you want to match the URL path without the query and fragment string.",
    "notImp": false
  },
  {
    "name": "rule.url_path",
...
export const Principal: OutType = { "Principal": [
  ...
  },
  {
    ...
    "enums": null,
    "comment": "Authenticated attributes that identify the downstream. It is recommended to NOT use this field, but instead use `MTlsAuthenticated`, configured via `custom`, which should be used for most use cases due to its improved security.",
    "notImp": false
  },
  {
  ...
  },
  {
    ...
    "fieldType": "CidrRange",
    "enums": null,
    "comment": "A CIDR block that describes the downstream remote/origin address.\n\n:::note\n\nThis may not be the physical peer and could be different from the `direct_remote_ip`. E.g, if the remote ip is inferred from the x-forwarder-for header, the proxy protocol, etc.",
    "notImp": false
  },
  {
  ...
  },
  {
    ...
    "fieldType": "TypedExtensionConfig",
    "enums": null,
    "comment": "Extension for configuring custom principals for RBAC. extension-category: envoy.rbac.principals",
    "notImp": false
  }
] };
