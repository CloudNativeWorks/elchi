...
export const LocalityLbEndpoints: OutType = { "LocalityLbEndpoints": [
  ...
  },
  {
    ...
    "enums": null,
    "comment": "[#not-implemented-hide:] Not implemented and deprecated.",
    "notImp": true
  },
  {
    ...
    "enums": null,
    "comment": "LEDS Configuration for the current locality. If this is set, the `lb_endpoints` field is ignored.",
    "notImp": false
  },
  {
    "name": "load_balancing_weight",
