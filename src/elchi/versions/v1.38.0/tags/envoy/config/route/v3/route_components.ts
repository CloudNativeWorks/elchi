...
export const RetryPolicy_RateLimitedRetryBackOff: OutType = { "RetryPolicy_RateLimitedRetryBackOff": [
  ...
  },
  {
    ...
    "fieldType": "Duration",
    "enums": null,
    "comment": "Specifies the maximum back off interval that Envoy will allow. If a reset header contains an interval longer than this then it will be discarded and the next header will be tried.\n\nDefaults to 300 seconds.",
    "notImp": false
  }
] };
...
export const HedgePolicy: OutType = { "HedgePolicy": [
  {
    ...
    "fieldType": "number",
    "enums": null,
    "comment": "Specifies the number of initial requests that should be sent upstream. Must be at least 1.\n\nDefaults to 1. [#not-implemented-hide:]",
    "notImp": true
  },
  {
    ...
    "enums": null,
    "comment": "Specifies a probability that an additional upstream request should be sent on top of what is specified by initial_requests.\n\nDefaults to 0. [#not-implemented-hide:]",
    "notImp": true
  },
  {
...
export const VirtualHost: OutType = { "VirtualHost": [
  ...
  },
  {
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "Decides whether the `x-envoy-attempt-count` header should be included in the upstream request. Setting this option will cause it to override any existing header value, so in the case of two Envoys on the request path with this option enabled, the upstream will see the attempt count as perceived by the second Envoy.\n\nDefaults to ``false``.\n\nThis header is unaffected by the `suppress_envoy_headers` flag.",
    "notImp": false
  },
  {
  ...
  },
  {
    ...
    "fieldType": "number",
    "enums": null,
    "comment": "The maximum bytes which will be buffered for retries and shadowing. If set, the bytes actually buffered will be the minimum value of this and the listener ``per_connection_buffer_limit_bytes``.\n\n:::attention\n\nThis field has been deprecated. Please use `request_body_buffer_limit` instead. Only one of ``per_request_buffer_limit_bytes`` and ``request_body_buffer_limit`` could be set. \n:::",
    "notImp": false
  },
  {
    "name": "request_body_buffer_limit",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "number",
    "enums": null,
    "comment": "The maximum bytes which will be buffered for request bodies to support large request body buffering beyond the ``per_connection_buffer_limit_bytes``.\n\nThis limit is specifically for the request body buffering and allows buffering larger payloads while maintaining flow control.\n\nBuffer limit precedence (from highest to lowest priority):\n\n1. If ``request_body_buffer_limit`` is set, then ``request_body_buffer_limit`` will be used. 2. If `per_request_buffer_limit_bytes` is set but ``request_body_buffer_limit`` is not, then ``min(per_request_buffer_limit_bytes, per_connection_buffer_limit_bytes)`` will be used. 3. If neither is set, then ``per_connection_buffer_limit_bytes`` will be used.\n\nFor flow control chunk sizes, ``min(per_connection_buffer_limit_bytes, 16KB)`` will be used.\n\nOnly one of `per_request_buffer_limit_bytes` and ``request_body_buffer_limit`` could be set.",
    "notImp": false
  },
  {
...
export const RouteMatch: OutType = { "RouteMatch": [
  ...
  },
  {
    ...
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "CookieMatcher[]",
    "enums": null,
    "comment": "Specifies a set of cookies on which the route should match. The router parses the ``Cookie`` header and evaluates the named cookie against each matcher. If the number of specified cookie matchers is nonzero, they all must match for the route to be selected.",
    "notImp": false
  },
  {
    "name": "grpc",
    ...
    "enums": null,
    "comment": "If specified, only gRPC requests will be matched. The router will check that the ``Content-Type`` header has ``application/grpc`` or one of the various ``application/grpc+`` values.",
    "notImp": false
  },
  {
    "name": "tls_context",
...
export const Tracing: OutType = { "Tracing": [
  ...
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "The operation name of the span which will be used for tracing.\n\nThe same `format specifier` as used for `HTTP access logging` applies here, however unknown specifier values are replaced with the empty string instead of ``-``.\n\nThis field will take precedence over and make following settings ineffective:\n\n* `route decorator`. * `x-envoy-decorator-operation`. * `HCM tracing operation`.",
    "notImp": false
  },
  {
    "name": "upstream_operation",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "string",
    "enums": null,
    "comment": "The operation name of the upstream span which will be used for tracing. This only takes effect when ``spawn_upstream_span`` is set to true and the upstream span is created.\n\nThe same `format specifier` as used for `HTTP access logging` applies here, however unknown specifier values are replaced with the empty string instead of ``-``.\n\nThis field will take precedence over and make following settings ineffective:\n\n* `HCM tracing upstream operation`",
    "notImp": false
  }
] };

export const Tracing_SingleFields = [
  "operation",
  "upstream_operation"
];
...
export const Route: OutType = { "Route": [
  ...
  },
  {
    ...
    "fieldType": "number",
    "enums": null,
    "comment": "The maximum bytes which will be buffered for retries and shadowing. If set, the bytes actually buffered will be the minimum value of this and the listener per_connection_buffer_limit_bytes.\n\n:::attention\n\nThis field has been deprecated. Please use `request_body_buffer_limit` instead. Only one of ``per_request_buffer_limit_bytes`` and ``request_body_buffer_limit`` may be set. \n:::",
    "notImp": false
  },
  {
    "name": "stat_prefix",
  ...
  },
  {
    ...
    "fieldType": "number",
    "enums": null,
    "comment": "The maximum bytes which will be buffered for request bodies to support large request body buffering beyond the ``per_connection_buffer_limit_bytes``.\n\nThis limit is specifically for the request body buffering and allows buffering larger payloads while maintaining flow control.\n\nBuffer limit precedence (from highest to lowest priority):\n\n1. If ``request_body_buffer_limit`` is set: use ``request_body_buffer_limit`` 2. If `per_request_buffer_limit_bytes` is set but ``request_body_buffer_limit`` is not: use ``min(per_request_buffer_limit_bytes, per_connection_buffer_limit_bytes)`` 3. If neither is set: use ``per_connection_buffer_limit_bytes``\n\nFor flow control chunk sizes, use ``min(per_connection_buffer_limit_bytes, 16KB)``.\n\nOnly one of `per_request_buffer_limit_bytes` and ``request_body_buffer_limit`` may be set.",
    "notImp": false
  }
] };
...
export const WeightedCluster: OutType = { "WeightedCluster": [
  ...
  {
    "name": "random_value_specifier.use_hash_policy",
    "isUnion": true,
    "isDeprecated": false,
    "fieldType": "boolean",
    "enums": null,
    "comment": "When set to true, the hash policies will be used to generate the random value for weighted cluster selection. This could ensure consistent cluster picking across multiple proxy levels for weighted traffic.",
    "notImp": false
  }
] };
...
export const WeightedCluster_SingleFields = [
  ...
  "random_value_specifier.use_hash_policy"
];
...
export const RouteAction: OutType = { "RouteAction": [
  ...
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "Rewrites the whole path (without query parameters) with the given path value. The router filter will place the original path before rewrite into the `x-envoy-original-path` header.\n\nOnly one of `regex_rewrite`, `path_rewrite_policy`, `path_rewrite`, or `prefix_rewrite` may be specified.\n\nThe `substitution format specifier` could be applied here. For example, with the following config:\n\n```yaml\n\n    path_rewrite: \"/new_path_prefix%REQ(custom-path-header-name)%\"\n```\n\nWould rewrite the path to ``/new_path_prefix/some_value`` given the header ``custom-path-header-name: some_value``. If the header is not present, the path will be rewritten to ``/new_path_prefix``.\n\nIf the final output of the path rewrite is empty, then the update will be ignored and the original path will be preserved.",
    "notImp": false
  },
  {
    "name": "host_rewrite_specifier.host_rewrite_literal",
  ...
  },
  {
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "Indicates that during forwarding, the host header will be swapped with the hostname of the upstream host chosen by the cluster manager. This option is applicable only when the destination cluster for a route is of type ``strict_dns`` or ``logical_dns``, or when `hostname` field is not empty. Setting this to true with other cluster types has no effect.",
    "notImp": false
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "Indicates that during forwarding, the host header will be swapped with the content of given downstream or `custom` header. If header value is empty, host header is left intact.\n\n:::attention\n\nPay attention to the potential security implications of using this option. Provided header must come from trusted source. \n:::\n\n:::note\n\nIf the header appears multiple times only the first value is used.",
    "notImp": false
  },
  {
    ...
    "fieldType": "RegexMatchAndSubstitute",
    "enums": null,
    "comment": "Indicates that during forwarding, the host header will be swapped with the result of the regex substitution executed on path value with query and fragment removed. This is useful for transitioning variable content between path segment and subdomain.\n\nFor example with the following config:\n\n```yaml\n\n    host_rewrite_path_regex:\n      pattern:\n        google_re2: {}\n        regex: \"^/(.+)/.+$\"\n      substitution: \\1\n```\n\nWould rewrite the host header to ``envoyproxy.io`` given the path ``/envoyproxy.io/some/path``.",
    "notImp": false
  },
  {
    "name": "host_rewrite_specifier.host_rewrite",
    "isUnion": true,
    "isDeprecated": false,
    "fieldType": "string",
    "enums": null,
    "comment": "Rewrites the host header with the value of this field. The router filter will place the original host header value before rewriting into the `x-envoy-original-host` header.\n\nThe `substitution format specifier` could be applied here. For example, with the following config:\n\n```yaml\n\n    host_rewrite: \"prefix-%REQ(custom-host-header-name)%\"\n```\n\nWould rewrite the host header to ``prefix-some_value`` given the header ``custom-host-header-name: some_value``. If the header is not present, the host header will be rewritten to an value of ``prefix-``.\n\nIf the final output of the host rewrite is empty, then the update will be ignored and the original host header will be preserved.",
    "notImp": false
  },
  {
  ...
  },
  {
    ...
    "fieldType": "Duration",
    "enums": null,
    "comment": "Specifies the codec stream flush timeout for the route.\n\nIf not specified, the first preference is the global `stream_flush_timeout`, but only if explicitly configured.\n\nIf neither the explicit HCM-wide flush timeout nor this route-specific flush timeout is configured, the route's stream idle timeout is reused for this timeout. This is for backwards compatibility since both behaviors were historically controlled by the one timeout.\n\nIf the route also does not have an idle timeout configured, the global `stream_idle_timeout`. used, again for backwards compatibility. That timeout defaults to 5 minutes.\n\nA value of 0 via any of the above paths will completely disable the timeout for a given route.",
    "notImp": false
  },
  {
  ...
  },
  {
    ...
    "fieldType": "RetryPolicy",
    "enums": null,
    "comment": "Indicates that the route has a retry policy. Note that if this is set, it'll take precedence over the virtual host level retry policy entirely (e.g., policies are not merged, the most internal one becomes the enforced policy).",
    "notImp": false
  },
  {
    "name": "retry_policy_typed_config",
    ...
    "fieldType": "Any",
    "enums": null,
    "comment": "[#not-implemented-hide:] Specifies the configuration for retry policy extension. Note that if this is set, it'll take precedence over the virtual host level retry policy entirely (e.g., policies are not merged, the most internal one becomes the enforced policy). `Retry policy` should not be set if this field is used.",
    "notImp": true
  },
  {
    "name": "request_mirror_policies",
  ...
  },
  {
    ...
    "fieldType": "HedgePolicy",
    "enums": null,
    "comment": "Indicates that the route has a hedge policy. Note that if this is set, it'll take precedence over the virtual host level hedge policy entirely (e.g., policies are not merged, the most internal one becomes the enforced policy).",
    "notImp": false
  },
  {
    "name": "max_stream_duration",
...
export const RouteAction_RequestMirrorPolicy: OutType = { "RouteAction_RequestMirrorPolicy": [
  ...
  },
  {
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "Disables appending the ``-shadow`` suffix to the shadowed ``Host`` header.\n\nDefaults to ``false``.",
    "notImp": false
  },
  {
    "name": "request_headers_mutations",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "HeaderMutation[]",
    "enums": null,
    "comment": "Specifies a list of header mutations that should be applied to each mirrored request. Header mutations are applied in the order they are specified. For more information, including details on header value syntax, see the documentation on `custom request headers`.",
    "notImp": false
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "Indicates that during mirroring, the host header will be swapped with this value. `disable_shadow_host_suffix_append` is implicitly enabled if this field is set.",
    "notImp": false
  }
] };
...
export const RouteAction_UpgradeConfig: OutType = { "RouteAction_UpgradeConfig": [
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "The case-insensitive name of this upgrade, for example, \"websocket\". For each upgrade type present in upgrade_configs, requests with Upgrade: [upgrade_type] will be proxied upstream.",
    "notImp": false
  },
  {
    "name": "enabled",
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "Determines if upgrades are available on this route.\n\nDefaults to ``true``.",
    "notImp": false
  },
  {
    "name": "connect_config",
...
export const DirectResponseAction: OutType = { "DirectResponseAction": [
  ...
  },
  {
    ...
    "enums": null,
    "comment": "Specifies a format string for the response body. If present, the contents of ``body_format`` will be formatted and used as the response body, where the contents of ``body`` (may be empty) will be passed as the variable ``%LOCAL_REPLY_BODY%``. If neither are provided, no body is included in the generated response.",
    "notImp": false
  }
] };
...
export const RateLimit_HitsAddend: OutType = { "RateLimit_HitsAddend": [
  ...
  },
  {
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "If true, the hits addend value will be treated as negative, effectively adding to the rate limit budget instead of consuming from it. This can be used to refill previously consumed rate limit tokens.",
    "notImp": false
  }
] };
...
export const RateLimit: OutType = { "RateLimit": [
  ...
  {
    "name": "x_ratelimit_option",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "RateLimit_XRateLimitOption",
    "enums": [
      "UNSPECIFIED",
      "OFF",
      "DRAFT_VERSION_03"
    ],
    "comment": "Descriptor level X-RateLimit headers options which may override the filter level setting.",
    "notImp": false
  }
] };
...
export const RateLimit_Action: OutType = { "RateLimit_Action": [
  ...
  {
    "name": "action_specifier.remote_address_match",
    "isUnion": true,
    "isDeprecated": false,
    "fieldType": "RateLimit_Action_RemoteAddressMatch",
    "enums": null,
    "comment": "Rate limit on remote address match.",
    "notImp": false
  }
] };
...
export const RateLimit_Action_QueryParameters: OutType = { "RateLimit_Action_QueryParameters": [
  ...
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "The key to use when creating the rate limit descriptor entry. This descriptor key will be used to identify the rate limit rule in the rate limiting service.",
    "notImp": false
  },
  {
    "name": "skip_if_absent",
...
export const RateLimit_Action_GenericKey: OutType = { "RateLimit_Action_GenericKey": [
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "Descriptor value of entry.\n\nThe same `format specifier` as used for `HTTP access logging` applies here, however unknown specifier values are replaced with the empty string instead of ``-``.\n\n:::note\n\nFormatter parsing is controlled by the runtime feature flag ``envoy.reloadable_features.enable_formatter_for_ratelimit_action_descriptor_value`` (disabled by default). \n:::\n\n  When enabled: The format string can contain multiple valid substitution fields. If multiple substitution fields are present, their results will be concatenated to form the final descriptor value. If it contains no substitution fields, the value will be used as is. If the final concatenated result is empty and ``default_value`` is set, the ``default_value`` will be used. If ``default_value`` is not set and the result is empty, this descriptor will be skipped and not included in the rate limit call.\n\n  When disabled (default): The descriptor_value is used as a literal string without any formatter parsing or substitution.\n\nFor example, ``static_value`` will be used as is since there are no substitution fields. ``%REQ(:method)%`` will be replaced with the HTTP method, and ``%REQ(:method)%%REQ(:path)%`` will be replaced with the concatenation of the HTTP method and path. ``%CEL(request.headers['user-id'])%`` will use CEL to extract the user ID from request headers.",
    "notImp": false
  },
  {
    "name": "default_value",
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "An optional value to use if the final concatenated ``descriptor_value`` result is empty. Only applicable when formatter parsing is enabled by the runtime feature flag ``envoy.reloadable_features.enable_formatter_for_ratelimit_action_descriptor_value`` (disabled by default).",
    "notImp": false
  },
  {
    "name": "descriptor_key",
...
export const RateLimit_Action_RemoteAddressMatch: OutType = { "RateLimit_Action_RemoteAddressMatch": [
  {
    "name": "descriptor_value",
    "isUnion": false,
    "isDeprecated": false,
  ...
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "An optional value to use if the final concatenated ``descriptor_value`` result is empty.",
    "notImp": false
  },
  {
    ...
    "enums": null,
    "comment": "Specifies an address matcher that controls whether the rate limit action is applied. The matcher checks the remote address (trusted address from `x-forwarded-for`) against the specified CIDR ranges. The rate limit action will be applied if the remote address matches any of the CIDR ranges (or does not match any if ``invert_match`` is set to true in the address matcher).",
    "notImp": false
  }
] };

export const RateLimit_Action_RemoteAddressMatch_SingleFields = [
  "descriptor_value",
  "descriptor_key",
  "default_value"
];
...
export const HeaderMatcher: OutType = { "HeaderMatcher": [
  ...
  },
  {
    ...
    "fieldType": "RegexMatcher",
    "enums": null,
    "comment": "If specified, this regex string is a regular expression rule which implies the entire request header value must match the regex. The rule will not match if only a subsequence of the request header value matches the regex.\n\n:::attention\n\nThis field is deprecated. Please use `string_match`.",
    "notImp": false
  },
  {
  ...
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "If specified, header match will be performed based on the prefix of the header value.\n\n:::note\n\nEmpty prefix is not allowed. Please use ``present_match`` instead. \n:::\n\n:::attention\n\nThis field is deprecated. Please use `string_match`. \n:::\n\nExamples:\n\n* The prefix ``abcd`` matches the value ``abcdxyz``, but not for ``abcxyz``.",
    "notImp": false
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "If specified, header match will be performed based on the suffix of the header value.\n\n:::note\n\nEmpty suffix is not allowed. Please use ``present_match`` instead. \n:::\n\n:::attention\n\nThis field is deprecated. Please use `string_match`. \n:::\n\nExamples:\n\n* The suffix ``abcd`` matches the value ``xyzabcd``, but not for ``xyzbcd``.",
    "notImp": false
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "If specified, header match will be performed based on whether the header value contains the given value or not.\n\n:::note\n\nEmpty contains match is not allowed. Please use ``present_match`` instead. \n:::\n\n:::attention\n\nThis field is deprecated. Please use `string_match`. \n:::\n\nExamples:\n\n* The value ``abcd`` matches the value ``xyzabcdpqr``, but not for ``xyzbcdpqr``.",
    "notImp": false
  },
  {
...
export const CookieMatcher: OutType = { "CookieMatcher": [
  {
    "name": "name",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "string",
    "enums": null,
    "comment": "Specifies the cookie name to evaluate.",
    "notImp": false
  },
  {
    "name": "string_match",
    ...
    "fieldType": "StringMatcher",
    "enums": null,
    "comment": "Match the cookie value using `StringMatcher` semantics.",
    "notImp": false
  },
  {
    "name": "invert_match",
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "Invert the match result. If the cookie is not present, the match result is false, so ``invert_match`` will cause the matcher to succeed when the cookie is absent.",
    "notImp": false
  }
] };

export const CookieMatcher_SingleFields = [
  "name",
  "invert_match"
];
