...
export const ShrinkHeapConfig: OutType = { "ShrinkHeapConfig": [
  {
    "name": "timer_interval",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "Duration",
    "enums": null,
    "comment": "The interval at which shrink heap action checks if memory should be released. If not specified, defaults to 10 seconds.",
    "notImp": false
  },
  {
    ...
    "fieldType": "number",
    "enums": null,
    "comment": "Maximum amount of unfreed memory in bytes to keep before releasing memory back to the system. This is used as the threshold passed to tcmalloc::MallocExtension::ReleaseMemoryToSystem(). If not specified, defaults to 104857600 (100MB).",
    "notImp": false
  }
] };

export const ShrinkHeapConfig_SingleFields = [
  "timer_interval",
...
export const OverloadAction: OutType = { "OverloadAction": [
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "The name of the overload action. This is just a well-known string that listeners can use for registering callbacks. Valid known overload actions include: - envoy.overload_actions.stop_accepting_requests - envoy.overload_actions.disable_http_keepalive - envoy.overload_actions.stop_accepting_connections - envoy.overload_actions.reject_incoming_connections - envoy.overload_actions.shrink_heap - envoy.overload_actions.reduce_timeouts - envoy.overload_actions.reset_high_memory_stream",
    "notImp": false
  },
  {
    "name": "triggers",
  ...
  },
  {
    ...
    "fieldType": "Any",
    "enums": null,
    "comment": "Configuration for the action being instantiated if applicable.",
    "notImp": false
  }
] };
