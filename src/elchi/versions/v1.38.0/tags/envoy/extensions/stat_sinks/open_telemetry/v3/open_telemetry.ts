...
export const SinkConfig: OutType = { "SinkConfig": [
  ...
  {
    "name": "protocol_specifier.http_service",
    "isUnion": true,
    "isDeprecated": false,
    "fieldType": "HttpService",
    "enums": null,
    "comment": "The upstream HTTP cluster that implements the OTLP/HTTP collector. See `OTLP/HTTP <https://opentelemetry.io/docs/specs/otlp/#otlphttp>`_.\n\n:::note\n\nThe ``request_headers_to_add`` property in the OTLP HTTP exporter service does not support the `format specifier`. The values configured are added as HTTP headers on the OTLP export request without any formatting applied.",
    "notImp": false
  },
  {
