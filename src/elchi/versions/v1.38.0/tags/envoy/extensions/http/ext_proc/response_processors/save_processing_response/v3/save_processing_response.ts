...
export const SaveProcessingResponse_SaveOptions: OutType = { "SaveProcessingResponse_SaveOptions": [
  {
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "When set to ``true``, saves the response for the corresponding response type.\n\nDefaults to ``false``.",
    "notImp": false
  },
  {
    "name": "save_on_error",
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "When set to ``true``, saves the response if there was an error when processing the response from the external processor.\n\nDefaults to ``false``.",
    "notImp": false
  }
] };
...
export const SaveProcessingResponse: OutType = { "SaveProcessingResponse": [
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "The default filter state name is ``envoy.http.ext_proc.response_processors.save_processing_response``. If defined, ``filter_state_name_suffix`` is appended to this name.\n\nFor example, setting ``filter_state_name_suffix`` to ``xyz`` will set the filter state name to ``envoy.http.ext_proc.response_processors.save_processing_response.xyz``.",
    "notImp": false
  },
  {
