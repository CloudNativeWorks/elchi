...
export const Composite: OutType = { "Composite": [
  ...
  },
  {
    ...
    "fieldType": "Matcher",
    "enums": null,
    "comment": "[#not-implemented-hide:] The match tree that will be used to select an action to execute. The action type should be `ExecuteFilterAction`.",
    "notImp": true
  }
] };
...
export const CompositePerRoute: OutType = { "CompositePerRoute": [
  {
    "name": "matcher",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "Matcher",
    "enums": null,
    "comment": "Override of the match tree for this route.",
    "notImp": false
  }
] };
