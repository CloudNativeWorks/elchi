...
export const Mutations: OutType = { "Mutations": [
  ...
  {
    "name": "response_trailers_mutations",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "HeaderMutation[]",
    "enums": null,
    "comment": "The response trailer mutations are applied before the response is sent to the downstream client.",
    "notImp": false
  },
  {
    "name": "request_trailers_mutations",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "HeaderMutation[]",
    "enums": null,
    "comment": "The request trailer mutations are applied before the request is sent to the upstream cluster.",
    "notImp": false
  }
] };
