...
export const OAuth2Credentials: OutType = { "OAuth2Credentials": [
  ...
  },
  {
    ...
    "enums": null,
    "comment": "The secret used to retrieve the access token. This value will be URL encoded when sent to the OAuth server. This field is required unless `auth_type` is set to ``TLS_CLIENT_AUTH``, in which case authentication is done via the client certificate.",
    "notImp": false
  },
  {
...
export const OAuth2PerRoute: OutType = { "OAuth2PerRoute": [
  {
    "name": "config",
    "isUnion": false,
    "isDeprecated": false,
    ...
    "enums": null,
    "comment": "Full OAuth2 config for this route.",
    "notImp": false
  }
] };
...
export const OAuth2: OutType = { "OAuth2": [
  {
    ...
    "fieldType": "OAuth2Config",
    "enums": null,
    "comment": "The OAuth2 filter config.",
    "notImp": false
  }
] };