...
export interface FileBasedMetadataConfig {
  $type: "envoy.config.grpc_credential.v2alpha.FileBasedMetadataConfig";
  /**
...
function createBaseFileBasedMetadataConfig(): FileBasedMetadataConfig {
  return { $type: "envoy.config.grpc_credential.v2alpha.FileBasedMetadataConfig" };
}
...
> = {
  $type: "envoy.config.grpc_credential.v2alpha.FileBasedMetadataConfig" as const,
