...
export const protobufPackage = "envoy.config.filter.http.csrf.v2";

/** CSRF filter config. */
export interface CsrfPolicy {
  $type: "envoy.config.filter.http.csrf.v2.CsrfPolicy";
  /**
...
function createBaseCsrfPolicy(): CsrfPolicy {
  return { $type: "envoy.config.filter.http.csrf.v2.CsrfPolicy" };
}

export const CsrfPolicy: MessageFns<CsrfPolicy, "envoy.config.filter.http.csrf.v2.CsrfPolicy"> = {
  $type: "envoy.config.filter.http.csrf.v2.CsrfPolicy" as const,
