...
export const ExecuteFilterAction: OutType = { "ExecuteFilterAction": [
  {
    ...
    "fieldType": "TypedExtensionConfig",
    "enums": null,
    "comment": "Filter specific configuration which depends on the filter being instantiated. See the supported filters for further documentation. Only one of ``typed_config`` or ``dynamic_config`` can be set. Ignored if ``filter_chain`` is set. extension-category: envoy.filters.http",
    "notImp": false
  },
  {
    "name": "dynamic_config",
    ...
    "enums": null,
    "comment": "Dynamic configuration of filter obtained via extension configuration discovery service. Only one of ``typed_config`` or ``dynamic_config`` can be set. Ignored if ``filter_chain`` is set.",
    "notImp": false
  },
  {
    "name": "filter_chain",
    ...
    "enums": null,
    "comment": "An inlined list of filter configurations. The specified filters will be executed in order. [#not-implemented-hide:]",
    "notImp": true
  },
  {
    "name": "sample_percent",
