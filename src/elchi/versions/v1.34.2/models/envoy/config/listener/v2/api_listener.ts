...
export const protobufPackage = "envoy.config.listener.v2";
...
export interface ApiListener {
  $type: "envoy.config.listener.v2.ApiListener";
  /**
...
function createBaseApiListener(): ApiListener {
  return { $type: "envoy.config.listener.v2.ApiListener" };
}

export const ApiListener: MessageFns<ApiListener, "envoy.config.listener.v2.ApiListener"> = {
  $type: "envoy.config.listener.v2.ApiListener" as const,
