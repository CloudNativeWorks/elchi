...
export const protobufPackage = "envoy.config.filter.http.on_demand.v2";

export interface OnDemand {
  $type: "envoy.config.filter.http.on_demand.v2.OnDemand";
}

function createBaseOnDemand(): OnDemand {
  return { $type: "envoy.config.filter.http.on_demand.v2.OnDemand" };
}

export const OnDemand: MessageFns<OnDemand, "envoy.config.filter.http.on_demand.v2.OnDemand"> = {
  $type: "envoy.config.filter.http.on_demand.v2.OnDemand" as const,

  encode(_: OnDemand, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
