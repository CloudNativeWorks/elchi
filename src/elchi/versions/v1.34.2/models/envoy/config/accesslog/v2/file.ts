...
export interface FileAccessLog {
  $type: "envoy.config.accesslog.v2.FileAccessLog";
...
function createBaseFileAccessLog(): FileAccessLog {
  return { $type: "envoy.config.accesslog.v2.FileAccessLog", access_log_format: undefined };
}

export const FileAccessLog: MessageFns<FileAccessLog, "envoy.config.accesslog.v2.FileAccessLog"> = {
  $type: "envoy.config.accesslog.v2.FileAccessLog" as const,
