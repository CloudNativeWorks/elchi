...
import { RateLimitDescriptor } from "../../../../common/ratelimit/v3/ratelimit";

export const protobufPackage = "envoy.extensions.filters.network.ratelimit.v3";

/** [#next-free-field: 7] */
export interface RateLimit {
  $type: "envoy.extensions.filters.network.ratelimit.v3.RateLimit";
...
function createBaseRateLimit(): RateLimit {
  return { $type: "envoy.extensions.filters.network.ratelimit.v3.RateLimit" };
}

export const RateLimit: MessageFns<RateLimit, "envoy.extensions.filters.network.ratelimit.v3.RateLimit"> = {
  $type: "envoy.extensions.filters.network.ratelimit.v3.RateLimit" as const,
