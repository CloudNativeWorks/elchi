...
export const protobufPackage = "envoy.extensions.filters.listener.local_ratelimit.v3";

export interface LocalRateLimit {
  $type: "envoy.extensions.filters.listener.local_ratelimit.v3.LocalRateLimit";
  /**
...
function createBaseLocalRateLimit(): LocalRateLimit {
  return { $type: "envoy.extensions.filters.listener.local_ratelimit.v3.LocalRateLimit" };
}
...
> = {
  $type: "envoy.extensions.filters.listener.local_ratelimit.v3.LocalRateLimit" as const,
