...
export const protobufPackage = "envoy.extensions.filters.listener.original_src.v3";
...
export interface OriginalSrc {
  $type: "envoy.extensions.filters.listener.original_src.v3.OriginalSrc";
  /**
...
function createBaseOriginalSrc(): OriginalSrc {
  return { $type: "envoy.extensions.filters.listener.original_src.v3.OriginalSrc" };
}

export const OriginalSrc: MessageFns<OriginalSrc, "envoy.extensions.filters.listener.original_src.v3.OriginalSrc"> = {
  $type: "envoy.extensions.filters.listener.original_src.v3.OriginalSrc" as const,
