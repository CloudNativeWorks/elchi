...
> = {
  ...
  encode(
    ...
    if (message.fixed_value !== undefined) {
      Duration.encode(message.fixed_value, writer.uint32(50).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.fixed_value = Duration.decode(reader, reader.uint32());
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): GradientControllerConfig_MinimumRTTCalculationParams {
    return {
      ...
      fixed_value: isSet(object.fixed_value) ? Duration.fromJSON(object.fixed_value) : undefined,
  ...
  toJSON(message: GradientControllerConfig_MinimumRTTCalculationParams): unknown {
    ...
    if (message.fixed_value !== undefined) {
      obj.fixed_value = Duration.toJSON(message.fixed_value);
    }
    if (message.request_count !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<GradientControllerConfig_MinimumRTTCalculationParams>, I>>(
    ...
    message.interval = (object.interval !== undefined && object.interval !== null)
      ...
      : undefined;
    message.fixed_value = (object.fixed_value !== undefined && object.fixed_value !== null)
      ? Duration.fromPartial(object.fixed_value)
      : undefined;
