...
export const protobufPackage = "envoy.extensions.filters.listener.original_dst.v3";

export interface OriginalDst {
  $type: "envoy.extensions.filters.listener.original_dst.v3.OriginalDst";
}

function createBaseOriginalDst(): OriginalDst {
  return { $type: "envoy.extensions.filters.listener.original_dst.v3.OriginalDst" };
}

export const OriginalDst: MessageFns<OriginalDst, "envoy.extensions.filters.listener.original_dst.v3.OriginalDst"> = {
  $type: "envoy.extensions.filters.listener.original_dst.v3.OriginalDst" as const,
