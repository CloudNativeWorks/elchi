...
export interface Config {
   ...
   */
  encryption_parameters?: SdsSecretConfig | undefined;
}
...
export const Config: MessageFns<Config, "envoy.extensions.quic.connection_id_generator.quic_lb.v3.Config"> = {
  ...
  encode(message: Config, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.unsafe_unencrypted_testing_mode !== undefined && message.unsafe_unencrypted_testing_mode !== false) {
      writer.uint32(8).bool(message.unsafe_unencrypted_testing_mode);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.unsafe_unencrypted_testing_mode = reader.bool();
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): Config {
    return {
      $type: Config.$type,
      unsafe_unencrypted_testing_mode: isSet(object.unsafe_unencrypted_testing_mode)
        ? globalThis.Boolean(object.unsafe_unencrypted_testing_mode)
        : undefined,
  ...
  toJSON(message: Config): unknown {
    const obj: any = {};
    if (message.unsafe_unencrypted_testing_mode !== undefined) {
      obj.unsafe_unencrypted_testing_mode = message.unsafe_unencrypted_testing_mode;
    }
    if (message.server_id !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<Config>, I>>(object: I): Config {
    const message = createBaseConfig();
    message.unsafe_unencrypted_testing_mode = object.unsafe_unencrypted_testing_mode ?? undefined;
