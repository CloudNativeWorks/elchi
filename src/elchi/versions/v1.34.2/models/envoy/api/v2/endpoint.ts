...
import { Endpoint, LocalityLbEndpoints } from "./endpoint/endpoint_components";
...
export interface ClusterLoadAssignment_Policy {
  $type: "envoy.api.v2.ClusterLoadAssignment.Policy";
  /**
   ...
   * @deprecated
   */
  disable_overprovisioning?: boolean | undefined;
}
...
function createBaseClusterLoadAssignment(): ClusterLoadAssignment {
  return { $type: "envoy.api.v2.ClusterLoadAssignment" };
}

export const ClusterLoadAssignment: MessageFns<ClusterLoadAssignment, "envoy.api.v2.ClusterLoadAssignment"> = {
  $type: "envoy.api.v2.ClusterLoadAssignment" as const,
...
function createBaseClusterLoadAssignment_Policy(): ClusterLoadAssignment_Policy {
  return { $type: "envoy.api.v2.ClusterLoadAssignment.Policy" };
}
...
> = {
  $type: "envoy.api.v2.ClusterLoadAssignment.Policy" as const,
  ...
  encode(message: ClusterLoadAssignment_Policy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.disable_overprovisioning !== undefined && message.disable_overprovisioning !== false) {
      writer.uint32(40).bool(message.disable_overprovisioning);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.disable_overprovisioning = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ClusterLoadAssignment_Policy {
    return {
      ...
      endpoint_stale_after: isSet(object.endpoint_stale_after)
        ...
        : undefined,
      disable_overprovisioning: isSet(object.disable_overprovisioning)
        ? globalThis.Boolean(object.disable_overprovisioning)
        : undefined,
    };
  },
  ...
  toJSON(message: ClusterLoadAssignment_Policy): unknown {
    ...
    if (message.disable_overprovisioning !== undefined) {
      obj.disable_overprovisioning = message.disable_overprovisioning;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ClusterLoadAssignment_Policy>, I>>(object: I): ClusterLoadAssignment_Policy {
    ...
    message.endpoint_stale_after = (object.endpoint_stale_after !== undefined && object.endpoint_stale_after !== null)
      ...
      : undefined;
    message.disable_overprovisioning = object.disable_overprovisioning ?? undefined;
    return message;
  },
};
...
function createBaseClusterLoadAssignment_Policy_DropOverload(): ClusterLoadAssignment_Policy_DropOverload {
  return { $type: "envoy.api.v2.ClusterLoadAssignment.Policy.DropOverload" };
}
...
> = {
  $type: "envoy.api.v2.ClusterLoadAssignment.Policy.DropOverload" as const,
...
function createBaseClusterLoadAssignment_NamedEndpointsEntry(): ClusterLoadAssignment_NamedEndpointsEntry {
  return { $type: "envoy.api.v2.ClusterLoadAssignment.NamedEndpointsEntry", key: "" };
}
...
> = {
  $type: "envoy.api.v2.ClusterLoadAssignment.NamedEndpointsEntry" as const,
