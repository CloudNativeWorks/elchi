...
export const protobufPackage = "envoy.service.event_reporting.v2alpha";
...
export interface StreamEventsRequest {
  $type: "envoy.service.event_reporting.v2alpha.StreamEventsRequest";
  /**
...
export interface StreamEventsRequest_Identifier {
  $type: "envoy.service.event_reporting.v2alpha.StreamEventsRequest.Identifier";
...
export interface StreamEventsResponse {
  $type: "envoy.service.event_reporting.v2alpha.StreamEventsResponse";
}

function createBaseStreamEventsRequest(): StreamEventsRequest {
  return { $type: "envoy.service.event_reporting.v2alpha.StreamEventsRequest" };
}
...
> = {
  $type: "envoy.service.event_reporting.v2alpha.StreamEventsRequest" as const,
...
function createBaseStreamEventsRequest_Identifier(): StreamEventsRequest_Identifier {
  return { $type: "envoy.service.event_reporting.v2alpha.StreamEventsRequest.Identifier" };
}
...
> = {
  $type: "envoy.service.event_reporting.v2alpha.StreamEventsRequest.Identifier" as const,
...
function createBaseStreamEventsResponse(): StreamEventsResponse {
  return { $type: "envoy.service.event_reporting.v2alpha.StreamEventsResponse" };
}
...
> = {
  $type: "envoy.service.event_reporting.v2alpha.StreamEventsResponse" as const,
...
export const EventReportingServiceServiceName = "envoy.service.event_reporting.v2alpha.EventReportingService";
