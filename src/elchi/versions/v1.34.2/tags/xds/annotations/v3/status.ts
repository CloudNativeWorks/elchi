...
export const FileStatusAnnotation: OutType = { "FileStatusAnnotation": [
  {
...
export const FileStatusAnnotation_SingleFields = [
  "work_in_progress"
];

export const MessageStatusAnnotation: OutType = { "MessageStatusAnnotation": [
  {
    "name": "work_in_progress",
    "isUnion": false,
    "isDeprecated": false,
...
export const MessageStatusAnnotation_SingleFields = [
  "work_in_progress"
];

export const FieldStatusAnnotation: OutType = { "FieldStatusAnnotation": [
  {
    "name": "work_in_progress",
    "isUnion": false,
    "isDeprecated": false,
...
export const FieldStatusAnnotation_SingleFields = [
  "work_in_progress"
];
