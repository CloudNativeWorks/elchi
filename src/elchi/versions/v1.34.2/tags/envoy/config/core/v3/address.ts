...
export const SocketAddress: OutType = { "SocketAddress": [
  ...
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "The Linux network namespace to bind the socket to. If this is set, Envoy will create the socket in the specified network namespace. Only supported on Linux. [#not-implemented-hide:]",
    "notImp": true
  }
] };
