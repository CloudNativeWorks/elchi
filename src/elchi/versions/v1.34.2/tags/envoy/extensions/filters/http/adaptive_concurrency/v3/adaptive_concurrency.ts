...
export const GradientControllerConfig_MinimumRTTCalculationParams: OutType = { "GradientControllerConfig_MinimumRTTCalculationParams": [
  {
    ...
    "fieldType": "Duration",
    "enums": null,
    "comment": "The time interval between recalculating the minimum request round-trip time. Has to be positive. If set to zero, dynamic sampling of the minRTT is disabled.",
    "notImp": false
  },
  {
    "name": "fixed_value",
    ...
    "fieldType": "Duration",
    "enums": null,
    "comment": "The fixed value for the minRTT. This value is used when minRTT is not sampled dynamically. If dynamic sampling of the minRTT is disabled, this field must be set.",
    "notImp": false
  },
  {
    "name": "request_count",
