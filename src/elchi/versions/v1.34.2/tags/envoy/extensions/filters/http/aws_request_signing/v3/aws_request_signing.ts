...
export const AwsRequestSigning: OutType = { "AwsRequestSigning": [
  ...
  },
  {
    ...
    "enums": null,
    "comment": "The credential provider for signing the request. This is optional and if not set, it will be retrieved from the procedure described in `config_http_filters_aws_request_signing`.",
    "notImp": false
  }
] };
