...
function createBaseGrpcMethodList(): GrpcMethodList {
  return { $type: "envoy.config.core.v3.GrpcMethodList" };
}

export const GrpcMethodList: MessageFns<GrpcMethodList, "envoy.config.core.v3.GrpcMethodList"> = {
  $type: "envoy.config.core.v3.GrpcMethodList" as const,
...
function createBaseGrpcMethodList_Service(): GrpcMethodList_Service {
  return { $type: "envoy.config.core.v3.GrpcMethodList.Service" };
}

export const GrpcMethodList_Service: MessageFns<GrpcMethodList_Service, "envoy.config.core.v3.GrpcMethodList.Service"> =
  {
    $type: "envoy.config.core.v3.GrpcMethodList.Service" as const,
