...
function createBaseBackoffStrategy(): BackoffStrategy {
  return { $type: "envoy.config.core.v3.BackoffStrategy" };
}

export const BackoffStrategy: MessageFns<BackoffStrategy, "envoy.config.core.v3.BackoffStrategy"> = {
  $type: "envoy.config.core.v3.BackoffStrategy" as const,
