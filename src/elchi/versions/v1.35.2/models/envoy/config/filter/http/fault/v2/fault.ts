...
import { FaultDelay, FaultRateLimit } from "../../../fault/v2/fault";

export const protobufPackage = "envoy.config.filter.http.fault.v2";

export interface FaultAbort {
  $type: "envoy.config.filter.http.fault.v2.FaultAbort";
  error_type?:
    | //
...
export interface HTTPFault {
  $type: "envoy.config.filter.http.fault.v2.HTTPFault";
  /**
   ...
   */
  response_rate_limit_percent_runtime?: string | undefined;
}

function createBaseFaultAbort(): FaultAbort {
  return { $type: "envoy.config.filter.http.fault.v2.FaultAbort", error_type: undefined };
}

export const FaultAbort: MessageFns<FaultAbort, "envoy.config.filter.http.fault.v2.FaultAbort"> = {
  $type: "envoy.config.filter.http.fault.v2.FaultAbort" as const,
...
function createBaseFaultAbort_HeaderAbort(): FaultAbort_HeaderAbort {
  return { $type: "envoy.config.filter.http.fault.v2.FaultAbort.HeaderAbort" };
}
...
> = {
  $type: "envoy.config.filter.http.fault.v2.FaultAbort.HeaderAbort" as const,
...
function createBaseHTTPFault(): HTTPFault {
  return { $type: "envoy.config.filter.http.fault.v2.HTTPFault" };
}

export const HTTPFault: MessageFns<HTTPFault, "envoy.config.filter.http.fault.v2.HTTPFault"> = {
  $type: "envoy.config.filter.http.fault.v2.HTTPFault" as const,
