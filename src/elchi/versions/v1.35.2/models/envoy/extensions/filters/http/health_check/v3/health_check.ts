...
export const protobufPackage = "envoy.extensions.filters.http.health_check.v3";

/** [#next-free-field: 6] */
export interface HealthCheck {
  $type: "envoy.extensions.filters.http.health_check.v3.HealthCheck";
...
export interface HealthCheck_ClusterMinHealthyPercentagesEntry {
  $type: "envoy.extensions.filters.http.health_check.v3.HealthCheck.ClusterMinHealthyPercentagesEntry";
  key: string;
  value?: Percent | undefined;
}

function createBaseHealthCheck(): HealthCheck {
  return { $type: "envoy.extensions.filters.http.health_check.v3.HealthCheck" };
}

export const HealthCheck: MessageFns<HealthCheck, "envoy.extensions.filters.http.health_check.v3.HealthCheck"> = {
  $type: "envoy.extensions.filters.http.health_check.v3.HealthCheck" as const,
...
> = {
  $type: "envoy.extensions.filters.http.health_check.v3.HealthCheck.ClusterMinHealthyPercentagesEntry" as const,
