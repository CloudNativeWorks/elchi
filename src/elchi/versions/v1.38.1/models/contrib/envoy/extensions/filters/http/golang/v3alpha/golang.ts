...
export interface Config {
   ...
   */
  generic_secrets?: SdsSecretConfig[] | undefined;
}
...
export interface RouterPlugin {
  ...
  override?: { $case: "disabled"; disabled: boolean } | { $case: "config"; config: Any } | undefined;
}
...
export const Config: MessageFns<Config, "envoy.extensions.filters.http.golang.v3alpha.Config"> = {
  ...
  encode(message: Config, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.generic_secrets !== undefined && message.generic_secrets.length !== 0) {
      for (const v of message.generic_secrets) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          if (message.generic_secrets === undefined) {
            message.generic_secrets = [];
          }
          const el = SdsSecretConfig.decode(reader, reader.uint32());
          if (el !== undefined) {
            message.generic_secrets!.push(el);
          }
          continue;
        }
      }
  ...
  fromJSON(object: any): Config {
    return {
      ...
      generic_secrets: globalThis.Array.isArray(object?.generic_secrets)
        ? object.generic_secrets.map((e: any) => SdsSecretConfig.fromJSON(e))
        : undefined,
    };
  },
  ...
  toJSON(message: Config): unknown {
    ...
    if (message.generic_secrets?.length) {
      obj.generic_secrets = message.generic_secrets.map((e) => SdsSecretConfig.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Config>, I>>(object: I): Config {
    ...
    message.generic_secrets = object.generic_secrets?.map((e) => SdsSecretConfig.fromPartial(e)) || undefined;
    return message;
  },
};
