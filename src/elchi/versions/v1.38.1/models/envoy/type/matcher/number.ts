...
export interface DoubleMatcher {
  ...
  match_pattern?: { $case: "range"; range: DoubleRange } | { $case: "exact"; exact: number } | undefined;
}

function createBaseDoubleMatcher(): DoubleMatcher {
  return { $type: "envoy.type.matcher.DoubleMatcher", match_pattern: undefined };
}

export const DoubleMatcher: MessageFns<DoubleMatcher, "envoy.type.matcher.DoubleMatcher"> = {
  $type: "envoy.type.matcher.DoubleMatcher" as const,
