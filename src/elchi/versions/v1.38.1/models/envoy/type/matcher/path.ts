...
export interface PathMatcher {
  $type: "envoy.type.matcher.PathMatcher";
  rule?: { $case: "path"; path: StringMatcher } | undefined;
}

function createBasePathMatcher(): PathMatcher {
  return { $type: "envoy.type.matcher.PathMatcher", rule: undefined };
}

export const PathMatcher: MessageFns<PathMatcher, "envoy.type.matcher.PathMatcher"> = {
  $type: "envoy.type.matcher.PathMatcher" as const,
