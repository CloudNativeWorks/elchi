...
function createBaseStructMatcher(): StructMatcher {
  return { $type: "envoy.type.matcher.v3.StructMatcher" };
}

export const StructMatcher: MessageFns<StructMatcher, "envoy.type.matcher.v3.StructMatcher"> = {
  $type: "envoy.type.matcher.v3.StructMatcher" as const,
...
function createBaseStructMatcher_PathSegment(): StructMatcher_PathSegment {
  return { $type: "envoy.type.matcher.v3.StructMatcher.PathSegment", segment: undefined };
}
...
> = {
  $type: "envoy.type.matcher.v3.StructMatcher.PathSegment" as const,
