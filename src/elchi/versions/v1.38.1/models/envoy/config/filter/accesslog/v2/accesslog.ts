...
export const protobufPackage = "envoy.config.filter.accesslog.v2";
...
export interface AccessLog {
  ...
  filter?: AccessLogFilter | undefined;
  config_type?: { $case: "config"; config: { [key: string]: any } | undefined } | {
    $case: "typed_config";
    typed_config: Any;
  } | undefined;
}
...
export interface ComparisonFilter {
  $type: "envoy.config.filter.accesslog.v2.ComparisonFilter";
  /** Comparison operator. */
  op?:
    | ComparisonFilter_Op
    | undefined;
...
function createBaseAccessLog(): AccessLog {
  return { $type: "envoy.config.filter.accesslog.v2.AccessLog", config_type: undefined };
}

export const AccessLog: MessageFns<AccessLog, "envoy.config.filter.accesslog.v2.AccessLog"> = {
  $type: "envoy.config.filter.accesslog.v2.AccessLog" as const,
  ...
  encode(message: AccessLog, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    switch (message.config_type?.$case) {
      case "config":
        Struct.encode(Struct.wrap(message.config_type.config), writer.uint32(26).fork()).join();
        break;
      case "typed_config":
...
function createBaseAccessLogFilter(): AccessLogFilter {
  return { $type: "envoy.config.filter.accesslog.v2.AccessLogFilter", filter_specifier: undefined };
}

export const AccessLogFilter: MessageFns<AccessLogFilter, "envoy.config.filter.accesslog.v2.AccessLogFilter"> = {
  $type: "envoy.config.filter.accesslog.v2.AccessLogFilter" as const,
...
function createBaseComparisonFilter(): ComparisonFilter {
  return { $type: "envoy.config.filter.accesslog.v2.ComparisonFilter" };
}

export const ComparisonFilter: MessageFns<ComparisonFilter, "envoy.config.filter.accesslog.v2.ComparisonFilter"> = {
  $type: "envoy.config.filter.accesslog.v2.ComparisonFilter" as const,
...
function createBaseStatusCodeFilter(): StatusCodeFilter {
  return { $type: "envoy.config.filter.accesslog.v2.StatusCodeFilter" };
}

export const StatusCodeFilter: MessageFns<StatusCodeFilter, "envoy.config.filter.accesslog.v2.StatusCodeFilter"> = {
  $type: "envoy.config.filter.accesslog.v2.StatusCodeFilter" as const,
...
function createBaseDurationFilter(): DurationFilter {
  return { $type: "envoy.config.filter.accesslog.v2.DurationFilter" };
}

export const DurationFilter: MessageFns<DurationFilter, "envoy.config.filter.accesslog.v2.DurationFilter"> = {
  $type: "envoy.config.filter.accesslog.v2.DurationFilter" as const,
...
function createBaseNotHealthCheckFilter(): NotHealthCheckFilter {
  return { $type: "envoy.config.filter.accesslog.v2.NotHealthCheckFilter" };
}

export const NotHealthCheckFilter: MessageFns<
  NotHealthCheckFilter,
  "envoy.config.filter.accesslog.v2.NotHealthCheckFilter"
> = {
  $type: "envoy.config.filter.accesslog.v2.NotHealthCheckFilter" as const,
...
function createBaseTraceableFilter(): TraceableFilter {
  return { $type: "envoy.config.filter.accesslog.v2.TraceableFilter" };
}

export const TraceableFilter: MessageFns<TraceableFilter, "envoy.config.filter.accesslog.v2.TraceableFilter"> = {
  $type: "envoy.config.filter.accesslog.v2.TraceableFilter" as const,
...
function createBaseRuntimeFilter(): RuntimeFilter {
  return { $type: "envoy.config.filter.accesslog.v2.RuntimeFilter" };
}

export const RuntimeFilter: MessageFns<RuntimeFilter, "envoy.config.filter.accesslog.v2.RuntimeFilter"> = {
  $type: "envoy.config.filter.accesslog.v2.RuntimeFilter" as const,
...
function createBaseAndFilter(): AndFilter {
  return { $type: "envoy.config.filter.accesslog.v2.AndFilter" };
}

export const AndFilter: MessageFns<AndFilter, "envoy.config.filter.accesslog.v2.AndFilter"> = {
  $type: "envoy.config.filter.accesslog.v2.AndFilter" as const,
...
function createBaseOrFilter(): OrFilter {
  return { $type: "envoy.config.filter.accesslog.v2.OrFilter" };
}

export const OrFilter: MessageFns<OrFilter, "envoy.config.filter.accesslog.v2.OrFilter"> = {
  $type: "envoy.config.filter.accesslog.v2.OrFilter" as const,
...
function createBaseHeaderFilter(): HeaderFilter {
  return { $type: "envoy.config.filter.accesslog.v2.HeaderFilter" };
}

export const HeaderFilter: MessageFns<HeaderFilter, "envoy.config.filter.accesslog.v2.HeaderFilter"> = {
  $type: "envoy.config.filter.accesslog.v2.HeaderFilter" as const,
...
function createBaseResponseFlagFilter(): ResponseFlagFilter {
  return { $type: "envoy.config.filter.accesslog.v2.ResponseFlagFilter" };
}

export const ResponseFlagFilter: MessageFns<ResponseFlagFilter, "envoy.config.filter.accesslog.v2.ResponseFlagFilter"> =
  {
    $type: "envoy.config.filter.accesslog.v2.ResponseFlagFilter" as const,
...
function createBaseGrpcStatusFilter(): GrpcStatusFilter {
  return { $type: "envoy.config.filter.accesslog.v2.GrpcStatusFilter" };
}

export const GrpcStatusFilter: MessageFns<GrpcStatusFilter, "envoy.config.filter.accesslog.v2.GrpcStatusFilter"> = {
  $type: "envoy.config.filter.accesslog.v2.GrpcStatusFilter" as const,
...
function createBaseExtensionFilter(): ExtensionFilter {
  return { $type: "envoy.config.filter.accesslog.v2.ExtensionFilter", config_type: undefined };
}

export const ExtensionFilter: MessageFns<ExtensionFilter, "envoy.config.filter.accesslog.v2.ExtensionFilter"> = {
  $type: "envoy.config.filter.accesslog.v2.ExtensionFilter" as const,
