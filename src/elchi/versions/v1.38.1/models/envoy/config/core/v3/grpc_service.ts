...
import { DataSource, HeaderValue, RetryPolicy } from "./base";
...
export interface GrpcService_EnvoyGrpc {
   ...
   * Default to false.
   */
  skip_envoy_headers?: boolean | undefined;
}
...
export interface GrpcService_GoogleGrpc {
  ...
  channel_args?: GrpcService_GoogleGrpc_ChannelArgs | undefined;
}
...
export interface GrpcService_GoogleGrpc_ChannelArgs {
  ...
  args?: Map<string, GrpcService_GoogleGrpc_ChannelArgs_Value> | undefined;
}
...
export interface GrpcService_GoogleGrpc_ChannelArgs_ArgsEntry {
  $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.ChannelArgs.ArgsEntry";
  key: string;
  value?: GrpcService_GoogleGrpc_ChannelArgs_Value | undefined;
}

function createBaseGrpcService(): GrpcService {
  return { $type: "envoy.config.core.v3.GrpcService", target_specifier: undefined };
}

export const GrpcService: MessageFns<GrpcService, "envoy.config.core.v3.GrpcService"> = {
  $type: "envoy.config.core.v3.GrpcService" as const,
...
function createBaseGrpcService_EnvoyGrpc(): GrpcService_EnvoyGrpc {
  return { $type: "envoy.config.core.v3.GrpcService.EnvoyGrpc" };
}

export const GrpcService_EnvoyGrpc: MessageFns<GrpcService_EnvoyGrpc, "envoy.config.core.v3.GrpcService.EnvoyGrpc"> = {
  $type: "envoy.config.core.v3.GrpcService.EnvoyGrpc" as const,
  ...
  encode(message: GrpcService_EnvoyGrpc, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.max_receive_message_length !== undefined) {
      UInt32Value.encode(
        { $type: "google.protobuf.UInt32Value", value: message.max_receive_message_length! },
        writer.uint32(34).fork(),
      ).join();
    }
    if (message.skip_envoy_headers !== undefined && message.skip_envoy_headers !== false) {
      writer.uint32(40).bool(message.skip_envoy_headers);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.max_receive_message_length = UInt32Value.decode(reader, reader.uint32()).value;
          continue;
        }
        case 5: {
          if (tag !== 40) {
          ...
          message.skip_envoy_headers = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): GrpcService_EnvoyGrpc {
    return {
      ...
      retry_policy: isSet(object.retry_policy) ? RetryPolicy.fromJSON(object.retry_policy) : undefined,
      max_receive_message_length: isSet(object.max_receive_message_length)
        ? Number(object.max_receive_message_length)
        : undefined,
      skip_envoy_headers: isSet(object.skip_envoy_headers) ? globalThis.Boolean(object.skip_envoy_headers) : undefined,
    };
  },
  ...
  toJSON(message: GrpcService_EnvoyGrpc): unknown {
    ...
    if (message.max_receive_message_length !== undefined) {
      obj.max_receive_message_length = message.max_receive_message_length;
    }
    if (message.skip_envoy_headers !== undefined) {
      obj.skip_envoy_headers = message.skip_envoy_headers;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GrpcService_EnvoyGrpc>, I>>(object: I): GrpcService_EnvoyGrpc {
    ...
    message.retry_policy = (object.retry_policy !== undefined && object.retry_policy !== null)
      ? RetryPolicy.fromPartial(object.retry_policy)
      : undefined;
    message.max_receive_message_length = object.max_receive_message_length ?? undefined;
    message.skip_envoy_headers = object.skip_envoy_headers ?? undefined;
    return message;
  },
};
...
function createBaseGrpcService_GoogleGrpc(): GrpcService_GoogleGrpc {
  return { $type: "envoy.config.core.v3.GrpcService.GoogleGrpc" };
}

export const GrpcService_GoogleGrpc: MessageFns<GrpcService_GoogleGrpc, "envoy.config.core.v3.GrpcService.GoogleGrpc"> =
  {
    $type: "envoy.config.core.v3.GrpcService.GoogleGrpc" as const,
    ...
    encode(message: GrpcService_GoogleGrpc, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
      ...
      if (message.channel_credentials_plugin !== undefined && message.channel_credentials_plugin.length !== 0) {
        for (const v of message.channel_credentials_plugin) {
          Any.encode(v!, writer.uint32(74).fork()).join();
        }
      }
      ...
      if (message.call_credentials_plugin !== undefined && message.call_credentials_plugin.length !== 0) {
        for (const v of message.call_credentials_plugin) {
      ...
      if (message.per_stream_buffer_limit_bytes !== undefined) {
        UInt32Value.encode(
          { $type: "google.protobuf.UInt32Value", value: message.per_stream_buffer_limit_bytes! },
          writer.uint32(58).fork(),
        ).join();
      }
      if (message.channel_args !== undefined) {
        GrpcService_GoogleGrpc_ChannelArgs.encode(message.channel_args, writer.uint32(66).fork()).join();
      }
      return writer;
    },
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 9: {
            ...
            if (message.channel_credentials_plugin === undefined) {
              message.channel_credentials_plugin = [];
            }
            const el = Any.decode(reader, reader.uint32());
            if (el !== undefined) {
              message.channel_credentials_plugin!.push(el);
            }
            continue;
          }
          case 3: {
          ...
          case 10: {
            ...
            if (message.call_credentials_plugin === undefined) {
              message.call_credentials_plugin = [];
            }
            const el = Any.decode(reader, reader.uint32());
            if (el !== undefined) {
              message.call_credentials_plugin!.push(el);
            }
            continue;
          }
          case 4: {
          ...
          case 7: {
            ...
            message.per_stream_buffer_limit_bytes = UInt32Value.decode(reader, reader.uint32()).value;
            continue;
          }
          case 8: {
            if (tag !== 66) {
            ...
            message.channel_args = GrpcService_GoogleGrpc_ChannelArgs.decode(reader, reader.uint32());
            continue;
          }
        }
        if ((tag & 7) === 4 || tag === 0) {
    ...
    fromJSON(object: any): GrpcService_GoogleGrpc {
      return {
        ...
        channel_credentials: isSet(object.channel_credentials)
          ...
          : undefined,
        channel_credentials_plugin: globalThis.Array.isArray(object?.channel_credentials_plugin)
          ? object.channel_credentials_plugin.map((e: any) => Any.fromJSON(e))
          : undefined,
        call_credentials: globalThis.Array.isArray(object?.call_credentials)
          ...
          : undefined,
        call_credentials_plugin: globalThis.Array.isArray(object?.call_credentials_plugin)
          ? object.call_credentials_plugin.map((e: any) => Any.fromJSON(e))
          : undefined,
        ...
        per_stream_buffer_limit_bytes: isSet(object.per_stream_buffer_limit_bytes)
          ? Number(object.per_stream_buffer_limit_bytes)
          : undefined,
        channel_args: isSet(object.channel_args)
          ? GrpcService_GoogleGrpc_ChannelArgs.fromJSON(object.channel_args)
          : undefined,
      };
    },
    ...
    toJSON(message: GrpcService_GoogleGrpc): unknown {
      ...
      if (message.channel_credentials_plugin?.length) {
        obj.channel_credentials_plugin = message.channel_credentials_plugin.map((e) => Any.toJSON(e));
      }
      ...
      if (message.call_credentials_plugin?.length) {
        obj.call_credentials_plugin = message.call_credentials_plugin.map((e) => Any.toJSON(e));
      }
      ...
      if (message.per_stream_buffer_limit_bytes !== undefined) {
        obj.per_stream_buffer_limit_bytes = message.per_stream_buffer_limit_bytes;
      }
      if (message.channel_args !== undefined) {
        obj.channel_args = GrpcService_GoogleGrpc_ChannelArgs.toJSON(message.channel_args);
      }
      return obj;
    },
    ...
    fromPartial<I extends Exact<DeepPartial<GrpcService_GoogleGrpc>, I>>(object: I): GrpcService_GoogleGrpc {
      ...
      message.channel_credentials = (object.channel_credentials !== undefined && object.channel_credentials !== null)
        ...
        : undefined;
      message.channel_credentials_plugin = object.channel_credentials_plugin?.map((e) => Any.fromPartial(e)) ||
        undefined;
      message.call_credentials =
        object.call_credentials?.map((e) => GrpcService_GoogleGrpc_CallCredentials.fromPartial(e)) || undefined;
      message.call_credentials_plugin = object.call_credentials_plugin?.map((e) => Any.fromPartial(e)) || undefined;
      ...
      message.per_stream_buffer_limit_bytes = object.per_stream_buffer_limit_bytes ?? undefined;
      message.channel_args = (object.channel_args !== undefined && object.channel_args !== null)
        ? GrpcService_GoogleGrpc_ChannelArgs.fromPartial(object.channel_args)
        : undefined;
      return message;
    },
  };
...
function createBaseGrpcService_GoogleGrpc_SslCredentials(): GrpcService_GoogleGrpc_SslCredentials {
  return { $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.SslCredentials" };
}
...
> = {
  $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.SslCredentials" as const,
...
function createBaseGrpcService_GoogleGrpc_GoogleLocalCredentials(): GrpcService_GoogleGrpc_GoogleLocalCredentials {
  return { $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.GoogleLocalCredentials" };
}
...
> = {
  $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.GoogleLocalCredentials" as const,
...
function createBaseGrpcService_GoogleGrpc_ChannelCredentials(): GrpcService_GoogleGrpc_ChannelCredentials {
  return { $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.ChannelCredentials", credential_specifier: undefined };
}
...
> = {
  $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.ChannelCredentials" as const,
...
function createBaseGrpcService_GoogleGrpc_CallCredentials(): GrpcService_GoogleGrpc_CallCredentials {
  return { $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.CallCredentials", credential_specifier: undefined };
}
...
> = {
  $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.CallCredentials" as const,
...
function createBaseGrpcService_GoogleGrpc_CallCredentials_ServiceAccountJWTAccessCredentials(): GrpcService_GoogleGrpc_CallCredentials_ServiceAccountJWTAccessCredentials {
  return { $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.CallCredentials.ServiceAccountJWTAccessCredentials" };
}
...
> = {
  $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.CallCredentials.ServiceAccountJWTAccessCredentials" as const,
...
function createBaseGrpcService_GoogleGrpc_CallCredentials_GoogleIAMCredentials(): GrpcService_GoogleGrpc_CallCredentials_GoogleIAMCredentials {
  return { $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.CallCredentials.GoogleIAMCredentials" };
}
...
> = {
  $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.CallCredentials.GoogleIAMCredentials" as const,
...
> = {
  $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.CallCredentials.MetadataCredentialsFromPlugin" as const,
...
function createBaseGrpcService_GoogleGrpc_CallCredentials_StsService(): GrpcService_GoogleGrpc_CallCredentials_StsService {
  return { $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.CallCredentials.StsService" };
}
...
> = {
  $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.CallCredentials.StsService" as const,
...
function createBaseGrpcService_GoogleGrpc_ChannelArgs(): GrpcService_GoogleGrpc_ChannelArgs {
  return { $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.ChannelArgs" };
}

export const GrpcService_GoogleGrpc_ChannelArgs: MessageFns<
  GrpcService_GoogleGrpc_ChannelArgs,
  "envoy.config.core.v3.GrpcService.GoogleGrpc.ChannelArgs"
> = {
  $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.ChannelArgs" as const,

  encode(message: GrpcService_GoogleGrpc_ChannelArgs, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    (message.args || new Map()).forEach((value, key) => {
      GrpcService_GoogleGrpc_ChannelArgs_ArgsEntry.encode({
        $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.ChannelArgs.ArgsEntry",
        key: key as any,
        value,
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GrpcService_GoogleGrpc_ChannelArgs {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGrpcService_GoogleGrpc_ChannelArgs();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          const entry1 = GrpcService_GoogleGrpc_ChannelArgs_ArgsEntry.decode(reader, reader.uint32());
          if (entry1.value !== undefined) {
            if (message.args === undefined) {
              message.args = new Map();
            }
            message.args!.set(entry1.key, entry1.value);
          }
          continue;
        }
      }
  ...
  fromJSON(object: any): GrpcService_GoogleGrpc_ChannelArgs {
    return {
      $type: GrpcService_GoogleGrpc_ChannelArgs.$type,
      args: isObject(object.args)
        ? Object.entries(object.args).reduce<Map<string, GrpcService_GoogleGrpc_ChannelArgs_Value>>(
          (acc, [key, value]) => {
            acc.set(key, GrpcService_GoogleGrpc_ChannelArgs_Value.fromJSON(value));
            return acc;
          },
          new Map(),
        )
  ...
  toJSON(message: GrpcService_GoogleGrpc_ChannelArgs): unknown {
    const obj: any = {};
    if (message.args?.size) {
      obj.args = {};
      message.args.forEach((v, k) => {
        obj.args[k] = GrpcService_GoogleGrpc_ChannelArgs_Value.toJSON(v);
      });
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<GrpcService_GoogleGrpc_ChannelArgs>, I>>(
    base?: I,
  ): GrpcService_GoogleGrpc_ChannelArgs {
    return GrpcService_GoogleGrpc_ChannelArgs.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GrpcService_GoogleGrpc_ChannelArgs>, I>>(
    object: I,
  ): GrpcService_GoogleGrpc_ChannelArgs {
    const message = createBaseGrpcService_GoogleGrpc_ChannelArgs();
    message.args = (object.args === undefined || object.args === null) ? undefined : (() => {
      const m = new Map();
      (object.args as Map<string, GrpcService_GoogleGrpc_ChannelArgs_Value> ?? new Map()).forEach((value, key) => {
        if (value !== undefined) {
          m.set(key, GrpcService_GoogleGrpc_ChannelArgs_Value.fromPartial(value));
        }
      });
      return m;
    })();
...
messageTypeRegistry.set(GrpcService_GoogleGrpc_ChannelArgs.$type, GrpcService_GoogleGrpc_ChannelArgs);

function createBaseGrpcService_GoogleGrpc_ChannelArgs_Value(): GrpcService_GoogleGrpc_ChannelArgs_Value {
  return { $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.ChannelArgs.Value", value_specifier: undefined };
}

export const GrpcService_GoogleGrpc_ChannelArgs_Value: MessageFns<
  GrpcService_GoogleGrpc_ChannelArgs_Value,
  "envoy.config.core.v3.GrpcService.GoogleGrpc.ChannelArgs.Value"
> = {
  $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.ChannelArgs.Value" as const,

  encode(message: GrpcService_GoogleGrpc_ChannelArgs_Value, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    switch (message.value_specifier?.$case) {
      case "string_value":
        writer.uint32(10).string(message.value_specifier.string_value);
        break;
      case "int_value":
        writer.uint32(16).int64(message.value_specifier.int_value);
        break;
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GrpcService_GoogleGrpc_ChannelArgs_Value {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGrpcService_GoogleGrpc_ChannelArgs_Value();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.value_specifier = { $case: "int_value", int_value: longToNumber(reader.int64()) };
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): GrpcService_GoogleGrpc_ChannelArgs_Value {
    return {
      $type: GrpcService_GoogleGrpc_ChannelArgs_Value.$type,
  ...
  toJSON(message: GrpcService_GoogleGrpc_ChannelArgs_Value): unknown {
    const obj: any = {};
    if (message.value_specifier?.$case === "string_value") {
      obj.string_value = message.value_specifier.string_value;
    }
    if (message.value_specifier?.$case === "int_value") {
      obj.int_value = Math.round(message.value_specifier.int_value);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<GrpcService_GoogleGrpc_ChannelArgs_Value>, I>>(
    base?: I,
  ): GrpcService_GoogleGrpc_ChannelArgs_Value {
    return GrpcService_GoogleGrpc_ChannelArgs_Value.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GrpcService_GoogleGrpc_ChannelArgs_Value>, I>>(
    object: I,
  ): GrpcService_GoogleGrpc_ChannelArgs_Value {
    const message = createBaseGrpcService_GoogleGrpc_ChannelArgs_Value();
    if (
    ...
    if (
      object.value_specifier?.$case === "int_value" &&
      object.value_specifier?.int_value !== undefined &&
      object.value_specifier?.int_value !== null
    ) {
      message.value_specifier = { $case: "int_value", int_value: object.value_specifier.int_value };
    }
    return message;
  },
};

messageTypeRegistry.set(GrpcService_GoogleGrpc_ChannelArgs_Value.$type, GrpcService_GoogleGrpc_ChannelArgs_Value);

function createBaseGrpcService_GoogleGrpc_ChannelArgs_ArgsEntry(): GrpcService_GoogleGrpc_ChannelArgs_ArgsEntry {
  return { $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.ChannelArgs.ArgsEntry", key: "" };
}

export const GrpcService_GoogleGrpc_ChannelArgs_ArgsEntry: MessageFns<
  GrpcService_GoogleGrpc_ChannelArgs_ArgsEntry,
  "envoy.config.core.v3.GrpcService.GoogleGrpc.ChannelArgs.ArgsEntry"
> = {
  $type: "envoy.config.core.v3.GrpcService.GoogleGrpc.ChannelArgs.ArgsEntry" as const,

  encode(
    message: GrpcService_GoogleGrpc_ChannelArgs_ArgsEntry,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (message.key !== "") {
    ...
    if (message.value !== undefined) {
      GrpcService_GoogleGrpc_ChannelArgs_Value.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GrpcService_GoogleGrpc_ChannelArgs_ArgsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGrpcService_GoogleGrpc_ChannelArgs_ArgsEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          message.value = GrpcService_GoogleGrpc_ChannelArgs_Value.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): GrpcService_GoogleGrpc_ChannelArgs_ArgsEntry {
    return {
      $type: GrpcService_GoogleGrpc_ChannelArgs_ArgsEntry.$type,
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? GrpcService_GoogleGrpc_ChannelArgs_Value.fromJSON(object.value) : undefined,
    };
  },

  toJSON(message: GrpcService_GoogleGrpc_ChannelArgs_ArgsEntry): unknown {
    const obj: any = {};
    if (message.key !== undefined) {
      obj.key = message.key;
    }
    if (message.value !== undefined) {
      obj.value = GrpcService_GoogleGrpc_ChannelArgs_Value.toJSON(message.value);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<GrpcService_GoogleGrpc_ChannelArgs_ArgsEntry>, I>>(
    base?: I,
  ): GrpcService_GoogleGrpc_ChannelArgs_ArgsEntry {
    return GrpcService_GoogleGrpc_ChannelArgs_ArgsEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GrpcService_GoogleGrpc_ChannelArgs_ArgsEntry>, I>>(
    object: I,
  ): GrpcService_GoogleGrpc_ChannelArgs_ArgsEntry {
    const message = createBaseGrpcService_GoogleGrpc_ChannelArgs_ArgsEntry();
    message.key = object.key ?? "";
    message.value = (object.value !== undefined && object.value !== null)
      ? GrpcService_GoogleGrpc_ChannelArgs_Value.fromPartial(object.value)
      : undefined;
    return message;
  },
};
...
messageTypeRegistry.set(
  GrpcService_GoogleGrpc_ChannelArgs_ArgsEntry.$type,
  GrpcService_GoogleGrpc_ChannelArgs_ArgsEntry,
);
