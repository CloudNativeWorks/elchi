...
export interface ScopedRouteConfiguration_Key_Fragment {
  ...
  type?: { $case: "string_key"; string_key: string } | undefined;
}

function createBaseScopedRouteConfiguration(): ScopedRouteConfiguration {
  return { $type: "envoy.config.route.v3.ScopedRouteConfiguration" };
}

export const ScopedRouteConfiguration: MessageFns<
  ScopedRouteConfiguration,
  "envoy.config.route.v3.ScopedRouteConfiguration"
> = {
  $type: "envoy.config.route.v3.ScopedRouteConfiguration" as const,

  encode(message: ScopedRouteConfiguration, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.on_demand !== undefined && message.on_demand !== false) {
      writer.uint32(32).bool(message.on_demand);
    }
    ...
    if (message.route_configuration !== undefined) {
      RouteConfiguration.encode(message.route_configuration, writer.uint32(42).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.route_configuration = RouteConfiguration.decode(reader, reader.uint32());
          continue;
        }
        case 3: {
          if (tag !== 26) {
  ...
  fromJSON(object: any): ScopedRouteConfiguration {
    return {
      ...
      on_demand: isSet(object.on_demand) ? globalThis.Boolean(object.on_demand) : undefined,
      ...
      route_configuration_name: isSet(object.route_configuration_name)
        ...
        : undefined,
      route_configuration: isSet(object.route_configuration)
        ? RouteConfiguration.fromJSON(object.route_configuration)
        : undefined,
  ...
  toJSON(message: ScopedRouteConfiguration): unknown {
    ...
    if (message.on_demand !== undefined) {
      obj.on_demand = message.on_demand;
    }
    ...
    if (message.route_configuration !== undefined) {
      obj.route_configuration = RouteConfiguration.toJSON(message.route_configuration);
    }
    if (message.key !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<ScopedRouteConfiguration>, I>>(object: I): ScopedRouteConfiguration {
    const message = createBaseScopedRouteConfiguration();
    message.on_demand = object.on_demand ?? undefined;
    message.name = object.name ?? undefined;
    message.route_configuration_name = object.route_configuration_name ?? undefined;
    message.route_configuration = (object.route_configuration !== undefined && object.route_configuration !== null)
      ? RouteConfiguration.fromPartial(object.route_configuration)
      : undefined;
...
function createBaseScopedRouteConfiguration_Key(): ScopedRouteConfiguration_Key {
  return { $type: "envoy.config.route.v3.ScopedRouteConfiguration.Key" };
}
...
> = {
  $type: "envoy.config.route.v3.ScopedRouteConfiguration.Key" as const,
...
function createBaseScopedRouteConfiguration_Key_Fragment(): ScopedRouteConfiguration_Key_Fragment {
  return { $type: "envoy.config.route.v3.ScopedRouteConfiguration.Key.Fragment", type: undefined };
}
...
> = {
  $type: "envoy.config.route.v3.ScopedRouteConfiguration.Key.Fragment" as const,
