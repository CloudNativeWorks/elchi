...
import { AddressMatcher } from "../../../type/matcher/v3/address";
...
export interface WeightedCluster {
  ...
  random_value_specifier?: { $case: "header_name"; header_name: string } | {
    $case: "use_hash_policy";
    use_hash_policy: boolean | undefined;
  } | undefined;
}
...
export interface WeightedCluster_ClusterWeight {
  ...
  host_rewrite_specifier?: { $case: "host_rewrite_literal"; host_rewrite_literal: string } | undefined;
}
...
export interface RetryPolicy_RetryPriority {
  ...
  name?: string | undefined;
  config_type?: { $case: "typed_config"; typed_config: Any } | undefined;
}
...
export interface RateLimit {
  ...
  x_ratelimit_option?: RateLimit_XRateLimitOption | undefined;
}

export enum RateLimit_XRateLimitOption {
  /**
   * UNSPECIFIED - X-RateLimit headers is not specified. When this enum is used at descriptor level,
...
export function rateLimit_XRateLimitOptionFromJSON(object: any): RateLimit_XRateLimitOption {
  switch (object) {
    case 0:
    case "UNSPECIFIED":
      return RateLimit_XRateLimitOption.UNSPECIFIED;
    case 1:
    case "OFF":
      return RateLimit_XRateLimitOption.OFF;
    case 2:
    case "DRAFT_VERSION_03":
      return RateLimit_XRateLimitOption.DRAFT_VERSION_03;
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum RateLimit_XRateLimitOption");
  }
}

export function rateLimit_XRateLimitOptionToJSON(object: RateLimit_XRateLimitOption): string {
  switch (object) {
    case RateLimit_XRateLimitOption.UNSPECIFIED:
      return "UNSPECIFIED";
    case RateLimit_XRateLimitOption.OFF:
      return "OFF";
    case RateLimit_XRateLimitOption.DRAFT_VERSION_03:
...
export function rateLimit_XRateLimitOptionToNumber(object: RateLimit_XRateLimitOption): number {
  switch (object) {
    case RateLimit_XRateLimitOption.UNSPECIFIED:
      return 0;
    case RateLimit_XRateLimitOption.OFF:
...
export interface RateLimit_Action {
  ...
  action_specifier?:
    ...
    | { $case: "remote_address_match"; remote_address_match: RateLimit_Action_RemoteAddressMatch }
    | undefined;
}
...
export enum RateLimit_Action_MetaData_Source {
  ...
  /** CLUSTER_ENTRY - Query :ref:`cluster metadata <envoy_v3_api_field_config.cluster.v3.Cluster.metadata>` */
  CLUSTER_ENTRY = "CLUSTER_ENTRY",
  /**
   * CLUSTER_LOCALITY_ENTRY - Query :ref:`cluster locality metadata <envoy_v3_api_field_config.endpoint.v3.LbEndpoint.metadata>`
   ...
   */
  CLUSTER_LOCALITY_ENTRY = "CLUSTER_LOCALITY_ENTRY",
}
...
export function rateLimit_Action_MetaData_SourceFromJSON(object: any): RateLimit_Action_MetaData_Source {
  switch (object) {
    ...
    case 2:
    case "CLUSTER_ENTRY":
      return RateLimit_Action_MetaData_Source.CLUSTER_ENTRY;
    case 3:
    case "CLUSTER_LOCALITY_ENTRY":
      return RateLimit_Action_MetaData_Source.CLUSTER_LOCALITY_ENTRY;
    default:
...
export function rateLimit_Action_MetaData_SourceToJSON(object: RateLimit_Action_MetaData_Source): string {
  switch (object) {
    ...
    case RateLimit_Action_MetaData_Source.ROUTE_ENTRY:
      return "ROUTE_ENTRY";
    case RateLimit_Action_MetaData_Source.CLUSTER_ENTRY:
      return "CLUSTER_ENTRY";
    case RateLimit_Action_MetaData_Source.CLUSTER_LOCALITY_ENTRY:
      return "CLUSTER_LOCALITY_ENTRY";
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum RateLimit_Action_MetaData_Source");
  }
}
 ...
 */
export interface RateLimit_Action_RemoteAddressMatch {
   ...
   */
  address_matcher?: AddressMatcher | undefined;
}

export interface RateLimit_Override {
  $type: "envoy.config.route.v3.RateLimit.Override";
  override_specifier?: { $case: "dynamic_metadata"; dynamic_metadata: RateLimit_Override_DynamicMetadata } | undefined;
}
...
export interface RateLimit_HitsAddend {
   ...
   * rate limit tokens.
   */
  is_negative_hits?: boolean | undefined;
}
...
export interface QueryParameterMatcher {
   ...
   */
  name?: string | undefined;
  query_parameter_match_specifier?: { $case: "string_match"; string_match: StringMatcher } | {
    $case: "present_match";
...
export const RateLimit: MessageFns<RateLimit, "envoy.config.route.v3.RateLimit"> = {
  ...
  encode(message: RateLimit, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (
      message.x_ratelimit_option !== undefined && message.x_ratelimit_option !== RateLimit_XRateLimitOption.UNSPECIFIED
    ) {
      writer.uint32(56).int32(rateLimit_XRateLimitOptionToNumber(message.x_ratelimit_option));
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.x_ratelimit_option = rateLimit_XRateLimitOptionFromJSON(reader.int32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): RateLimit {
    return {
      ...
      apply_on_stream_done: isSet(object.apply_on_stream_done)
        ...
        : undefined,
      x_ratelimit_option: isSet(object.x_ratelimit_option)
        ? rateLimit_XRateLimitOptionFromJSON(object.x_ratelimit_option)
        : undefined,
    };
  },
  ...
  toJSON(message: RateLimit): unknown {
    ...
    if (message.x_ratelimit_option !== undefined) {
      obj.x_ratelimit_option = rateLimit_XRateLimitOptionToJSON(message.x_ratelimit_option);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<RateLimit>, I>>(object: I): RateLimit {
    ...
    message.x_ratelimit_option = object.x_ratelimit_option ?? undefined;
    return message;
  },
};
...
export const RateLimit_Action: MessageFns<RateLimit_Action, "envoy.config.route.v3.RateLimit.Action"> = {
  ...
  encode(message: RateLimit_Action, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    switch (message.action_specifier?.$case) {
      ...
      case "query_parameter_value_match":
        ...
        break;
      case "remote_address_match":
        RateLimit_Action_RemoteAddressMatch.encode(
          message.action_specifier.remote_address_match,
          writer.uint32(106).fork(),
        ).join();
        break;
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 13: {
          ...
          message.action_specifier = {
            $case: "remote_address_match",
            remote_address_match: RateLimit_Action_RemoteAddressMatch.decode(reader, reader.uint32()),
          };
          continue;
        }
      }
  ...
  fromJSON(object: any): RateLimit_Action {
    return {
      ...
      action_specifier: isSet(object.source_cluster)
        ...
        : isSet(object.remote_address_match)
        ? {
          $case: "remote_address_match",
          remote_address_match: RateLimit_Action_RemoteAddressMatch.fromJSON(object.remote_address_match),
        }
        : undefined,
    };
  },
  ...
  toJSON(message: RateLimit_Action): unknown {
    ...
    if (message.action_specifier?.$case === "remote_address_match") {
      obj.remote_address_match = RateLimit_Action_RemoteAddressMatch.toJSON(
        message.action_specifier.remote_address_match,
      );
    }
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<RateLimit_Action>, I>>(object: I): RateLimit_Action {
    ...
    if (
      object.action_specifier?.$case === "remote_address_match" &&
      object.action_specifier?.remote_address_match !== undefined &&
      object.action_specifier?.remote_address_match !== null
    ) {
      message.action_specifier = {
        $case: "remote_address_match",
        remote_address_match: RateLimit_Action_RemoteAddressMatch.fromPartial(
          object.action_specifier.remote_address_match,
        ),
      };
    }
    return message;
...
function createBaseRateLimit_Action_RemoteAddressMatch(): RateLimit_Action_RemoteAddressMatch {
  return { $type: "envoy.config.route.v3.RateLimit.Action.RemoteAddressMatch" };
}

export const RateLimit_Action_RemoteAddressMatch: MessageFns<
  RateLimit_Action_RemoteAddressMatch,
  "envoy.config.route.v3.RateLimit.Action.RemoteAddressMatch"
> = {
  $type: "envoy.config.route.v3.RateLimit.Action.RemoteAddressMatch" as const,

  encode(message: RateLimit_Action_RemoteAddressMatch, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.descriptor_value !== undefined && message.descriptor_value !== "") {
      writer.uint32(10).string(message.descriptor_value);
    }
    if (message.descriptor_key !== undefined && message.descriptor_key !== "") {
    ...
    if (message.address_matcher !== undefined) {
      AddressMatcher.encode(message.address_matcher, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RateLimit_Action_RemoteAddressMatch {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRateLimit_Action_RemoteAddressMatch();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 4: {
          ...
          message.address_matcher = AddressMatcher.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): RateLimit_Action_RemoteAddressMatch {
    return {
      $type: RateLimit_Action_RemoteAddressMatch.$type,
      descriptor_value: isSet(object.descriptor_value) ? globalThis.String(object.descriptor_value) : undefined,
      descriptor_key: isSet(object.descriptor_key) ? globalThis.String(object.descriptor_key) : undefined,
      default_value: isSet(object.default_value) ? globalThis.String(object.default_value) : undefined,
      address_matcher: isSet(object.address_matcher) ? AddressMatcher.fromJSON(object.address_matcher) : undefined,
    };
  },

  toJSON(message: RateLimit_Action_RemoteAddressMatch): unknown {
    const obj: any = {};
    if (message.descriptor_value !== undefined) {
      obj.descriptor_value = message.descriptor_value;
    }
    ...
    if (message.address_matcher !== undefined) {
      obj.address_matcher = AddressMatcher.toJSON(message.address_matcher);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<RateLimit_Action_RemoteAddressMatch>, I>>(
    base?: I,
  ): RateLimit_Action_RemoteAddressMatch {
    return RateLimit_Action_RemoteAddressMatch.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RateLimit_Action_RemoteAddressMatch>, I>>(
    object: I,
  ): RateLimit_Action_RemoteAddressMatch {
    const message = createBaseRateLimit_Action_RemoteAddressMatch();
    message.descriptor_value = object.descriptor_value ?? undefined;
    message.descriptor_key = object.descriptor_key ?? undefined;
    message.default_value = object.default_value ?? undefined;
    message.address_matcher = (object.address_matcher !== undefined && object.address_matcher !== null)
      ? AddressMatcher.fromPartial(object.address_matcher)
      : undefined;
    return message;
  },
};

messageTypeRegistry.set(RateLimit_Action_RemoteAddressMatch.$type, RateLimit_Action_RemoteAddressMatch);
...
export const RateLimit_HitsAddend: MessageFns<RateLimit_HitsAddend, "envoy.config.route.v3.RateLimit.HitsAddend"> = {
  ...
  encode(message: RateLimit_HitsAddend, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.is_negative_hits !== undefined && message.is_negative_hits !== false) {
      writer.uint32(24).bool(message.is_negative_hits);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.is_negative_hits = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): RateLimit_HitsAddend {
    return {
      ...
      is_negative_hits: isSet(object.is_negative_hits) ? globalThis.Boolean(object.is_negative_hits) : undefined,
    };
  },
  ...
  toJSON(message: RateLimit_HitsAddend): unknown {
    ...
    if (message.is_negative_hits !== undefined) {
      obj.is_negative_hits = message.is_negative_hits;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<RateLimit_HitsAddend>, I>>(object: I): RateLimit_HitsAddend {
    ...
    message.format = object.format ?? undefined;
    message.is_negative_hits = object.is_negative_hits ?? undefined;
    return message;
  },
};
