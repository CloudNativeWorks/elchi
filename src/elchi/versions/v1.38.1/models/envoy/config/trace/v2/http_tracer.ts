...
export interface Tracing_Http {
  $type: "envoy.config.trace.v2.Tracing.Http";
  /**
...
function createBaseTracing(): Tracing {
  return { $type: "envoy.config.trace.v2.Tracing" };
}

export const Tracing: MessageFns<Tracing, "envoy.config.trace.v2.Tracing"> = {
  $type: "envoy.config.trace.v2.Tracing" as const,
...
function createBaseTracing_Http(): Tracing_Http {
  return { $type: "envoy.config.trace.v2.Tracing.Http", config_type: undefined };
}

export const Tracing_Http: MessageFns<Tracing_Http, "envoy.config.trace.v2.Tracing.Http"> = {
  $type: "envoy.config.trace.v2.Tracing.Http" as const,
