 ...
 * this action.
 */
export interface ShrinkHeapConfig {
  $type: "envoy.config.overload.v3.ShrinkHeapConfig";
  /**
...
function createBaseShrinkHeapConfig(): ShrinkHeapConfig {
  return { $type: "envoy.config.overload.v3.ShrinkHeapConfig" };
}

export const ShrinkHeapConfig: MessageFns<ShrinkHeapConfig, "envoy.config.overload.v3.ShrinkHeapConfig"> = {
  $type: "envoy.config.overload.v3.ShrinkHeapConfig" as const,

  encode(message: ShrinkHeapConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.timer_interval !== undefined) {
      Duration.encode(message.timer_interval, writer.uint32(10).fork()).join();
    }
    if (message.max_unfreed_memory_bytes !== undefined) {
      UInt64Value.encode(
        { $type: "google.protobuf.UInt64Value", value: message.max_unfreed_memory_bytes! },
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ShrinkHeapConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseShrinkHeapConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.timer_interval = Duration.decode(reader, reader.uint32());
          continue;
        }
        case 2: {
          if (tag !== 18) {
          ...
          message.max_unfreed_memory_bytes = UInt64Value.decode(reader, reader.uint32()).value;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ShrinkHeapConfig {
    return {
      $type: ShrinkHeapConfig.$type,
      timer_interval: isSet(object.timer_interval) ? Duration.fromJSON(object.timer_interval) : undefined,
      max_unfreed_memory_bytes: isSet(object.max_unfreed_memory_bytes)
        ? Number(object.max_unfreed_memory_bytes)
        : undefined,
    };
  },

  toJSON(message: ShrinkHeapConfig): unknown {
    const obj: any = {};
    if (message.timer_interval !== undefined) {
      obj.timer_interval = Duration.toJSON(message.timer_interval);
    }
    if (message.max_unfreed_memory_bytes !== undefined) {
      obj.max_unfreed_memory_bytes = message.max_unfreed_memory_bytes;
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<ShrinkHeapConfig>, I>>(base?: I): ShrinkHeapConfig {
    return ShrinkHeapConfig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ShrinkHeapConfig>, I>>(object: I): ShrinkHeapConfig {
    const message = createBaseShrinkHeapConfig();
    message.timer_interval = (object.timer_interval !== undefined && object.timer_interval !== null)
      ? Duration.fromPartial(object.timer_interval)
      : undefined;
...
messageTypeRegistry.set(ShrinkHeapConfig.$type, ShrinkHeapConfig);
