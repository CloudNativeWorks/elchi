...
export interface StatsConfig {
   ...
   */
  stats_matcher?: StatsMatcher | undefined;
}

/** Configuration for disabling stat instantiation. */
export interface StatsMatcher {
  $type: "envoy.config.metrics.v2.StatsMatcher";
  stats_matcher?:
...
export interface TagSpecifier {
  ...
  tag_value?: { $case: "regex"; regex: string } | { $case: "fixed_value"; fixed_value: string } | undefined;
}
...
export interface StatsdSink {
  $type: "envoy.config.metrics.v2.StatsdSink";
  statsd_specifier?:
...
export interface DogStatsdSink {
  $type: "envoy.config.metrics.v2.DogStatsdSink";
...
export interface HystrixSink {
  $type: "envoy.config.metrics.v2.HystrixSink";
  /**
...
function createBaseStatsSink(): StatsSink {
  return { $type: "envoy.config.metrics.v2.StatsSink", config_type: undefined };
}

export const StatsSink: MessageFns<StatsSink, "envoy.config.metrics.v2.StatsSink"> = {
  $type: "envoy.config.metrics.v2.StatsSink" as const,
...
function createBaseStatsConfig(): StatsConfig {
  return { $type: "envoy.config.metrics.v2.StatsConfig" };
}

export const StatsConfig: MessageFns<StatsConfig, "envoy.config.metrics.v2.StatsConfig"> = {
  $type: "envoy.config.metrics.v2.StatsConfig" as const,
...
function createBaseStatsMatcher(): StatsMatcher {
  return { $type: "envoy.config.metrics.v2.StatsMatcher", stats_matcher: undefined };
}

export const StatsMatcher: MessageFns<StatsMatcher, "envoy.config.metrics.v2.StatsMatcher"> = {
  $type: "envoy.config.metrics.v2.StatsMatcher" as const,
...
function createBaseTagSpecifier(): TagSpecifier {
  return { $type: "envoy.config.metrics.v2.TagSpecifier", tag_value: undefined };
}

export const TagSpecifier: MessageFns<TagSpecifier, "envoy.config.metrics.v2.TagSpecifier"> = {
  $type: "envoy.config.metrics.v2.TagSpecifier" as const,
...
function createBaseStatsdSink(): StatsdSink {
  return { $type: "envoy.config.metrics.v2.StatsdSink", statsd_specifier: undefined };
}

export const StatsdSink: MessageFns<StatsdSink, "envoy.config.metrics.v2.StatsdSink"> = {
  $type: "envoy.config.metrics.v2.StatsdSink" as const,
...
function createBaseDogStatsdSink(): DogStatsdSink {
  return { $type: "envoy.config.metrics.v2.DogStatsdSink", dog_statsd_specifier: undefined };
}

export const DogStatsdSink: MessageFns<DogStatsdSink, "envoy.config.metrics.v2.DogStatsdSink"> = {
  $type: "envoy.config.metrics.v2.DogStatsdSink" as const,
...
function createBaseHystrixSink(): HystrixSink {
  return { $type: "envoy.config.metrics.v2.HystrixSink" };
}

export const HystrixSink: MessageFns<HystrixSink, "envoy.config.metrics.v2.HystrixSink"> = {
  $type: "envoy.config.metrics.v2.HystrixSink" as const,
