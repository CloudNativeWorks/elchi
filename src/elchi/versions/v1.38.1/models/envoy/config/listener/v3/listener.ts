...
import { Address, TcpKeepalive } from "../../core/v3/address";
import {
  Metadata,
  TrafficDirection,
...
export interface Listener_ConnectionBalanceConfig {
  ...
  balance_type?: { $case: "exact_balance"; exact_balance: Listener_ConnectionBalanceConfig_ExactBalance } | {
    $case: "extend_balance";
    extend_balance: TypedExtensionConfig;
  } | undefined;
}
...
export const AdditionalAddress: MessageFns<AdditionalAddress, "envoy.config.listener.v3.AdditionalAddress"> = {
  ...
  encode(message: AdditionalAddress, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.tcp_keepalive !== undefined) {
      TcpKeepalive.encode(message.tcp_keepalive, writer.uint32(26).fork()).join();
    }
    return writer;
  },
...
export const Listener: MessageFns<Listener, "envoy.config.listener.v3.Listener"> = {
  ...
  encode(message: Listener, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.per_connection_buffer_high_watermark_timeout !== undefined) {
      Duration.encode(message.per_connection_buffer_high_watermark_timeout, writer.uint32(306).fork()).join();
    }
    ...
    if (message.tcp_keepalive !== undefined) {
      TcpKeepalive.encode(message.tcp_keepalive, writer.uint32(298).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 38: {
          ...
          message.per_connection_buffer_high_watermark_timeout = Duration.decode(reader, reader.uint32());
          continue;
        }
        case 6: {
          if (tag !== 50) {
  ...
  fromJSON(object: any): Listener {
    return {
      ...
      per_connection_buffer_limit_bytes: isSet(object.per_connection_buffer_limit_bytes)
        ...
        : undefined,
      per_connection_buffer_high_watermark_timeout: isSet(object.per_connection_buffer_high_watermark_timeout)
        ? Duration.fromJSON(object.per_connection_buffer_high_watermark_timeout)
        : undefined,
  ...
  toJSON(message: Listener): unknown {
    ...
    if (message.per_connection_buffer_high_watermark_timeout !== undefined) {
      obj.per_connection_buffer_high_watermark_timeout = Duration.toJSON(
        message.per_connection_buffer_high_watermark_timeout,
      );
    }
    if (message.metadata !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<Listener>, I>>(object: I): Listener {
    ...
    message.per_connection_buffer_high_watermark_timeout =
      (object.per_connection_buffer_high_watermark_timeout !== undefined &&
          object.per_connection_buffer_high_watermark_timeout !== null)
        ? Duration.fromPartial(object.per_connection_buffer_high_watermark_timeout)
        : undefined;
