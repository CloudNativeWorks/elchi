...
import { MatchPredicate } from "../../../../config/common/matcher/v3/matcher";
...
} from "../../../../config/route/v3/route_components";
...
export interface HttpProtocolOptions {
  ...
  upstream_http_protocol_options?: UpstreamHttpProtocolOptions | undefined;
...
export interface HttpProtocolOptions_OutlierDetection {
   ...
   */
  error_matcher?: MatchPredicate | undefined;
}
...
> = {
  ...
  encode(message: HttpProtocolOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.outlier_detection !== undefined) {
      HttpProtocolOptions_OutlierDetection.encode(message.outlier_detection, writer.uint32(66).fork()).join();
    }
    if (message.request_mirror_policies !== undefined && message.request_mirror_policies.length !== 0) {
      for (const v of message.request_mirror_policies) {
        RouteAction_RequestMirrorPolicy.encode(v!, writer.uint32(74).fork()).join();
      }
    }
    if (message.hash_policy !== undefined && message.hash_policy.length !== 0) {
      for (const v of message.hash_policy) {
        RouteAction_HashPolicy.encode(v!, writer.uint32(82).fork()).join();
      }
    }
    if (message.retry_policy !== undefined) {
      RetryPolicy.encode(message.retry_policy, writer.uint32(90).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8: {
          ...
          message.outlier_detection = HttpProtocolOptions_OutlierDetection.decode(reader, reader.uint32());
          continue;
        }
        case 9: {
          if (tag !== 74) {
  ...
  fromJSON(object: any): HttpProtocolOptions {
    return {
      ...
      outlier_detection: isSet(object.outlier_detection)
        ? HttpProtocolOptions_OutlierDetection.fromJSON(object.outlier_detection)
        : undefined,
  ...
  toJSON(message: HttpProtocolOptions): unknown {
    ...
    if (message.outlier_detection !== undefined) {
      obj.outlier_detection = HttpProtocolOptions_OutlierDetection.toJSON(message.outlier_detection);
    }
  ...
  fromPartial<I extends Exact<DeepPartial<HttpProtocolOptions>, I>>(object: I): HttpProtocolOptions {
    ...
    message.outlier_detection = (object.outlier_detection !== undefined && object.outlier_detection !== null)
      ? HttpProtocolOptions_OutlierDetection.fromPartial(object.outlier_detection)
      : undefined;
    message.request_mirror_policies =
...
function createBaseHttpProtocolOptions_OutlierDetection(): HttpProtocolOptions_OutlierDetection {
  return { $type: "envoy.extensions.upstreams.http.v3.HttpProtocolOptions.OutlierDetection" };
}

export const HttpProtocolOptions_OutlierDetection: MessageFns<
  HttpProtocolOptions_OutlierDetection,
  "envoy.extensions.upstreams.http.v3.HttpProtocolOptions.OutlierDetection"
> = {
  $type: "envoy.extensions.upstreams.http.v3.HttpProtocolOptions.OutlierDetection" as const,

  encode(message: HttpProtocolOptions_OutlierDetection, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.error_matcher !== undefined) {
      MatchPredicate.encode(message.error_matcher, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): HttpProtocolOptions_OutlierDetection {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseHttpProtocolOptions_OutlierDetection();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.error_matcher = MatchPredicate.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): HttpProtocolOptions_OutlierDetection {
    return {
      $type: HttpProtocolOptions_OutlierDetection.$type,
      error_matcher: isSet(object.error_matcher) ? MatchPredicate.fromJSON(object.error_matcher) : undefined,
    };
  },

  toJSON(message: HttpProtocolOptions_OutlierDetection): unknown {
    const obj: any = {};
    if (message.error_matcher !== undefined) {
      obj.error_matcher = MatchPredicate.toJSON(message.error_matcher);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<HttpProtocolOptions_OutlierDetection>, I>>(
    base?: I,
  ): HttpProtocolOptions_OutlierDetection {
    return HttpProtocolOptions_OutlierDetection.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<HttpProtocolOptions_OutlierDetection>, I>>(
    object: I,
  ): HttpProtocolOptions_OutlierDetection {
    const message = createBaseHttpProtocolOptions_OutlierDetection();
    message.error_matcher = (object.error_matcher !== undefined && object.error_matcher !== null)
      ? MatchPredicate.fromPartial(object.error_matcher)
      : undefined;
    return message;
  },
};

messageTypeRegistry.set(HttpProtocolOptions_OutlierDetection.$type, HttpProtocolOptions_OutlierDetection);
