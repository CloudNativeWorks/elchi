...
export const protobufPackage = "envoy.extensions.filters.http.buffer.v3";
...
export interface BufferPerRoute {
  $type: "envoy.extensions.filters.http.buffer.v3.BufferPerRoute";
  override?: { $case: "disabled"; disabled: boolean } | { $case: "buffer"; buffer: Buffer } | undefined;
}

function createBaseBuffer(): Buffer {
  return { $type: "envoy.extensions.filters.http.buffer.v3.Buffer" };
}

export const Buffer: MessageFns<Buffer, "envoy.extensions.filters.http.buffer.v3.Buffer"> = {
  $type: "envoy.extensions.filters.http.buffer.v3.Buffer" as const,
...
function createBaseBufferPerRoute(): BufferPerRoute {
  return { $type: "envoy.extensions.filters.http.buffer.v3.BufferPerRoute", override: undefined };
}

export const BufferPerRoute: MessageFns<BufferPerRoute, "envoy.extensions.filters.http.buffer.v3.BufferPerRoute"> = {
  $type: "envoy.extensions.filters.http.buffer.v3.BufferPerRoute" as const,
