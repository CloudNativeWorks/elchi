...
export interface HttpConnectionManager {
   ...
   */
  forward_proto_config?: ForwardProtoConfig | undefined;
}
 ...
 */
export enum HttpConnectionManager_ForwardClientCertFormat {
  /**
   * TEXT - Use the :ref:`text format <config_http_conn_man_headers_x-forwarded-client-cert_text>`.
   * This is the default.
   */
  TEXT = "TEXT",
  /** JSON - Use the :ref:`JSON format <config_http_conn_man_headers_x-forwarded-client-cert_json>`. */
  JSON = "JSON",
}

export function httpConnectionManager_ForwardClientCertFormatFromJSON(
  object: any,
): HttpConnectionManager_ForwardClientCertFormat {
  switch (object) {
    case 0:
    case "TEXT":
      return HttpConnectionManager_ForwardClientCertFormat.TEXT;
    case 1:
    case "JSON":
      return HttpConnectionManager_ForwardClientCertFormat.JSON;
    default:
      throw new globalThis.Error(
        "Unrecognized enum value " + object + " for enum HttpConnectionManager_ForwardClientCertFormat",
      );
  }
}

export function httpConnectionManager_ForwardClientCertFormatToJSON(
  object: HttpConnectionManager_ForwardClientCertFormat,
): string {
  switch (object) {
    case HttpConnectionManager_ForwardClientCertFormat.TEXT:
      return "TEXT";
    case HttpConnectionManager_ForwardClientCertFormat.JSON:
      return "JSON";
    default:
      throw new globalThis.Error(
        "Unrecognized enum value " + object + " for enum HttpConnectionManager_ForwardClientCertFormat",
...
export function httpConnectionManager_ForwardClientCertFormatToNumber(
  object: HttpConnectionManager_ForwardClientCertFormat,
): number {
  switch (object) {
    case HttpConnectionManager_ForwardClientCertFormat.TEXT:
...
export interface HttpConnectionManager_Tracing {
   ...
   */
  no_context_propagation?: boolean | undefined;
}
...
export interface HttpConnectionManager_SetCurrentClientCertDetails {
   ...
   */
  format?: HttpConnectionManager_ForwardClientCertFormat | undefined;
}
 ...
 */
export interface HttpConnectionManager_ForwardClientCertConfig {
  $type: "envoy.extensions.filters.network.http_connection_manager.v3.HttpConnectionManager.ForwardClientCertConfig";
   ...
   * for details.
   */
  set_current_client_cert_details?: HttpConnectionManager_SetCurrentClientCertDetails | undefined;
}
...
export interface HttpConnectionManager_ProxyStatusConfig {
   ...
   * overwritten.
   */
  set_recommended_response_code?: boolean | undefined;
  proxy_name?: { $case: "use_node_id"; use_node_id: boolean } | {
 ...
 */
export interface ForwardProtoConfig {
  $type: "envoy.extensions.filters.network.http_connection_manager.v3.ForwardProtoConfig";
  /**
   ...
   */
  http_destination_ports?: number[] | undefined;
}
...
export interface ScopedRoutes_ScopeKeyBuilder_FragmentBuilder_HeaderValueExtractor {
  ...
  extract_type?: { $case: "index"; index: number } | {
    $case: "element";
...
> = {
  ...
  encode(message: HttpConnectionManager, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.stream_flush_timeout !== undefined) {
      Duration.encode(message.stream_flush_timeout, writer.uint32(474).fork()).join();
    }
    ...
    if (message.forward_client_cert_matcher !== undefined) {
      Matcher.encode(message.forward_client_cert_matcher, writer.uint32(482).fork()).join();
    }
    ...
    if (message.forward_proto_config !== undefined) {
      ForwardProtoConfig.encode(message.forward_proto_config, writer.uint32(490).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 59: {
          ...
          message.stream_flush_timeout = Duration.decode(reader, reader.uint32());
          continue;
        }
        case 28: {
          if (tag !== 226) {
        ...
        case 60: {
          ...
          message.forward_client_cert_matcher = Matcher.decode(reader, reader.uint32());
          continue;
        }
        case 18: {
          if (tag !== 144) {
        ...
        case 61: {
          ...
          message.forward_proto_config = ForwardProtoConfig.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): HttpConnectionManager {
    return {
      ...
      stream_idle_timeout: isSet(object.stream_idle_timeout)
        ...
        : undefined,
      stream_flush_timeout: isSet(object.stream_flush_timeout)
        ? Duration.fromJSON(object.stream_flush_timeout)
        : undefined,
      ...
      set_current_client_cert_details: isSet(object.set_current_client_cert_details)
        ...
        : undefined,
      forward_client_cert_matcher: isSet(object.forward_client_cert_matcher)
        ? Matcher.fromJSON(object.forward_client_cert_matcher)
        : undefined,
      ...
      add_proxy_protocol_connection_state: isSet(object.add_proxy_protocol_connection_state)
        ...
        : undefined,
      forward_proto_config: isSet(object.forward_proto_config)
        ? ForwardProtoConfig.fromJSON(object.forward_proto_config)
        : undefined,
    };
  },
  ...
  toJSON(message: HttpConnectionManager): unknown {
    ...
    if (message.stream_flush_timeout !== undefined) {
      obj.stream_flush_timeout = Duration.toJSON(message.stream_flush_timeout);
    }
    if (message.request_timeout !== undefined) {
    ...
    if (message.forward_client_cert_matcher !== undefined) {
      obj.forward_client_cert_matcher = Matcher.toJSON(message.forward_client_cert_matcher);
    }
    ...
    if (message.forward_proto_config !== undefined) {
      obj.forward_proto_config = ForwardProtoConfig.toJSON(message.forward_proto_config);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<HttpConnectionManager>, I>>(object: I): HttpConnectionManager {
    ...
    message.stream_idle_timeout = (object.stream_idle_timeout !== undefined && object.stream_idle_timeout !== null)
      ...
      : undefined;
    message.stream_flush_timeout = (object.stream_flush_timeout !== undefined && object.stream_flush_timeout !== null)
      ? Duration.fromPartial(object.stream_flush_timeout)
      : undefined;
    ...
    message.set_current_client_cert_details =
      (object.set_current_client_cert_details !== undefined && object.set_current_client_cert_details !== null)
        ...
        : undefined;
    message.forward_client_cert_matcher =
      (object.forward_client_cert_matcher !== undefined && object.forward_client_cert_matcher !== null)
        ? Matcher.fromPartial(object.forward_client_cert_matcher)
        : undefined;
    ...
    message.forward_proto_config = (object.forward_proto_config !== undefined && object.forward_proto_config !== null)
      ? ForwardProtoConfig.fromPartial(object.forward_proto_config)
      : undefined;
    return message;
  },
};
...
> = {
  ...
  encode(message: HttpConnectionManager_Tracing, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.operation !== undefined && message.operation !== "") {
      writer.uint32(90).string(message.operation);
    }
    if (message.upstream_operation !== undefined && message.upstream_operation !== "") {
      writer.uint32(98).string(message.upstream_operation);
    }
    if (message.no_context_propagation !== undefined && message.no_context_propagation !== false) {
      writer.uint32(104).bool(message.no_context_propagation);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 13: {
          ...
          message.no_context_propagation = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): HttpConnectionManager_Tracing {
    return {
      ...
      no_context_propagation: isSet(object.no_context_propagation)
        ? globalThis.Boolean(object.no_context_propagation)
        : undefined,
    };
  },
  ...
  toJSON(message: HttpConnectionManager_Tracing): unknown {
    ...
    if (message.no_context_propagation !== undefined) {
      obj.no_context_propagation = message.no_context_propagation;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<HttpConnectionManager_Tracing>, I>>(
    ...
    message.no_context_propagation = object.no_context_propagation ?? undefined;
    return message;
  },
};
...
> = {
  ...
  encode(
    ...
    if (message.format !== undefined && message.format !== HttpConnectionManager_ForwardClientCertFormat.TEXT) {
      writer.uint32(56).int32(httpConnectionManager_ForwardClientCertFormatToNumber(message.format));
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.format = httpConnectionManager_ForwardClientCertFormatFromJSON(reader.int32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): HttpConnectionManager_SetCurrentClientCertDetails {
    return {
      ...
      format: isSet(object.format) ? httpConnectionManager_ForwardClientCertFormatFromJSON(object.format) : undefined,
    };
  },
  ...
  toJSON(message: HttpConnectionManager_SetCurrentClientCertDetails): unknown {
    ...
    if (message.format !== undefined) {
      obj.format = httpConnectionManager_ForwardClientCertFormatToJSON(message.format);
    }
    return obj;
  },
...
function createBaseHttpConnectionManager_ForwardClientCertConfig(): HttpConnectionManager_ForwardClientCertConfig {
  return {
    $type: "envoy.extensions.filters.network.http_connection_manager.v3.HttpConnectionManager.ForwardClientCertConfig",
  };
}

export const HttpConnectionManager_ForwardClientCertConfig: MessageFns<
...
> = {
  $type:
    "envoy.extensions.filters.network.http_connection_manager.v3.HttpConnectionManager.ForwardClientCertConfig" as const,

  encode(
    message: HttpConnectionManager_ForwardClientCertConfig,
    writer: BinaryWriter = new BinaryWriter(),
  ): BinaryWriter {
    if (
      message.forward_client_cert_details !== undefined &&
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): HttpConnectionManager_ForwardClientCertConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseHttpConnectionManager_ForwardClientCertConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): HttpConnectionManager_ForwardClientCertConfig {
    return {
      $type: HttpConnectionManager_ForwardClientCertConfig.$type,
      forward_client_cert_details: isSet(object.forward_client_cert_details)
        ? httpConnectionManager_ForwardClientCertDetailsFromJSON(object.forward_client_cert_details)
        : undefined,
      set_current_client_cert_details: isSet(object.set_current_client_cert_details)
  ...
  toJSON(message: HttpConnectionManager_ForwardClientCertConfig): unknown {
    const obj: any = {};
    if (message.forward_client_cert_details !== undefined) {
      obj.forward_client_cert_details = httpConnectionManager_ForwardClientCertDetailsToJSON(
        message.forward_client_cert_details,
  ...
  create<I extends Exact<DeepPartial<HttpConnectionManager_ForwardClientCertConfig>, I>>(
    base?: I,
  ): HttpConnectionManager_ForwardClientCertConfig {
    return HttpConnectionManager_ForwardClientCertConfig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<HttpConnectionManager_ForwardClientCertConfig>, I>>(
    object: I,
  ): HttpConnectionManager_ForwardClientCertConfig {
    const message = createBaseHttpConnectionManager_ForwardClientCertConfig();
    message.forward_client_cert_details = object.forward_client_cert_details ?? undefined;
...
messageTypeRegistry.set(
  HttpConnectionManager_ForwardClientCertConfig.$type,
  HttpConnectionManager_ForwardClientCertConfig,
);
...
function createBaseForwardProtoConfig(): ForwardProtoConfig {
  return { $type: "envoy.extensions.filters.network.http_connection_manager.v3.ForwardProtoConfig" };
}

export const ForwardProtoConfig: MessageFns<
  ForwardProtoConfig,
  "envoy.extensions.filters.network.http_connection_manager.v3.ForwardProtoConfig"
> = {
  $type: "envoy.extensions.filters.network.http_connection_manager.v3.ForwardProtoConfig" as const,

  encode(message: ForwardProtoConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.https_destination_ports !== undefined && message.https_destination_ports.length !== 0) {
      writer.uint32(10).fork();
      for (const v of message.https_destination_ports) {
        writer.uint32(v);
      }
      writer.join();
    }
    if (message.http_destination_ports !== undefined && message.http_destination_ports.length !== 0) {
      writer.uint32(18).fork();
      for (const v of message.http_destination_ports) {
        writer.uint32(v);
      }
      writer.join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ForwardProtoConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseForwardProtoConfig();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          if (tag === 8) {
            if (message.https_destination_ports === undefined) {
              message.https_destination_ports = [];
            }
            message.https_destination_ports!.push(reader.uint32());
        ...
        case 2: {
          if (tag === 16) {
            if (message.http_destination_ports === undefined) {
              message.http_destination_ports = [];
            }
            message.http_destination_ports!.push(reader.uint32());
  ...
  fromJSON(object: any): ForwardProtoConfig {
    return {
      $type: ForwardProtoConfig.$type,
      https_destination_ports: globalThis.Array.isArray(object?.https_destination_ports)
        ? object.https_destination_ports.map((e: any) => globalThis.Number(e))
        : undefined,
      http_destination_ports: globalThis.Array.isArray(object?.http_destination_ports)
        ? object.http_destination_ports.map((e: any) => globalThis.Number(e))
        : undefined,
    };
  },

  toJSON(message: ForwardProtoConfig): unknown {
    const obj: any = {};
    if (message.https_destination_ports?.length) {
      obj.https_destination_ports = message.https_destination_ports.map((e) => Math.round(e));
    }
    if (message.http_destination_ports?.length) {
      obj.http_destination_ports = message.http_destination_ports.map((e) => Math.round(e));
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<ForwardProtoConfig>, I>>(base?: I): ForwardProtoConfig {
    return ForwardProtoConfig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ForwardProtoConfig>, I>>(object: I): ForwardProtoConfig {
    const message = createBaseForwardProtoConfig();
    message.https_destination_ports = object.https_destination_ports?.map((e) => e) || undefined;
    message.http_destination_ports = object.http_destination_ports?.map((e) => e) || undefined;
    return message;
  },
};

messageTypeRegistry.set(ForwardProtoConfig.$type, ForwardProtoConfig);
