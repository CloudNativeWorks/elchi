...
export interface JwtProvider {
   ...
   *       seconds: 86400
   */
  max_lifetime?: Duration | undefined;
...
export interface JwtRequirement {
  ...
  requires_type?:
    ...
    | { $case: "extract_only_without_validation"; extract_only_without_validation: ExtractOnlyWithoutValidation }
    | undefined;
}

/** Reserved for future extensions (e.g., claim filtering, logging options) */
export interface ExtractOnlyWithoutValidation {
  $type: "envoy.extensions.filters.http.jwt_authn.v3.ExtractOnlyWithoutValidation";
}
...
export interface RequirementRule {
  ...
  requirement_type?: { $case: "requires"; requires: JwtRequirement } | {
...
export interface PerRouteConfig {
  ...
  requirement_specifier?: { $case: "disabled"; disabled: boolean } | {
    $case: "requirement_name";
    requirement_name: string;
  } | undefined;
}
...
export const JwtRequirement: MessageFns<JwtRequirement, "envoy.extensions.filters.http.jwt_authn.v3.JwtRequirement"> = {
  ...
  encode(message: JwtRequirement, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    switch (message.requires_type?.$case) {
      ...
      case "allow_missing":
        ...
        break;
      case "extract_only_without_validation":
        ExtractOnlyWithoutValidation.encode(
          message.requires_type.extract_only_without_validation,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.requires_type = {
            $case: "extract_only_without_validation",
            extract_only_without_validation: ExtractOnlyWithoutValidation.decode(reader, reader.uint32()),
          };
          continue;
        }
      }
  ...
  fromJSON(object: any): JwtRequirement {
    return {
      ...
      requires_type: isSet(object.provider_name)
        ...
        : isSet(object.extract_only_without_validation)
        ? {
          $case: "extract_only_without_validation",
          extract_only_without_validation: ExtractOnlyWithoutValidation.fromJSON(
            object.extract_only_without_validation,
          ),
        }
        : undefined,
    };
  ...
  toJSON(message: JwtRequirement): unknown {
    ...
    if (message.requires_type?.$case === "extract_only_without_validation") {
      obj.extract_only_without_validation = ExtractOnlyWithoutValidation.toJSON(
        message.requires_type.extract_only_without_validation,
      );
    }
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<JwtRequirement>, I>>(object: I): JwtRequirement {
    ...
    if (
      object.requires_type?.$case === "extract_only_without_validation" &&
      object.requires_type?.extract_only_without_validation !== undefined &&
      object.requires_type?.extract_only_without_validation !== null
    ) {
      message.requires_type = {
        $case: "extract_only_without_validation",
        extract_only_without_validation: ExtractOnlyWithoutValidation.fromPartial(
          object.requires_type.extract_only_without_validation,
        ),
      };
    }
    return message;
...
function createBaseExtractOnlyWithoutValidation(): ExtractOnlyWithoutValidation {
  return { $type: "envoy.extensions.filters.http.jwt_authn.v3.ExtractOnlyWithoutValidation" };
}

export const ExtractOnlyWithoutValidation: MessageFns<
  ExtractOnlyWithoutValidation,
  "envoy.extensions.filters.http.jwt_authn.v3.ExtractOnlyWithoutValidation"
> = {
  $type: "envoy.extensions.filters.http.jwt_authn.v3.ExtractOnlyWithoutValidation" as const,

  encode(_: ExtractOnlyWithoutValidation, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ExtractOnlyWithoutValidation {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseExtractOnlyWithoutValidation();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
  ...
  fromJSON(_: any): ExtractOnlyWithoutValidation {
    return { $type: ExtractOnlyWithoutValidation.$type };
  },

  toJSON(_: ExtractOnlyWithoutValidation): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<ExtractOnlyWithoutValidation>, I>>(base?: I): ExtractOnlyWithoutValidation {
    return ExtractOnlyWithoutValidation.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ExtractOnlyWithoutValidation>, I>>(_: I): ExtractOnlyWithoutValidation {
    const message = createBaseExtractOnlyWithoutValidation();
    return message;
  },
};

messageTypeRegistry.set(ExtractOnlyWithoutValidation.$type, ExtractOnlyWithoutValidation);
