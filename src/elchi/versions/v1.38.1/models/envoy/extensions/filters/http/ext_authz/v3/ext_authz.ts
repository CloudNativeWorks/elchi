...
export interface ShadowDecision {
  $type: "envoy.extensions.filters.http.ext_authz.v3.ShadowDecision";
  /** The decision the auth server returned. */
  check_result?:
    | ShadowDecision_CheckResult
    | undefined;
  /**
   ...
   */
  response_headers?: HeaderValue[] | undefined;
}

/** The decision the auth server returned. */
export enum ShadowDecision_CheckResult {
...
export function shadowDecision_CheckResultFromJSON(object: any): ShadowDecision_CheckResult {
  switch (object) {
    case 0:
    case "UNSPECIFIED":
      return ShadowDecision_CheckResult.UNSPECIFIED;
    case 1:
    case "OK":
      return ShadowDecision_CheckResult.OK;
    case 2:
    case "DENIED":
      return ShadowDecision_CheckResult.DENIED;
    case 3:
    case "ERROR":
      return ShadowDecision_CheckResult.ERROR;
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum ShadowDecision_CheckResult");
  }
}

export function shadowDecision_CheckResultToJSON(object: ShadowDecision_CheckResult): string {
  switch (object) {
    case ShadowDecision_CheckResult.UNSPECIFIED:
      return "UNSPECIFIED";
    case ShadowDecision_CheckResult.OK:
      return "OK";
    case ShadowDecision_CheckResult.DENIED:
      return "DENIED";
    case ShadowDecision_CheckResult.ERROR:
      return "ERROR";
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum ShadowDecision_CheckResult");
  }
...
export function shadowDecision_CheckResultToNumber(object: ShadowDecision_CheckResult): number {
  switch (object) {
    case ShadowDecision_CheckResult.UNSPECIFIED:
      return 0;
    case ShadowDecision_CheckResult.OK:
...
export interface CheckSettings {
  ...
  service_override?: { $case: "grpc_service"; grpc_service: GrpcService } | {
    $case: "http_service";
...
export const ExtAuthz: MessageFns<ExtAuthz, "envoy.extensions.filters.http.ext_authz.v3.ExtAuthz"> = {
  ...
  encode(message: ExtAuthz, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.max_denied_response_body_bytes !== undefined && message.max_denied_response_body_bytes !== 0) {
      writer.uint32(240).uint32(message.max_denied_response_body_bytes);
    }
    if (message.enforce_response_header_limits !== undefined && message.enforce_response_header_limits !== false) {
      writer.uint32(248).bool(message.enforce_response_header_limits);
    }
    if (message.shadow_mode !== undefined && message.shadow_mode !== false) {
      writer.uint32(256).bool(message.shadow_mode);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 30: {
          ...
          message.max_denied_response_body_bytes = reader.uint32();
          continue;
        }
        case 31: {
          if (tag !== 248) {
          ...
          message.enforce_response_header_limits = reader.bool();
          continue;
        }
        case 32: {
          if (tag !== 256) {
          ...
          message.shadow_mode = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ExtAuthz {
    return {
      ...
      emit_filter_state_stats: isSet(object.emit_filter_state_stats)
        ...
        : undefined,
      max_denied_response_body_bytes: isSet(object.max_denied_response_body_bytes)
        ? globalThis.Number(object.max_denied_response_body_bytes)
        : undefined,
      enforce_response_header_limits: isSet(object.enforce_response_header_limits)
        ? globalThis.Boolean(object.enforce_response_header_limits)
        : undefined,
      shadow_mode: isSet(object.shadow_mode) ? globalThis.Boolean(object.shadow_mode) : undefined,
    };
  },
  ...
  toJSON(message: ExtAuthz): unknown {
    ...
    if (message.max_denied_response_body_bytes !== undefined) {
      obj.max_denied_response_body_bytes = Math.round(message.max_denied_response_body_bytes);
    }
    if (message.enforce_response_header_limits !== undefined) {
      obj.enforce_response_header_limits = message.enforce_response_header_limits;
    }
    if (message.shadow_mode !== undefined) {
      obj.shadow_mode = message.shadow_mode;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ExtAuthz>, I>>(object: I): ExtAuthz {
    ...
    message.max_denied_response_body_bytes = object.max_denied_response_body_bytes ?? undefined;
    message.enforce_response_header_limits = object.enforce_response_header_limits ?? undefined;
    message.shadow_mode = object.shadow_mode ?? undefined;
    return message;
  },
};
...
function createBaseShadowDecision(): ShadowDecision {
  return { $type: "envoy.extensions.filters.http.ext_authz.v3.ShadowDecision" };
}

export const ShadowDecision: MessageFns<ShadowDecision, "envoy.extensions.filters.http.ext_authz.v3.ShadowDecision"> = {
  $type: "envoy.extensions.filters.http.ext_authz.v3.ShadowDecision" as const,

  encode(message: ShadowDecision, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.check_result !== undefined && message.check_result !== ShadowDecision_CheckResult.UNSPECIFIED) {
      writer.uint32(8).int32(shadowDecision_CheckResultToNumber(message.check_result));
    }
    if (message.status_code !== undefined && message.status_code !== 0) {
      writer.uint32(16).uint32(message.status_code);
    }
    if (message.response_headers !== undefined && message.response_headers.length !== 0) {
      for (const v of message.response_headers) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ShadowDecision {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseShadowDecision();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.check_result = shadowDecision_CheckResultFromJSON(reader.int32());
          continue;
        }
        case 2: {
          if (tag !== 16) {
        ...
        case 3: {
          ...
          if (el !== undefined) {
            message.response_headers!.push(el);
          }
          continue;
        }
      }
  ...
  fromJSON(object: any): ShadowDecision {
    return {
      $type: ShadowDecision.$type,
      check_result: isSet(object.check_result) ? shadowDecision_CheckResultFromJSON(object.check_result) : undefined,
      status_code: isSet(object.status_code) ? globalThis.Number(object.status_code) : undefined,
      response_headers: globalThis.Array.isArray(object?.response_headers)
        ? object.response_headers.map((e: any) => HeaderValue.fromJSON(e))
        : undefined,
    };
  },

  toJSON(message: ShadowDecision): unknown {
    const obj: any = {};
    if (message.check_result !== undefined) {
      obj.check_result = shadowDecision_CheckResultToJSON(message.check_result);
    }
    if (message.status_code !== undefined) {
      obj.status_code = Math.round(message.status_code);
    }
    if (message.response_headers?.length) {
      obj.response_headers = message.response_headers.map((e) => HeaderValue.toJSON(e));
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<ShadowDecision>, I>>(base?: I): ShadowDecision {
    return ShadowDecision.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ShadowDecision>, I>>(object: I): ShadowDecision {
    const message = createBaseShadowDecision();
    message.check_result = object.check_result ?? undefined;
    message.status_code = object.status_code ?? undefined;
    message.response_headers = object.response_headers?.map((e) => HeaderValue.fromPartial(e)) || undefined;
    return message;
  },
};

messageTypeRegistry.set(ShadowDecision.$type, ShadowDecision);
...
export const HttpService: MessageFns<HttpService, "envoy.extensions.filters.http.ext_authz.v3.HttpService"> = {
  ...
  encode(message: HttpService, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.path_override !== undefined && message.path_override !== "") {
      writer.uint32(82).string(message.path_override);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10: {
          ...
          message.path_override = reader.string();
          continue;
        }
        case 7: {
          if (tag !== 58) {
  ...
  fromJSON(object: any): HttpService {
    return {
      ...
      path_override: isSet(object.path_override) ? globalThis.String(object.path_override) : undefined,
  ...
  toJSON(message: HttpService): unknown {
    ...
    if (message.path_override !== undefined) {
      obj.path_override = message.path_override;
    }
    if (message.authorization_request !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<HttpService>, I>>(object: I): HttpService {
    ...
    message.path_override = object.path_override ?? undefined;
...
function createBaseCheckSettings(): CheckSettings {
  return { $type: "envoy.extensions.filters.http.ext_authz.v3.CheckSettings", service_override: undefined };
}
...
export const CheckSettings: MessageFns<CheckSettings, "envoy.extensions.filters.http.ext_authz.v3.CheckSettings"> = {
  ...
  encode(message: CheckSettings, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    switch (message.service_override?.$case) {
      case "grpc_service":
        GrpcService.encode(message.service_override.grpc_service, writer.uint32(34).fork()).join();
        break;
      case "http_service":
        HttpService.encode(message.service_override.http_service, writer.uint32(42).fork()).join();
        break;
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.service_override = {
            $case: "http_service",
            http_service: HttpService.decode(reader, reader.uint32()),
          };
          continue;
        }
      }
  ...
  fromJSON(object: any): CheckSettings {
    return {
      ...
      with_request_body: isSet(object.with_request_body)
        ? BufferSettings.fromJSON(object.with_request_body)
        : undefined,
      service_override: isSet(object.grpc_service)
        ? { $case: "grpc_service", grpc_service: GrpcService.fromJSON(object.grpc_service) }
        : isSet(object.http_service)
        ? { $case: "http_service", http_service: HttpService.fromJSON(object.http_service) }
        : undefined,
  ...
  toJSON(message: CheckSettings): unknown {
    ...
    if (message.service_override?.$case === "grpc_service") {
      obj.grpc_service = GrpcService.toJSON(message.service_override.grpc_service);
    }
    if (message.service_override?.$case === "http_service") {
      obj.http_service = HttpService.toJSON(message.service_override.http_service);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<CheckSettings>, I>>(object: I): CheckSettings {
    ...
    message.with_request_body = (object.with_request_body !== undefined && object.with_request_body !== null)
      ...
      : undefined;
    if (
      object.service_override?.$case === "grpc_service" &&
      object.service_override?.grpc_service !== undefined &&
      object.service_override?.grpc_service !== null
    ) {
      message.service_override = {
        $case: "grpc_service",
        grpc_service: GrpcService.fromPartial(object.service_override.grpc_service),
      };
    }
    if (
      object.service_override?.$case === "http_service" &&
      object.service_override?.http_service !== undefined &&
      object.service_override?.http_service !== null
    ) {
      message.service_override = {
        $case: "http_service",
        http_service: HttpService.fromPartial(object.service_override.http_service),
      };
    }
    return message;
  },
