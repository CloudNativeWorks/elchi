...
import { HTTPAccessLogEntry, TCPAccessLogEntry } from "../../../data/accesslog/v2/accesslog";

export const protobufPackage = "envoy.service.accesslog.v2";

/** Empty response for the StreamAccessLogs API. Will never be sent. See below. */
export interface StreamAccessLogsResponse {
  $type: "envoy.service.accesslog.v2.StreamAccessLogsResponse";
}
...
export interface StreamAccessLogsMessage {
  $type: "envoy.service.accesslog.v2.StreamAccessLogsMessage";
  /**
   * Identifier data that will only be sent in the first message on the stream. This is effectively
   * structured metadata and is a performance optimization.
   */
  identifier?: StreamAccessLogsMessage_Identifier | undefined;
  log_entries?: { $case: "http_logs"; http_logs: StreamAccessLogsMessage_HTTPAccessLogEntries } | {
    $case: "tcp_logs";
...
export interface StreamAccessLogsMessage_Identifier {
  $type: "envoy.service.accesslog.v2.StreamAccessLogsMessage.Identifier";
...
function createBaseStreamAccessLogsResponse(): StreamAccessLogsResponse {
  return { $type: "envoy.service.accesslog.v2.StreamAccessLogsResponse" };
}
...
> = {
  $type: "envoy.service.accesslog.v2.StreamAccessLogsResponse" as const,
...
function createBaseStreamAccessLogsMessage(): StreamAccessLogsMessage {
  return { $type: "envoy.service.accesslog.v2.StreamAccessLogsMessage", log_entries: undefined };
}
...
> = {
  $type: "envoy.service.accesslog.v2.StreamAccessLogsMessage" as const,
...
function createBaseStreamAccessLogsMessage_Identifier(): StreamAccessLogsMessage_Identifier {
  return { $type: "envoy.service.accesslog.v2.StreamAccessLogsMessage.Identifier" };
}
...
> = {
  $type: "envoy.service.accesslog.v2.StreamAccessLogsMessage.Identifier" as const,
...
function createBaseStreamAccessLogsMessage_HTTPAccessLogEntries(): StreamAccessLogsMessage_HTTPAccessLogEntries {
  return { $type: "envoy.service.accesslog.v2.StreamAccessLogsMessage.HTTPAccessLogEntries" };
}
...
> = {
  $type: "envoy.service.accesslog.v2.StreamAccessLogsMessage.HTTPAccessLogEntries" as const,
...
function createBaseStreamAccessLogsMessage_TCPAccessLogEntries(): StreamAccessLogsMessage_TCPAccessLogEntries {
  return { $type: "envoy.service.accesslog.v2.StreamAccessLogsMessage.TCPAccessLogEntries" };
}
...
> = {
  $type: "envoy.service.accesslog.v2.StreamAccessLogsMessage.TCPAccessLogEntries" as const,
...
export const AccessLogServiceServiceName = "envoy.service.accesslog.v2.AccessLogService";
