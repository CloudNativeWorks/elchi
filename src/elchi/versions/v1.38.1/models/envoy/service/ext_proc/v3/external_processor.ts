...
export interface ProcessingResponse {
  ...
  response?:
    ...
    | { $case: "streamed_immediate_response"; streamed_immediate_response: StreamedImmediateResponse }
    | undefined;
  /**
...
export interface HttpBody {
   ...
   */
  grpc_message_compressed?: boolean | undefined;
}
 ...
 */
export interface StreamedImmediateResponse {
  $type: "envoy.service.ext_proc.v3.StreamedImmediateResponse";
  response?:
    | { $case: "headers_response"; headers_response: HttpHeaders }
    | { $case: "body_response"; body_response: StreamedBodyResponse }
    | { $case: "trailers_response"; trailers_response: HeaderMap }
    | undefined;
}
...
export interface BodyMutation {
  ...
  mutation?: { $case: "body"; body: Uint8Array } | { $case: "clear_body"; clear_body: boolean } | {
...
export const ProcessingResponse: MessageFns<ProcessingResponse, "envoy.service.ext_proc.v3.ProcessingResponse"> = {
  ...
  encode(message: ProcessingResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    switch (message.response?.$case) {
      ...
      case "immediate_response":
        ...
        break;
      case "streamed_immediate_response":
        StreamedImmediateResponse.encode(message.response.streamed_immediate_response, writer.uint32(90).fork()).join();
        break;
    }
    ...
    if (message.request_drain !== undefined && message.request_drain !== false) {
      writer.uint32(96).bool(message.request_drain);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11: {
          ...
          message.response = {
            $case: "streamed_immediate_response",
            streamed_immediate_response: StreamedImmediateResponse.decode(reader, reader.uint32()),
          };
          continue;
        }
        case 8: {
        ...
        case 12: {
          ...
          message.request_drain = reader.bool();
          continue;
        }
        case 10: {
          if (tag !== 82) {
  ...
  fromJSON(object: any): ProcessingResponse {
    return {
      ...
      response: isSet(object.request_headers)
        ...
        : isSet(object.streamed_immediate_response)
        ? {
          $case: "streamed_immediate_response",
          streamed_immediate_response: StreamedImmediateResponse.fromJSON(object.streamed_immediate_response),
        }
        : undefined,
      ...
      request_drain: isSet(object.request_drain) ? globalThis.Boolean(object.request_drain) : undefined,
  ...
  toJSON(message: ProcessingResponse): unknown {
    ...
    if (message.response?.$case === "streamed_immediate_response") {
      obj.streamed_immediate_response = StreamedImmediateResponse.toJSON(message.response.streamed_immediate_response);
    }
    if (message.dynamic_metadata !== undefined) {
    ...
    if (message.request_drain !== undefined) {
      obj.request_drain = message.request_drain;
    }
    if (message.override_message_timeout !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<ProcessingResponse>, I>>(object: I): ProcessingResponse {
    ...
    if (
      object.response?.$case === "streamed_immediate_response" &&
      object.response?.streamed_immediate_response !== undefined &&
      object.response?.streamed_immediate_response !== null
    ) {
      message.response = {
        $case: "streamed_immediate_response",
        streamed_immediate_response: StreamedImmediateResponse.fromPartial(object.response.streamed_immediate_response),
      };
    }
    ...
    message.mode_override = (object.mode_override !== undefined && object.mode_override !== null)
      ...
      : undefined;
    message.request_drain = object.request_drain ?? undefined;
...
export const HttpBody: MessageFns<HttpBody, "envoy.service.ext_proc.v3.HttpBody"> = {
  ...
  encode(message: HttpBody, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.end_of_stream_without_message !== undefined && message.end_of_stream_without_message !== false) {
      writer.uint32(24).bool(message.end_of_stream_without_message);
    }
    if (message.grpc_message_compressed !== undefined && message.grpc_message_compressed !== false) {
      writer.uint32(32).bool(message.grpc_message_compressed);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.end_of_stream_without_message = reader.bool();
          continue;
        }
        case 4: {
          if (tag !== 32) {
          ...
          message.grpc_message_compressed = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): HttpBody {
    return {
      ...
      end_of_stream: isSet(object.end_of_stream) ? globalThis.Boolean(object.end_of_stream) : undefined,
      end_of_stream_without_message: isSet(object.end_of_stream_without_message)
        ? globalThis.Boolean(object.end_of_stream_without_message)
        : undefined,
      grpc_message_compressed: isSet(object.grpc_message_compressed)
        ? globalThis.Boolean(object.grpc_message_compressed)
        : undefined,
    };
  },
  ...
  toJSON(message: HttpBody): unknown {
    ...
    if (message.end_of_stream_without_message !== undefined) {
      obj.end_of_stream_without_message = message.end_of_stream_without_message;
    }
    if (message.grpc_message_compressed !== undefined) {
      obj.grpc_message_compressed = message.grpc_message_compressed;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<HttpBody>, I>>(object: I): HttpBody {
    ...
    message.end_of_stream = object.end_of_stream ?? undefined;
    message.end_of_stream_without_message = object.end_of_stream_without_message ?? undefined;
    message.grpc_message_compressed = object.grpc_message_compressed ?? undefined;
    return message;
  },
};
...
function createBaseStreamedImmediateResponse(): StreamedImmediateResponse {
  return { $type: "envoy.service.ext_proc.v3.StreamedImmediateResponse", response: undefined };
}

export const StreamedImmediateResponse: MessageFns<
  StreamedImmediateResponse,
  "envoy.service.ext_proc.v3.StreamedImmediateResponse"
> = {
  $type: "envoy.service.ext_proc.v3.StreamedImmediateResponse" as const,

  encode(message: StreamedImmediateResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    switch (message.response?.$case) {
      case "headers_response":
        HttpHeaders.encode(message.response.headers_response, writer.uint32(10).fork()).join();
        break;
      case "body_response":
        StreamedBodyResponse.encode(message.response.body_response, writer.uint32(18).fork()).join();
        break;
      case "trailers_response":
        HeaderMap.encode(message.response.trailers_response, writer.uint32(26).fork()).join();
        break;
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): StreamedImmediateResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseStreamedImmediateResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.response = {
            $case: "headers_response",
            headers_response: HttpHeaders.decode(reader, reader.uint32()),
          };
          continue;
        }
        case 2: {
          ...
          message.response = {
            $case: "body_response",
            body_response: StreamedBodyResponse.decode(reader, reader.uint32()),
          };
          continue;
        }
        case 3: {
          ...
          message.response = {
            $case: "trailers_response",
            trailers_response: HeaderMap.decode(reader, reader.uint32()),
          };
          continue;
        }
      }
  ...
  fromJSON(object: any): StreamedImmediateResponse {
    return {
      $type: StreamedImmediateResponse.$type,
      response: isSet(object.headers_response)
        ? { $case: "headers_response", headers_response: HttpHeaders.fromJSON(object.headers_response) }
        : isSet(object.body_response)
        ? { $case: "body_response", body_response: StreamedBodyResponse.fromJSON(object.body_response) }
        : isSet(object.trailers_response)
        ? { $case: "trailers_response", trailers_response: HeaderMap.fromJSON(object.trailers_response) }
        : undefined,
    };
  },

  toJSON(message: StreamedImmediateResponse): unknown {
    const obj: any = {};
    if (message.response?.$case === "headers_response") {
      obj.headers_response = HttpHeaders.toJSON(message.response.headers_response);
    }
    if (message.response?.$case === "body_response") {
      obj.body_response = StreamedBodyResponse.toJSON(message.response.body_response);
    }
    if (message.response?.$case === "trailers_response") {
      obj.trailers_response = HeaderMap.toJSON(message.response.trailers_response);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<StreamedImmediateResponse>, I>>(base?: I): StreamedImmediateResponse {
    return StreamedImmediateResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<StreamedImmediateResponse>, I>>(object: I): StreamedImmediateResponse {
    const message = createBaseStreamedImmediateResponse();
    if (
      object.response?.$case === "headers_response" &&
      object.response?.headers_response !== undefined &&
      object.response?.headers_response !== null
    ) {
      message.response = {
        $case: "headers_response",
        headers_response: HttpHeaders.fromPartial(object.response.headers_response),
      };
    }
    if (
      object.response?.$case === "body_response" &&
      object.response?.body_response !== undefined &&
      object.response?.body_response !== null
    ) {
      message.response = {
        $case: "body_response",
        body_response: StreamedBodyResponse.fromPartial(object.response.body_response),
      };
    }
    if (
      object.response?.$case === "trailers_response" &&
      object.response?.trailers_response !== undefined &&
      object.response?.trailers_response !== null
    ) {
      message.response = {
        $case: "trailers_response",
        trailers_response: HeaderMap.fromPartial(object.response.trailers_response),
      };
    }
    return message;
  },
...
messageTypeRegistry.set(StreamedImmediateResponse.$type, StreamedImmediateResponse);
