...
import { Locality, Node } from "../../../config/core/v3/base";
import {
  HealthCheck,
  HealthStatus,
...
export const protobufPackage = "envoy.service.health.v3";
...
export interface Capability {
  $type: "envoy.service.health.v3.Capability";
...
export interface EndpointHealth {
   ...
   */
  health_metadata?: { [key: string]: any } | undefined;
}
...
export interface ClusterEndpointsHealth {
  ...
  locality_endpoints_health?: LocalityEndpointsHealth[] | undefined;
}
...
export interface EndpointHealthResponse {
  ...
  cluster_endpoints_health?: ClusterEndpointsHealth[] | undefined;
}

export interface HealthCheckRequestOrEndpointHealthResponse {
  $type: "envoy.service.health.v3.HealthCheckRequestOrEndpointHealthResponse";
  request_type?: { $case: "health_check_request"; health_check_request: HealthCheckRequest } | {
...
export interface ClusterHealthCheck {
   ...
   */
  upstream_bind_config?: BindConfig | undefined;
}

export interface HealthCheckSpecifier {
  $type: "envoy.service.health.v3.HealthCheckSpecifier";
...
export interface HdsDummy {
  $type: "envoy.service.health.v3.HdsDummy";
}

function createBaseCapability(): Capability {
  return { $type: "envoy.service.health.v3.Capability" };
}

export const Capability: MessageFns<Capability, "envoy.service.health.v3.Capability"> = {
  $type: "envoy.service.health.v3.Capability" as const,
...
function createBaseHealthCheckRequest(): HealthCheckRequest {
  return { $type: "envoy.service.health.v3.HealthCheckRequest" };
}

export const HealthCheckRequest: MessageFns<HealthCheckRequest, "envoy.service.health.v3.HealthCheckRequest"> = {
  $type: "envoy.service.health.v3.HealthCheckRequest" as const,
...
function createBaseEndpointHealth(): EndpointHealth {
  return { $type: "envoy.service.health.v3.EndpointHealth" };
}

export const EndpointHealth: MessageFns<EndpointHealth, "envoy.service.health.v3.EndpointHealth"> = {
  $type: "envoy.service.health.v3.EndpointHealth" as const,
  ...
  encode(message: EndpointHealth, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.health_metadata !== undefined) {
      Struct.encode(Struct.wrap(message.health_metadata), writer.uint32(26).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.health_metadata = Struct.unwrap(Struct.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): EndpointHealth {
    return {
      ...
      health_metadata: isObject(object.health_metadata) ? object.health_metadata : undefined,
    };
  },
  ...
  toJSON(message: EndpointHealth): unknown {
    ...
    if (message.health_metadata !== undefined) {
      obj.health_metadata = message.health_metadata;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<EndpointHealth>, I>>(object: I): EndpointHealth {
    ...
    message.health_metadata = object.health_metadata ?? undefined;
    return message;
  },
};
...
function createBaseLocalityEndpointsHealth(): LocalityEndpointsHealth {
  return { $type: "envoy.service.health.v3.LocalityEndpointsHealth" };
}

export const LocalityEndpointsHealth: MessageFns<
  LocalityEndpointsHealth,
  "envoy.service.health.v3.LocalityEndpointsHealth"
> = {
  $type: "envoy.service.health.v3.LocalityEndpointsHealth" as const,

  encode(message: LocalityEndpointsHealth, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.endpoints_health !== undefined && message.endpoints_health.length !== 0) {
      for (const v of message.endpoints_health) {
        EndpointHealth.encode(v!, writer.uint32(18).fork()).join();
      }
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): LocalityEndpointsHealth {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseLocalityEndpointsHealth();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): LocalityEndpointsHealth {
    return {
      $type: LocalityEndpointsHealth.$type,
  ...
  toJSON(message: LocalityEndpointsHealth): unknown {
    const obj: any = {};
    if (message.locality !== undefined) {
  ...
  create<I extends Exact<DeepPartial<LocalityEndpointsHealth>, I>>(base?: I): LocalityEndpointsHealth {
    return LocalityEndpointsHealth.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<LocalityEndpointsHealth>, I>>(object: I): LocalityEndpointsHealth {
    const message = createBaseLocalityEndpointsHealth();
...
messageTypeRegistry.set(LocalityEndpointsHealth.$type, LocalityEndpointsHealth);

function createBaseClusterEndpointsHealth(): ClusterEndpointsHealth {
  return { $type: "envoy.service.health.v3.ClusterEndpointsHealth" };
}

export const ClusterEndpointsHealth: MessageFns<
  ClusterEndpointsHealth,
  "envoy.service.health.v3.ClusterEndpointsHealth"
> = {
  $type: "envoy.service.health.v3.ClusterEndpointsHealth" as const,

  encode(message: ClusterEndpointsHealth, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.cluster_name !== undefined && message.cluster_name !== "") {
      writer.uint32(10).string(message.cluster_name);
    }
    if (message.locality_endpoints_health !== undefined && message.locality_endpoints_health.length !== 0) {
      for (const v of message.locality_endpoints_health) {
        LocalityEndpointsHealth.encode(v!, writer.uint32(18).fork()).join();
      }
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ClusterEndpointsHealth {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseClusterEndpointsHealth();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
        ...
        case 2: {
          ...
          if (message.locality_endpoints_health === undefined) {
            message.locality_endpoints_health = [];
          }
          const el = LocalityEndpointsHealth.decode(reader, reader.uint32());
          if (el !== undefined) {
            message.locality_endpoints_health!.push(el);
          }
          continue;
        }
      }
  ...
  fromJSON(object: any): ClusterEndpointsHealth {
    return {
      $type: ClusterEndpointsHealth.$type,
      cluster_name: isSet(object.cluster_name) ? globalThis.String(object.cluster_name) : undefined,
      locality_endpoints_health: globalThis.Array.isArray(object?.locality_endpoints_health)
        ? object.locality_endpoints_health.map((e: any) => LocalityEndpointsHealth.fromJSON(e))
        : undefined,
    };
  },

  toJSON(message: ClusterEndpointsHealth): unknown {
    const obj: any = {};
    if (message.cluster_name !== undefined) {
      obj.cluster_name = message.cluster_name;
    }
    if (message.locality_endpoints_health?.length) {
      obj.locality_endpoints_health = message.locality_endpoints_health.map((e) => LocalityEndpointsHealth.toJSON(e));
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<ClusterEndpointsHealth>, I>>(base?: I): ClusterEndpointsHealth {
    return ClusterEndpointsHealth.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ClusterEndpointsHealth>, I>>(object: I): ClusterEndpointsHealth {
    const message = createBaseClusterEndpointsHealth();
    message.cluster_name = object.cluster_name ?? undefined;
    message.locality_endpoints_health =
      object.locality_endpoints_health?.map((e) => LocalityEndpointsHealth.fromPartial(e)) || undefined;
    return message;
  },
};

messageTypeRegistry.set(ClusterEndpointsHealth.$type, ClusterEndpointsHealth);

function createBaseEndpointHealthResponse(): EndpointHealthResponse {
  return { $type: "envoy.service.health.v3.EndpointHealthResponse" };
}
...
> = {
  $type: "envoy.service.health.v3.EndpointHealthResponse" as const,
  ...
  encode(message: EndpointHealthResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.cluster_endpoints_health !== undefined && message.cluster_endpoints_health.length !== 0) {
      for (const v of message.cluster_endpoints_health) {
        ClusterEndpointsHealth.encode(v!, writer.uint32(18).fork()).join();
      }
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          if (message.cluster_endpoints_health === undefined) {
            message.cluster_endpoints_health = [];
          }
          const el = ClusterEndpointsHealth.decode(reader, reader.uint32());
          if (el !== undefined) {
            message.cluster_endpoints_health!.push(el);
          }
          continue;
        }
      }
  ...
  fromJSON(object: any): EndpointHealthResponse {
    return {
      ...
      endpoints_health: globalThis.Array.isArray(object?.endpoints_health)
        ? object.endpoints_health.map((e: any) => EndpointHealth.fromJSON(e))
        : undefined,
      cluster_endpoints_health: globalThis.Array.isArray(object?.cluster_endpoints_health)
        ? object.cluster_endpoints_health.map((e: any) => ClusterEndpointsHealth.fromJSON(e))
        : undefined,
    };
  },
  ...
  toJSON(message: EndpointHealthResponse): unknown {
    ...
    if (message.cluster_endpoints_health?.length) {
      obj.cluster_endpoints_health = message.cluster_endpoints_health.map((e) => ClusterEndpointsHealth.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<EndpointHealthResponse>, I>>(object: I): EndpointHealthResponse {
    ...
    message.endpoints_health = object.endpoints_health?.map((e) => EndpointHealth.fromPartial(e)) || undefined;
    message.cluster_endpoints_health =
      object.cluster_endpoints_health?.map((e) => ClusterEndpointsHealth.fromPartial(e)) || undefined;
    return message;
  },
};
...
function createBaseHealthCheckRequestOrEndpointHealthResponse(): HealthCheckRequestOrEndpointHealthResponse {
  return { $type: "envoy.service.health.v3.HealthCheckRequestOrEndpointHealthResponse", request_type: undefined };
}
...
> = {
  $type: "envoy.service.health.v3.HealthCheckRequestOrEndpointHealthResponse" as const,
...
function createBaseLocalityEndpoints(): LocalityEndpoints {
  return { $type: "envoy.service.health.v3.LocalityEndpoints" };
}

export const LocalityEndpoints: MessageFns<LocalityEndpoints, "envoy.service.health.v3.LocalityEndpoints"> = {
  $type: "envoy.service.health.v3.LocalityEndpoints" as const,
...
function createBaseClusterHealthCheck(): ClusterHealthCheck {
  return { $type: "envoy.service.health.v3.ClusterHealthCheck" };
}

export const ClusterHealthCheck: MessageFns<ClusterHealthCheck, "envoy.service.health.v3.ClusterHealthCheck"> = {
  $type: "envoy.service.health.v3.ClusterHealthCheck" as const,
  ...
  encode(message: ClusterHealthCheck, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.transport_socket_matches !== undefined && message.transport_socket_matches.length !== 0) {
      for (const v of message.transport_socket_matches) {
        Cluster_TransportSocketMatch.encode(v!, writer.uint32(34).fork()).join();
      }
    }
    if (message.upstream_bind_config !== undefined) {
      BindConfig.encode(message.upstream_bind_config, writer.uint32(42).fork()).join();
    }
    return writer;
  },
...
function createBaseHealthCheckSpecifier(): HealthCheckSpecifier {
  return { $type: "envoy.service.health.v3.HealthCheckSpecifier" };
}

export const HealthCheckSpecifier: MessageFns<HealthCheckSpecifier, "envoy.service.health.v3.HealthCheckSpecifier"> = {
  $type: "envoy.service.health.v3.HealthCheckSpecifier" as const,
...
function createBaseHdsDummy(): HdsDummy {
  return { $type: "envoy.service.health.v3.HdsDummy" };
}

export const HdsDummy: MessageFns<HdsDummy, "envoy.service.health.v3.HdsDummy"> = {
  $type: "envoy.service.health.v3.HdsDummy" as const,

  encode(_: HdsDummy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): HdsDummy {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseHdsDummy();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
  ...
  fromJSON(_: any): HdsDummy {
    return { $type: HdsDummy.$type };
  },

  toJSON(_: HdsDummy): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<HdsDummy>, I>>(base?: I): HdsDummy {
    return HdsDummy.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<HdsDummy>, I>>(_: I): HdsDummy {
    const message = createBaseHdsDummy();
    return message;
  },
};

messageTypeRegistry.set(HdsDummy.$type, HdsDummy);
...
export const HealthDiscoveryServiceServiceName = "envoy.service.health.v3.HealthDiscoveryService";
