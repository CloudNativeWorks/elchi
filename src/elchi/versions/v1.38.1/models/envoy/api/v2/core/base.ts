...
export interface DataSource {
  ...
  specifier?: { $case: "filename"; filename: string } | { $case: "inline_bytes"; inline_bytes: Uint8Array } | {
    $case: "inline_string";
...
export interface AsyncDataSource {
  ...
  specifier?: { $case: "local"; local: DataSource } | { $case: "remote"; remote: RemoteDataSource } | undefined;
}
