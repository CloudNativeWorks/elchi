...
} from "../../../api/v2/core/base";

export const protobufPackage = "envoy.data.accesslog.v2";
...
export interface AccessLogCommon {
   ...
   * `google.protobuf.Any`.
   */
  filter_state_objects?: Map<string, Any> | undefined;
}
...
export interface ResponseFlags {
  ...
  downstream_protocol_error?: boolean | undefined;
}
...
export interface TLSProperties {
  ...
  peer_certificate_properties?:
    ...
    | undefined;
  /** The TLS session ID. */
  tls_session_id?: string | undefined;
}
...
export interface TLSProperties_CertificateProperties_SubjectAltName {
  ...
  san?: { $case: "uri"; uri: string } | { $case: "dns"; dns: string } | undefined;
}

/** [#next-free-field: 14] */
export interface HTTPRequestProperties {
  $type: "envoy.data.accesslog.v2.HTTPRequestProperties";
  ...
  request_headers?: Map<string, string> | undefined;
}
...
export interface HTTPResponseProperties {
  $type: "envoy.data.accesslog.v2.HTTPResponseProperties";
  ...
  response_code_details?: string | undefined;
}
...
function createBaseTCPAccessLogEntry(): TCPAccessLogEntry {
  return { $type: "envoy.data.accesslog.v2.TCPAccessLogEntry" };
}

export const TCPAccessLogEntry: MessageFns<TCPAccessLogEntry, "envoy.data.accesslog.v2.TCPAccessLogEntry"> = {
  $type: "envoy.data.accesslog.v2.TCPAccessLogEntry" as const,
...
function createBaseHTTPAccessLogEntry(): HTTPAccessLogEntry {
  return { $type: "envoy.data.accesslog.v2.HTTPAccessLogEntry" };
}

export const HTTPAccessLogEntry: MessageFns<HTTPAccessLogEntry, "envoy.data.accesslog.v2.HTTPAccessLogEntry"> = {
  $type: "envoy.data.accesslog.v2.HTTPAccessLogEntry" as const,
...
function createBaseConnectionProperties(): ConnectionProperties {
  return { $type: "envoy.data.accesslog.v2.ConnectionProperties" };
}

export const ConnectionProperties: MessageFns<ConnectionProperties, "envoy.data.accesslog.v2.ConnectionProperties"> = {
  $type: "envoy.data.accesslog.v2.ConnectionProperties" as const,
...
function createBaseAccessLogCommon(): AccessLogCommon {
  return { $type: "envoy.data.accesslog.v2.AccessLogCommon" };
}

export const AccessLogCommon: MessageFns<AccessLogCommon, "envoy.data.accesslog.v2.AccessLogCommon"> = {
  $type: "envoy.data.accesslog.v2.AccessLogCommon" as const,
...
function createBaseAccessLogCommon_FilterStateObjectsEntry(): AccessLogCommon_FilterStateObjectsEntry {
  return { $type: "envoy.data.accesslog.v2.AccessLogCommon.FilterStateObjectsEntry", key: "" };
}

export const AccessLogCommon_FilterStateObjectsEntry: MessageFns<
  AccessLogCommon_FilterStateObjectsEntry,
  "envoy.data.accesslog.v2.AccessLogCommon.FilterStateObjectsEntry"
> = {
  $type: "envoy.data.accesslog.v2.AccessLogCommon.FilterStateObjectsEntry" as const,
...
function createBaseResponseFlags(): ResponseFlags {
  return { $type: "envoy.data.accesslog.v2.ResponseFlags" };
}

export const ResponseFlags: MessageFns<ResponseFlags, "envoy.data.accesslog.v2.ResponseFlags"> = {
  $type: "envoy.data.accesslog.v2.ResponseFlags" as const,
...
function createBaseResponseFlags_Unauthorized(): ResponseFlags_Unauthorized {
  return { $type: "envoy.data.accesslog.v2.ResponseFlags.Unauthorized" };
}
...
> = {
  $type: "envoy.data.accesslog.v2.ResponseFlags.Unauthorized" as const,
...
function createBaseTLSProperties(): TLSProperties {
  return { $type: "envoy.data.accesslog.v2.TLSProperties" };
}

export const TLSProperties: MessageFns<TLSProperties, "envoy.data.accesslog.v2.TLSProperties"> = {
  $type: "envoy.data.accesslog.v2.TLSProperties" as const,
...
function createBaseTLSProperties_CertificateProperties(): TLSProperties_CertificateProperties {
  return { $type: "envoy.data.accesslog.v2.TLSProperties.CertificateProperties" };
}
...
> = {
  $type: "envoy.data.accesslog.v2.TLSProperties.CertificateProperties" as const,
...
function createBaseTLSProperties_CertificateProperties_SubjectAltName(): TLSProperties_CertificateProperties_SubjectAltName {
  return { $type: "envoy.data.accesslog.v2.TLSProperties.CertificateProperties.SubjectAltName", san: undefined };
}
...
> = {
  $type: "envoy.data.accesslog.v2.TLSProperties.CertificateProperties.SubjectAltName" as const,
...
function createBaseHTTPRequestProperties(): HTTPRequestProperties {
  return { $type: "envoy.data.accesslog.v2.HTTPRequestProperties" };
}

export const HTTPRequestProperties: MessageFns<HTTPRequestProperties, "envoy.data.accesslog.v2.HTTPRequestProperties"> =
  {
    $type: "envoy.data.accesslog.v2.HTTPRequestProperties" as const,
...
function createBaseHTTPRequestProperties_RequestHeadersEntry(): HTTPRequestProperties_RequestHeadersEntry {
  return { $type: "envoy.data.accesslog.v2.HTTPRequestProperties.RequestHeadersEntry", key: "", value: "" };
}

export const HTTPRequestProperties_RequestHeadersEntry: MessageFns<
  HTTPRequestProperties_RequestHeadersEntry,
  "envoy.data.accesslog.v2.HTTPRequestProperties.RequestHeadersEntry"
> = {
  $type: "envoy.data.accesslog.v2.HTTPRequestProperties.RequestHeadersEntry" as const,
...
function createBaseHTTPResponseProperties(): HTTPResponseProperties {
  return { $type: "envoy.data.accesslog.v2.HTTPResponseProperties" };
}
...
> = {
  $type: "envoy.data.accesslog.v2.HTTPResponseProperties" as const,
...
function createBaseHTTPResponseProperties_ResponseHeadersEntry(): HTTPResponseProperties_ResponseHeadersEntry {
  return { $type: "envoy.data.accesslog.v2.HTTPResponseProperties.ResponseHeadersEntry", key: "", value: "" };
}

export const HTTPResponseProperties_ResponseHeadersEntry: MessageFns<
  HTTPResponseProperties_ResponseHeadersEntry,
  "envoy.data.accesslog.v2.HTTPResponseProperties.ResponseHeadersEntry"
> = {
  $type: "envoy.data.accesslog.v2.HTTPResponseProperties.ResponseHeadersEntry" as const,
...
function createBaseHTTPResponseProperties_ResponseTrailersEntry(): HTTPResponseProperties_ResponseTrailersEntry {
  return { $type: "envoy.data.accesslog.v2.HTTPResponseProperties.ResponseTrailersEntry", key: "", value: "" };
}

export const HTTPResponseProperties_ResponseTrailersEntry: MessageFns<
  HTTPResponseProperties_ResponseTrailersEntry,
  "envoy.data.accesslog.v2.HTTPResponseProperties.ResponseTrailersEntry"
> = {
  $type: "envoy.data.accesslog.v2.HTTPResponseProperties.ResponseTrailersEntry" as const,
