...
export enum AccessLogType {
  ...
  TcpConnectionStart = "TcpConnectionStart",
...
export function accessLogTypeFromJSON(object: any): AccessLogType {
  switch (object) {
    ...
    case 14:
    case "TcpConnectionStart":
      return AccessLogType.TcpConnectionStart;
    case 3:
...
export function accessLogTypeToJSON(object: AccessLogType): string {
  switch (object) {
    ...
    case AccessLogType.TcpPeriodic:
      return "TcpPeriodic";
    case AccessLogType.TcpConnectionStart:
      return "TcpConnectionStart";
