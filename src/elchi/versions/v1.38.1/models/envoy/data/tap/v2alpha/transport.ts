...
export interface Connection {
  $type: "envoy.data.tap.v2alpha.Connection";
  /** Local address. */
  local_address?:
    | Address
    | undefined;
...
export interface SocketEvent {
  $type: "envoy.data.tap.v2alpha.SocketEvent";
  /** Timestamp for event. */
  timestamp?: Date | undefined;
  event_selector?: { $case: "read"; read: SocketEvent_Read } | { $case: "write"; write: SocketEvent_Write } | {
    $case: "closed";
...
export interface SocketEvent_Read {
  $type: "envoy.data.tap.v2alpha.SocketEvent.Read";
  /** Binary data read. */
  data?: Body | undefined;
}
...
export interface SocketEvent_Write {
  $type: "envoy.data.tap.v2alpha.SocketEvent.Write";
  /** Binary data written. */
  data?:
    | Body
    | undefined;
...
export interface SocketEvent_Closed {
  $type: "envoy.data.tap.v2alpha.SocketEvent.Closed";
}
...
export interface SocketStreamedTraceSegment {
  ...
  message_piece?: { $case: "connection"; connection: Connection } | { $case: "event"; event: SocketEvent } | undefined;
}

function createBaseConnection(): Connection {
  return { $type: "envoy.data.tap.v2alpha.Connection" };
}

export const Connection: MessageFns<Connection, "envoy.data.tap.v2alpha.Connection"> = {
  $type: "envoy.data.tap.v2alpha.Connection" as const,
  ...
  encode(message: Connection, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.remote_address !== undefined) {
      Address.encode(message.remote_address, writer.uint32(26).fork()).join();
    }
    return writer;
  },
...
function createBaseSocketEvent(): SocketEvent {
  return { $type: "envoy.data.tap.v2alpha.SocketEvent", event_selector: undefined };
}

export const SocketEvent: MessageFns<SocketEvent, "envoy.data.tap.v2alpha.SocketEvent"> = {
  $type: "envoy.data.tap.v2alpha.SocketEvent" as const,
...
function createBaseSocketEvent_Read(): SocketEvent_Read {
  return { $type: "envoy.data.tap.v2alpha.SocketEvent.Read" };
}

export const SocketEvent_Read: MessageFns<SocketEvent_Read, "envoy.data.tap.v2alpha.SocketEvent.Read"> = {
  $type: "envoy.data.tap.v2alpha.SocketEvent.Read" as const,
...
function createBaseSocketEvent_Write(): SocketEvent_Write {
  return { $type: "envoy.data.tap.v2alpha.SocketEvent.Write" };
}

export const SocketEvent_Write: MessageFns<SocketEvent_Write, "envoy.data.tap.v2alpha.SocketEvent.Write"> = {
  $type: "envoy.data.tap.v2alpha.SocketEvent.Write" as const,
...
function createBaseSocketEvent_Closed(): SocketEvent_Closed {
  return { $type: "envoy.data.tap.v2alpha.SocketEvent.Closed" };
}

export const SocketEvent_Closed: MessageFns<SocketEvent_Closed, "envoy.data.tap.v2alpha.SocketEvent.Closed"> = {
  $type: "envoy.data.tap.v2alpha.SocketEvent.Closed" as const,
...
function createBaseSocketBufferedTrace(): SocketBufferedTrace {
  return { $type: "envoy.data.tap.v2alpha.SocketBufferedTrace" };
}

export const SocketBufferedTrace: MessageFns<SocketBufferedTrace, "envoy.data.tap.v2alpha.SocketBufferedTrace"> = {
  $type: "envoy.data.tap.v2alpha.SocketBufferedTrace" as const,
...
function createBaseSocketStreamedTraceSegment(): SocketStreamedTraceSegment {
  return { $type: "envoy.data.tap.v2alpha.SocketStreamedTraceSegment", message_piece: undefined };
}
...
> = {
  $type: "envoy.data.tap.v2alpha.SocketStreamedTraceSegment" as const,
