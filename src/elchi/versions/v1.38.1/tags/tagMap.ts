export const tagMap: { [relativePath: string]: () => Promise<any> } = {
    ...
    'contrib/envoy/extensions/filters/common/workload_discovery/v3/discovery': () => import('./contrib/envoy/extensions/filters/common/workload_discovery/v3/discovery').then(module => ({
        'GatewayAddress': module.GatewayAddress,
        'GatewayAddress_SingleFields': module.GatewayAddress_SingleFields,
        'ApplicationTunnel': module.ApplicationTunnel,
        'ApplicationTunnel_SingleFields': module.ApplicationTunnel_SingleFields,
        'Locality': module.Locality,
        'Locality_SingleFields': module.Locality_SingleFields,
        'Workload': module.Workload,
        'Workload_SingleFields': module.Workload_SingleFields,
        'PortList': module.PortList,
        'Workload_ServicesEntry': module.Workload_ServicesEntry,
        'Workload_ServicesEntry_SingleFields': module.Workload_ServicesEntry_SingleFields,
        'Port': module.Port,
        'Port_SingleFields': module.Port_SingleFields,
        'NetworkAddress': module.NetworkAddress,
        'NetworkAddress_SingleFields': module.NetworkAddress_SingleFields,
        'NamespacedHostname': module.NamespacedHostname,
        'NamespacedHostname_SingleFields': module.NamespacedHostname_SingleFields
    })),
    'contrib/envoy/extensions/filters/common/workload_discovery/v3/extension': () => import('./contrib/envoy/extensions/filters/common/workload_discovery/v3/extension').then(module => ({
        'BootstrapExtension': module.BootstrapExtension
    })),
    'contrib/envoy/extensions/filters/http/alpn/v3/alpn': () => import('./contrib/envoy/extensions/filters/http/alpn/v3/alpn').then(module => ({
        'FilterConfig': module.FilterConfig,
        'FilterConfig_AlpnOverride': module.FilterConfig_AlpnOverride,
        'FilterConfig_AlpnOverride_SingleFields': module.FilterConfig_AlpnOverride_SingleFields
    })),
    'contrib/envoy/extensions/filters/http/istio_stats/v3/istio_stats': () => import('./contrib/envoy/extensions/filters/http/istio_stats/v3/istio_stats').then(module => ({
        'MetricConfig': module.MetricConfig,
        'MetricConfig_SingleFields': module.MetricConfig_SingleFields,
        'MetricConfig_DimensionsEntry': module.MetricConfig_DimensionsEntry,
        'MetricConfig_DimensionsEntry_SingleFields': module.MetricConfig_DimensionsEntry_SingleFields,
        'MetricDefinition': module.MetricDefinition,
        'MetricDefinition_SingleFields': module.MetricDefinition_SingleFields,
        'PluginConfig': module.PluginConfig,
        'PluginConfig_SingleFields': module.PluginConfig_SingleFields
    })),
    'contrib/envoy/extensions/filters/http/peer_metadata/v3/peer_metadata': () => import('./contrib/envoy/extensions/filters/http/peer_metadata/v3/peer_metadata').then(module => ({
        'Config': module.Config,
        'Config_SingleFields': module.Config_SingleFields,
        'Config_IstioHeaders': module.Config_IstioHeaders,
        'Config_IstioHeaders_SingleFields': module.Config_IstioHeaders_SingleFields,
        'Config_UpstreamFilterState': module.Config_UpstreamFilterState,
        'Config_UpstreamFilterState_SingleFields': module.Config_UpstreamFilterState_SingleFields,
        'Config_DiscoveryMethod': module.Config_DiscoveryMethod,
        'Config_PropagationMethod': module.Config_PropagationMethod
    })),
    ...
    'contrib/envoy/extensions/filters/network/metadata_exchange/v3/metadata_exchange': () => import('./contrib/envoy/extensions/filters/network/metadata_exchange/v3/metadata_exchange').then(module => ({
        'MetadataExchange': module.MetadataExchange,
        'MetadataExchange_SingleFields': module.MetadataExchange_SingleFields
    })),
    ...
    'contrib/envoy/extensions/filters/network/peer_metadata/v3/peer_metadata': () => import('./contrib/envoy/extensions/filters/network/peer_metadata/v3/peer_metadata').then(module => ({
        'Config': module.Config,
        'Config_SingleFields': module.Config_SingleFields
    })),
    ...
    'contrib/envoy/extensions/stat_sinks/kafka/v3/kafka_stats_sink': () => import('./contrib/envoy/extensions/stat_sinks/kafka/v3/kafka_stats_sink').then(module => ({
        'KafkaStatsSinkConfig': module.KafkaStatsSinkConfig,
        'KafkaStatsSinkConfig_SingleFields': module.KafkaStatsSinkConfig_SingleFields,
        'KafkaStatsSinkConfig_ProducerConfigEntry': module.KafkaStatsSinkConfig_ProducerConfigEntry,
        'KafkaStatsSinkConfig_ProducerConfigEntry_SingleFields': module.KafkaStatsSinkConfig_ProducerConfigEntry_SingleFields
    })),
    ...
    'envoy/config/core/v3/cel': () => import('./envoy/config/core/v3/cel').then(module => ({
        'CelExpressionConfig': module.CelExpressionConfig,
        'CelExpressionConfig_SingleFields': module.CelExpressionConfig_SingleFields
    })),
    ...
    'envoy/config/core/v3/protocol': () => import('./envoy/config/core/v3/protocol').then(module => ({
        ...
        'QuicProtocolOptions_ConnectionMigrationSettings_MigrateIdleConnectionSettings': module.QuicProtocolOptions_ConnectionMigrationSettings_MigrateIdleConnectionSettings,
        'QuicProtocolOptions_ConnectionMigrationSettings_MigrateIdleConnectionSettings_SingleFields': module.QuicProtocolOptions_ConnectionMigrationSettings_MigrateIdleConnectionSettings_SingleFields,
        'QuicProtocolOptions_ConnectionMigrationSettings': module.QuicProtocolOptions_ConnectionMigrationSettings,
        'QuicProtocolOptions_ConnectionMigrationSettings_SingleFields': module.QuicProtocolOptions_ConnectionMigrationSettings_SingleFields,
    ...
    'envoy/config/overload/v3/overload': () => import('./envoy/config/overload/v3/overload').then(module => ({
        ...
        'ShrinkHeapConfig': module.ShrinkHeapConfig,
        'ShrinkHeapConfig_SingleFields': module.ShrinkHeapConfig_SingleFields,
    ...
    'envoy/config/route/v3/route_components': () => import('./envoy/config/route/v3/route_components').then(module => ({
        ...
        'Tracing_SingleFields': module.Tracing_SingleFields,
        'Route': module.Route,
        ...
        'RateLimit_Action_RemoteAddressMatch': module.RateLimit_Action_RemoteAddressMatch,
        'RateLimit_Action_RemoteAddressMatch_SingleFields': module.RateLimit_Action_RemoteAddressMatch_SingleFields,
        ...
        'CookieMatcher': module.CookieMatcher,
        'CookieMatcher_SingleFields': module.CookieMatcher_SingleFields,
        'FilterConfig': module.FilterConfig,
    ...
    'envoy/data/tap/v3/transport': () => import('./envoy/data/tap/v3/transport').then(module => ({
        ...
        'SocketEvent_SingleFields': module.SocketEvent_SingleFields,
    ...
    'envoy/extensions/access_loggers/dynamic_modules/v3/dynamic_modules': () => import('./envoy/extensions/access_loggers/dynamic_modules/v3/dynamic_modules').then(module => ({
        'DynamicModuleAccessLog': module.DynamicModuleAccessLog,
        'DynamicModuleAccessLog_SingleFields': module.DynamicModuleAccessLog_SingleFields
    })),
    ...
    'envoy/extensions/access_loggers/filters/process_ratelimit/v3/process_ratelimit': () => import('./envoy/extensions/access_loggers/filters/process_ratelimit/v3/process_ratelimit').then(module => ({
        'DynamicTokenBucket': module.DynamicTokenBucket,
        'DynamicTokenBucket_SingleFields': module.DynamicTokenBucket_SingleFields,
        'ProcessRateLimitFilter': module.ProcessRateLimitFilter
    })),
    ...
    'envoy/extensions/access_loggers/stats/v3/stats': () => import('./envoy/extensions/access_loggers/stats/v3/stats').then(module => ({
        'Config': module.Config,
        'Config_SingleFields': module.Config_SingleFields,
        'Config_Tag': module.Config_Tag,
        'Config_Tag_SingleFields': module.Config_Tag_SingleFields,
        'Config_Stat': module.Config_Stat,
        'Config_Stat_SingleFields': module.Config_Stat_SingleFields,
        'Config_Histogram': module.Config_Histogram,
        'Config_Histogram_SingleFields': module.Config_Histogram_SingleFields,
        'Config_Counter': module.Config_Counter,
        'Config_Counter_SingleFields': module.Config_Counter_SingleFields,
        'Config_Gauge_PairedAddSubtract': module.Config_Gauge_PairedAddSubtract,
        'Config_Gauge_PairedAddSubtract_SingleFields': module.Config_Gauge_PairedAddSubtract_SingleFields,
        'Config_Gauge_Set': module.Config_Gauge_Set,
        'Config_Gauge_Set_SingleFields': module.Config_Gauge_Set_SingleFields,
        'Config_Gauge': module.Config_Gauge,
        'Config_Gauge_SingleFields': module.Config_Gauge_SingleFields
    })),
    ...
    'envoy/extensions/bootstrap/dynamic_modules/v3/dynamic_modules': () => import('./envoy/extensions/bootstrap/dynamic_modules/v3/dynamic_modules').then(module => ({
        'DynamicModuleBootstrapExtension': module.DynamicModuleBootstrapExtension,
        'DynamicModuleBootstrapExtension_SingleFields': module.DynamicModuleBootstrapExtension_SingleFields
    })),
    ...
    'envoy/extensions/bootstrap/reverse_tunnel/downstream_socket_interface/v3/downstream_reverse_connection_socket_interface': () => import('./envoy/extensions/bootstrap/reverse_tunnel/downstream_socket_interface/v3/downstream_reverse_connection_socket_interface').then(module => ({
        'DownstreamReverseConnectionSocketInterface_HttpHandshakeConfig': module.DownstreamReverseConnectionSocketInterface_HttpHandshakeConfig,
        'DownstreamReverseConnectionSocketInterface_HttpHandshakeConfig_SingleFields': module.DownstreamReverseConnectionSocketInterface_HttpHandshakeConfig_SingleFields,
    ...
    'envoy/extensions/clusters/composite/v3/cluster': () => import('./envoy/extensions/clusters/composite/v3/cluster').then(module => ({
        'ClusterConfig': module.ClusterConfig,
        'ClusterConfig_ClusterEntry': module.ClusterConfig_ClusterEntry,
        'ClusterConfig_ClusterEntry_SingleFields': module.ClusterConfig_ClusterEntry_SingleFields
    })),
    ...
    'envoy/extensions/clusters/dynamic_modules/v3/cluster': () => import('./envoy/extensions/clusters/dynamic_modules/v3/cluster').then(module => ({
        'ClusterConfig': module.ClusterConfig,
        'ClusterConfig_SingleFields': module.ClusterConfig_SingleFields
    })),
    'envoy/extensions/clusters/mcp_multicluster/v3/cluster': () => import('./envoy/extensions/clusters/mcp_multicluster/v3/cluster').then(module => ({
        'ClusterConfig': module.ClusterConfig,
        'ClusterConfig_McpCluster': module.ClusterConfig_McpCluster,
        'ClusterConfig_McpCluster_SingleFields': module.ClusterConfig_McpCluster_SingleFields,
        'ClusterConfig_McpBackend': module.ClusterConfig_McpBackend,
        'ClusterConfig_McpBackend_SingleFields': module.ClusterConfig_McpBackend_SingleFields
    })),
    ...
    'envoy/extensions/common/ratelimit/v3/ratelimit': () => import('./envoy/extensions/common/ratelimit/v3/ratelimit').then(module => ({
        ...
        'LocalRateLimitDescriptor_SingleFields': module.LocalRateLimitDescriptor_SingleFields
    })),
    ...
    'envoy/extensions/content_parsers/json/v3/json_content_parser': () => import('./envoy/extensions/content_parsers/json/v3/json_content_parser').then(module => ({
        'JsonContentParser': module.JsonContentParser,
        'JsonContentParser_RuleConfig': module.JsonContentParser_RuleConfig,
        'JsonContentParser_RuleConfig_SingleFields': module.JsonContentParser_RuleConfig_SingleFields
    })),
    ...
    'envoy/extensions/filters/http/a2a/v3/a2a': () => import('./envoy/extensions/filters/http/a2a/v3/a2a').then(module => ({
        'ParserConfig': module.ParserConfig,
        'ParserConfig_SingleFields': module.ParserConfig_SingleFields,
        'A2a': module.A2a,
        'A2a_SingleFields': module.A2a_SingleFields,
        'MethodParsingConfig': module.MethodParsingConfig,
        'MethodParsingConfig_SingleFields': module.MethodParsingConfig_SingleFields,
        'ParserConfig_MethodConfigsEntry': module.ParserConfig_MethodConfigsEntry,
        'ParserConfig_MethodConfigsEntry_SingleFields': module.ParserConfig_MethodConfigsEntry_SingleFields
    })),
    ...
    'envoy/extensions/filters/http/composite/v3/composite': () => import('./envoy/extensions/filters/http/composite/v3/composite').then(module => ({
        ...
        'Composite_NamedFilterChainsEntry': module.Composite_NamedFilterChainsEntry,
        'Composite_NamedFilterChainsEntry_SingleFields': module.Composite_NamedFilterChainsEntry_SingleFields,
        'CompositePerRoute': module.CompositePerRoute,
        ...
        'ExecuteFilterAction_SingleFields': module.ExecuteFilterAction_SingleFields
    })),
    ...
    'envoy/extensions/filters/http/ext_authz/v3/ext_authz': () => import('./envoy/extensions/filters/http/ext_authz/v3/ext_authz').then(module => ({
        ...
        'ShadowDecision': module.ShadowDecision,
        'ShadowDecision_SingleFields': module.ShadowDecision_SingleFields,
    ...
    'envoy/extensions/filters/http/file_server/v3/file_server': () => import('./envoy/extensions/filters/http/file_server/v3/file_server').then(module => ({
        'FileServerConfig': module.FileServerConfig,
        'FileServerConfig_SingleFields': module.FileServerConfig_SingleFields,
        'FileServerConfig_PathMapping': module.FileServerConfig_PathMapping,
        'FileServerConfig_PathMapping_SingleFields': module.FileServerConfig_PathMapping_SingleFields,
        'FileServerConfig_DirectoryBehavior': module.FileServerConfig_DirectoryBehavior,
        'FileServerConfig_DirectoryBehavior_SingleFields': module.FileServerConfig_DirectoryBehavior_SingleFields,
        'FileServerConfig_ContentTypesEntry': module.FileServerConfig_ContentTypesEntry,
        'FileServerConfig_ContentTypesEntry_SingleFields': module.FileServerConfig_ContentTypesEntry_SingleFields
    })),
    ...
    'envoy/extensions/filters/http/geoip/v3/geoip': () => import('./envoy/extensions/filters/http/geoip/v3/geoip').then(module => ({
        ...
        'Geoip_CustomHeaderConfig': module.Geoip_CustomHeaderConfig,
        'Geoip_CustomHeaderConfig_SingleFields': module.Geoip_CustomHeaderConfig_SingleFields,
        'Geoip': module.Geoip
    })),
    ...
    'envoy/extensions/filters/http/mcp/v3/mcp': () => import('./envoy/extensions/filters/http/mcp/v3/mcp').then(module => ({
        'ParserConfig': module.ParserConfig,
        'ParserConfig_SingleFields': module.ParserConfig_SingleFields,
        'Mcp': module.Mcp,
        'Mcp_SingleFields': module.Mcp_SingleFields,
        'ParserConfig_AttributeExtractionRule': module.ParserConfig_AttributeExtractionRule,
        'ParserConfig_AttributeExtractionRule_SingleFields': module.ParserConfig_AttributeExtractionRule_SingleFields,
        'ParserConfig_MethodConfig': module.ParserConfig_MethodConfig,
        'ParserConfig_MethodConfig_SingleFields': module.ParserConfig_MethodConfig_SingleFields,
        'McpOverride': module.McpOverride,
        'McpOverride_SingleFields': module.McpOverride_SingleFields
    })),
    'envoy/extensions/filters/http/mcp_json_rest_bridge/v3/mcp_json_rest_bridge': () => import('./envoy/extensions/filters/http/mcp_json_rest_bridge/v3/mcp_json_rest_bridge').then(module => ({
        'ServerInfo': module.ServerInfo,
        'ServerInfo_SingleFields': module.ServerInfo_SingleFields,
        'HttpRule': module.HttpRule,
        'HttpRule_SingleFields': module.HttpRule_SingleFields,
        'ServerToolConfig': module.ServerToolConfig,
        'ServerToolConfig_SingleFields': module.ServerToolConfig_SingleFields,
        'McpJsonRestBridge': module.McpJsonRestBridge,
        'ToolConfig': module.ToolConfig,
        'ToolConfig_SingleFields': module.ToolConfig_SingleFields
    })),
    'envoy/extensions/filters/http/mcp_router/v3/mcp_router': () => import('./envoy/extensions/filters/http/mcp_router/v3/mcp_router').then(module => ({
        'HeaderSource': module.HeaderSource,
        'HeaderSource_SingleFields': module.HeaderSource_SingleFields,
        'DynamicMetadataSource': module.DynamicMetadataSource,
        'IdentityExtractor': module.IdentityExtractor,
        'ValidationPolicy': module.ValidationPolicy,
        'ValidationPolicy_SingleFields': module.ValidationPolicy_SingleFields,
        'SessionIdentity': module.SessionIdentity,
        'McpRouter': module.McpRouter,
        'McpRouter_McpCluster': module.McpRouter_McpCluster,
        'McpRouter_McpCluster_SingleFields': module.McpRouter_McpCluster_SingleFields,
        'McpRouter_McpBackend': module.McpRouter_McpBackend,
        'McpRouter_McpBackend_SingleFields': module.McpRouter_McpBackend_SingleFields
    })),
    'envoy/extensions/filters/http/oauth2/v3/oauth': () => import('./envoy/extensions/filters/http/oauth2/v3/oauth').then(module => ({
        ...
        'OAuth2PerRoute': module.OAuth2PerRoute,
    ...
    'envoy/extensions/filters/http/proto_api_scrubber/v3/config': () => import('./envoy/extensions/filters/http/proto_api_scrubber/v3/config').then(module => ({
        ...
        'MessageRestrictions': module.MessageRestrictions,
        'Restrictions_MessageRestrictionsEntry': module.Restrictions_MessageRestrictionsEntry,
        'Restrictions_MessageRestrictionsEntry_SingleFields': module.Restrictions_MessageRestrictionsEntry_SingleFields,
        ...
        'MessageRestrictions_FieldRestrictionsEntry': module.MessageRestrictions_FieldRestrictionsEntry,
        'MessageRestrictions_FieldRestrictionsEntry_SingleFields': module.MessageRestrictions_FieldRestrictionsEntry_SingleFields
    })),
    ...
    'envoy/extensions/filters/http/sse_to_metadata/v3/sse_to_metadata': () => import('./envoy/extensions/filters/http/sse_to_metadata/v3/sse_to_metadata').then(module => ({
        'SseToMetadata_ProcessingRules': module.SseToMetadata_ProcessingRules,
        'SseToMetadata_ProcessingRules_SingleFields': module.SseToMetadata_ProcessingRules_SingleFields,
        'SseToMetadata': module.SseToMetadata
    })),
    ...
    'envoy/extensions/filters/http/transform/v3/transform': () => import('./envoy/extensions/filters/http/transform/v3/transform').then(module => ({
        'BodyTransformation': module.BodyTransformation,
        'BodyTransformation_SingleFields': module.BodyTransformation_SingleFields,
        'Transformation': module.Transformation,
        'TransformConfig': module.TransformConfig,
        'TransformConfig_SingleFields': module.TransformConfig_SingleFields
    })),
    'envoy/extensions/filters/http/wasm/v3/wasm': () => import('./envoy/extensions/filters/http/wasm/v3/wasm').then(module => ({
        'Wasm': module.Wasm
    })),
    'envoy/extensions/filters/listener/dynamic_modules/v3/dynamic_modules': () => import('./envoy/extensions/filters/listener/dynamic_modules/v3/dynamic_modules').then(module => ({
        'DynamicModuleListenerFilter': module.DynamicModuleListenerFilter,
        'DynamicModuleListenerFilter_SingleFields': module.DynamicModuleListenerFilter_SingleFields
    })),
    ...
    'envoy/extensions/filters/listener/set_filter_state/v3/set_filter_state': () => import('./envoy/extensions/filters/listener/set_filter_state/v3/set_filter_state').then(module => ({
        'Config': module.Config
    })),
    ...
    'envoy/extensions/filters/network/dynamic_modules/v3/dynamic_modules': () => import('./envoy/extensions/filters/network/dynamic_modules/v3/dynamic_modules').then(module => ({
        'DynamicModuleNetworkFilter': module.DynamicModuleNetworkFilter,
        'DynamicModuleNetworkFilter_SingleFields': module.DynamicModuleNetworkFilter_SingleFields
    })),
    ...
    'envoy/extensions/filters/network/geoip/v3/geoip': () => import('./envoy/extensions/filters/network/geoip/v3/geoip').then(module => ({
        'Geoip': module.Geoip,
        'Geoip_SingleFields': module.Geoip_SingleFields
    })),
    'envoy/extensions/filters/network/http_connection_manager/v3/http_connection_manager': () => import('./envoy/extensions/filters/network/http_connection_manager/v3/http_connection_manager').then(module => ({
        ...
        'ForwardProtoConfig': module.ForwardProtoConfig,
        'ForwardProtoConfig_SingleFields': module.ForwardProtoConfig_SingleFields,
        ...
        'HttpConnectionManager_ForwardClientCertConfig': module.HttpConnectionManager_ForwardClientCertConfig,
        'HttpConnectionManager_ForwardClientCertConfig_SingleFields': module.HttpConnectionManager_ForwardClientCertConfig_SingleFields,
    ...
    'envoy/extensions/filters/network/redis_proxy/v3/redis_proxy': () => import('./envoy/extensions/filters/network/redis_proxy/v3/redis_proxy').then(module => ({
        ...
        'RedisProtocolOptions_Credential': module.RedisProtocolOptions_Credential
    })),
    'envoy/extensions/filters/network/reverse_tunnel/v3/drain_aware_hcm': () => import('./envoy/extensions/filters/network/reverse_tunnel/v3/drain_aware_hcm').then(module => ({
        'DrainAwareHttpConnectionManager': module.DrainAwareHttpConnectionManager
    })),
    ...
    'envoy/extensions/filters/network/tcp_bandwidth_limit/v3/tcp_bandwidth_limit': () => import('./envoy/extensions/filters/network/tcp_bandwidth_limit/v3/tcp_bandwidth_limit').then(module => ({
        'TcpBandwidthLimit': module.TcpBandwidthLimit,
        'TcpBandwidthLimit_SingleFields': module.TcpBandwidthLimit_SingleFields
    })),
    ...
    'envoy/extensions/filters/udp/dynamic_modules/v3/dynamic_modules': () => import('./envoy/extensions/filters/udp/dynamic_modules/v3/dynamic_modules').then(module => ({
        'DynamicModuleUdpListenerFilter': module.DynamicModuleUdpListenerFilter,
        'DynamicModuleUdpListenerFilter_SingleFields': module.DynamicModuleUdpListenerFilter_SingleFields
    })),
    ...
    'envoy/extensions/formatter/generic_secret/v3/generic_secret': () => import('./envoy/extensions/formatter/generic_secret/v3/generic_secret').then(module => ({
        'GenericSecret': module.GenericSecret,
        'GenericSecret_SecretConfigsEntry': module.GenericSecret_SecretConfigsEntry,
        'GenericSecret_SecretConfigsEntry_SingleFields': module.GenericSecret_SecretConfigsEntry_SingleFields
    })),
    'envoy/extensions/geoip_providers/common/v3/common': () => import('./envoy/extensions/geoip_providers/common/v3/common').then(module => ({
        ...
        'CommonGeoipProviderConfig_GeolocationFieldKeys': module.CommonGeoipProviderConfig_GeolocationFieldKeys,
        'CommonGeoipProviderConfig_GeolocationFieldKeys_SingleFields': module.CommonGeoipProviderConfig_GeolocationFieldKeys_SingleFields,
    ...
    'envoy/extensions/http/ext_proc/processing_request_modifiers/mapped_attribute_builder/v3/mapped_attribute_builder': () => import('./envoy/extensions/http/ext_proc/processing_request_modifiers/mapped_attribute_builder/v3/mapped_attribute_builder').then(module => ({
        ...
        'MappedAttributeBuilder_MappedResponseAttributesEntry': module.MappedAttributeBuilder_MappedResponseAttributesEntry,
        'MappedAttributeBuilder_MappedResponseAttributesEntry_SingleFields': module.MappedAttributeBuilder_MappedResponseAttributesEntry_SingleFields
    })),
    ...
    'envoy/extensions/http/injected_credentials/oauth2/v3/oauth2': () => import('./envoy/extensions/http/injected_credentials/oauth2/v3/oauth2').then(module => ({
        ...
        'OAuth2_EndpointParameter': module.OAuth2_EndpointParameter,
        'OAuth2_EndpointParameter_SingleFields': module.OAuth2_EndpointParameter_SingleFields
    })),
    ...
    'envoy/extensions/load_balancing_policies/dynamic_modules/v3/dynamic_modules': () => import('./envoy/extensions/load_balancing_policies/dynamic_modules/v3/dynamic_modules').then(module => ({
        'DynamicModulesLoadBalancerConfig': module.DynamicModulesLoadBalancerConfig,
        'DynamicModulesLoadBalancerConfig_SingleFields': module.DynamicModulesLoadBalancerConfig_SingleFields
    })),
    ...
    'envoy/extensions/load_balancing_policies/random_subsetting/v3/random_subsetting': () => import('./envoy/extensions/load_balancing_policies/random_subsetting/v3/random_subsetting').then(module => ({
        'RandomSubsetting': module.RandomSubsetting,
        'RandomSubsetting_SingleFields': module.RandomSubsetting_SingleFields
    })),
    ...
    'envoy/extensions/matching/actions/transform_stat/v3/transform_stat': () => import('./envoy/extensions/matching/actions/transform_stat/v3/transform_stat').then(module => ({
        'TransformStat_UpdateTag': module.TransformStat_UpdateTag,
        'TransformStat_UpdateTag_SingleFields': module.TransformStat_UpdateTag_SingleFields,
        'TransformStat': module.TransformStat
    })),
    ...
    'envoy/extensions/matching/common_inputs/transport_socket/v3/transport_socket_inputs': () => import('./envoy/extensions/matching/common_inputs/transport_socket/v3/transport_socket_inputs').then(module => ({
        'EndpointMetadataInput': module.EndpointMetadataInput,
        'EndpointMetadataInput_SingleFields': module.EndpointMetadataInput_SingleFields,
        'EndpointMetadataInput_PathSegment': module.EndpointMetadataInput_PathSegment,
        'EndpointMetadataInput_PathSegment_SingleFields': module.EndpointMetadataInput_PathSegment_SingleFields,
        'LocalityMetadataInput': module.LocalityMetadataInput,
        'LocalityMetadataInput_SingleFields': module.LocalityMetadataInput_SingleFields,
        'LocalityMetadataInput_PathSegment': module.LocalityMetadataInput_PathSegment,
        'LocalityMetadataInput_PathSegment_SingleFields': module.LocalityMetadataInput_PathSegment_SingleFields,
        'FilterStateInput': module.FilterStateInput,
        'FilterStateInput_SingleFields': module.FilterStateInput_SingleFields,
        'TransportSocketNameAction': module.TransportSocketNameAction,
        'TransportSocketNameAction_SingleFields': module.TransportSocketNameAction_SingleFields
    })),
    ...
    'envoy/extensions/matching/input_matchers/dynamic_modules/v3/dynamic_modules': () => import('./envoy/extensions/matching/input_matchers/dynamic_modules/v3/dynamic_modules').then(module => ({
        'DynamicModuleMatcher': module.DynamicModuleMatcher,
        'DynamicModuleMatcher_SingleFields': module.DynamicModuleMatcher_SingleFields
    })),
    ...
    'envoy/extensions/network/dns_resolver/hickory/v3/hickory_dns_resolver': () => import('./envoy/extensions/network/dns_resolver/hickory/v3/hickory_dns_resolver').then(module => ({
        'DnsOverTlsConfig': module.DnsOverTlsConfig,
        'DnsOverTlsConfig_SingleFields': module.DnsOverTlsConfig_SingleFields,
        'DnsOverHttpsConfig': module.DnsOverHttpsConfig,
        'DnsOverHttpsConfig_SingleFields': module.DnsOverHttpsConfig_SingleFields,
        'HickoryDnsResolverConfig': module.HickoryDnsResolverConfig,
        'HickoryDnsResolverConfig_SingleFields': module.HickoryDnsResolverConfig_SingleFields
    })),
    ...
    'envoy/extensions/tracers/dynamic_modules/v3/dynamic_modules': () => import('./envoy/extensions/tracers/dynamic_modules/v3/dynamic_modules').then(module => ({
        'DynamicModuleTracer': module.DynamicModuleTracer,
        'DynamicModuleTracer_SingleFields': module.DynamicModuleTracer_SingleFields
    })),
    ...
    'envoy/extensions/transport_sockets/tls/cert_mappers/filter_state_override/v3/config': () => import('./envoy/extensions/transport_sockets/tls/cert_mappers/filter_state_override/v3/config').then(module => ({
        'Config': module.Config,
        'Config_SingleFields': module.Config_SingleFields
    })),
    'envoy/extensions/transport_sockets/tls/cert_mappers/sni/v3/config': () => import('./envoy/extensions/transport_sockets/tls/cert_mappers/sni/v3/config').then(module => ({
        'SNI': module.SNI,
        'SNI_SingleFields': module.SNI_SingleFields
    })),
    'envoy/extensions/transport_sockets/tls/cert_mappers/static_name/v3/config': () => import('./envoy/extensions/transport_sockets/tls/cert_mappers/static_name/v3/config').then(module => ({
        'StaticName': module.StaticName,
        'StaticName_SingleFields': module.StaticName_SingleFields
    })),
    'envoy/extensions/transport_sockets/tls/cert_selectors/on_demand_secret/v3/config': () => import('./envoy/extensions/transport_sockets/tls/cert_selectors/on_demand_secret/v3/config').then(module => ({
        'Config': module.Config,
        'Config_SingleFields': module.Config_SingleFields
    })),
    'envoy/extensions/transport_sockets/tls/cert_validator/dynamic_modules/v3/dynamic_modules': () => import('./envoy/extensions/transport_sockets/tls/cert_validator/dynamic_modules/v3/dynamic_modules').then(module => ({
        'DynamicModuleCertValidatorConfig': module.DynamicModuleCertValidatorConfig,
        'DynamicModuleCertValidatorConfig_SingleFields': module.DynamicModuleCertValidatorConfig_SingleFields
    })),
    ...
    'envoy/extensions/upstreams/http/dynamic_modules/v3/dynamic_modules': () => import('./envoy/extensions/upstreams/http/dynamic_modules/v3/dynamic_modules').then(module => ({
        'Config': module.Config,
        'Config_SingleFields': module.Config_SingleFields
    })),
    ...
    'envoy/service/ext_proc/v3/external_processor': () => import('./envoy/service/ext_proc/v3/external_processor').then(module => ({
        ...
        'StreamedImmediateResponse': module.StreamedImmediateResponse,
    ...
    'envoy/type/matcher/v3/address': () => import('./envoy/type/matcher/v3/address').then(module => ({
        ...
        'AddressMatcher_SingleFields': module.AddressMatcher_SingleFields
    })),
    ...
    'google/protobuf/descriptor': () => import('./google/protobuf/descriptor').then(module => ({
        ...
        'FeatureSet': module.FeatureSet,
        'FeatureSet_SingleFields': module.FeatureSet_SingleFields,
        ...
        'ExtensionRangeOptions_SingleFields': module.ExtensionRangeOptions_SingleFields,
        ...
        'ExtensionRangeOptions_Declaration': module.ExtensionRangeOptions_Declaration,
        'ExtensionRangeOptions_Declaration_SingleFields': module.ExtensionRangeOptions_Declaration_SingleFields,
        'FieldOptions_FeatureSupport': module.FieldOptions_FeatureSupport,
        'FieldOptions_FeatureSupport_SingleFields': module.FieldOptions_FeatureSupport_SingleFields,
        ...
        'FieldOptions_EditionDefault': module.FieldOptions_EditionDefault,
        'FieldOptions_EditionDefault_SingleFields': module.FieldOptions_EditionDefault_SingleFields,
        ...
        'FeatureSetDefaults': module.FeatureSetDefaults,
        'FeatureSetDefaults_SingleFields': module.FeatureSetDefaults_SingleFields,
        'FeatureSetDefaults_FeatureSetEditionDefault': module.FeatureSetDefaults_FeatureSetEditionDefault,
        'FeatureSetDefaults_FeatureSetEditionDefault_SingleFields': module.FeatureSetDefaults_FeatureSetEditionDefault_SingleFields,
