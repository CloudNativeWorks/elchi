...
export const ValueMatcher: OutType = { "ValueMatcher": [
  {
    ...
    "enums": null,
    "comment": "Specifies the way to match a Protobuf::Value. Primitive values and ListValue are supported. StructValue is not supported and is always not matched. [#next-free-field: 8]",
    "notImp": false
  },
  {
