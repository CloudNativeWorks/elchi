...
export const HeaderMutation: OutType = { "HeaderMutation": [
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "The HeaderMutation structure specifies an action that may be taken on HTTP headers.",
    "notImp": false
  },
  {
    "name": "action.append",
  ...
  {
    "name": "action.remove_on_match",
    "isUnion": true,
    "isDeprecated": false,
    "fieldType": "HeaderMutation_RemoveOnMatch",
    "enums": null,
    "comment": "The HeaderMutation structure specifies an action that may be taken on HTTP headers.",
    "notImp": false
  }
...
export const HeaderMutation_RemoveOnMatch: OutType = { "HeaderMutation_RemoveOnMatch": [
  {
    "name": "key_matcher",
    "isUnion": false,
    "isDeprecated": false,
    ...
    "enums": null,
    "comment": "A string matcher that will be applied to the header key. If the header key matches, the header will be removed.",
    "notImp": false
  }
] };