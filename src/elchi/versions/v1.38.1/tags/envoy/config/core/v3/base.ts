...
export const Node: OutType = { "Node": [
  ...
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "Identifies a specific Envoy instance. The node identifier is presented to the management server, which may use this identifier to distinguish per Envoy configuration for serving. [#next-free-field: 13]",
    "notImp": false
  },
  {
...
export const DataSource: OutType = { "DataSource": [
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "Data source consisting of a file, an inline value, or an environment variable. [#next-free-field: 6]",
    "notImp": false
  },
  {
...
export const AsyncDataSource: OutType = { "AsyncDataSource": [
  {
    ...
    "enums": null,
    "comment": "Async data source which support async data fetch.",
    "notImp": false
  },
  {
...
export const TransportSocket: OutType = { "TransportSocket": [
  ...
  },
  {
    ...
    "fieldType": "Any",
    "enums": null,
    "comment": "Configuration for transport socket in `listeners` and `clusters`. If the configuration is empty, a default transport socket implementation and configuration will be chosen based on the platform and existence of tls_context.",
    "notImp": false
  }
] };
