...
export const UpstreamLocalityStats: OutType = { "UpstreamLocalityStats": [
  ...
  },
  {
    ...
    "fieldType": "number",
    "enums": null,
    "comment": "The total number of unfinished requests. A request can be an HTTP request or a TCP connection for a TCP connection pool.",
    "notImp": false
  },
  {
  ...
  },
  {
    ...
    "fieldType": "number",
    "enums": null,
    "comment": "The total number of requests that were issued by this Envoy since the last report. This information is aggregated over all the upstream endpoints in the locality. A request can be an HTTP request or a TCP connection for a TCP connection pool.",
    "notImp": false
  },
  {
