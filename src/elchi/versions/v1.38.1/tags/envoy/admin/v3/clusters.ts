...
export const HostHealthStatus: OutType = { "HostHealthStatus": [
  ...
  },
  {
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "The host is awaiting first health check.",
    "notImp": false
  },
  {
  ...
  },
  {
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "The host failed active health check due to timeout.",
    "notImp": false
  },
  {
    "name": "failed_degraded_outlier_detection",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "boolean",
    "enums": null,
    "comment": "The host is currently being marked as degraded through outlier detection.",
    "notImp": false
  },
  {
