...
export const ReloadConfig: OutType = { "ReloadConfig": [
  {
    "name": "backoff",
    "isUnion": false,
    "isDeprecated": false,
    ...
    "enums": null,
    "comment": "Backoff strategy for the VM failure reload. If not specified, the default 1s base interval will be applied.",
    "notImp": false
  }
] };
...
export const VmConfig: OutType = { "VmConfig": [
  ...
  },
  {
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "Allow the wasm file to include pre-compiled code on VMs which support it.\n\n:::warning\nThis should only be enabled for trusted sources as the precompiled code is not verified.",
    "notImp": false
  },
  {
...
export const PluginConfig: OutType = { "PluginConfig": [
  ...
  },
  {
    ...
    "fieldType": "VmConfig",
    "enums": null,
    "comment": "Base Configuration for Wasm Plugins e.g. filters and services. [#next-free-field: 10]",
    "notImp": false
  },
  {
    "name": "configuration",
  ...
  },
  {
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "If there is a fatal error on the VM (e.g. exception, ``abort()``, ``on_start`` or ``on_configure`` return false), then all plugins associated with the VM will either fail closed (by default), e.g. by returning an HTTP 503 error, or fail open (if 'fail_open' is set to true) by bypassing the filter.\n\n:::note\nWhen ``on_start`` or ``on_configure`` return ``false`` during xDS updates the xDS configuration will be rejected and when ``on_start`` or ``on_configure`` return ``false`` on initial startup the proxy will not start. \n:::\n\nThis field is deprecated in favor of the ``failure_policy`` field.",
    "notImp": false
  },
  {
    "name": "failure_policy",
    ...
    "comment": "The failure policy for the plugin.",
    "notImp": false
  },
  {
    "name": "reload_config",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "ReloadConfig",
    "enums": null,
    "comment": "Reload configuration. This is only applied when ``failure_policy`` is set to ``FAIL_RELOAD``.",
    "notImp": false
  },
  {
  ...
  {
    "name": "allow_on_headers_stop_iteration",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "boolean",
    "enums": null,
    "comment": "Whether or not to allow plugin onRequestHeaders and onResponseHeaders callbacks to return FilterHeadersStatus::StopIteration.",
    "notImp": false
  }
] };
