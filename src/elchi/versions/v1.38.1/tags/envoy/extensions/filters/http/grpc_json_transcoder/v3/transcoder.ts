...
export const GrpcJsonTranscoder_PrintOptions: OutType = { "GrpcJsonTranscoder_PrintOptions": [
  ...
  {
    "name": "stream_sse_style_delimited",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "boolean",
    "enums": null,
    "comment": "If true, enforces Server-Sent Events (SSE) message framing (``data: <message>\\n\\n``) and, ``stream_newline_delimited`` is ignored. If false, message framing is determined by ``stream_newline_delimited``.",
    "notImp": false
  }
] };
