...
export const Forwarding: OutType = { "Forwarding": [
  {
    "name": "header",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "string",
    "enums": null,
    "comment": "The header name in which to store the client information. If this field is non-empty, the client string associated with the matched credential will be injected into the request before forwarding upstream.",
    "notImp": false
  },
  {
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "If true, remove the API key from the request before forwarding upstream.\n\nThis applies to all configured key sources: ``header``, ``query``, and ``cookie``.",
    "notImp": false
  }
] };

export const Forwarding_SingleFields = [
  "header",
  "hide_credentials"
];
...
export const ApiKeyAuth: OutType = { "ApiKeyAuth": [
  ...
  },
  {
    ...
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "Forwarding",
    "enums": null,
    "comment": "Optional configuration to control what information should be propagated to upstream services.",
    "notImp": false
  }
] };
...
export const ApiKeyAuthPerRoute: OutType = { "ApiKeyAuthPerRoute": [
  ...
  },
  {
    ...
    "fieldType": "Forwarding",
    "enums": null,
    "comment": "Optional configuration to control what information should be propagated to upstream services. If this field is non-empty, then the forwarding information in the filter level configuration will be ignored and the forwarding in this configuration will be used.",
    "notImp": false
  }
] };
