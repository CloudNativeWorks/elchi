...
export const SPIFFECertValidatorConfig_TrustDomain: OutType = { "SPIFFECertValidatorConfig_TrustDomain": [
  ...
  {
    "name": "workload_trust_domain",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "string",
    "enums": null,
    "comment": "Optional workload trust domain selection condition. The filter object ``envoy.tls.cert_validator.spiffe.workload_trust_domain`` must match exactly the value of this field. If not specified, the filter state object must be absent or be empty to match this trust domain.",
    "notImp": false
  }
] };
