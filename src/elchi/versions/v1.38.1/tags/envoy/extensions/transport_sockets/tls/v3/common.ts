...
export const TlsParameters: OutType = { "TlsParameters": [
  ...
  },
  {
    ...
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "TlsParameters_CompliancePolicy[]",
    "enums": null,
    "comment": "Compliance policies configure various aspects of the TLS based on the given policy. The policies are applied last during configuration and may override the other TLS parameters, or any previous policy.",
    "notImp": false
  }
] };
...
export const PrivateKeyProvider: OutType = { "PrivateKeyProvider": [
  ...
  },
  {
    ...
    "fieldType": "Any",
    "enums": null,
    "comment": "BoringSSL private key method configuration. The private key methods are used for external (potentially asynchronous) signing and decryption operations. Some use cases for private key methods would be TPM support and TLS acceleration.",
    "notImp": false
  },
  {
    "name": "fallback",
...
export const TlsCertificate: OutType = { "TlsCertificate": [
  ...
  },
  {
    ...
    "enums": null,
    "comment": "BoringSSL private key method provider. This is an alternative to `private_key` field. When both `private_key` and `private_key_provider` fields are set, ``private_key_provider`` takes precedence. If ``private_key_provider`` is unavailable and `fallback` is enabled, ``private_key`` will be used.",
    "notImp": false
  },
  {
    "name": "password",
