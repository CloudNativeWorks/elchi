...
export const DynamicParameterConstraints: OutType = { "DynamicParameterConstraints": [
  {
    ...
    "enums": null,
    "comment": "A set of dynamic parameter constraints associated with a variant of an individual xDS resource. These constraints determine whether the resource matches a subscription based on the set of dynamic parameters in the subscription, as specified in the `ResourceLocator.dynamic_parameters` field. This allows xDS implementations (clients, servers, and caching proxies) to determine which variant of a resource is appropriate for a given client.",
    "notImp": false
  },
  {
...
export const DynamicParameterConstraints_SingleConstraint: OutType = { "DynamicParameterConstraints_SingleConstraint": [
  ...
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "A single constraint for a given key.",
    "notImp": false
  },
  {
