...
export const DiscoveryRequest: OutType = { "DiscoveryRequest": [
  ...
  },
  {
    ...
    "enums": null,
    "comment": "[#not-implemented-hide:] Alternative to ``resource_names`` field that allows specifying dynamic parameters along with each resource name. Clients that populate this field must be able to handle responses from the server where resources are wrapped in a Resource message. Note that it is legal for a request to have some resources listed in ``resource_names`` and others in ``resource_locators``.",
    "notImp": true
  },
  {
    "name": "type_url",
...
export const DeltaDiscoveryRequest: OutType = { "DeltaDiscoveryRequest": [
  ...
  },
  {
    ...
    "fieldType": "ResourceLocator[]",
    "enums": null,
    "comment": "[#not-implemented-hide:] Alternative to ``resource_names_subscribe`` field that allows specifying dynamic parameters along with each resource name. Note that it is legal for a request to have some resources listed in ``resource_names_subscribe`` and others in ``resource_locators_subscribe``.",
    "notImp": true
  },
  {
    ...
    "fieldType": "ResourceLocator[]",
    "enums": null,
    "comment": "[#not-implemented-hide:] Alternative to ``resource_names_unsubscribe`` field that allows specifying dynamic parameters along with each resource name. Note that it is legal for a request to have some resources listed in ``resource_names_unsubscribe`` and others in ``resource_locators_unsubscribe``.",
    "notImp": true
  },
  {
...
export const DeltaDiscoveryResponse: OutType = { "DeltaDiscoveryResponse": [
  ...
  },
  {
    ...
    "fieldType": "string[]",
    "enums": null,
    "comment": "Resources names of resources that have be deleted and to be removed from the xDS Client. Removed resources for missing resources can be ignored.",
    "notImp": false
  },
  {
  ...
  },
  {
    ...
    "fieldType": "ResourceError[]",
    "enums": null,
    "comment": "[#not-implemented-hide:] Errors associated with specific resources. Note that a resource in this field with a status of NOT_FOUND should be treated the same as a resource listed in the 'removed_resources' or 'removed_resource_names' fields.",
    "notImp": true
  }
] };
...
export const Resource_CacheControl: OutType = { "Resource_CacheControl": [
  {
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "If true, xDS proxies may not cache this resource. Note that this does not apply to clients other than xDS proxies, which must cache resources for their own use, regardless of the value of this field.",
    "notImp": false
  }
] };
