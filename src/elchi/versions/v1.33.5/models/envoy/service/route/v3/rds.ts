...
export const protobufPackage = "envoy.service.route.v3";
...
export interface RdsDummy {
  $type: "envoy.service.route.v3.RdsDummy";
}

function createBaseRdsDummy(): RdsDummy {
  return { $type: "envoy.service.route.v3.RdsDummy" };
}

export const RdsDummy: MessageFns<RdsDummy, "envoy.service.route.v3.RdsDummy"> = {
  $type: "envoy.service.route.v3.RdsDummy" as const,
...
export const RouteDiscoveryServiceServiceName = "envoy.service.route.v3.RouteDiscoveryService";
...
export const VirtualHostDiscoveryServiceServiceName = "envoy.service.route.v3.VirtualHostDiscoveryService";
