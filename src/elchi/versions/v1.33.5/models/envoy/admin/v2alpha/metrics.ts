...
export interface SimpleMetric {
  $type: "envoy.admin.v2alpha.SimpleMetric";
...
function createBaseSimpleMetric(): SimpleMetric {
  return { $type: "envoy.admin.v2alpha.SimpleMetric" };
}

export const SimpleMetric: MessageFns<SimpleMetric, "envoy.admin.v2alpha.SimpleMetric"> = {
  $type: "envoy.admin.v2alpha.SimpleMetric" as const,
