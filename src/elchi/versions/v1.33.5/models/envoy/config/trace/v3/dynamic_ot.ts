...
export interface DynamicOtConfig {
  $type: "envoy.config.trace.v3.DynamicOtConfig";
  /**
...
function createBaseDynamicOtConfig(): DynamicOtConfig {
  return { $type: "envoy.config.trace.v3.DynamicOtConfig" };
}

export const DynamicOtConfig: MessageFns<DynamicOtConfig, "envoy.config.trace.v3.DynamicOtConfig"> = {
  $type: "envoy.config.trace.v3.DynamicOtConfig" as const,
