...
> = {
  ...
  encode(_: CpuUtilizationConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
  ...
  fromJSON(_: any): CpuUtilizationConfig {
    return { $type: CpuUtilizationConfig.$type };
  },

  toJSON(_: CpuUtilizationConfig): unknown {
    const obj: any = {};
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<CpuUtilizationConfig>, I>>(_: I): CpuUtilizationConfig {
    const message = createBaseCpuUtilizationConfig();
    return message;
  },
};
