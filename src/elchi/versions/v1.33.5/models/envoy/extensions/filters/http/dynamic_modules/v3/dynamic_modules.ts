...
export interface DynamicModuleFilter {
   ...
   */
  filter_config?: string | undefined;
}
...
> = {
  ...
  encode(message: DynamicModuleFilter, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.filter_config !== undefined && message.filter_config !== "") {
      writer.uint32(26).string(message.filter_config);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.filter_config = reader.string();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): DynamicModuleFilter {
    return {
      ...
      filter_config: isSet(object.filter_config) ? globalThis.String(object.filter_config) : undefined,
    };
  },
  ...
  toJSON(message: DynamicModuleFilter): unknown {
    ...
    if (message.filter_config !== undefined) {
      obj.filter_config = message.filter_config;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<DynamicModuleFilter>, I>>(object: I): DynamicModuleFilter {
    ...
    message.filter_config = object.filter_config ?? undefined;
    return message;
  },
};
