...
export const protobufPackage = "envoy.extensions.filters.network.client_ssl_auth.v3";

export interface ClientSSLAuth {
  $type: "envoy.extensions.filters.network.client_ssl_auth.v3.ClientSSLAuth";
  /**
...
function createBaseClientSSLAuth(): ClientSSLAuth {
  return { $type: "envoy.extensions.filters.network.client_ssl_auth.v3.ClientSSLAuth" };
}

export const ClientSSLAuth: MessageFns<
  ClientSSLAuth,
  "envoy.extensions.filters.network.client_ssl_auth.v3.ClientSSLAuth"
> = {
  $type: "envoy.extensions.filters.network.client_ssl_auth.v3.ClientSSLAuth" as const,
