...
export const CommonGeoipProviderConfig_GeolocationHeadersToAdd: OutType = { "CommonGeoipProviderConfig_GeolocationHeadersToAdd": [
  ...
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "This field is being deprecated, use ``anon`` instead.",
    "notImp": false
  },
  {
    "name": "anon",
  ...
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "If set, the IP address will be checked if it belongs to the ISP named iCloud Private Relay and header will be populated with the check result. Header value will be set to either \"true\" or \"false\" depending on the check result.",
    "notImp": false
  }
] };
