...
export const HealthCheck: OutType = { "HealthCheck": [
  ...
  },
  {
    ...
    "enums": null,
    "comment": "If operating in non-pass-through mode, specifies a set of upstream cluster names and the minimum percentage of servers in each of those clusters that must be healthy or degraded in order for the filter to return a 200. If any of the clusters configured here does not exist, the filter will not return a 200.\n\n:::note\n\nThis value is interpreted as an integer by truncating, so 12.50% will be calculated as if it were 12%.",
    "notImp": false
  },
  {
    "name": "headers",
