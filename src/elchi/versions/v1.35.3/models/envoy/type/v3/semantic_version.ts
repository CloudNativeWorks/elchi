...
function createBaseSemanticVersion(): SemanticVersion {
  return { $type: "envoy.type.v3.SemanticVersion" };
}

export const SemanticVersion: MessageFns<SemanticVersion, "envoy.type.v3.SemanticVersion"> = {
  $type: "envoy.type.v3.SemanticVersion" as const,
