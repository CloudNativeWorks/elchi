...
export interface StreamTapsRequest {
  $type: "envoy.service.tap.v2alpha.StreamTapsRequest";
  /**
...
export interface StreamTapsRequest_Identifier {
  $type: "envoy.service.tap.v2alpha.StreamTapsRequest.Identifier";
...
export interface StreamTapsResponse {
  $type: "envoy.service.tap.v2alpha.StreamTapsResponse";
}

function createBaseStreamTapsRequest(): StreamTapsRequest {
  return { $type: "envoy.service.tap.v2alpha.StreamTapsRequest" };
}

export const StreamTapsRequest: MessageFns<StreamTapsRequest, "envoy.service.tap.v2alpha.StreamTapsRequest"> = {
  $type: "envoy.service.tap.v2alpha.StreamTapsRequest" as const,
...
function createBaseStreamTapsRequest_Identifier(): StreamTapsRequest_Identifier {
  return { $type: "envoy.service.tap.v2alpha.StreamTapsRequest.Identifier" };
}
...
> = {
  $type: "envoy.service.tap.v2alpha.StreamTapsRequest.Identifier" as const,
...
function createBaseStreamTapsResponse(): StreamTapsResponse {
  return { $type: "envoy.service.tap.v2alpha.StreamTapsResponse" };
}

export const StreamTapsResponse: MessageFns<StreamTapsResponse, "envoy.service.tap.v2alpha.StreamTapsResponse"> = {
  $type: "envoy.service.tap.v2alpha.StreamTapsResponse" as const,
...
export const TapSinkServiceServiceName = "envoy.service.tap.v2alpha.TapSinkService";
