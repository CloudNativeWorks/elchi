...
export const protobufPackage = "envoy.config.filter.network.local_rate_limit.v2alpha";

export interface LocalRateLimit {
  $type: "envoy.config.filter.network.local_rate_limit.v2alpha.LocalRateLimit";
  /**
...
function createBaseLocalRateLimit(): LocalRateLimit {
  return { $type: "envoy.config.filter.network.local_rate_limit.v2alpha.LocalRateLimit" };
}
...
> = {
  $type: "envoy.config.filter.network.local_rate_limit.v2alpha.LocalRateLimit" as const,
