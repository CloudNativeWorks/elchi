...
export const protobufPackage = "envoy.config.filter.http.squash.v2";

/** [#next-free-field: 6] */
export interface Squash {
  $type: "envoy.config.filter.http.squash.v2.Squash";
...
function createBaseSquash(): Squash {
  return { $type: "envoy.config.filter.http.squash.v2.Squash" };
}

export const Squash: MessageFns<Squash, "envoy.config.filter.http.squash.v2.Squash"> = {
  $type: "envoy.config.filter.http.squash.v2.Squash" as const,
