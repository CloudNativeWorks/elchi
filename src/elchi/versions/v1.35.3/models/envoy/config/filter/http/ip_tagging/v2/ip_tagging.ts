...
export const protobufPackage = "envoy.config.filter.http.ip_tagging.v2";

export interface IPTagging {
  $type: "envoy.config.filter.http.ip_tagging.v2.IPTagging";
...
export interface IPTagging_IPTag {
  $type: "envoy.config.filter.http.ip_tagging.v2.IPTagging.IPTag";
...
function createBaseIPTagging(): IPTagging {
  return { $type: "envoy.config.filter.http.ip_tagging.v2.IPTagging" };
}

export const IPTagging: MessageFns<IPTagging, "envoy.config.filter.http.ip_tagging.v2.IPTagging"> = {
  $type: "envoy.config.filter.http.ip_tagging.v2.IPTagging" as const,
...
function createBaseIPTagging_IPTag(): IPTagging_IPTag {
  return { $type: "envoy.config.filter.http.ip_tagging.v2.IPTagging.IPTag" };
}

export const IPTagging_IPTag: MessageFns<IPTagging_IPTag, "envoy.config.filter.http.ip_tagging.v2.IPTagging.IPTag"> = {
  $type: "envoy.config.filter.http.ip_tagging.v2.IPTagging.IPTag" as const,
