...
export const protobufPackage = "envoy.config.cluster.aggregate.v2alpha";
...
export interface ClusterConfig {
  $type: "envoy.config.cluster.aggregate.v2alpha.ClusterConfig";
  /**
...
function createBaseClusterConfig(): ClusterConfig {
  return { $type: "envoy.config.cluster.aggregate.v2alpha.ClusterConfig" };
}

export const ClusterConfig: MessageFns<ClusterConfig, "envoy.config.cluster.aggregate.v2alpha.ClusterConfig"> = {
  $type: "envoy.config.cluster.aggregate.v2alpha.ClusterConfig" as const,
