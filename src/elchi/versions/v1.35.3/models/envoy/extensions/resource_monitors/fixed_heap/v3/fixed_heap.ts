...
export const protobufPackage = "envoy.extensions.resource_monitors.fixed_heap.v3";
...
export interface FixedHeapConfig {
  $type: "envoy.extensions.resource_monitors.fixed_heap.v3.FixedHeapConfig";
  max_heap_size_bytes?: number | undefined;
}

function createBaseFixedHeapConfig(): FixedHeapConfig {
  return { $type: "envoy.extensions.resource_monitors.fixed_heap.v3.FixedHeapConfig" };
}
...
> = {
  $type: "envoy.extensions.resource_monitors.fixed_heap.v3.FixedHeapConfig" as const,
