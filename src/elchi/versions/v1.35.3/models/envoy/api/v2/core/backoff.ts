...
export interface BackoffStrategy {
  $type: "envoy.api.v2.core.BackoffStrategy";
  /**
...
function createBaseBackoffStrategy(): BackoffStrategy {
  return { $type: "envoy.api.v2.core.BackoffStrategy" };
}

export const BackoffStrategy: MessageFns<BackoffStrategy, "envoy.api.v2.core.BackoffStrategy"> = {
  $type: "envoy.api.v2.core.BackoffStrategy" as const,
...
messageTypeRegistry.set(BackoffStrategy.$type, BackoffStrategy);
