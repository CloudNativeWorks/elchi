...
export interface ListStringMatcher {
  $type: "xds.type.matcher.v3.ListStringMatcher";
  patterns?: StringMatcher[] | undefined;
}

function createBaseStringMatcher(): StringMatcher {
  return { $type: "xds.type.matcher.v3.StringMatcher", match_pattern: undefined };
}

export const StringMatcher: MessageFns<StringMatcher, "xds.type.matcher.v3.StringMatcher"> = {
  $type: "xds.type.matcher.v3.StringMatcher" as const,
...
function createBaseListStringMatcher(): ListStringMatcher {
  return { $type: "xds.type.matcher.v3.ListStringMatcher" };
}

export const ListStringMatcher: MessageFns<ListStringMatcher, "xds.type.matcher.v3.ListStringMatcher"> = {
  $type: "xds.type.matcher.v3.ListStringMatcher" as const,
