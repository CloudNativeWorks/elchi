...
export const Http: MessageFns<Http, "google.api.Http"> = {
  ...
  encode(message: Http, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.fully_decode_reserved_expansion !== undefined && message.fully_decode_reserved_expansion !== false) {
  ...
  fromPartial<I extends Exact<DeepPartial<Http>, I>>(object: I): Http {
    ...
    message.fully_decode_reserved_expansion = object.fully_decode_reserved_expansion ?? undefined;
    return message;
  },
};
...
function createBaseHttpRule(): HttpRule {
  return { $type: "google.api.HttpRule", pattern: undefined };
}
...
export const HttpRule: MessageFns<HttpRule, "google.api.HttpRule"> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 11: {
          ...
          const el = HttpRule.decode(reader, reader.uint32());
          if (el !== undefined) {
            message.additional_bindings!.push(el);
          }
          continue;
        }
      }
  ...
  fromJSON(object: any): HttpRule {
    return {
      ...
      response_body: isSet(object.response_body) ? globalThis.String(object.response_body) : undefined,
  ...
  fromPartial<I extends Exact<DeepPartial<HttpRule>, I>>(object: I): HttpRule {
    ...
    message.response_body = object.response_body ?? undefined;
    message.additional_bindings = object.additional_bindings?.map((e) => HttpRule.fromPartial(e)) || undefined;
    return message;
  },
};
...
function createBaseCustomHttpPattern(): CustomHttpPattern {
  return { $type: "google.api.CustomHttpPattern" };
}
