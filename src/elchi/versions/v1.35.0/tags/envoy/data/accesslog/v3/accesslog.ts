...
export const ResponseFlags: OutType = { "ResponseFlags": [
  ...
  },
  {
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "Indicates there was an upstream request timeout.",
    "notImp": false
  },
  {
    "name": "local_reset",
  ...
  },
  {
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "Indicates that the request or connection exceeded the downstream connection duration.",
    "notImp": false
  },
  {
...
export const AccessLogCommon: OutType = { "AccessLogCommon": [
  ...
  },
  {
    ...
    "fieldType": "Address",
    "enums": null,
    "comment": "This field is the remote/origin address on which the request from the user was received.\n\n:::note\nThis may not be the actual peer address. For example, it might be derived from headers like ``x-forwarded-for``, the proxy protocol, or similar sources.",
    "notImp": false
  },
  {
  ...
  },
  {
    ...
    "enums": null,
    "comment": "If the connection is secure, this field will contain TLS properties.",
    "notImp": false
  },
  {
    "name": "start_time",
  ...
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "If upstream connection failed due to transport socket (e.g. TLS handshake), provides the failure reason from the transport socket. The format of this field depends on the configured upstream transport socket. Common TLS failures are in `TLS troubleshooting`.",
    "notImp": false
  },
  {
    "name": "route_name",
  ...
  },
  {
    ...
    "enums": null,
    "comment": "A list of custom tags, which annotate logs with additional information. To configure this value, see the documentation for `custom_tags`.",
    "notImp": false
  },
  {
    "name": "duration",
  ...
  },
  {
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "Indicates whether this log entry is the final entry (flushed after the stream completed) or an intermediate entry (flushed periodically during the stream).\n\nFor long-lived streams (e.g., TCP connections or long-lived HTTP/2 streams), there may be multiple intermediate entries and only one final entry.\n\nIf needed, a unique identifier (see `stream_id`) can be used to correlate all intermediate and final log entries for the same stream.\n\n:::attention\n\nThis field is deprecated in favor of ``access_log_type``, which provides a clearer indication of the log entry type. \n:::",
    "notImp": false
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "If downstream connection in listener failed due to transport socket (e.g. TLS handshake), provides the failure reason from the transport socket. The format of this field depends on the configured downstream transport socket. Common TLS failures are in `TLS troubleshooting`.",
    "notImp": false
  },
  {
