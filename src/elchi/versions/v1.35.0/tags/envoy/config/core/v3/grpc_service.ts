...
export const GrpcService_GoogleGrpc: OutType = { "GrpcService_GoogleGrpc": [
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "The target URI when using the `Google C++ gRPC client <https://github.com/grpc/grpc>`_. SSL credentials will be supplied in `channel_credentials`.",
    "notImp": false
  },
  {
  ...
  },
  {
    ...
    "enums": null,
    "comment": "A set of call credentials that can be composed with `channel credentials <https://grpc.io/docs/guides/auth.html#credential-types>`_.",
    "notImp": false
  },
  {
    "name": "stat_prefix",
