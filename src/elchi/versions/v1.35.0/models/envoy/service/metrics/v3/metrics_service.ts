...
export const protobufPackage = "envoy.service.metrics.v3";

export interface StreamMetricsResponse {
  $type: "envoy.service.metrics.v3.StreamMetricsResponse";
}

export interface StreamMetricsMessage {
  $type: "envoy.service.metrics.v3.StreamMetricsMessage";
  /**
...
export interface StreamMetricsMessage_Identifier {
  $type: "envoy.service.metrics.v3.StreamMetricsMessage.Identifier";
  /** The node sending metrics over the stream. */
  node?: Node | undefined;
}

function createBaseStreamMetricsResponse(): StreamMetricsResponse {
  return { $type: "envoy.service.metrics.v3.StreamMetricsResponse" };
}
...
> = {
  $type: "envoy.service.metrics.v3.StreamMetricsResponse" as const,
...
function createBaseStreamMetricsMessage(): StreamMetricsMessage {
  return { $type: "envoy.service.metrics.v3.StreamMetricsMessage" };
}

export const StreamMetricsMessage: MessageFns<StreamMetricsMessage, "envoy.service.metrics.v3.StreamMetricsMessage"> = {
  $type: "envoy.service.metrics.v3.StreamMetricsMessage" as const,
...
function createBaseStreamMetricsMessage_Identifier(): StreamMetricsMessage_Identifier {
  return { $type: "envoy.service.metrics.v3.StreamMetricsMessage.Identifier" };
}
...
> = {
  $type: "envoy.service.metrics.v3.StreamMetricsMessage.Identifier" as const,
...
export const MetricsServiceServiceName = "envoy.service.metrics.v3.MetricsService";
