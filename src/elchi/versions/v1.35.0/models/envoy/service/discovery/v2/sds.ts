...
export interface SdsDummy {
  $type: "envoy.service.discovery.v2.SdsDummy";
}

function createBaseSdsDummy(): SdsDummy {
  return { $type: "envoy.service.discovery.v2.SdsDummy" };
}

export const SdsDummy: MessageFns<SdsDummy, "envoy.service.discovery.v2.SdsDummy"> = {
  $type: "envoy.service.discovery.v2.SdsDummy" as const,
...
export const SecretDiscoveryServiceServiceName = "envoy.service.discovery.v2.SecretDiscoveryService";
