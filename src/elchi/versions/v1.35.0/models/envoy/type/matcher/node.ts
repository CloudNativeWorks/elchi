...
function createBaseNodeMatcher(): NodeMatcher {
  return { $type: "envoy.type.matcher.NodeMatcher" };
}

export const NodeMatcher: MessageFns<NodeMatcher, "envoy.type.matcher.NodeMatcher"> = {
  $type: "envoy.type.matcher.NodeMatcher" as const,
