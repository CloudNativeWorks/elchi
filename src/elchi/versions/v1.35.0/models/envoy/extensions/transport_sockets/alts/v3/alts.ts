...
export const protobufPackage = "envoy.extensions.transport_sockets.alts.v3";
...
export interface Alts {
  $type: "envoy.extensions.transport_sockets.alts.v3.Alts";
  /**
...
function createBaseAlts(): Alts {
  return { $type: "envoy.extensions.transport_sockets.alts.v3.Alts" };
}

export const Alts: MessageFns<Alts, "envoy.extensions.transport_sockets.alts.v3.Alts"> = {
  $type: "envoy.extensions.transport_sockets.alts.v3.Alts" as const,
