...
export interface LuaPerRoute {
   ...
   *   end
   */
  filter_context?: { [key: string]: any } | undefined;
}
...
export const LuaPerRoute: MessageFns<LuaPerRoute, "envoy.extensions.filters.http.lua.v3.LuaPerRoute"> = {
  ...
  encode(message: LuaPerRoute, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.filter_context !== undefined) {
      Struct.encode(Struct.wrap(message.filter_context), writer.uint32(34).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.filter_context = Struct.unwrap(Struct.decode(reader, reader.uint32()));
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): LuaPerRoute {
    return {
      ...
      override: isSet(object.disabled)
        ...
        : undefined,
      filter_context: isObject(object.filter_context) ? object.filter_context : undefined,
    };
  },
  ...
  toJSON(message: LuaPerRoute): unknown {
    ...
    if (message.filter_context !== undefined) {
      obj.filter_context = message.filter_context;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<LuaPerRoute>, I>>(object: I): LuaPerRoute {
    ...
    message.filter_context = object.filter_context ?? undefined;
    return message;
  },
};
