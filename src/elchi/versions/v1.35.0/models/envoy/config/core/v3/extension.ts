...
function createBaseTypedExtensionConfig(): TypedExtensionConfig {
  return { $type: "envoy.config.core.v3.TypedExtensionConfig" };
}

export const TypedExtensionConfig: MessageFns<TypedExtensionConfig, "envoy.config.core.v3.TypedExtensionConfig"> = {
  $type: "envoy.config.core.v3.TypedExtensionConfig" as const,
