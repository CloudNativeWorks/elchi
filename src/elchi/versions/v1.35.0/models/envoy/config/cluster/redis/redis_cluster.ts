...
export const protobufPackage = "envoy.config.cluster.redis";

/** [#next-free-field: 7] */
export interface RedisClusterConfig {
  $type: "envoy.config.cluster.redis.RedisClusterConfig";
...
function createBaseRedisClusterConfig(): RedisClusterConfig {
  return { $type: "envoy.config.cluster.redis.RedisClusterConfig" };
}

export const RedisClusterConfig: MessageFns<RedisClusterConfig, "envoy.config.cluster.redis.RedisClusterConfig"> = {
  $type: "envoy.config.cluster.redis.RedisClusterConfig" as const,
