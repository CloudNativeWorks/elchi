...
export interface Memory {
  $type: "envoy.admin.v2alpha.Memory";
  /**
...
function createBaseMemory(): Memory {
  return { $type: "envoy.admin.v2alpha.Memory" };
}

export const Memory: MessageFns<Memory, "envoy.admin.v2alpha.Memory"> = {
  $type: "envoy.admin.v2alpha.Memory" as const,
