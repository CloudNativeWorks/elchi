...
export interface ListenerStatus {
   ...
   * configuration.
   */
  additional_local_addresses?: Address[] | undefined;
}

function createBaseListeners(): Listeners {
  return { $type: "envoy.admin.v3.Listeners" };
}

export const Listeners: MessageFns<Listeners, "envoy.admin.v3.Listeners"> = {
  $type: "envoy.admin.v3.Listeners" as const,
...
function createBaseListenerStatus(): ListenerStatus {
  return { $type: "envoy.admin.v3.ListenerStatus" };
}

export const ListenerStatus: MessageFns<ListenerStatus, "envoy.admin.v3.ListenerStatus"> = {
  $type: "envoy.admin.v3.ListenerStatus" as const,
  ...
  encode(message: ListenerStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.additional_local_addresses !== undefined && message.additional_local_addresses.length !== 0) {
      for (const v of message.additional_local_addresses) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          if (message.additional_local_addresses === undefined) {
            message.additional_local_addresses = [];
          }
          const el = Address.decode(reader, reader.uint32());
          if (el !== undefined) {
            message.additional_local_addresses!.push(el);
          }
          continue;
        }
      }
  ...
  fromJSON(object: any): ListenerStatus {
    return {
      ...
      additional_local_addresses: globalThis.Array.isArray(object?.additional_local_addresses)
        ? object.additional_local_addresses.map((e: any) => Address.fromJSON(e))
        : undefined,
    };
  },
  ...
  toJSON(message: ListenerStatus): unknown {
    ...
    if (message.additional_local_addresses?.length) {
      obj.additional_local_addresses = message.additional_local_addresses.map((e) => Address.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ListenerStatus>, I>>(object: I): ListenerStatus {
    ...
    message.local_address = (object.local_address !== undefined && object.local_address !== null)
      ...
      : undefined;
    message.additional_local_addresses = object.additional_local_addresses?.map((e) => Address.fromPartial(e)) ||
      undefined;
    return message;
  },
};
