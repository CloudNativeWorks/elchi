...
function createBaseHttpUri(): HttpUri {
  return { $type: "envoy.api.v2.core.HttpUri", http_upstream_type: undefined };
}

export const HttpUri: MessageFns<HttpUri, "envoy.api.v2.core.HttpUri"> = {
  $type: "envoy.api.v2.core.HttpUri" as const,
