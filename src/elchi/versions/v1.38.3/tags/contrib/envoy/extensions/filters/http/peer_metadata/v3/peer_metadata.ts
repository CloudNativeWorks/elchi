...
export const Config_UpstreamFilterState: OutType = { "Config_UpstreamFilterState": [
  {
    "name": "peer_metadata_key",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "string",
    "enums": null,
    "comment": "Upstream filter state key that will be used to store peer metadata.",
    "notImp": false
  }
] };

export const Config_UpstreamFilterState_SingleFields = [
  "peer_metadata_key"
];
...
export const Config_DiscoveryMethod: OutType = { "Config_DiscoveryMethod": [
  ...
  {
    "name": "method_specifier.upstream_filter_state",
    "isUnion": true,
    "isDeprecated": false,
    "fieldType": "Config_UpstreamFilterState",
    "enums": null,
    "comment": "An exhaustive list of the derivation methods.",
    "notImp": false
  }
