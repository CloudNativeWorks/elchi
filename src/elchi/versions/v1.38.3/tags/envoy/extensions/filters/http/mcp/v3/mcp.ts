...
export const Mcp: OutType = { "Mcp": [
  ...
  {
    "name": "request_storage_mode",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "Mcp_RequestStorageMode",
    "enums": [
      "MODE_UNSPECIFIED",
      "DYNAMIC_METADATA",
      "FILTER_STATE",
    ...
    "comment": "Where to store parsed MCP request attributes. Controls whether attributes are written to dynamic metadata, filter state, or both. Default is DYNAMIC_METADATA when unspecified.",
    "notImp": false
  },
  {
    ...
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "Mcp_TraceContextPropagationConfig",
    "enums": null,
    "comment": "If set, extract and validate W3C trace context from the MCP request body (params._meta.traceparent & params._meta.tracestate) and propagate it in HTTP headers ``traceparent`` and ``tracestate`` (respectively).\n\nThe traceparent and tracestate fields are validated and propagated according to the spec at ``https://www.w3.org/TR/trace-context/``.\n\nIf unset (default), do not extract or inject trace context.",
    "notImp": false
  },
  {
    "name": "propagate_baggage",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "Mcp_BaggagePropagationConfig",
    "enums": null,
    "comment": "Note that this is independent of ``propagate_trace_context``. Also note that if this is set, the downstream request's baggage header will be overwritten if the MCP request body contains a valid baggage field.\n\nIf unset (default), do not extract or inject baggage.",
    "notImp": false
  }
] };
