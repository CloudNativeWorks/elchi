...
export const UdpProxyConfig: OutType = { "UdpProxyConfig": [
  ...
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "Configuration for the UDP proxy filter. [#next-free-field: 14]",
    "notImp": false
  },
  {
...
export const UdpProxyConfig_HashPolicy: OutType = { "UdpProxyConfig_HashPolicy": [
  {
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "Specifies the UDP hash policy. The packets can be routed by hash policy.",
    "notImp": false
  },
  {
...
export const UdpProxyConfig_SessionFilter: OutType = { "UdpProxyConfig_SessionFilter": [
  ...
  },
  {
    ...
    "fieldType": "Any",
    "enums": null,
    "comment": "Configuration for UDP session filters.",
    "notImp": false
  },
  {
