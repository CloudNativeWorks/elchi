...
export const JwtCacheConfig: OutType = { "JwtCacheConfig": [
  {
    ...
    "fieldType": "number",
    "enums": null,
    "comment": "The unit is number of JWTs, default to 100.",
    "notImp": false
  },
  {
    "name": "jwt_max_token_size",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "number",
    "enums": null,
    "comment": "The maximum size of a single cached token in bytes. If this field is not set or is set to 0, then the default value 4096 bytes is used. The maximum value for a token is inclusive.",
    "notImp": false
  }
] };
...
export const JwtProvider: OutType = { "JwtProvider": [
  ...
  },
  {
    ...
    "enums": null,
    "comment": "Enables JWT cache, its size is specified by ``jwt_cache_size``. Only valid JWTs are cached.",
    "notImp": false
  },
  {
  ...
  },
  {
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "Clears route cache in order to allow the JWT to correctly affect routing decisions. Filter clears all cached routes when:\n\n1. The field is set to ``true``.\n\n2. At least one ``claim_to_headers`` header is added to the request OR if ``payload_in_metadata`` is set.",
    "notImp": false
  }
] };
...
export const JwtRequirement: OutType = { "JwtRequirement": [
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "This message specifies a Jwt requirement. An empty message means JWT verification is not required. Here are some config examples:\n\n```yaml\n\n # Example 1: not required with an empty message\n```\n\n # Example 2: require A provider_name: provider-A\n\n # Example 3: require A or B requires_any: requirements: - provider_name: provider-A - provider_name: provider-B\n\n # Example 4: require A and B requires_all: requirements: - provider_name: provider-A - provider_name: provider-B\n\n # Example 5: require A and (B or C) requires_all: requirements: - provider_name: provider-A - requires_any: requirements: - provider_name: provider-B - provider_name: provider-C\n\n # Example 6: require A or (B and C) requires_any: requirements: - provider_name: provider-A - requires_all: requirements: - provider_name: provider-B - provider_name: provider-C\n\n # Example 7: A is optional (if token from A is provided, it must be valid, but also allows missing token.) requires_any: requirements: - provider_name: provider-A - allow_missing: {}\n\n # Example 8: A is optional and B is required. requires_all: requirements: - requires_any: requirements: - provider_name: provider-A - allow_missing: {} - provider_name: provider-B\n\n[#next-free-field: 8]",
    "notImp": false
  },
  {
  ...
  {
    "name": "requires_type.extract_only_without_validation",
    "isUnion": true,
    "isDeprecated": false,
    "fieldType": "ExtractOnlyWithoutValidation",
    "enums": null,
    "comment": "This message specifies a Jwt requirement. An empty message means JWT verification is not required. Here are some config examples:\n\n```yaml\n\n # Example 1: not required with an empty message\n```\n\n # Example 2: require A provider_name: provider-A\n\n # Example 3: require A or B requires_any: requirements: - provider_name: provider-A - provider_name: provider-B\n\n # Example 4: require A and B requires_all: requirements: - provider_name: provider-A - provider_name: provider-B\n\n # Example 5: require A and (B or C) requires_all: requirements: - provider_name: provider-A - requires_any: requirements: - provider_name: provider-B - provider_name: provider-C\n\n # Example 6: require A or (B and C) requires_any: requirements: - provider_name: provider-A - requires_all: requirements: - provider_name: provider-B - provider_name: provider-C\n\n # Example 7: A is optional (if token from A is provided, it must be valid, but also allows missing token.) requires_any: requirements: - provider_name: provider-A - allow_missing: {}\n\n # Example 8: A is optional and B is required. requires_all: requirements: - requires_any: requirements: - provider_name: provider-A - allow_missing: {} - provider_name: provider-B\n\n[#next-free-field: 8]",
    "notImp": false
  }
...
export const PerRouteConfig: OutType = { "PerRouteConfig": [
  {
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "Specify per-route config.",
    "notImp": false
  },
  {
