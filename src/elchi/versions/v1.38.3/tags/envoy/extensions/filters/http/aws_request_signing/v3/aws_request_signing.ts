...
export const AwsRequestSigning: OutType = { "AwsRequestSigning": [
  ...
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "Indicates that before signing headers, the host header will be swapped with this value. If not set or empty, the original host header value will be used and no rewrite will happen.\n\n:::note\nThis rewrite affects both signing and host header forwarding. However, this option shouldn't be used with `HCM host rewrite` given that the value set here would be used for signing whereas the value set in the HCM would be used for host header forwarding which is not the desired outcome.",
    "notImp": false
  },
  {
