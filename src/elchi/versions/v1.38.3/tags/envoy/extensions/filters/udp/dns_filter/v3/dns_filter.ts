...
export const DnsFilterConfig_ServerContextConfig: OutType = { "DnsFilterConfig_ServerContextConfig": [
  {
    ...
    "fieldType": "DnsTable",
    "enums": null,
    "comment": "This message contains the configuration for the DNS Filter operating in a server context. This message will contain the virtual hosts and associated addresses with which Envoy will respond to queries",
    "notImp": false
  },
  {
