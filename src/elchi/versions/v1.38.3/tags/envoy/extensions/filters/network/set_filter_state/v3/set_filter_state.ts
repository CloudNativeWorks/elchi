...
export const Config: OutType = { "Config": [
  ...
  {
    "name": "on_downstream_data",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "FilterStateValue[]",
    "enums": null,
    "comment": "A sequence of the filter state values to apply in the specified order when data is first received from the downstream connection.",
    "notImp": false
  }
] };