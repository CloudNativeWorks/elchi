...
export const FilterConfig: OutType = { "FilterConfig": [
  ...
  },
  {
    ...
    "fieldType": "number",
    "enums": null,
    "comment": "Configuration for the SNI-based dynamic forward proxy filter. See the `architecture overview` for more information. Note this filter must be configured along with `TLS inspector listener filter` to work. [#extension: envoy.filters.network.sni_dynamic_forward_proxy]",
    "notImp": false
  },
  {
