...
export const OAuth2: OutType = { "OAuth2": [
  ...
  },
  {
    ...
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "OAuth2_EndpointParameter[]",
    "enums": null,
    "comment": "Optional list of additional parameters to send to the token endpoint. These parameters will be URL-encoded and included in the token request body.",
    "notImp": false
  }
] };
...
export const OAuth2_EndpointParameter: OutType = { "OAuth2_EndpointParameter": [
  {
    "name": "name",
    "isUnion": false,
    "isDeprecated": false,
...
export const OAuth2_EndpointParameter_SingleFields = [
  "name",
  "value"
];