...
export const OverrideHost: OutType = { "OverrideHost": [
  ...
  {
    "name": "selected_host_key",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "MetadataKey",
    "enums": null,
    "comment": "The metadata key to populate with the selected host address. This is optional and may be used to inform downstream filters of the host address selected by load balancing policy.",
    "notImp": false
  },
  {
