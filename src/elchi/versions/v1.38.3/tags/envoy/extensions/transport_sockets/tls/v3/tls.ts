...
export const CommonTlsContext: OutType = { "CommonTlsContext": [
  ...
  },
  {
    ...
    "fieldType": "TypedExtensionConfig",
    "enums": null,
    "comment": "Custom TLS certificate selector.\n\nFor the downstream TLS socket, select a TLS certificate based on TLS client hello. If empty, defaults to native TLS certificate selection behavior: DNS SANs or Subject Common Name in TLS certificates is extracted as server name pattern to match SNI.\n\nFor the upstream TLS socket, select a TLS certificate based on TLS server hello and the transport socket options. extension-category: envoy.tls.certificate_selectors,envoy.tls.upstream_certificate_selectors",
    "notImp": false
  },
  {
  ...
  },
  {
    ...
    "enums": null,
    "comment": "TLS context shared by both client and server TLS contexts. [#next-free-field: 17]",
    "notImp": false
  },
  {
