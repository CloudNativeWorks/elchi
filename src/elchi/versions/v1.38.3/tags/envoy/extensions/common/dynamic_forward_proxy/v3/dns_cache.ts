...
export const DnsCacheConfig: OutType = { "DnsCacheConfig": [
  ...
  {
    "name": "disable_dns_refresh_on_failure",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "boolean",
    "enums": null,
    "comment": "Disable the DNS refresh on failure. If this field is set to true, it will ignore the `typed_dns_resolver_config`. If not specified, it defaults to false. By enabling this feature, the failed hosts will now be treated as a cache miss, allowing the failed hosts to be resolved on demand.",
    "notImp": false
  },
  {
