...
export const ClusterConfig: OutType = { "ClusterConfig": [
  {
    ...
    "enums": null,
    "comment": "Configuration for the dynamic forward proxy cluster. See the `architecture overview` for more information. [#extension: envoy.clusters.dynamic_forward_proxy]",
    "notImp": false
  },
  {
