...
export const SocketEvent: OutType = { "SocketEvent": [
  ...
  },
  {
    ...
    "enums": null,
    "comment": "Event in a socket trace. [#next-free-field: 7]",
    "notImp": false
  },
  {
  ...
  },
  {
    ...
    "fieldType": "number",
    "enums": null,
    "comment": "Data sequence number",
    "notImp": false
  }
] };

export const SocketEvent_SingleFields = [
  "seq_num"
];
...
export const SocketStreamedTraceSegment: OutType = { "SocketStreamedTraceSegment": [
  ...
  },
  {
    ...
    "fieldType": "Connection",
    "enums": null,
    "comment": "A streamed socket trace segment. Multiple segments make up a full trace.",
    "notImp": false
  },
  {
