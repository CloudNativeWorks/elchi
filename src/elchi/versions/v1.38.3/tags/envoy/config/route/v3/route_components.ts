...
export const Route: OutType = { "Route": [
  ...
  },
  {
    ...
    "enums": null,
    "comment": "A route is both a specification of how to match a request as well as an indication of what to do next (e.g., redirect, forward, rewrite, etc.).\n\n:::attention\n\nEnvoy supports routing on HTTP method via `header matching`. [#next-free-field: 21]",
    "notImp": false
  },
  {
...
export const WeightedCluster: OutType = { "WeightedCluster": [
  ...
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "Compared to the `cluster` field that specifies a single upstream cluster as the target of a request, the `weighted_clusters` option allows for specification of multiple upstream clusters along with weights that indicate the percentage of traffic to be forwarded to each cluster. The router selects an upstream cluster based on the weights. [#next-free-field: 6]",
    "notImp": false
  },
  {
...
export const RouteAction_HashPolicy: OutType = { "RouteAction_HashPolicy": [
  {
    ...
    "enums": null,
    "comment": "Specifies the route's hashing policy if the upstream cluster uses a hashing `load balancer`. [#next-free-field: 7]",
    "notImp": false
  },
  {
...
export const QueryParameterMatcher: OutType = { "QueryParameterMatcher": [
  ...
  },
  {
    ...
    "fieldType": "StringMatcher",
    "enums": null,
    "comment": "Query parameter matching treats the query string of a request's `:path` header as an ampersand-separated list of keys and/or key=value elements. [#next-free-field: 7]",
    "notImp": false
  },
  {
