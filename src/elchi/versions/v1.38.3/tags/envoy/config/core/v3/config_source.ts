...
export const ConfigSource: OutType = { "ConfigSource": [
  ...
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "Configuration for `listeners`, `clusters`, `routes`, `endpoints` etc. may either be sourced from the filesystem or from an xDS API source. Filesystem configs are watched with inotify for updates. [#next-free-field: 9]",
    "notImp": false
  },
  {
...
export const ExtensionConfigSource: OutType = { "ExtensionConfigSource": [
  ...
  },
  {
    ...
    "fieldType": "string[]",
    "enums": null,
    "comment": "A set of permitted extension type URLs for the type encoded inside of the `TypedExtensionConfig`. Extension configuration updates are rejected if they do not match any type URL in the set.",
    "notImp": false
  }
] };
