...
export const EnvoyInternalAddress: OutType = { "EnvoyInternalAddress": [
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "The address represents an envoy internal listener.",
    "notImp": false
  },
  {
    "name": "endpoint_id",
...
export const TcpKeepalive: OutType = { "TcpKeepalive": [
  {
    ...
    "fieldType": "number",
    "enums": null,
    "comment": "Maximum number of keepalive probes to send without response before deciding the connection is dead. Default is to use the OS level configuration (unless overridden, Linux defaults to 9.) Setting this to ``0`` disables TCP keepalive.",
    "notImp": false
  },
  {
    "name": "keepalive_time",
    ...
    "fieldType": "number",
    "enums": null,
    "comment": "The number of seconds a connection needs to be idle before keep-alive probes start being sent. Default is to use the OS level configuration (unless overridden, Linux defaults to 7200s (i.e., 2 hours.) Setting this to ``0`` disables TCP keepalive.",
    "notImp": false
  },
  {
    ...
    "fieldType": "number",
    "enums": null,
    "comment": "The number of seconds between keep-alive probes. Default is to use the OS level configuration (unless overridden, Linux defaults to 75s.) Setting this to ``0`` disables TCP keepalive.",
    "notImp": false
  }
] };
