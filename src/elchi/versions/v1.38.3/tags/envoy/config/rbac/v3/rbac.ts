...
export const Permission: OutType = { "Permission": [
  {
    ...
    "enums": null,
    "comment": "Permission defines an action (or actions) that a principal can take. [#next-free-field: 15]",
    "notImp": false
  },
  {
    "name": "rule.or_rules",
...
export const Principal: OutType = { "Principal": [
  {
    ...
    "enums": null,
    "comment": "Principal defines an identity or a group of identities for a downstream subject. [#next-free-field: 15]",
    "notImp": false
  },
  {
