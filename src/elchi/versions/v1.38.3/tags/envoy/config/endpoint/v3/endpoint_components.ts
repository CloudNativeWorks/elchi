...
export const LbEndpoint: OutType = { "LbEndpoint": [
  {
    ...
    "fieldType": "Endpoint",
    "enums": null,
    "comment": "An Endpoint that Envoy can route traffic to. [#next-free-field: 6]",
    "notImp": false
  },
  {
...
export const LbEndpointCollection: OutType = { "LbEndpointCollection": [
  {
    "name": "entries",
    "isUnion": false,
    "isDeprecated": false,
...
export const LedsClusterLocalityConfig: OutType = { "LedsClusterLocalityConfig": [
  ...
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "The name of the LbEndpoint collection resource.\n\nIf the name ends in ``/*``, it indicates an LbEndpoint glob collection, which is supported only in the xDS incremental protocol variants. Otherwise, it indicates an LbEndpointCollection list collection.\n\nEnvoy currently supports only glob collections.",
    "notImp": false
  }
] };
...
export const LocalityLbEndpoints: OutType = { "LocalityLbEndpoints": [
  ...
  },
  {
    ...
    "enums": null,
    "comment": "The group of endpoints belonging to the locality specified. This is ignored if `leds_cluster_locality_config` is set.",
    "notImp": false
  },
  {
    ...
    "enums": null,
    "comment": "A group of endpoints belonging to a Locality. One can have multiple LocalityLbEndpoints for a locality, but only if they have different priorities. [#next-free-field: 10]",
    "notImp": false
  },
  {
