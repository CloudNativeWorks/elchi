...
export const ZipkinConfig: OutType = { "ZipkinConfig": [
  ...
  {
    "name": "timestamp_trace_ids",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "boolean",
    "enums": null,
    "comment": "Determines whether trace IDs will include a timestamp in the first 4 bytes. When enabled, trace IDs are generated with the format: [32-bit epoch seconds][32-bit random]. The default value is false, which results in fully random trace IDs. For 128-bit trace IDs, the timestamp is encoded in the high 32 bits of the high 64-bit word.",
    "notImp": false
  }
] };
