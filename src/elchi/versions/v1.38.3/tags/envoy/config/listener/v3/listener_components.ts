...
export const FilterChain: OutType = { "FilterChain": [
  ...
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "The unique name (or empty) by which this filter chain is known.\n\n:::note\n`filter_chain_matcher` requires that filter chains are uniquely named within a listener.",
    "notImp": false
  }
] };
...
export const ListenerFilterChainMatchPredicate: OutType = { "ListenerFilterChainMatchPredicate": [
  {
    ...
    "enums": null,
    "comment": "Listener filter chain match configuration. This is a recursive structure which allows complex nested match configurations to be built using various logical operators.\n\nExamples:\n\n* Matches if the destination port is 3306.\n\n```yaml\n\n destination_port_range:\n  start: 3306\n  end: 3307\n```\n\n* Matches if the destination port is 3306 or 15000.\n\n```yaml\n\n or_match:\n   rules:\n     - destination_port_range:\n         start: 3306\n         end: 3307\n     - destination_port_range:\n         start: 15000\n         end: 15001\n```\n\n[#next-free-field: 6]",
    "notImp": false
  },
  {
    "name": "rule.and_match",
