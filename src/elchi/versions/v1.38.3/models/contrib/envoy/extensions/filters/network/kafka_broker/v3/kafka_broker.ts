...
export const protobufPackage = "envoy.extensions.filters.network.kafka_broker.v3";
...
export interface KafkaBroker {
  $type: "envoy.extensions.filters.network.kafka_broker.v3.KafkaBroker";
   ...
   * Disabled by default.
   */
  force_response_rewrite?: boolean | undefined;
   ...
   */
  api_keys_denied?: number[] | undefined;
}

/** Collection of rules matching by broker ID. */
export interface IdBasedBrokerRewriteSpec {
  $type: "envoy.extensions.filters.network.kafka_broker.v3.IdBasedBrokerRewriteSpec";
...
export interface IdBasedBrokerRewriteRule {
  $type: "envoy.extensions.filters.network.kafka_broker.v3.IdBasedBrokerRewriteRule";
  /** Broker ID to match. */
  id?:
    | number
    | undefined;
...
export const KafkaBroker: MessageFns<KafkaBroker, "envoy.extensions.filters.network.kafka_broker.v3.KafkaBroker"> = {
  $type: "envoy.extensions.filters.network.kafka_broker.v3.KafkaBroker" as const,
  ...
  encode(message: KafkaBroker, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.api_keys_allowed !== undefined && message.api_keys_allowed.length !== 0) {
      writer.uint32(34).fork();
      for (const v of message.api_keys_allowed) {
        writer.uint32(v);
      }
      writer.join();
    }
    if (message.api_keys_denied !== undefined && message.api_keys_denied.length !== 0) {
      writer.uint32(42).fork();
      for (const v of message.api_keys_denied) {
        writer.uint32(v);
      }
      writer.join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): KafkaBroker {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          if (tag === 32) {
            if (message.api_keys_allowed === undefined) {
              message.api_keys_allowed = [];
            }
            message.api_keys_allowed!.push(reader.uint32());
        ...
        case 5: {
          if (tag === 40) {
            if (message.api_keys_denied === undefined) {
              message.api_keys_denied = [];
            }
            message.api_keys_denied!.push(reader.uint32());
  ...
  fromJSON(object: any): KafkaBroker {
    return {
      ...
      broker_address_rewrite_spec: isSet(object.id_based_broker_address_rewrite_spec)
        ...
        : undefined,
      api_keys_allowed: globalThis.Array.isArray(object?.api_keys_allowed)
        ? object.api_keys_allowed.map((e: any) => globalThis.Number(e))
        : undefined,
      api_keys_denied: globalThis.Array.isArray(object?.api_keys_denied)
        ? object.api_keys_denied.map((e: any) => globalThis.Number(e))
        : undefined,
    };
  },
  ...
  toJSON(message: KafkaBroker): unknown {
    ...
    if (message.api_keys_allowed?.length) {
      obj.api_keys_allowed = message.api_keys_allowed.map((e) => Math.round(e));
    }
    if (message.api_keys_denied?.length) {
      obj.api_keys_denied = message.api_keys_denied.map((e) => Math.round(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<KafkaBroker>, I>>(object: I): KafkaBroker {
    ...
    message.api_keys_allowed = object.api_keys_allowed?.map((e) => e) || undefined;
    message.api_keys_denied = object.api_keys_denied?.map((e) => e) || undefined;
    return message;
  },
};
...
function createBaseIdBasedBrokerRewriteSpec(): IdBasedBrokerRewriteSpec {
  return { $type: "envoy.extensions.filters.network.kafka_broker.v3.IdBasedBrokerRewriteSpec" };
}

export const IdBasedBrokerRewriteSpec: MessageFns<
  IdBasedBrokerRewriteSpec,
  "envoy.extensions.filters.network.kafka_broker.v3.IdBasedBrokerRewriteSpec"
> = {
  $type: "envoy.extensions.filters.network.kafka_broker.v3.IdBasedBrokerRewriteSpec" as const,
...
function createBaseIdBasedBrokerRewriteRule(): IdBasedBrokerRewriteRule {
  return { $type: "envoy.extensions.filters.network.kafka_broker.v3.IdBasedBrokerRewriteRule" };
}

export const IdBasedBrokerRewriteRule: MessageFns<
  IdBasedBrokerRewriteRule,
  "envoy.extensions.filters.network.kafka_broker.v3.IdBasedBrokerRewriteRule"
> = {
  $type: "envoy.extensions.filters.network.kafka_broker.v3.IdBasedBrokerRewriteRule" as const,
