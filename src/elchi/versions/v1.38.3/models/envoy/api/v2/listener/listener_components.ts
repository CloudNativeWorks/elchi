...
export interface Filter {
  $type: "envoy.api.v2.listener.Filter";
  /**
...
export function filterChainMatch_ConnectionSourceTypeFromJSON(object: any): FilterChainMatch_ConnectionSourceType {
  switch (object) {
    ...
    case 1:
    case "LOCAL":
      return FilterChainMatch_ConnectionSourceType.LOCAL;
    case 2:
    case "EXTERNAL":
...
export function filterChainMatch_ConnectionSourceTypeToJSON(object: FilterChainMatch_ConnectionSourceType): string {
  switch (object) {
    case FilterChainMatch_ConnectionSourceType.ANY:
      return "ANY";
    case FilterChainMatch_ConnectionSourceType.LOCAL:
      return "LOCAL";
...
function createBaseFilter(): Filter {
  return { $type: "envoy.api.v2.listener.Filter", config_type: undefined };
}

export const Filter: MessageFns<Filter, "envoy.api.v2.listener.Filter"> = {
  $type: "envoy.api.v2.listener.Filter" as const,
...
function createBaseFilterChainMatch(): FilterChainMatch {
  return { $type: "envoy.api.v2.listener.FilterChainMatch" };
}

export const FilterChainMatch: MessageFns<FilterChainMatch, "envoy.api.v2.listener.FilterChainMatch"> = {
  $type: "envoy.api.v2.listener.FilterChainMatch" as const,
...
function createBaseFilterChain(): FilterChain {
  return { $type: "envoy.api.v2.listener.FilterChain" };
}

export const FilterChain: MessageFns<FilterChain, "envoy.api.v2.listener.FilterChain"> = {
  $type: "envoy.api.v2.listener.FilterChain" as const,
  ...
  encode(message: FilterChain, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.tls_context !== undefined) {
      DownstreamTlsContext.encode(message.tls_context, writer.uint32(18).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.tls_context = DownstreamTlsContext.decode(reader, reader.uint32());
          continue;
        }
        case 3: {
          if (tag !== 26) {
  ...
  fromJSON(object: any): FilterChain {
    return {
      ...
      filter_chain_match: isSet(object.filter_chain_match)
        ...
        : undefined,
      tls_context: isSet(object.tls_context) ? DownstreamTlsContext.fromJSON(object.tls_context) : undefined,
  ...
  toJSON(message: FilterChain): unknown {
    ...
    if (message.tls_context !== undefined) {
      obj.tls_context = DownstreamTlsContext.toJSON(message.tls_context);
    }
  ...
  fromPartial<I extends Exact<DeepPartial<FilterChain>, I>>(object: I): FilterChain {
    ...
    message.tls_context = (object.tls_context !== undefined && object.tls_context !== null)
      ? DownstreamTlsContext.fromPartial(object.tls_context)
      : undefined;
...
function createBaseListenerFilterChainMatchPredicate(): ListenerFilterChainMatchPredicate {
  return { $type: "envoy.api.v2.listener.ListenerFilterChainMatchPredicate", rule: undefined };
}
...
> = {
  $type: "envoy.api.v2.listener.ListenerFilterChainMatchPredicate" as const,
...
function createBaseListenerFilterChainMatchPredicate_MatchSet(): ListenerFilterChainMatchPredicate_MatchSet {
  return { $type: "envoy.api.v2.listener.ListenerFilterChainMatchPredicate.MatchSet" };
}
...
> = {
  $type: "envoy.api.v2.listener.ListenerFilterChainMatchPredicate.MatchSet" as const,
...
function createBaseListenerFilter(): ListenerFilter {
  return { $type: "envoy.api.v2.listener.ListenerFilter", config_type: undefined };
}

export const ListenerFilter: MessageFns<ListenerFilter, "envoy.api.v2.listener.ListenerFilter"> = {
  $type: "envoy.api.v2.listener.ListenerFilter" as const,
