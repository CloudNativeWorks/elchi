...
export interface HealthCheck {
  ...
  tls_options?: HealthCheck_TlsOptions | undefined;
}

/** Describes the encoding of the payload bytes in the payload. */
export interface HealthCheck_Payload {
  $type: "envoy.api.v2.core.HealthCheck.Payload";
  payload?: { $case: "text"; text: string } | { $case: "binary"; binary: Uint8Array } | undefined;
}
...
export interface HealthCheck_HttpHealthCheck {
   ...
   * <arch_overview_health_checking_identity>` for more information.
   */
  service_name_matcher?: StringMatcher | undefined;
}
...
export interface HealthCheck_TcpHealthCheck {
   ...
   */
  receive?: HealthCheck_Payload[] | undefined;
}

export interface HealthCheck_RedisHealthCheck {
  $type: "envoy.api.v2.core.HealthCheck.RedisHealthCheck";
  /**
...
export interface HealthCheck_TlsOptions {
  $type: "envoy.api.v2.core.HealthCheck.TlsOptions";
  /**
...
function createBaseHealthCheck(): HealthCheck {
  return { $type: "envoy.api.v2.core.HealthCheck", health_checker: undefined };
}

export const HealthCheck: MessageFns<HealthCheck, "envoy.api.v2.core.HealthCheck"> = {
  $type: "envoy.api.v2.core.HealthCheck" as const,
...
function createBaseHealthCheck_Payload(): HealthCheck_Payload {
  return { $type: "envoy.api.v2.core.HealthCheck.Payload", payload: undefined };
}

export const HealthCheck_Payload: MessageFns<HealthCheck_Payload, "envoy.api.v2.core.HealthCheck.Payload"> = {
  $type: "envoy.api.v2.core.HealthCheck.Payload" as const,
...
function createBaseHealthCheck_HttpHealthCheck(): HealthCheck_HttpHealthCheck {
  return { $type: "envoy.api.v2.core.HealthCheck.HttpHealthCheck" };
}
...
> = {
  $type: "envoy.api.v2.core.HealthCheck.HttpHealthCheck" as const,
  ...
  encode(message: HealthCheck_HttpHealthCheck, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.receive !== undefined) {
      HealthCheck_Payload.encode(message.receive, writer.uint32(34).fork()).join();
    }
    ...
    if (message.use_http2 !== undefined && message.use_http2 !== false) {
      writer.uint32(56).bool(message.use_http2);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.receive = HealthCheck_Payload.decode(reader, reader.uint32());
          continue;
        }
        case 5: {
          if (tag !== 42) {
  ...
  fromJSON(object: any): HealthCheck_HttpHealthCheck {
    return {
      ...
      receive: isSet(object.receive) ? HealthCheck_Payload.fromJSON(object.receive) : undefined,
      ...
      request_headers_to_remove: globalThis.Array.isArray(object?.request_headers_to_remove)
        ...
        : undefined,
      use_http2: isSet(object.use_http2) ? globalThis.Boolean(object.use_http2) : undefined,
  ...
  toJSON(message: HealthCheck_HttpHealthCheck): unknown {
    ...
    if (message.receive !== undefined) {
      obj.receive = HealthCheck_Payload.toJSON(message.receive);
    }
    ...
    if (message.use_http2 !== undefined) {
      obj.use_http2 = message.use_http2;
    }
  ...
  fromPartial<I extends Exact<DeepPartial<HealthCheck_HttpHealthCheck>, I>>(object: I): HealthCheck_HttpHealthCheck {
    ...
    message.receive = (object.receive !== undefined && object.receive !== null)
      ? HealthCheck_Payload.fromPartial(object.receive)
      : undefined;
    ...
    message.use_http2 = object.use_http2 ?? undefined;
...
function createBaseHealthCheck_TcpHealthCheck(): HealthCheck_TcpHealthCheck {
  return { $type: "envoy.api.v2.core.HealthCheck.TcpHealthCheck" };
}
...
> = {
  $type: "envoy.api.v2.core.HealthCheck.TcpHealthCheck" as const,
...
function createBaseHealthCheck_RedisHealthCheck(): HealthCheck_RedisHealthCheck {
  return { $type: "envoy.api.v2.core.HealthCheck.RedisHealthCheck" };
}
...
> = {
  $type: "envoy.api.v2.core.HealthCheck.RedisHealthCheck" as const,
...
function createBaseHealthCheck_GrpcHealthCheck(): HealthCheck_GrpcHealthCheck {
  return { $type: "envoy.api.v2.core.HealthCheck.GrpcHealthCheck" };
}
...
> = {
  $type: "envoy.api.v2.core.HealthCheck.GrpcHealthCheck" as const,
...
function createBaseHealthCheck_CustomHealthCheck(): HealthCheck_CustomHealthCheck {
  return { $type: "envoy.api.v2.core.HealthCheck.CustomHealthCheck", config_type: undefined };
}
...
> = {
  $type: "envoy.api.v2.core.HealthCheck.CustomHealthCheck" as const,
...
function createBaseHealthCheck_TlsOptions(): HealthCheck_TlsOptions {
  return { $type: "envoy.api.v2.core.HealthCheck.TlsOptions" };
}

export const HealthCheck_TlsOptions: MessageFns<HealthCheck_TlsOptions, "envoy.api.v2.core.HealthCheck.TlsOptions"> = {
  $type: "envoy.api.v2.core.HealthCheck.TlsOptions" as const,
