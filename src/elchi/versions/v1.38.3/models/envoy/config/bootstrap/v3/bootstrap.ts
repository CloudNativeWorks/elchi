...
export interface Bootstrap {
  ...
  stats_flush?: { $case: "stats_flush_on_admin"; stats_flush_on_admin: boolean } | undefined;
  stats_eviction?:
    | { $case: "stats_eviction_interval"; stats_eviction_interval: Duration }
    | undefined;
  /**
...
export interface Bootstrap_ApplicationLogConfig_LogFormat {
  ...
  log_format?: { $case: "json_format"; json_format: { [key: string]: any } | undefined } | {
    $case: "text_format";
    text_format: string;
  } | undefined;
}
...
export interface Admin {
   ...
   *   - prefix: /healthcheck
   */
  allow_paths?: StringMatcher[] | undefined;
}
...
export interface MemoryAllocatorManager {
   ...
   */
  max_unfreed_memory_bytes?: number | undefined;
}

function createBaseBootstrap(): Bootstrap {
  return { $type: "envoy.config.bootstrap.v3.Bootstrap", stats_flush: undefined, stats_eviction: undefined };
}
...
export const Bootstrap: MessageFns<Bootstrap, "envoy.config.bootstrap.v3.Bootstrap"> = {
  ...
  encode(message: Bootstrap, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    switch (message.stats_eviction?.$case) {
      case "stats_eviction_interval":
        Duration.encode(message.stats_eviction.stats_eviction_interval, writer.uint32(338).fork()).join();
        break;
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 42: {
          ...
          message.stats_eviction = {
            $case: "stats_eviction_interval",
            stats_eviction_interval: Duration.decode(reader, reader.uint32()),
          };
          continue;
        }
        case 8: {
  ...
  fromJSON(object: any): Bootstrap {
    return {
      ...
      stats_flush: isSet(object.stats_flush_on_admin)
        ...
        : undefined,
      stats_eviction: isSet(object.stats_eviction_interval)
        ? {
          $case: "stats_eviction_interval",
          stats_eviction_interval: Duration.fromJSON(object.stats_eviction_interval),
        }
        : undefined,
  ...
  toJSON(message: Bootstrap): unknown {
    ...
    if (message.stats_eviction?.$case === "stats_eviction_interval") {
      obj.stats_eviction_interval = Duration.toJSON(message.stats_eviction.stats_eviction_interval);
    }
    if (message.watchdog !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<Bootstrap>, I>>(object: I): Bootstrap {
    ...
    if (
      object.stats_eviction?.$case === "stats_eviction_interval" &&
      object.stats_eviction?.stats_eviction_interval !== undefined &&
      object.stats_eviction?.stats_eviction_interval !== null
    ) {
      message.stats_eviction = {
        $case: "stats_eviction_interval",
        stats_eviction_interval: Duration.fromPartial(object.stats_eviction.stats_eviction_interval),
      };
    }
...
export const Admin: MessageFns<Admin, "envoy.config.bootstrap.v3.Admin"> = {
  ...
  encode(message: Admin, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.allow_paths !== undefined && message.allow_paths.length !== 0) {
      for (const v of message.allow_paths) {
        StringMatcher.encode(v!, writer.uint32(58).fork()).join();
      }
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          if (message.allow_paths === undefined) {
            message.allow_paths = [];
          }
          const el = StringMatcher.decode(reader, reader.uint32());
          if (el !== undefined) {
            message.allow_paths!.push(el);
          }
          continue;
        }
      }
  ...
  fromJSON(object: any): Admin {
    return {
      ...
      allow_paths: globalThis.Array.isArray(object?.allow_paths)
        ? object.allow_paths.map((e: any) => StringMatcher.fromJSON(e))
        : undefined,
    };
  },
  ...
  toJSON(message: Admin): unknown {
    ...
    if (message.allow_paths?.length) {
      obj.allow_paths = message.allow_paths.map((e) => StringMatcher.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Admin>, I>>(object: I): Admin {
    ...
    message.allow_paths = object.allow_paths?.map((e) => StringMatcher.fromPartial(e)) || undefined;
    return message;
  },
};
...
> = {
  ...
  encode(message: MemoryAllocatorManager, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.soft_memory_limit_bytes !== undefined) {
      UInt64Value.encode(
        { $type: "google.protobuf.UInt64Value", value: message.soft_memory_limit_bytes! },
        writer.uint32(26).fork(),
      ).join();
    }
    if (message.max_per_cpu_cache_size_bytes !== undefined) {
      UInt32Value.encode(
        { $type: "google.protobuf.UInt32Value", value: message.max_per_cpu_cache_size_bytes! },
        writer.uint32(34).fork(),
      ).join();
    }
    if (message.max_unfreed_memory_bytes !== undefined && message.max_unfreed_memory_bytes !== 0) {
      writer.uint32(40).uint64(message.max_unfreed_memory_bytes);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.soft_memory_limit_bytes = UInt64Value.decode(reader, reader.uint32()).value;
          continue;
        }
        case 4: {
          if (tag !== 34) {
          ...
          message.max_per_cpu_cache_size_bytes = UInt32Value.decode(reader, reader.uint32()).value;
          continue;
        }
        case 5: {
          if (tag !== 40) {
          ...
          message.max_unfreed_memory_bytes = longToNumber(reader.uint64());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): MemoryAllocatorManager {
    return {
      ...
      memory_release_interval: isSet(object.memory_release_interval)
        ...
        : undefined,
      soft_memory_limit_bytes: isSet(object.soft_memory_limit_bytes)
        ? Number(object.soft_memory_limit_bytes)
        : undefined,
      max_per_cpu_cache_size_bytes: isSet(object.max_per_cpu_cache_size_bytes)
        ? Number(object.max_per_cpu_cache_size_bytes)
        : undefined,
      max_unfreed_memory_bytes: isSet(object.max_unfreed_memory_bytes)
        ? globalThis.Number(object.max_unfreed_memory_bytes)
        : undefined,
    };
  },
  ...
  toJSON(message: MemoryAllocatorManager): unknown {
    ...
    if (message.soft_memory_limit_bytes !== undefined) {
      obj.soft_memory_limit_bytes = message.soft_memory_limit_bytes;
    }
    if (message.max_per_cpu_cache_size_bytes !== undefined) {
      obj.max_per_cpu_cache_size_bytes = message.max_per_cpu_cache_size_bytes;
    }
    if (message.max_unfreed_memory_bytes !== undefined) {
      obj.max_unfreed_memory_bytes = Math.round(message.max_unfreed_memory_bytes);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<MemoryAllocatorManager>, I>>(object: I): MemoryAllocatorManager {
    ...
    message.memory_release_interval =
      (object.memory_release_interval !== undefined && object.memory_release_interval !== null)
        ...
        : undefined;
    message.soft_memory_limit_bytes = object.soft_memory_limit_bytes ?? undefined;
    message.max_per_cpu_cache_size_bytes = object.max_per_cpu_cache_size_bytes ?? undefined;
    message.max_unfreed_memory_bytes = object.max_unfreed_memory_bytes ?? undefined;
    return message;
  },
};
