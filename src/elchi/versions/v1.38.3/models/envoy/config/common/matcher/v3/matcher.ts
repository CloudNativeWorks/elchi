...
export interface Matcher_OnMatch {
   ...
   */
  keep_matching?: boolean | undefined;
}
...
export interface Matcher_MatcherList_Predicate_SinglePredicate {
  ...
  matcher?: { $case: "value_match"; value_match: StringMatcher } | {
    $case: "custom_match";
    custom_match: TypedExtensionConfig;
  } | undefined;
}
...
export const Matcher_OnMatch: MessageFns<Matcher_OnMatch, "envoy.config.common.matcher.v3.Matcher.OnMatch"> = {
  ...
  encode(message: Matcher_OnMatch, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.keep_matching !== undefined && message.keep_matching !== false) {
      writer.uint32(24).bool(message.keep_matching);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.keep_matching = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Matcher_OnMatch {
    return {
      ...
      on_match: isSet(object.matcher)
        ...
        : undefined,
      keep_matching: isSet(object.keep_matching) ? globalThis.Boolean(object.keep_matching) : undefined,
    };
  },
  ...
  toJSON(message: Matcher_OnMatch): unknown {
    ...
    if (message.keep_matching !== undefined) {
      obj.keep_matching = message.keep_matching;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Matcher_OnMatch>, I>>(object: I): Matcher_OnMatch {
    ...
    message.keep_matching = object.keep_matching ?? undefined;
    return message;
  },
};
