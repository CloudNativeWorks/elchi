...
export const protobufPackage = "envoy.config.common.tap.v2alpha";

/** Common configuration for all tap extensions. */
export interface CommonExtensionConfig {
  $type: "envoy.config.common.tap.v2alpha.CommonExtensionConfig";
  config_type?: { $case: "admin_config"; admin_config: AdminConfig } | {
    $case: "static_config";
    static_config: TapConfig;
  } | undefined;
}
...
function createBaseCommonExtensionConfig(): CommonExtensionConfig {
  return { $type: "envoy.config.common.tap.v2alpha.CommonExtensionConfig", config_type: undefined };
}
...
> = {
  $type: "envoy.config.common.tap.v2alpha.CommonExtensionConfig" as const,
...
function createBaseAdminConfig(): AdminConfig {
  return { $type: "envoy.config.common.tap.v2alpha.AdminConfig" };
}

export const AdminConfig: MessageFns<AdminConfig, "envoy.config.common.tap.v2alpha.AdminConfig"> = {
  $type: "envoy.config.common.tap.v2alpha.AdminConfig" as const,
