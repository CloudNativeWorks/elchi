...
export interface Cluster {
  ...
  lb_subset_config?: Cluster_LbSubsetConfig | undefined;
  lb_config?:
...
export enum UpstreamConnectionOptions_FirstAddressFamilyVersion {
  /** DEFAULT - Use the first address family encountered in the address list. */
  DEFAULT = "DEFAULT",
  V4 = "V4",
  V6 = "V6",
  PIPE = "PIPE",
...
export function upstreamConnectionOptions_FirstAddressFamilyVersionFromJSON(
  ...
  switch (object) {
    ...
    case 3:
    case "PIPE":
      return UpstreamConnectionOptions_FirstAddressFamilyVersion.PIPE;
    case 4:
    case "INTERNAL":
      return UpstreamConnectionOptions_FirstAddressFamilyVersion.INTERNAL;
    default:
      throw new globalThis.Error(
...
export function upstreamConnectionOptions_FirstAddressFamilyVersionToJSON(
  ...
  switch (object) {
    ...
    case UpstreamConnectionOptions_FirstAddressFamilyVersion.V6:
      return "V6";
    case UpstreamConnectionOptions_FirstAddressFamilyVersion.PIPE:
      return "PIPE";
    case UpstreamConnectionOptions_FirstAddressFamilyVersion.INTERNAL:
      return "INTERNAL";
    default:
      throw new globalThis.Error(
        "Unrecognized enum value " + object + " for enum UpstreamConnectionOptions_FirstAddressFamilyVersion",
...
export const Cluster: MessageFns<Cluster, "envoy.config.cluster.v3.Cluster"> = {
  ...
  encode(message: Cluster, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.transport_socket_matcher !== undefined) {
      Matcher.encode(message.transport_socket_matcher, writer.uint32(474).fork()).join();
    }
    ...
    if (message.per_connection_buffer_high_watermark_timeout !== undefined) {
      Duration.encode(message.per_connection_buffer_high_watermark_timeout, writer.uint32(482).fork()).join();
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 59: {
          ...
          message.transport_socket_matcher = Matcher.decode(reader, reader.uint32());
          continue;
        }
        case 1: {
          if (tag !== 10) {
  ...
  fromJSON(object: any): Cluster {
    return {
      ...
      transport_socket_matches: globalThis.Array.isArray(object?.transport_socket_matches)
        ...
        : undefined,
      transport_socket_matcher: isSet(object.transport_socket_matcher)
        ? Matcher.fromJSON(object.transport_socket_matcher)
        : undefined,
  ...
  toJSON(message: Cluster): unknown {
    ...
    if (message.transport_socket_matcher !== undefined) {
      obj.transport_socket_matcher = Matcher.toJSON(message.transport_socket_matcher);
    }
  ...
  fromPartial<I extends Exact<DeepPartial<Cluster>, I>>(object: I): Cluster {
    ...
    message.transport_socket_matcher =
      (object.transport_socket_matcher !== undefined && object.transport_socket_matcher !== null)
        ? Matcher.fromPartial(object.transport_socket_matcher)
        : undefined;
