...
export interface ValueMatcher {
  ...
  match_pattern?:
    ...
    | { $case: "or_match"; or_match: OrMatcher }
    | undefined;
}
...
export interface ListMatcher {
  ...
  match_pattern?: { $case: "one_of"; one_of: ValueMatcher } | undefined;
}

/** Specifies a list of alternatives for the match. */
export interface OrMatcher {
  $type: "envoy.type.matcher.v3.OrMatcher";
  value_matchers?: ValueMatcher[] | undefined;
}

function createBaseValueMatcher(): ValueMatcher {
  return { $type: "envoy.type.matcher.v3.ValueMatcher", match_pattern: undefined };
}

export const ValueMatcher: MessageFns<ValueMatcher, "envoy.type.matcher.v3.ValueMatcher"> = {
  $type: "envoy.type.matcher.v3.ValueMatcher" as const,
  ...
  encode(message: ValueMatcher, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    switch (message.match_pattern?.$case) {
      ...
      case "list_match":
        ...
        break;
      case "or_match":
        OrMatcher.encode(message.match_pattern.or_match, writer.uint32(58).fork()).join();
        break;
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7: {
          ...
          message.match_pattern = { $case: "or_match", or_match: OrMatcher.decode(reader, reader.uint32()) };
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ValueMatcher {
    return {
      ...
      match_pattern: isSet(object.null_match)
        ...
        : isSet(object.or_match)
        ? { $case: "or_match", or_match: OrMatcher.fromJSON(object.or_match) }
        : undefined,
    };
  },
  ...
  toJSON(message: ValueMatcher): unknown {
    ...
    if (message.match_pattern?.$case === "or_match") {
      obj.or_match = OrMatcher.toJSON(message.match_pattern.or_match);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ValueMatcher>, I>>(object: I): ValueMatcher {
    ...
    if (
      object.match_pattern?.$case === "or_match" &&
      object.match_pattern?.or_match !== undefined &&
      object.match_pattern?.or_match !== null
    ) {
      message.match_pattern = { $case: "or_match", or_match: OrMatcher.fromPartial(object.match_pattern.or_match) };
    }
    return message;
  },
};
...
function createBaseValueMatcher_NullMatch(): ValueMatcher_NullMatch {
  return { $type: "envoy.type.matcher.v3.ValueMatcher.NullMatch" };
}

export const ValueMatcher_NullMatch: MessageFns<
  ValueMatcher_NullMatch,
  "envoy.type.matcher.v3.ValueMatcher.NullMatch"
> = {
  $type: "envoy.type.matcher.v3.ValueMatcher.NullMatch" as const,
...
function createBaseListMatcher(): ListMatcher {
  return { $type: "envoy.type.matcher.v3.ListMatcher", match_pattern: undefined };
}

export const ListMatcher: MessageFns<ListMatcher, "envoy.type.matcher.v3.ListMatcher"> = {
  $type: "envoy.type.matcher.v3.ListMatcher" as const,
...
function createBaseOrMatcher(): OrMatcher {
  return { $type: "envoy.type.matcher.v3.OrMatcher" };
}

export const OrMatcher: MessageFns<OrMatcher, "envoy.type.matcher.v3.OrMatcher"> = {
  $type: "envoy.type.matcher.v3.OrMatcher" as const,

  encode(message: OrMatcher, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.value_matchers !== undefined && message.value_matchers.length !== 0) {
      for (const v of message.value_matchers) {
        ValueMatcher.encode(v!, writer.uint32(10).fork()).join();
      }
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): OrMatcher {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseOrMatcher();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          if (message.value_matchers === undefined) {
            message.value_matchers = [];
          }
          const el = ValueMatcher.decode(reader, reader.uint32());
          if (el !== undefined) {
            message.value_matchers!.push(el);
          }
          continue;
        }
      }
  ...
  fromJSON(object: any): OrMatcher {
    return {
      $type: OrMatcher.$type,
      value_matchers: globalThis.Array.isArray(object?.value_matchers)
        ? object.value_matchers.map((e: any) => ValueMatcher.fromJSON(e))
        : undefined,
    };
  },

  toJSON(message: OrMatcher): unknown {
    const obj: any = {};
    if (message.value_matchers?.length) {
      obj.value_matchers = message.value_matchers.map((e) => ValueMatcher.toJSON(e));
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<OrMatcher>, I>>(base?: I): OrMatcher {
    return OrMatcher.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OrMatcher>, I>>(object: I): OrMatcher {
    const message = createBaseOrMatcher();
    message.value_matchers = object.value_matchers?.map((e) => ValueMatcher.fromPartial(e)) || undefined;
    return message;
  },
};

messageTypeRegistry.set(OrMatcher.$type, OrMatcher);
