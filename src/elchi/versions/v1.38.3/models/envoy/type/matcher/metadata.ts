...
function createBaseMetadataMatcher(): MetadataMatcher {
  return { $type: "envoy.type.matcher.MetadataMatcher" };
}

export const MetadataMatcher: MessageFns<MetadataMatcher, "envoy.type.matcher.MetadataMatcher"> = {
  $type: "envoy.type.matcher.MetadataMatcher" as const,
...
function createBaseMetadataMatcher_PathSegment(): MetadataMatcher_PathSegment {
  return { $type: "envoy.type.matcher.MetadataMatcher.PathSegment", segment: undefined };
}
...
> = {
  $type: "envoy.type.matcher.MetadataMatcher.PathSegment" as const,
