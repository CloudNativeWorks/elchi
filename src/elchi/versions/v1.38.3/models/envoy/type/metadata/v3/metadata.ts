...
export const protobufPackage = "envoy.type.metadata.v3";
...
function createBaseMetadataKey(): MetadataKey {
  return { $type: "envoy.type.metadata.v3.MetadataKey" };
}

export const MetadataKey: MessageFns<MetadataKey, "envoy.type.metadata.v3.MetadataKey"> = {
  $type: "envoy.type.metadata.v3.MetadataKey" as const,
...
function createBaseMetadataKey_PathSegment(): MetadataKey_PathSegment {
  return { $type: "envoy.type.metadata.v3.MetadataKey.PathSegment", segment: undefined };
}
...
> = {
  $type: "envoy.type.metadata.v3.MetadataKey.PathSegment" as const,
...
function createBaseMetadataKind(): MetadataKind {
  return { $type: "envoy.type.metadata.v3.MetadataKind", kind: undefined };
}

export const MetadataKind: MessageFns<MetadataKind, "envoy.type.metadata.v3.MetadataKind"> = {
  $type: "envoy.type.metadata.v3.MetadataKind" as const,
...
function createBaseMetadataKind_Request(): MetadataKind_Request {
  return { $type: "envoy.type.metadata.v3.MetadataKind.Request" };
}

export const MetadataKind_Request: MessageFns<MetadataKind_Request, "envoy.type.metadata.v3.MetadataKind.Request"> = {
  $type: "envoy.type.metadata.v3.MetadataKind.Request" as const,
...
function createBaseMetadataKind_Route(): MetadataKind_Route {
  return { $type: "envoy.type.metadata.v3.MetadataKind.Route" };
}

export const MetadataKind_Route: MessageFns<MetadataKind_Route, "envoy.type.metadata.v3.MetadataKind.Route"> = {
  $type: "envoy.type.metadata.v3.MetadataKind.Route" as const,
...
function createBaseMetadataKind_Cluster(): MetadataKind_Cluster {
  return { $type: "envoy.type.metadata.v3.MetadataKind.Cluster" };
}

export const MetadataKind_Cluster: MessageFns<MetadataKind_Cluster, "envoy.type.metadata.v3.MetadataKind.Cluster"> = {
  $type: "envoy.type.metadata.v3.MetadataKind.Cluster" as const,
...
function createBaseMetadataKind_Host(): MetadataKind_Host {
  return { $type: "envoy.type.metadata.v3.MetadataKind.Host" };
}

export const MetadataKind_Host: MessageFns<MetadataKind_Host, "envoy.type.metadata.v3.MetadataKind.Host"> = {
  $type: "envoy.type.metadata.v3.MetadataKind.Host" as const,
