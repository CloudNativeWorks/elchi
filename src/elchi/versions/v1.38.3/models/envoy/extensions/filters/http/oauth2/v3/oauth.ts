...
export interface OAuth2Credentials {
   ...
   */
  token_secret?: SdsSecretConfig | undefined;
  token_formation?:
...
export interface OAuth2Config {
   ...
   */
  allow_failed_matcher?: HeaderMatcher[] | undefined;
}
...
export enum OAuth2Config_AuthType {
  ...
  /**
   * TLS_CLIENT_AUTH - The client will be authenticated using mutual TLS (mTLS) with a client certificate.
...
export function oAuth2Config_AuthTypeFromJSON(object: any): OAuth2Config_AuthType {
  switch (object) {
    ...
    case "TLS_CLIENT_AUTH":
      return OAuth2Config_AuthType.TLS_CLIENT_AUTH;
    default:
...
export function oAuth2Config_AuthTypeToJSON(object: OAuth2Config_AuthType): string {
  switch (object) {
    ...
    case OAuth2Config_AuthType.BASIC_AUTH:
      return "BASIC_AUTH";
    case OAuth2Config_AuthType.TLS_CLIENT_AUTH:
 ...
 */
export interface OAuth2PerRoute {
  $type: "envoy.extensions.filters.http.oauth2.v3.OAuth2PerRoute";
...
export const CookieConfig: MessageFns<CookieConfig, "envoy.extensions.filters.http.oauth2.v3.CookieConfig"> = {
  ...
  encode(message: CookieConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.partitioned !== undefined && message.partitioned !== false) {
      writer.uint32(24).bool(message.partitioned);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.partitioned = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): CookieConfig {
    return {
      ...
      partitioned: isSet(object.partitioned) ? globalThis.Boolean(object.partitioned) : undefined,
    };
  },
  ...
  toJSON(message: CookieConfig): unknown {
    ...
    if (message.partitioned !== undefined) {
      obj.partitioned = message.partitioned;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<CookieConfig>, I>>(object: I): CookieConfig {
    ...
    message.partitioned = object.partitioned ?? undefined;
    return message;
  },
};
...
export const OAuth2Config: MessageFns<OAuth2Config, "envoy.extensions.filters.http.oauth2.v3.OAuth2Config"> = {
  ...
  encode(message: OAuth2Config, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.allow_failed_matcher !== undefined && message.allow_failed_matcher.length !== 0) {
      for (const v of message.allow_failed_matcher) {
        HeaderMatcher.encode(v!, writer.uint32(218).fork()).join();
      }
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 27: {
          ...
          if (message.allow_failed_matcher === undefined) {
            message.allow_failed_matcher = [];
          }
          const el = HeaderMatcher.decode(reader, reader.uint32());
          if (el !== undefined) {
            message.allow_failed_matcher!.push(el);
          }
          continue;
        }
      }
  ...
  fromJSON(object: any): OAuth2Config {
    return {
      ...
      disable_token_encryption: isSet(object.disable_token_encryption)
        ...
        : undefined,
      allow_failed_matcher: globalThis.Array.isArray(object?.allow_failed_matcher)
        ? object.allow_failed_matcher.map((e: any) => HeaderMatcher.fromJSON(e))
        : undefined,
    };
  },
  ...
  toJSON(message: OAuth2Config): unknown {
    ...
    if (message.allow_failed_matcher?.length) {
      obj.allow_failed_matcher = message.allow_failed_matcher.map((e) => HeaderMatcher.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<OAuth2Config>, I>>(object: I): OAuth2Config {
    ...
    message.allow_failed_matcher = object.allow_failed_matcher?.map((e) => HeaderMatcher.fromPartial(e)) || undefined;
    return message;
  },
};
...
function createBaseOAuth2PerRoute(): OAuth2PerRoute {
  return { $type: "envoy.extensions.filters.http.oauth2.v3.OAuth2PerRoute" };
}

export const OAuth2PerRoute: MessageFns<OAuth2PerRoute, "envoy.extensions.filters.http.oauth2.v3.OAuth2PerRoute"> = {
  $type: "envoy.extensions.filters.http.oauth2.v3.OAuth2PerRoute" as const,

  encode(message: OAuth2PerRoute, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): OAuth2PerRoute {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseOAuth2PerRoute();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): OAuth2PerRoute {
    return {
      $type: OAuth2PerRoute.$type,
      config: isSet(object.config) ? OAuth2Config.fromJSON(object.config) : undefined,
    };
  },

  toJSON(message: OAuth2PerRoute): unknown {
    const obj: any = {};
    if (message.config !== undefined) {
  ...
  create<I extends Exact<DeepPartial<OAuth2PerRoute>, I>>(base?: I): OAuth2PerRoute {
    return OAuth2PerRoute.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<OAuth2PerRoute>, I>>(object: I): OAuth2PerRoute {
    const message = createBaseOAuth2PerRoute();
...
messageTypeRegistry.set(OAuth2PerRoute.$type, OAuth2PerRoute);
