...
export interface RateLimitQuotaBucketSettings_NoAssignmentBehavior {
  ...
  no_assignment_behavior?: { $case: "fallback_rate_limit"; fallback_rate_limit: RateLimitStrategy } | undefined;
}
...
export interface RateLimitQuotaBucketSettings_ExpiredAssignmentBehavior {
  ...
  expired_assignment_behavior?: { $case: "fallback_rate_limit"; fallback_rate_limit: RateLimitStrategy } | {
...
export interface RateLimitQuotaBucketSettings_BucketIdBuilder_ValueBuilder {
  ...
  value_specifier?: { $case: "string_value"; string_value: string } | {
    $case: "custom_value";
    custom_value: TypedExtensionConfig;
  } | undefined;
}
