...
export interface FilterConfig {
   ...
   */
  allow_dynamic_host_from_filter_state?: boolean | undefined;
}

/** Per route Configuration for the dynamic forward proxy HTTP filter. */
export interface PerRouteConfig {
  $type: "envoy.extensions.filters.http.dynamic_forward_proxy.v3.PerRouteConfig";
  host_rewrite_specifier?: { $case: "host_rewrite_literal"; host_rewrite_literal: string } | {
...
> = {
  ...
  encode(message: FilterConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (
      message.allow_dynamic_host_from_filter_state !== undefined &&
      message.allow_dynamic_host_from_filter_state !== false
    ) {
      writer.uint32(32).bool(message.allow_dynamic_host_from_filter_state);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4: {
          ...
          message.allow_dynamic_host_from_filter_state = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): FilterConfig {
    return {
      ...
      save_upstream_address: isSet(object.save_upstream_address)
        ...
        : undefined,
      allow_dynamic_host_from_filter_state: isSet(object.allow_dynamic_host_from_filter_state)
        ? globalThis.Boolean(object.allow_dynamic_host_from_filter_state)
        : undefined,
    };
  },
  ...
  toJSON(message: FilterConfig): unknown {
    ...
    if (message.allow_dynamic_host_from_filter_state !== undefined) {
      obj.allow_dynamic_host_from_filter_state = message.allow_dynamic_host_from_filter_state;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<FilterConfig>, I>>(object: I): FilterConfig {
    ...
    message.allow_dynamic_host_from_filter_state = object.allow_dynamic_host_from_filter_state ?? undefined;
    return message;
  },
};
