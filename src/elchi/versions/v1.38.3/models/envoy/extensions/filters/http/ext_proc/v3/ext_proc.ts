...
export interface ExternalProcessor {
   ...
   */
  allow_content_length_header?: boolean | undefined;
}
...
export interface MetadataOptions {
   ...
   */
  cluster_metadata_forwarding_namespaces?: MetadataOptions_MetadataNamespaces | undefined;
}
...
export interface ExtProcPerRoute {
  ...
  override?: { $case: "disabled"; disabled: boolean } | { $case: "overrides"; overrides: ExtProcOverrides } | undefined;
}
...
export interface ExtProcOverrides {
   ...
   */
  processing_request_modifier?: TypedExtensionConfig | undefined;
}
...
> = {
  ...
  encode(message: ExternalProcessor, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.processing_request_modifier !== undefined) {
      TypedExtensionConfig.encode(message.processing_request_modifier, writer.uint32(202).fork()).join();
    }
    ...
    if (message.status_on_error !== undefined) {
      HttpStatus.encode(message.status_on_error, writer.uint32(194).fork()).join();
    }
    if (message.allow_content_length_header !== undefined && message.allow_content_length_header !== false) {
      writer.uint32(208).bool(message.allow_content_length_header);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 25: {
          ...
          message.processing_request_modifier = TypedExtensionConfig.decode(reader, reader.uint32());
          continue;
        }
        case 23: {
          if (tag !== 186) {
        ...
        case 26: {
          ...
          message.allow_content_length_header = reader.bool();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): ExternalProcessor {
    return {
      ...
      allowed_override_modes: globalThis.Array.isArray(object?.allowed_override_modes)
        ...
        : undefined,
      processing_request_modifier: isSet(object.processing_request_modifier)
        ? TypedExtensionConfig.fromJSON(object.processing_request_modifier)
        : undefined,
      ...
      allow_content_length_header: isSet(object.allow_content_length_header)
        ? globalThis.Boolean(object.allow_content_length_header)
        : undefined,
    };
  },
  ...
  toJSON(message: ExternalProcessor): unknown {
    ...
    if (message.processing_request_modifier !== undefined) {
      obj.processing_request_modifier = TypedExtensionConfig.toJSON(message.processing_request_modifier);
    }
    if (message.on_processing_response !== undefined) {
    ...
    if (message.allow_content_length_header !== undefined) {
      obj.allow_content_length_header = message.allow_content_length_header;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<ExternalProcessor>, I>>(object: I): ExternalProcessor {
    ...
    message.allowed_override_modes = object.allowed_override_modes?.map((e) => ProcessingMode.fromPartial(e)) ||
      undefined;
    message.processing_request_modifier =
      (object.processing_request_modifier !== undefined && object.processing_request_modifier !== null)
        ? TypedExtensionConfig.fromPartial(object.processing_request_modifier)
        : undefined;
    ...
    message.status_on_error = (object.status_on_error !== undefined && object.status_on_error !== null)
      ...
      : undefined;
    message.allow_content_length_header = object.allow_content_length_header ?? undefined;
    return message;
  },
};
...
export const MetadataOptions: MessageFns<MetadataOptions, "envoy.extensions.filters.http.ext_proc.v3.MetadataOptions"> =
  {
    ...
    encode(message: MetadataOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
      ...
      if (message.cluster_metadata_forwarding_namespaces !== undefined) {
        MetadataOptions_MetadataNamespaces.encode(
          message.cluster_metadata_forwarding_namespaces,
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 3: {
            ...
            message.cluster_metadata_forwarding_namespaces = MetadataOptions_MetadataNamespaces.decode(
              reader,
              reader.uint32(),
            );
            continue;
    ...
    fromJSON(object: any): MetadataOptions {
      return {
        ...
        receiving_namespaces: isSet(object.receiving_namespaces)
          ...
          : undefined,
        cluster_metadata_forwarding_namespaces: isSet(object.cluster_metadata_forwarding_namespaces)
          ? MetadataOptions_MetadataNamespaces.fromJSON(object.cluster_metadata_forwarding_namespaces)
          : undefined,
      };
    },
    ...
    toJSON(message: MetadataOptions): unknown {
      ...
      if (message.cluster_metadata_forwarding_namespaces !== undefined) {
        obj.cluster_metadata_forwarding_namespaces = MetadataOptions_MetadataNamespaces.toJSON(
          message.cluster_metadata_forwarding_namespaces,
        );
      }
      return obj;
    ...
    fromPartial<I extends Exact<DeepPartial<MetadataOptions>, I>>(object: I): MetadataOptions {
      ...
      message.receiving_namespaces = (object.receiving_namespaces !== undefined && object.receiving_namespaces !== null)
        ...
        : undefined;
      message.cluster_metadata_forwarding_namespaces =
        (object.cluster_metadata_forwarding_namespaces !== undefined &&
            object.cluster_metadata_forwarding_namespaces !== null)
          ? MetadataOptions_MetadataNamespaces.fromPartial(object.cluster_metadata_forwarding_namespaces)
          : undefined;
      return message;
    },
  };
...
> = {
  ...
  encode(message: ExtProcOverrides, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.failure_mode_allow !== undefined) {
      BoolValue.encode(
        { $type: "google.protobuf.BoolValue", value: message.failure_mode_allow! },
        writer.uint32(66).fork(),
      ).join();
    }
    if (message.processing_request_modifier !== undefined) {
      TypedExtensionConfig.encode(message.processing_request_modifier, writer.uint32(74).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8: {
          ...
          message.failure_mode_allow = BoolValue.decode(reader, reader.uint32()).value;
          continue;
        }
        case 9: {
          if (tag !== 74) {
  ...
  fromJSON(object: any): ExtProcOverrides {
    return {
      ...
      grpc_initial_metadata: globalThis.Array.isArray(object?.grpc_initial_metadata)
        ...
        : undefined,
      failure_mode_allow: isSet(object.failure_mode_allow) ? Boolean(object.failure_mode_allow) : undefined,
      processing_request_modifier: isSet(object.processing_request_modifier)
        ? TypedExtensionConfig.fromJSON(object.processing_request_modifier)
        : undefined,
    };
