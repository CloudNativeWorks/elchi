...
import { HeaderMatcher, WeightedCluster } from "../../../../../config/route/v3/route_components";
...
export interface MethodMatch_ParameterMatchSpecifier {
  ...
  parameter_match_specifier?: { $case: "exact_match"; exact_match: string } | {
    $case: "range_match";
    range_match: Int64Range;
  } | undefined;
}

export interface MethodMatch_ParamsMatchEntry {
  $type: "envoy.extensions.filters.network.dubbo_proxy.v3.MethodMatch.ParamsMatchEntry";
  key: number;
...
function createBaseRouteConfiguration(): RouteConfiguration {
  return { $type: "envoy.extensions.filters.network.dubbo_proxy.v3.RouteConfiguration" };
}
...
> = {
  $type: "envoy.extensions.filters.network.dubbo_proxy.v3.RouteConfiguration" as const,
...
function createBaseRoute(): Route {
  return { $type: "envoy.extensions.filters.network.dubbo_proxy.v3.Route" };
}

export const Route: MessageFns<Route, "envoy.extensions.filters.network.dubbo_proxy.v3.Route"> = {
  $type: "envoy.extensions.filters.network.dubbo_proxy.v3.Route" as const,
...
function createBaseRouteMatch(): RouteMatch {
  return { $type: "envoy.extensions.filters.network.dubbo_proxy.v3.RouteMatch" };
}

export const RouteMatch: MessageFns<RouteMatch, "envoy.extensions.filters.network.dubbo_proxy.v3.RouteMatch"> = {
  $type: "envoy.extensions.filters.network.dubbo_proxy.v3.RouteMatch" as const,
...
function createBaseRouteAction(): RouteAction {
  return { $type: "envoy.extensions.filters.network.dubbo_proxy.v3.RouteAction", cluster_specifier: undefined };
}

export const RouteAction: MessageFns<RouteAction, "envoy.extensions.filters.network.dubbo_proxy.v3.RouteAction"> = {
  $type: "envoy.extensions.filters.network.dubbo_proxy.v3.RouteAction" as const,
...
function createBaseMethodMatch(): MethodMatch {
  return { $type: "envoy.extensions.filters.network.dubbo_proxy.v3.MethodMatch" };
}

export const MethodMatch: MessageFns<MethodMatch, "envoy.extensions.filters.network.dubbo_proxy.v3.MethodMatch"> = {
  $type: "envoy.extensions.filters.network.dubbo_proxy.v3.MethodMatch" as const,
...
> = {
  $type: "envoy.extensions.filters.network.dubbo_proxy.v3.MethodMatch.ParameterMatchSpecifier" as const,
...
function createBaseMethodMatch_ParamsMatchEntry(): MethodMatch_ParamsMatchEntry {
  return { $type: "envoy.extensions.filters.network.dubbo_proxy.v3.MethodMatch.ParamsMatchEntry", key: 0 };
}
...
> = {
  $type: "envoy.extensions.filters.network.dubbo_proxy.v3.MethodMatch.ParamsMatchEntry" as const,
...
function createBaseMultipleRouteConfiguration(): MultipleRouteConfiguration {
  return { $type: "envoy.extensions.filters.network.dubbo_proxy.v3.MultipleRouteConfiguration" };
}

export const MultipleRouteConfiguration: MessageFns<
  MultipleRouteConfiguration,
  "envoy.extensions.filters.network.dubbo_proxy.v3.MultipleRouteConfiguration"
> = {
  $type: "envoy.extensions.filters.network.dubbo_proxy.v3.MultipleRouteConfiguration" as const,

  encode(message: MultipleRouteConfiguration, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== undefined && message.name !== "") {
      writer.uint32(10).string(message.name);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MultipleRouteConfiguration {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMultipleRouteConfiguration();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): MultipleRouteConfiguration {
    return {
      $type: MultipleRouteConfiguration.$type,
      name: isSet(object.name) ? globalThis.String(object.name) : undefined,
  ...
  toJSON(message: MultipleRouteConfiguration): unknown {
    const obj: any = {};
    if (message.name !== undefined) {
      obj.name = message.name;
    }
  ...
  create<I extends Exact<DeepPartial<MultipleRouteConfiguration>, I>>(base?: I): MultipleRouteConfiguration {
    return MultipleRouteConfiguration.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MultipleRouteConfiguration>, I>>(object: I): MultipleRouteConfiguration {
    const message = createBaseMultipleRouteConfiguration();
    message.name = object.name ?? undefined;
...
messageTypeRegistry.set(MultipleRouteConfiguration.$type, MultipleRouteConfiguration);
