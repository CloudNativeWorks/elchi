...
export interface LocalityLbConfig_ZoneAwareLbConfig {
   ...
   */
  locality_basis?: LocalityLbConfig_ZoneAwareLbConfig_LocalityBasis | undefined;
}
...
export enum LocalityLbConfig_ZoneAwareLbConfig_LocalityBasis {
  /** HEALTHY_HOSTS_NUM - Use the number of healthy hosts in each locality. */
  HEALTHY_HOSTS_NUM = "HEALTHY_HOSTS_NUM",
  /** HEALTHY_HOSTS_WEIGHT - Use the weights of healthy hosts in each locality. */
  HEALTHY_HOSTS_WEIGHT = "HEALTHY_HOSTS_WEIGHT",
}

export function localityLbConfig_ZoneAwareLbConfig_LocalityBasisFromJSON(
  object: any,
): LocalityLbConfig_ZoneAwareLbConfig_LocalityBasis {
  switch (object) {
    case 0:
    case "HEALTHY_HOSTS_NUM":
      return LocalityLbConfig_ZoneAwareLbConfig_LocalityBasis.HEALTHY_HOSTS_NUM;
    case 1:
    case "HEALTHY_HOSTS_WEIGHT":
      return LocalityLbConfig_ZoneAwareLbConfig_LocalityBasis.HEALTHY_HOSTS_WEIGHT;
    default:
      throw new globalThis.Error(
        "Unrecognized enum value " + object + " for enum LocalityLbConfig_ZoneAwareLbConfig_LocalityBasis",
      );
  }
}

export function localityLbConfig_ZoneAwareLbConfig_LocalityBasisToJSON(
  object: LocalityLbConfig_ZoneAwareLbConfig_LocalityBasis,
): string {
  switch (object) {
    case LocalityLbConfig_ZoneAwareLbConfig_LocalityBasis.HEALTHY_HOSTS_NUM:
      return "HEALTHY_HOSTS_NUM";
    case LocalityLbConfig_ZoneAwareLbConfig_LocalityBasis.HEALTHY_HOSTS_WEIGHT:
      return "HEALTHY_HOSTS_WEIGHT";
    default:
      throw new globalThis.Error(
        "Unrecognized enum value " + object + " for enum LocalityLbConfig_ZoneAwareLbConfig_LocalityBasis",
      );
...
export function localityLbConfig_ZoneAwareLbConfig_LocalityBasisToNumber(
  object: LocalityLbConfig_ZoneAwareLbConfig_LocalityBasis,
): number {
  switch (object) {
    case LocalityLbConfig_ZoneAwareLbConfig_LocalityBasis.HEALTHY_HOSTS_NUM:
...
> = {
  ...
  encode(message: LocalityLbConfig_ZoneAwareLbConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (
      message.locality_basis !== undefined &&
      message.locality_basis !== LocalityLbConfig_ZoneAwareLbConfig_LocalityBasis.HEALTHY_HOSTS_NUM
    ) {
      writer.uint32(48).int32(localityLbConfig_ZoneAwareLbConfig_LocalityBasisToNumber(message.locality_basis));
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.locality_basis = localityLbConfig_ZoneAwareLbConfig_LocalityBasisFromJSON(reader.int32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): LocalityLbConfig_ZoneAwareLbConfig {
    return {
      ...
      force_local_zone: isSet(object.force_local_zone)
        ...
        : undefined,
      locality_basis: isSet(object.locality_basis)
        ? localityLbConfig_ZoneAwareLbConfig_LocalityBasisFromJSON(object.locality_basis)
        : undefined,
    };
  },
  ...
  toJSON(message: LocalityLbConfig_ZoneAwareLbConfig): unknown {
    ...
    if (message.locality_basis !== undefined) {
      obj.locality_basis = localityLbConfig_ZoneAwareLbConfig_LocalityBasisToJSON(message.locality_basis);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<LocalityLbConfig_ZoneAwareLbConfig>, I>>(
    ...
    message.force_local_zone = (object.force_local_zone !== undefined && object.force_local_zone !== null)
      ...
      : undefined;
    message.locality_basis = object.locality_basis ?? undefined;
    return message;
  },
};
