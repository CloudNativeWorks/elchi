...
export const protobufPackage = "envoy.extensions.filters.network.mongo_proxy.v3";

/** [#next-free-field: 6] */
export interface MongoProxy {
  $type: "envoy.extensions.filters.network.mongo_proxy.v3.MongoProxy";
  /**
...
function createBaseMongoProxy(): MongoProxy {
  return { $type: "envoy.extensions.filters.network.mongo_proxy.v3.MongoProxy" };
}

export const MongoProxy: MessageFns<MongoProxy, "envoy.extensions.filters.network.mongo_proxy.v3.MongoProxy"> = {
  $type: "envoy.extensions.filters.network.mongo_proxy.v3.MongoProxy" as const,
