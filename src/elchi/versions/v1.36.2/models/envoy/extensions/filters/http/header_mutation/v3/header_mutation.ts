...
import { KeyValueMutation } from "../../../../../config/core/v3/base";
...
export interface Mutations {
  ...
  request_trailers_mutations?: HeaderMutation1[] | undefined;
}
...
export const Mutations: MessageFns<Mutations, "envoy.extensions.filters.http.header_mutation.v3.Mutations"> = {
  ...
  encode(message: Mutations, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.query_parameter_mutations !== undefined && message.query_parameter_mutations.length !== 0) {
      for (const v of message.query_parameter_mutations) {
        KeyValueMutation.encode(v!, writer.uint32(26).fork()).join();
      }
    }
    ...
    if (message.response_trailers_mutations !== undefined && message.response_trailers_mutations.length !== 0) {
      for (const v of message.response_trailers_mutations) {
        HeaderMutation1.encode(v!, writer.uint32(34).fork()).join();
      }
    }
    if (message.request_trailers_mutations !== undefined && message.request_trailers_mutations.length !== 0) {
      for (const v of message.request_trailers_mutations) {
        HeaderMutation1.encode(v!, writer.uint32(42).fork()).join();
      }
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          if (message.query_parameter_mutations === undefined) {
            message.query_parameter_mutations = [];
          }
          const el = KeyValueMutation.decode(reader, reader.uint32());
          if (el !== undefined) {
            message.query_parameter_mutations!.push(el);
          }
          continue;
        }
        case 2: {
        ...
        case 4: {
          ...
          if (message.response_trailers_mutations === undefined) {
            message.response_trailers_mutations = [];
          }
          const el = HeaderMutation1.decode(reader, reader.uint32());
          if (el !== undefined) {
            message.response_trailers_mutations!.push(el);
          }
          continue;
        }
        case 5: {
          ...
          if (message.request_trailers_mutations === undefined) {
            message.request_trailers_mutations = [];
          }
          const el = HeaderMutation1.decode(reader, reader.uint32());
          if (el !== undefined) {
            message.request_trailers_mutations!.push(el);
          }
          continue;
        }
      }
  ...
  fromJSON(object: any): Mutations {
    return {
      ...
      request_mutations: globalThis.Array.isArray(object?.request_mutations)
        ...
        : undefined,
      query_parameter_mutations: globalThis.Array.isArray(object?.query_parameter_mutations)
        ? object.query_parameter_mutations.map((e: any) => KeyValueMutation.fromJSON(e))
        : undefined,
      response_mutations: globalThis.Array.isArray(object?.response_mutations)
        ...
        : undefined,
      response_trailers_mutations: globalThis.Array.isArray(object?.response_trailers_mutations)
        ? object.response_trailers_mutations.map((e: any) => HeaderMutation1.fromJSON(e))
        : undefined,
      request_trailers_mutations: globalThis.Array.isArray(object?.request_trailers_mutations)
        ? object.request_trailers_mutations.map((e: any) => HeaderMutation1.fromJSON(e))
        : undefined,
    };
  },
  ...
  toJSON(message: Mutations): unknown {
    ...
    if (message.query_parameter_mutations?.length) {
      obj.query_parameter_mutations = message.query_parameter_mutations.map((e) => KeyValueMutation.toJSON(e));
    }
    if (message.response_mutations?.length) {
      obj.response_mutations = message.response_mutations.map((e) => HeaderMutation1.toJSON(e));
    }
    if (message.response_trailers_mutations?.length) {
      obj.response_trailers_mutations = message.response_trailers_mutations.map((e) => HeaderMutation1.toJSON(e));
    }
    if (message.request_trailers_mutations?.length) {
      obj.request_trailers_mutations = message.request_trailers_mutations.map((e) => HeaderMutation1.toJSON(e));
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Mutations>, I>>(object: I): Mutations {
    ...
    message.query_parameter_mutations = object.query_parameter_mutations?.map((e) => KeyValueMutation.fromPartial(e)) ||
      undefined;
    message.response_mutations = object.response_mutations?.map((e) => HeaderMutation1.fromPartial(e)) || undefined;
    message.response_trailers_mutations =
      object.response_trailers_mutations?.map((e) => HeaderMutation1.fromPartial(e)) || undefined;
    message.request_trailers_mutations =
      object.request_trailers_mutations?.map((e) => HeaderMutation1.fromPartial(e)) || undefined;
    return message;
  },
};
