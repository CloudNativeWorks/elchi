...
export const protobufPackage = "envoy.config.retry.previous_priorities";
...
export interface PreviousPrioritiesConfig {
  $type: "envoy.config.retry.previous_priorities.PreviousPrioritiesConfig";
  /**
...
function createBasePreviousPrioritiesConfig(): PreviousPrioritiesConfig {
  return { $type: "envoy.config.retry.previous_priorities.PreviousPrioritiesConfig" };
}
...
> = {
  $type: "envoy.config.retry.previous_priorities.PreviousPrioritiesConfig" as const,
