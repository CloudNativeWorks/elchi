...
export const protobufPackage = "envoy.config.filter.thrift.rate_limit.v2alpha1";

/** [#next-free-field: 6] */
export interface RateLimit {
  $type: "envoy.config.filter.thrift.rate_limit.v2alpha1.RateLimit";
...
function createBaseRateLimit(): RateLimit {
  return { $type: "envoy.config.filter.thrift.rate_limit.v2alpha1.RateLimit" };
}

export const RateLimit: MessageFns<RateLimit, "envoy.config.filter.thrift.rate_limit.v2alpha1.RateLimit"> = {
  $type: "envoy.config.filter.thrift.rate_limit.v2alpha1.RateLimit" as const,
