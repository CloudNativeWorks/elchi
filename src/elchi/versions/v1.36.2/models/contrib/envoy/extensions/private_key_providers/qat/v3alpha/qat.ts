...
export const protobufPackage = "envoy.extensions.private_key_providers.qat.v3alpha";

export interface QatPrivateKeyMethodConfig {
  $type: "envoy.extensions.private_key_providers.qat.v3alpha.QatPrivateKeyMethodConfig";
  /**
...
function createBaseQatPrivateKeyMethodConfig(): QatPrivateKeyMethodConfig {
  return { $type: "envoy.extensions.private_key_providers.qat.v3alpha.QatPrivateKeyMethodConfig" };
}

export const QatPrivateKeyMethodConfig: MessageFns<
  QatPrivateKeyMethodConfig,
  "envoy.extensions.private_key_providers.qat.v3alpha.QatPrivateKeyMethodConfig"
> = {
  $type: "envoy.extensions.private_key_providers.qat.v3alpha.QatPrivateKeyMethodConfig" as const,

  encode(message: QatPrivateKeyMethodConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QatPrivateKeyMethodConfig {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQatPrivateKeyMethodConfig();
  ...
  fromJSON(object: any): QatPrivateKeyMethodConfig {
    return {
      $type: QatPrivateKeyMethodConfig.$type,
  ...
  toJSON(message: QatPrivateKeyMethodConfig): unknown {
    const obj: any = {};
    if (message.private_key !== undefined) {
  ...
  create<I extends Exact<DeepPartial<QatPrivateKeyMethodConfig>, I>>(base?: I): QatPrivateKeyMethodConfig {
    return QatPrivateKeyMethodConfig.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QatPrivateKeyMethodConfig>, I>>(object: I): QatPrivateKeyMethodConfig {
    const message = createBaseQatPrivateKeyMethodConfig();
...
messageTypeRegistry.set(QatPrivateKeyMethodConfig.$type, QatPrivateKeyMethodConfig);
