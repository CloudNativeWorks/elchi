...
export const SinkConfig: OutType = { "SinkConfig": [
  ...
  },
  {
    ...
    "fieldType": "Matcher",
    "enums": null,
    "comment": "The custom conversion from a stat to a metric. Currently, the only supported input is ``envoy.extensions.matching.common_inputs.stats.v3.StatFullNameMatchInput`` and the only support action is ``envoy.extensions.stat_sinks.open_telemetry.v3.SinkConfig.ConversionAction``.",
    "notImp": false
  }
] };
