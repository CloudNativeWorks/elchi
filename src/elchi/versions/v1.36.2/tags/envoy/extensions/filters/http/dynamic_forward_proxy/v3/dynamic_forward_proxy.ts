...
export const PerRouteConfig: OutType = { "PerRouteConfig": [
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "Indicates that before DNS lookup, the host header will be swapped with this value. If not set or empty, the original host header value will be used and no rewrite will happen.\n\n:::note\n\nThis rewrite affects both DNS lookup and host header forwarding. However, this option shouldn't be used with `HCM host rewrite header` given that the value set here would be used for DNS lookups whereas the value set in the HCM would be used for host header forwarding which might not be the desired outcome.",
    "notImp": false
  },
  {
