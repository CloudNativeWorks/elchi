...
export const protobufPackage = "envoy.extensions.filters.network.golang.v3alpha";

/** [#next-free-field: 6] */
export interface Config {
  $type: "envoy.extensions.filters.network.golang.v3alpha.Config";
...
function createBaseConfig(): Config {
  return { $type: "envoy.extensions.filters.network.golang.v3alpha.Config" };
}

export const Config: MessageFns<Config, "envoy.extensions.filters.network.golang.v3alpha.Config"> = {
  $type: "envoy.extensions.filters.network.golang.v3alpha.Config" as const,

  encode(message: Config, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.is_terminal_filter !== undefined && message.is_terminal_filter !== false) {
      writer.uint32(8).bool(message.is_terminal_filter);
    }
    if (message.library_id !== undefined && message.library_id !== "") {
      writer.uint32(18).string(message.library_id);
    }
    if (message.library_path !== undefined && message.library_path !== "") {
      writer.uint32(26).string(message.library_path);
    }
    if (message.plugin_name !== undefined && message.plugin_name !== "") {
      writer.uint32(34).string(message.plugin_name);
    }
    if (message.plugin_config !== undefined) {
      Any.encode(message.plugin_config, writer.uint32(42).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.is_terminal_filter = reader.bool();
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): Config {
    return {
      $type: Config.$type,
      is_terminal_filter: isSet(object.is_terminal_filter) ? globalThis.Boolean(object.is_terminal_filter) : undefined,
  ...
  toJSON(message: Config): unknown {
    const obj: any = {};
    if (message.is_terminal_filter !== undefined) {
      obj.is_terminal_filter = message.is_terminal_filter;
    }
  ...
  fromPartial<I extends Exact<DeepPartial<Config>, I>>(object: I): Config {
    const message = createBaseConfig();
    message.is_terminal_filter = object.is_terminal_filter ?? undefined;
