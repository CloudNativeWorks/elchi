...
function createBasePercent(): Percent {
  return { $type: "envoy.type.Percent" };
}

export const Percent: MessageFns<Percent, "envoy.type.Percent"> = {
  $type: "envoy.type.Percent" as const,
...
function createBaseFractionalPercent(): FractionalPercent {
  return { $type: "envoy.type.FractionalPercent" };
}

export const FractionalPercent: MessageFns<FractionalPercent, "envoy.type.FractionalPercent"> = {
  $type: "envoy.type.FractionalPercent" as const,
