...
import { MetadataKey, MetadataKind } from "../../metadata/v2/metadata";

export const protobufPackage = "envoy.type.tracing.v2";
...
export interface CustomTag_Literal {
  $type: "envoy.type.tracing.v2.CustomTag.Literal";
...
export interface CustomTag_Environment {
  $type: "envoy.type.tracing.v2.CustomTag.Environment";
...
export interface CustomTag_Metadata {
  $type: "envoy.type.tracing.v2.CustomTag.Metadata";
...
function createBaseCustomTag(): CustomTag {
  return { $type: "envoy.type.tracing.v2.CustomTag", type: undefined };
}

export const CustomTag: MessageFns<CustomTag, "envoy.type.tracing.v2.CustomTag"> = {
  $type: "envoy.type.tracing.v2.CustomTag" as const,
...
function createBaseCustomTag_Literal(): CustomTag_Literal {
  return { $type: "envoy.type.tracing.v2.CustomTag.Literal" };
}

export const CustomTag_Literal: MessageFns<CustomTag_Literal, "envoy.type.tracing.v2.CustomTag.Literal"> = {
  $type: "envoy.type.tracing.v2.CustomTag.Literal" as const,
...
function createBaseCustomTag_Environment(): CustomTag_Environment {
  return { $type: "envoy.type.tracing.v2.CustomTag.Environment" };
}

export const CustomTag_Environment: MessageFns<CustomTag_Environment, "envoy.type.tracing.v2.CustomTag.Environment"> = {
  $type: "envoy.type.tracing.v2.CustomTag.Environment" as const,
...
function createBaseCustomTag_Header(): CustomTag_Header {
  return { $type: "envoy.type.tracing.v2.CustomTag.Header" };
}

export const CustomTag_Header: MessageFns<CustomTag_Header, "envoy.type.tracing.v2.CustomTag.Header"> = {
  $type: "envoy.type.tracing.v2.CustomTag.Header" as const,
...
function createBaseCustomTag_Metadata(): CustomTag_Metadata {
  return { $type: "envoy.type.tracing.v2.CustomTag.Metadata" };
}

export const CustomTag_Metadata: MessageFns<CustomTag_Metadata, "envoy.type.tracing.v2.CustomTag.Metadata"> = {
  $type: "envoy.type.tracing.v2.CustomTag.Metadata" as const,
