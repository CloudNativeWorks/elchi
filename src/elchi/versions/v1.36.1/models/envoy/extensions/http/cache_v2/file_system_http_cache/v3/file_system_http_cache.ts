...
export const protobufPackage = "envoy.extensions.http.cache_v2.file_system_http_cache.v3";
 ...
 * [#next-free-field: 11]
 */
export interface FileSystemHttpCacheV2Config {
  $type: "envoy.extensions.http.cache_v2.file_system_http_cache.v3.FileSystemHttpCacheV2Config";
...
function createBaseFileSystemHttpCacheV2Config(): FileSystemHttpCacheV2Config {
  return { $type: "envoy.extensions.http.cache_v2.file_system_http_cache.v3.FileSystemHttpCacheV2Config" };
}

export const FileSystemHttpCacheV2Config: MessageFns<
  FileSystemHttpCacheV2Config,
  "envoy.extensions.http.cache_v2.file_system_http_cache.v3.FileSystemHttpCacheV2Config"
> = {
  $type: "envoy.extensions.http.cache_v2.file_system_http_cache.v3.FileSystemHttpCacheV2Config" as const,

  encode(message: FileSystemHttpCacheV2Config, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): FileSystemHttpCacheV2Config {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseFileSystemHttpCacheV2Config();
  ...
  fromJSON(object: any): FileSystemHttpCacheV2Config {
    return {
      $type: FileSystemHttpCacheV2Config.$type,
  ...
  toJSON(message: FileSystemHttpCacheV2Config): unknown {
    const obj: any = {};
    if (message.manager_config !== undefined) {
  ...
  create<I extends Exact<DeepPartial<FileSystemHttpCacheV2Config>, I>>(base?: I): FileSystemHttpCacheV2Config {
    return FileSystemHttpCacheV2Config.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<FileSystemHttpCacheV2Config>, I>>(object: I): FileSystemHttpCacheV2Config {
    const message = createBaseFileSystemHttpCacheV2Config();
...
messageTypeRegistry.set(FileSystemHttpCacheV2Config.$type, FileSystemHttpCacheV2Config);
