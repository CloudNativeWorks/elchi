...
export interface GenericSecret {
   ...
   * that only only one of secret and secrets is set.
   */
  secrets?: Map<string, DataSource> | undefined;
}

export interface GenericSecret_SecretsEntry {
  $type: "envoy.extensions.transport_sockets.tls.v3.GenericSecret.SecretsEntry";
  key: string;
...
function createBaseGenericSecret(): GenericSecret {
  return { $type: "envoy.extensions.transport_sockets.tls.v3.GenericSecret" };
}

export const GenericSecret: MessageFns<GenericSecret, "envoy.extensions.transport_sockets.tls.v3.GenericSecret"> = {
  $type: "envoy.extensions.transport_sockets.tls.v3.GenericSecret" as const,
  ...
  encode(message: GenericSecret, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    (message.secrets || new Map()).forEach((value, key) => {
      GenericSecret_SecretsEntry.encode({
        $type: "envoy.extensions.transport_sockets.tls.v3.GenericSecret.SecretsEntry",
        key: key as any,
        value,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          const entry2 = GenericSecret_SecretsEntry.decode(reader, reader.uint32());
          if (entry2.value !== undefined) {
            if (message.secrets === undefined) {
              message.secrets = new Map();
            }
            message.secrets!.set(entry2.key, entry2.value);
          }
          continue;
        }
      }
  ...
  fromJSON(object: any): GenericSecret {
    return {
      ...
      secrets: isObject(object.secrets)
        ? Object.entries(object.secrets).reduce<Map<string, DataSource>>((acc, [key, value]) => {
  ...
  toJSON(message: GenericSecret): unknown {
    ...
    if (message.secrets?.size) {
      obj.secrets = {};
      message.secrets.forEach((v, k) => {
        obj.secrets[k] = DataSource.toJSON(v);
      });
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<GenericSecret>, I>>(object: I): GenericSecret {
    ...
    message.secret = (object.secret !== undefined && object.secret !== null)
      ...
      : undefined;
    message.secrets = (object.secrets === undefined || object.secrets === null) ? undefined : (() => {
      const m = new Map();
      (object.secrets as Map<string, DataSource> ?? new Map()).forEach((value, key) => {
        if (value !== undefined) {
...
function createBaseGenericSecret_SecretsEntry(): GenericSecret_SecretsEntry {
  return { $type: "envoy.extensions.transport_sockets.tls.v3.GenericSecret.SecretsEntry", key: "" };
}

export const GenericSecret_SecretsEntry: MessageFns<
  GenericSecret_SecretsEntry,
  "envoy.extensions.transport_sockets.tls.v3.GenericSecret.SecretsEntry"
> = {
  $type: "envoy.extensions.transport_sockets.tls.v3.GenericSecret.SecretsEntry" as const,

  encode(message: GenericSecret_SecretsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GenericSecret_SecretsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGenericSecret_SecretsEntry();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): GenericSecret_SecretsEntry {
    return {
      $type: GenericSecret_SecretsEntry.$type,
      key: isSet(object.key) ? globalThis.String(object.key) : "",
      value: isSet(object.value) ? DataSource.fromJSON(object.value) : undefined,
    };
  },

  toJSON(message: GenericSecret_SecretsEntry): unknown {
    const obj: any = {};
  ...
  create<I extends Exact<DeepPartial<GenericSecret_SecretsEntry>, I>>(base?: I): GenericSecret_SecretsEntry {
    return GenericSecret_SecretsEntry.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GenericSecret_SecretsEntry>, I>>(object: I): GenericSecret_SecretsEntry {
    const message = createBaseGenericSecret_SecretsEntry();
...
messageTypeRegistry.set(GenericSecret_SecretsEntry.$type, GenericSecret_SecretsEntry);

function createBaseSdsSecretConfig(): SdsSecretConfig {
  return { $type: "envoy.extensions.transport_sockets.tls.v3.SdsSecretConfig" };
}

export const SdsSecretConfig: MessageFns<SdsSecretConfig, "envoy.extensions.transport_sockets.tls.v3.SdsSecretConfig"> =
  {
    $type: "envoy.extensions.transport_sockets.tls.v3.SdsSecretConfig" as const,
...
function createBaseSecret(): Secret {
  return { $type: "envoy.extensions.transport_sockets.tls.v3.Secret", type: undefined };
}

export const Secret: MessageFns<Secret, "envoy.extensions.transport_sockets.tls.v3.Secret"> = {
  $type: "envoy.extensions.transport_sockets.tls.v3.Secret" as const,
