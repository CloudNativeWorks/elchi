...
export const protobufPackage = "envoy.config.filter.http.header_to_metadata.v2";

export interface Config {
  $type: "envoy.config.filter.http.header_to_metadata.v2.Config";
...
export interface Config_KeyValuePair {
  $type: "envoy.config.filter.http.header_to_metadata.v2.Config.KeyValuePair";
...
export interface Config_Rule {
  $type: "envoy.config.filter.http.header_to_metadata.v2.Config.Rule";
...
function createBaseConfig(): Config {
  return { $type: "envoy.config.filter.http.header_to_metadata.v2.Config" };
}

export const Config: MessageFns<Config, "envoy.config.filter.http.header_to_metadata.v2.Config"> = {
  $type: "envoy.config.filter.http.header_to_metadata.v2.Config" as const,
...
function createBaseConfig_KeyValuePair(): Config_KeyValuePair {
  return { $type: "envoy.config.filter.http.header_to_metadata.v2.Config.KeyValuePair" };
}
...
> = {
  $type: "envoy.config.filter.http.header_to_metadata.v2.Config.KeyValuePair" as const,
...
function createBaseConfig_Rule(): Config_Rule {
  return { $type: "envoy.config.filter.http.header_to_metadata.v2.Config.Rule" };
}

export const Config_Rule: MessageFns<Config_Rule, "envoy.config.filter.http.header_to_metadata.v2.Config.Rule"> = {
  $type: "envoy.config.filter.http.header_to_metadata.v2.Config.Rule" as const,
