...
import { HeaderMap, HeaderValue } from "../../../api/v2/core/base";
...
export interface HttpBufferedTrace {
  ...
  request?:
    ...
    | undefined;
  /** Response message. */
  response?: HttpBufferedTrace_Message | undefined;
}

/** HTTP message wrapper. */
export interface HttpBufferedTrace_Message {
  $type: "envoy.data.tap.v2alpha.HttpBufferedTrace.Message";
  /** Message headers. */
  headers?:
    | HeaderValue[]
    | undefined;
  ...
  body?:
    ...
    | undefined;
  /** Message trailers. */
  trailers?: HeaderValue[] | undefined;
}
...
function createBaseHttpBufferedTrace(): HttpBufferedTrace {
  return { $type: "envoy.data.tap.v2alpha.HttpBufferedTrace" };
}

export const HttpBufferedTrace: MessageFns<HttpBufferedTrace, "envoy.data.tap.v2alpha.HttpBufferedTrace"> = {
  $type: "envoy.data.tap.v2alpha.HttpBufferedTrace" as const,
...
function createBaseHttpBufferedTrace_Message(): HttpBufferedTrace_Message {
  return { $type: "envoy.data.tap.v2alpha.HttpBufferedTrace.Message" };
}
...
> = {
  $type: "envoy.data.tap.v2alpha.HttpBufferedTrace.Message" as const,
...
function createBaseHttpStreamedTraceSegment(): HttpStreamedTraceSegment {
  return { $type: "envoy.data.tap.v2alpha.HttpStreamedTraceSegment", message_piece: undefined };
}
...
> = {
  $type: "envoy.data.tap.v2alpha.HttpStreamedTraceSegment" as const,
