...
export const OAuth2Config: OutType = { "OAuth2Config": [
  ...
  },
  {
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "If set to true, allows automatic access token refresh using the associated refresh token (see `RFC 6749 section 6 <https://datatracker.ietf.org/doc/html/rfc6749#section-6>`_), provided that the OAuth server supports that. Default value is false.",
    "notImp": false
  },
  {
