...
export const TcpProxy: OutType = { "TcpProxy": [
  ...
  },
  {
    ...
    "fieldType": "Metadata",
    "enums": null,
    "comment": "Optional endpoint metadata match criteria. Only endpoints in the upstream cluster with metadata matching that set in metadata_match will be considered. The filter name should be specified as ``envoy.lb``.",
    "notImp": false
  },
  {
    "name": "idle_timeout",
