...
export const KeyValueAppend: OutType = { "KeyValueAppend": [
  {
    ...
    "fieldType": "KeyValue",
    "enums": null,
    "comment": "Key/value pair entry that this option to append or overwrite.",
    "notImp": false
  },
  {
    "name": "action",
...
export const KeyValueMutation: OutType = { "KeyValueMutation": [
  {
    ...
    "enums": null,
    "comment": "Key/value pair to append or overwrite. Only one of ``append`` or ``remove`` can be set.",
    "notImp": false
  },
  {
    "name": "remove",
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "Key to remove. Only one of ``append`` or ``remove`` can be set.",
    "notImp": false
  }
] };
