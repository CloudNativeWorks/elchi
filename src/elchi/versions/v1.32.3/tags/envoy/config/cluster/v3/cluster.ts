...
export const TrackClusterStats: OutType = { "TrackClusterStats": [
  ...
  },
  {
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "If request_response_sizes is true, then the `histograms`  tracking header and body sizes of requests and responses will be published.",
    "notImp": false
  },
  {
...
export const Cluster: OutType = { "Cluster": [
  ...
  },
  {
    ...
    "enums": null,
    "comment": "The extension_protocol_options field is used to provide extension-specific protocol options for upstream connections. The key should match the extension filter name, such as \"envoy.filters.network.thrift_proxy\". See the extension's documentation for details on specific options.",
    "notImp": false
  },
  {
