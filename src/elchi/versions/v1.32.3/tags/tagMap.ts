export const tagMap: { [relativePath: string]: () => Promise<any> } = {
    ...
    'contrib/envoy/extensions/filters/http/squash/v3/squash': () => import('./contrib/envoy/extensions/filters/http/squash/v3/squash').then(module => ({
        ...
        'Squash_SingleFields': module.Squash_SingleFields
    })),
    ...
    'envoy/config/core/v3/substitution_format_string': () => import('./envoy/config/core/v3/substitution_format_string').then(module => ({
        ...
        'JsonFormatOptions_SingleFields': module.JsonFormatOptions_SingleFields,
    ...
    'envoy/config/grpc_credential/v3/aws_iam': () => import('./envoy/config/grpc_credential/v3/aws_iam').then(module => ({
        ...
        'AwsIamConfig_SingleFields': module.AwsIamConfig_SingleFields
    })),
    ...
    'envoy/config/listener/v3/listener_components': () => import('./envoy/config/listener/v3/listener_components').then(module => ({
        ...
        'FilterChain_OnDemandConfiguration': module.FilterChain_OnDemandConfiguration,
        'FilterChain_OnDemandConfiguration_SingleFields': module.FilterChain_OnDemandConfiguration_SingleFields,
    ...
    'envoy/config/trace/v3/opencensus': () => import('./envoy/config/trace/v3/opencensus').then(module => ({
        'OpenCensusConfig': module.OpenCensusConfig
    })),
    ...
    'envoy/extensions/filters/http/ratelimit/v3/rate_limit': () => import('./envoy/extensions/filters/http/ratelimit/v3/rate_limit').then(module => ({
        'RateLimit': module.RateLimit,
        'RateLimit_SingleFields': module.RateLimit_SingleFields,
        'RateLimitConfig_Override': module.RateLimitConfig_Override,
        'RateLimitConfig': module.RateLimitConfig,
        'RateLimitConfig_SingleFields': module.RateLimitConfig_SingleFields,
        'RateLimitConfig_Action': module.RateLimitConfig_Action,
        'RateLimitConfig_Action_RequestHeaders': module.RateLimitConfig_Action_RequestHeaders,
        'RateLimitConfig_Action_RequestHeaders_SingleFields': module.RateLimitConfig_Action_RequestHeaders_SingleFields,
        'RateLimitConfig_Action_GenericKey': module.RateLimitConfig_Action_GenericKey,
        'RateLimitConfig_Action_GenericKey_SingleFields': module.RateLimitConfig_Action_GenericKey_SingleFields,
        'RateLimitConfig_Action_HeaderValueMatch': module.RateLimitConfig_Action_HeaderValueMatch,
        'RateLimitConfig_Action_HeaderValueMatch_SingleFields': module.RateLimitConfig_Action_HeaderValueMatch_SingleFields,
        'RateLimitConfig_Action_MetaData': module.RateLimitConfig_Action_MetaData,
        'RateLimitConfig_Action_MetaData_SingleFields': module.RateLimitConfig_Action_MetaData_SingleFields,
        'RateLimitConfig_Override_DynamicMetadata': module.RateLimitConfig_Override_DynamicMetadata,
    ...
    'envoy/service/trace/v3/trace_service': () => import('./envoy/service/trace/v3/trace_service').then(module => ({
        'StreamTracesMessage_Identifier': module.StreamTracesMessage_Identifier,
        'StreamTracesMessage': module.StreamTracesMessage
    })),
    ...
    'opencensus/proto/resource/v1/resource': () => import('./opencensus/proto/resource/v1/resource').then(module => ({
        'Resource': module.Resource,
        'Resource_SingleFields': module.Resource_SingleFields,
        'Resource_LabelsEntry': module.Resource_LabelsEntry,
        'Resource_LabelsEntry_SingleFields': module.Resource_LabelsEntry_SingleFields
    })),
    'opencensus/proto/trace/v1/trace': () => import('./opencensus/proto/trace/v1/trace').then(module => ({
        'Span_Tracestate': module.Span_Tracestate,
        'TruncatableString': module.TruncatableString,
        'TruncatableString_SingleFields': module.TruncatableString_SingleFields,
        'Span_Attributes': module.Span_Attributes,
        'Span_Attributes_SingleFields': module.Span_Attributes_SingleFields,
        'StackTrace_StackFrames': module.StackTrace_StackFrames,
        'StackTrace_StackFrames_SingleFields': module.StackTrace_StackFrames_SingleFields,
        'StackTrace': module.StackTrace,
        'StackTrace_SingleFields': module.StackTrace_SingleFields,
        'Span_TimeEvents': module.Span_TimeEvents,
        'Span_TimeEvents_SingleFields': module.Span_TimeEvents_SingleFields,
        'Span_Links': module.Span_Links,
        'Span_Links_SingleFields': module.Span_Links_SingleFields,
        'Status': module.Status,
        'Status_SingleFields': module.Status_SingleFields,
        'Span': module.Span,
        'Span_SingleFields': module.Span_SingleFields,
        'Span_Tracestate_Entry': module.Span_Tracestate_Entry,
        'Span_Tracestate_Entry_SingleFields': module.Span_Tracestate_Entry_SingleFields,
        'AttributeValue': module.AttributeValue,
        'AttributeValue_SingleFields': module.AttributeValue_SingleFields,
        'Span_Attributes_AttributeMapEntry': module.Span_Attributes_AttributeMapEntry,
        'Span_Attributes_AttributeMapEntry_SingleFields': module.Span_Attributes_AttributeMapEntry_SingleFields,
        'Span_TimeEvent': module.Span_TimeEvent,
        'Span_TimeEvent_Annotation': module.Span_TimeEvent_Annotation,
        'Span_TimeEvent_MessageEvent': module.Span_TimeEvent_MessageEvent,
        'Span_TimeEvent_MessageEvent_SingleFields': module.Span_TimeEvent_MessageEvent_SingleFields,
        'Span_Link': module.Span_Link,
        'Span_Link_SingleFields': module.Span_Link_SingleFields,
        'Module': module.Module,
        'StackTrace_StackFrame': module.StackTrace_StackFrame,
        'StackTrace_StackFrame_SingleFields': module.StackTrace_StackFrame_SingleFields
    })),
    'opencensus/proto/trace/v1/trace_config': () => import('./opencensus/proto/trace/v1/trace_config').then(module => ({
        'TraceConfig': module.TraceConfig,
        'TraceConfig_SingleFields': module.TraceConfig_SingleFields,
        'ProbabilitySampler': module.ProbabilitySampler,
        'ProbabilitySampler_SingleFields': module.ProbabilitySampler_SingleFields,
        'ConstantSampler': module.ConstantSampler,
        'ConstantSampler_SingleFields': module.ConstantSampler_SingleFields,
        'RateLimitingSampler': module.RateLimitingSampler,
        'RateLimitingSampler_SingleFields': module.RateLimitingSampler_SingleFields
    })),
