...
export interface FilterChain {
   ...
   */
  on_demand_configuration?: FilterChain_OnDemandConfiguration | undefined;
}
...
export interface FilterChain_OnDemandConfiguration {
   ...
   */
  rebuild_timeout?: Duration | undefined;
}
...
export const FilterChain: MessageFns<FilterChain, "envoy.config.listener.v3.FilterChain"> = {
  ...
  encode(message: FilterChain, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.on_demand_configuration !== undefined) {
      FilterChain_OnDemandConfiguration.encode(message.on_demand_configuration, writer.uint32(66).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8: {
          ...
          message.on_demand_configuration = FilterChain_OnDemandConfiguration.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): FilterChain {
    return {
      ...
      transport_socket_connect_timeout: isSet(object.transport_socket_connect_timeout)
        ...
        : undefined,
      name: isSet(object.name) ? globalThis.String(object.name) : undefined,
      on_demand_configuration: isSet(object.on_demand_configuration)
        ? FilterChain_OnDemandConfiguration.fromJSON(object.on_demand_configuration)
        : undefined,
    };
  },
  ...
  toJSON(message: FilterChain): unknown {
    ...
    if (message.on_demand_configuration !== undefined) {
      obj.on_demand_configuration = FilterChain_OnDemandConfiguration.toJSON(message.on_demand_configuration);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<FilterChain>, I>>(object: I): FilterChain {
    ...
    message.transport_socket_connect_timeout =
      (object.transport_socket_connect_timeout !== undefined && object.transport_socket_connect_timeout !== null)
        ...
        : undefined;
    message.name = object.name ?? undefined;
    message.on_demand_configuration =
      (object.on_demand_configuration !== undefined && object.on_demand_configuration !== null)
        ? FilterChain_OnDemandConfiguration.fromPartial(object.on_demand_configuration)
        : undefined;
    return message;
  },
};
...
function createBaseFilterChain_OnDemandConfiguration(): FilterChain_OnDemandConfiguration {
  return { $type: "envoy.config.listener.v3.FilterChain.OnDemandConfiguration" };
}

export const FilterChain_OnDemandConfiguration: MessageFns<
  FilterChain_OnDemandConfiguration,
  "envoy.config.listener.v3.FilterChain.OnDemandConfiguration"
> = {
  $type: "envoy.config.listener.v3.FilterChain.OnDemandConfiguration" as const,

  encode(message: FilterChain_OnDemandConfiguration, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.rebuild_timeout !== undefined) {
      Duration.encode(message.rebuild_timeout, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): FilterChain_OnDemandConfiguration {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseFilterChain_OnDemandConfiguration();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.rebuild_timeout = Duration.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): FilterChain_OnDemandConfiguration {
    return {
      $type: FilterChain_OnDemandConfiguration.$type,
      rebuild_timeout: isSet(object.rebuild_timeout) ? Duration.fromJSON(object.rebuild_timeout) : undefined,
    };
  },

  toJSON(message: FilterChain_OnDemandConfiguration): unknown {
    const obj: any = {};
    if (message.rebuild_timeout !== undefined) {
      obj.rebuild_timeout = Duration.toJSON(message.rebuild_timeout);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<FilterChain_OnDemandConfiguration>, I>>(
    base?: I,
  ): FilterChain_OnDemandConfiguration {
    return FilterChain_OnDemandConfiguration.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<FilterChain_OnDemandConfiguration>, I>>(
    object: I,
  ): FilterChain_OnDemandConfiguration {
    const message = createBaseFilterChain_OnDemandConfiguration();
    message.rebuild_timeout = (object.rebuild_timeout !== undefined && object.rebuild_timeout !== null)
      ? Duration.fromPartial(object.rebuild_timeout)
      : undefined;
    return message;
  },
};

messageTypeRegistry.set(FilterChain_OnDemandConfiguration.$type, FilterChain_OnDemandConfiguration);
