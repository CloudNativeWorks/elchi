...
export interface OpenCensusConfig {
  $type: "envoy.config.trace.v2.OpenCensusConfig";
...
function createBaseOpenCensusConfig(): OpenCensusConfig {
  return { $type: "envoy.config.trace.v2.OpenCensusConfig" };
}

export const OpenCensusConfig: MessageFns<OpenCensusConfig, "envoy.config.trace.v2.OpenCensusConfig"> = {
  $type: "envoy.config.trace.v2.OpenCensusConfig" as const,
