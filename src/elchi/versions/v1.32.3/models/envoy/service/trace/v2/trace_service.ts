...
export const protobufPackage = "envoy.service.trace.v2";

export interface StreamTracesResponse {
  $type: "envoy.service.trace.v2.StreamTracesResponse";
}

export interface StreamTracesMessage {
  $type: "envoy.service.trace.v2.StreamTracesMessage";
  /**
...
export interface StreamTracesMessage_Identifier {
  $type: "envoy.service.trace.v2.StreamTracesMessage.Identifier";
  /** The node sending the access log messages over the stream. */
  node?: Node | undefined;
}

function createBaseStreamTracesResponse(): StreamTracesResponse {
  return { $type: "envoy.service.trace.v2.StreamTracesResponse" };
}

export const StreamTracesResponse: MessageFns<StreamTracesResponse, "envoy.service.trace.v2.StreamTracesResponse"> = {
  $type: "envoy.service.trace.v2.StreamTracesResponse" as const,
...
function createBaseStreamTracesMessage(): StreamTracesMessage {
  return { $type: "envoy.service.trace.v2.StreamTracesMessage" };
}

export const StreamTracesMessage: MessageFns<StreamTracesMessage, "envoy.service.trace.v2.StreamTracesMessage"> = {
  $type: "envoy.service.trace.v2.StreamTracesMessage" as const,
...
function createBaseStreamTracesMessage_Identifier(): StreamTracesMessage_Identifier {
  return { $type: "envoy.service.trace.v2.StreamTracesMessage.Identifier" };
}
...
> = {
  $type: "envoy.service.trace.v2.StreamTracesMessage.Identifier" as const,
...
export const TraceServiceServiceName = "envoy.service.trace.v2.TraceService";
