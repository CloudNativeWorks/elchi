...
export interface SrdsDummy {
  $type: "envoy.service.route.v3.SrdsDummy";
}

function createBaseSrdsDummy(): SrdsDummy {
  return { $type: "envoy.service.route.v3.SrdsDummy" };
}

export const SrdsDummy: MessageFns<SrdsDummy, "envoy.service.route.v3.SrdsDummy"> = {
  $type: "envoy.service.route.v3.SrdsDummy" as const,
...
export const ScopedRoutesDiscoveryServiceServiceName = "envoy.service.route.v3.ScopedRoutesDiscoveryService";
