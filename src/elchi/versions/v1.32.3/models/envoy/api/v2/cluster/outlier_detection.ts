...
export interface OutlierDetection {
   ...
   */
  failure_percentage_request_volume?: number | undefined;
}

function createBaseOutlierDetection(): OutlierDetection {
  return { $type: "envoy.api.v2.cluster.OutlierDetection" };
}

export const OutlierDetection: MessageFns<OutlierDetection, "envoy.api.v2.cluster.OutlierDetection"> = {
  $type: "envoy.api.v2.cluster.OutlierDetection" as const,
