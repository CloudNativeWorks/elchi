...
export const FileDescriptorProto: MessageFns<FileDescriptorProto, "google.protobuf.FileDescriptorProto"> = {
  ...
  encode(message: FileDescriptorProto, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.option_dependency !== undefined && message.option_dependency.length !== 0) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 15: {
          ...
          if (message.option_dependency === undefined) {
            message.option_dependency = [];
          }
          const el = reader.string();
          if (el !== undefined) {
            message.option_dependency!.push(el);
          }
          continue;
        }
        case 4: {
  ...
  fromPartial<I extends Exact<DeepPartial<FileDescriptorProto>, I>>(object: I): FileDescriptorProto {
    ...
    message.option_dependency = object.option_dependency?.map((e) => e) || undefined;
...
export const ExtensionRangeOptions: MessageFns<ExtensionRangeOptions, "google.protobuf.ExtensionRangeOptions"> = {
  ...
  fromPartial<I extends Exact<DeepPartial<ExtensionRangeOptions>, I>>(object: I): ExtensionRangeOptions {
    ...
    message.uninterpreted_option = object.uninterpreted_option?.map((e) => UninterpretedOption.fromPartial(e)) ||
      undefined;
    message.declaration = object.declaration?.map((e) => ExtensionRangeOptions_Declaration.fromPartial(e)) || undefined;
...
function createBaseExtensionRangeOptions_Declaration(): ExtensionRangeOptions_Declaration {
  return { $type: "google.protobuf.ExtensionRangeOptions.Declaration" };
}
...
export const FieldOptions: MessageFns<FieldOptions, "google.protobuf.FieldOptions"> = {
  ...
  encode(message: FieldOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.edition_defaults !== undefined && message.edition_defaults.length !== 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<FieldOptions>, I>>(object: I): FieldOptions {
    ...
    message.targets = object.targets?.map((e) => e) || undefined;
...
function createBaseFieldOptions_EditionDefault(): FieldOptions_EditionDefault {
  return { $type: "google.protobuf.FieldOptions.EditionDefault" };
}
...
function createBaseFieldOptions_FeatureSupport(): FieldOptions_FeatureSupport {
  return { $type: "google.protobuf.FieldOptions.FeatureSupport" };
}
...
> = {
  ...
  encode(message: FieldOptions_FeatureSupport, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.edition_introduced !== undefined && message.edition_introduced !== Edition.EDITION_UNKNOWN) {
      writer.uint32(8).int32(editionToNumber(message.edition_introduced));
    }
    if (message.edition_deprecated !== undefined && message.edition_deprecated !== Edition.EDITION_UNKNOWN) {
    ...
    if (message.edition_removed !== undefined && message.edition_removed !== Edition.EDITION_UNKNOWN) {
  ...
  fromJSON(object: any): FieldOptions_FeatureSupport {
    return {
      ...
      edition_introduced: isSet(object.edition_introduced) ? editionFromJSON(object.edition_introduced) : undefined,
      edition_deprecated: isSet(object.edition_deprecated) ? editionFromJSON(object.edition_deprecated) : undefined,
      deprecation_warning: isSet(object.deprecation_warning)
        ? globalThis.String(object.deprecation_warning)
        : undefined,
      edition_removed: isSet(object.edition_removed) ? editionFromJSON(object.edition_removed) : undefined,
    };
  },
...
function createBaseFeatureSet(): FeatureSet {
  return { $type: "google.protobuf.FeatureSet" };
}
...
export const FeatureSet: MessageFns<FeatureSet, "google.protobuf.FeatureSet"> = {
  ...
  encode(message: FeatureSet, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (
      message.field_presence !== undefined && message.field_presence !== FeatureSet_FieldPresence.FIELD_PRESENCE_UNKNOWN
    ) {
      writer.uint32(8).int32(featureSet_FieldPresenceToNumber(message.field_presence));
    }
    if (message.enum_type !== undefined && message.enum_type !== FeatureSet_EnumType.ENUM_TYPE_UNKNOWN) {
      writer.uint32(16).int32(featureSet_EnumTypeToNumber(message.enum_type));
    }
    if (
      message.repeated_field_encoding !== undefined &&
      message.repeated_field_encoding !== FeatureSet_RepeatedFieldEncoding.REPEATED_FIELD_ENCODING_UNKNOWN
    ) {
    ...
    if (
      ...
      message.utf8_validation !== FeatureSet_Utf8Validation.UTF8_VALIDATION_UNKNOWN
    ) {
      writer.uint32(32).int32(featureSet_Utf8ValidationToNumber(message.utf8_validation));
    }
    if (
      message.message_encoding !== undefined &&
      message.message_encoding !== FeatureSet_MessageEncoding.MESSAGE_ENCODING_UNKNOWN
    ) {
      writer.uint32(40).int32(featureSet_MessageEncodingToNumber(message.message_encoding));
    }
    if (message.json_format !== undefined && message.json_format !== FeatureSet_JsonFormat.JSON_FORMAT_UNKNOWN) {
      writer.uint32(48).int32(featureSet_JsonFormatToNumber(message.json_format));
    }
    if (
      message.enforce_naming_style !== undefined &&
      message.enforce_naming_style !== FeatureSet_EnforceNamingStyle.ENFORCE_NAMING_STYLE_UNKNOWN
    ) {
    ...
    if (
      ...
      writer.uint32(64).int32(
        featureSet_VisibilityFeature_DefaultSymbolVisibilityToNumber(message.default_symbol_visibility),
      );
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8: {
          ...
          message.default_symbol_visibility = featureSet_VisibilityFeature_DefaultSymbolVisibilityFromJSON(
            reader.int32(),
          );
          continue;
        }
  ...
  fromJSON(object: any): FeatureSet {
    return {
      ...
      field_presence: isSet(object.field_presence)
        ...
        : undefined,
      enum_type: isSet(object.enum_type) ? featureSet_EnumTypeFromJSON(object.enum_type) : undefined,
      ...
      message_encoding: isSet(object.message_encoding)
        ...
        : undefined,
      json_format: isSet(object.json_format) ? featureSet_JsonFormatFromJSON(object.json_format) : undefined,
...
function createBaseFeatureSetDefaults(): FeatureSetDefaults {
  return { $type: "google.protobuf.FeatureSetDefaults" };
}
...
export const FeatureSetDefaults: MessageFns<FeatureSetDefaults, "google.protobuf.FeatureSetDefaults"> = {
  ...
  encode(message: FeatureSetDefaults, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.minimum_edition !== undefined && message.minimum_edition !== Edition.EDITION_UNKNOWN) {
      writer.uint32(32).int32(editionToNumber(message.minimum_edition));
    }
    if (message.maximum_edition !== undefined && message.maximum_edition !== Edition.EDITION_UNKNOWN) {
  ...
  fromJSON(object: any): FeatureSetDefaults {
    return {
      ...
      defaults: globalThis.Array.isArray(object?.defaults)
        ...
        : undefined,
      minimum_edition: isSet(object.minimum_edition) ? editionFromJSON(object.minimum_edition) : undefined,
      maximum_edition: isSet(object.maximum_edition) ? editionFromJSON(object.maximum_edition) : undefined,
    };
  },
...
function createBaseFeatureSetDefaults_FeatureSetEditionDefault(): FeatureSetDefaults_FeatureSetEditionDefault {
  return { $type: "google.protobuf.FeatureSetDefaults.FeatureSetEditionDefault" };
}
