...
export interface CheckResponse {
  ...
  http_response?:
     ...
     */
    { $case: "error_response"; error_response: DeniedHttpResponse }
    | undefined;
  /**
...
export const CheckResponse: MessageFns<CheckResponse, "envoy.service.auth.v3.CheckResponse"> = {
  ...
  encode(message: CheckResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    switch (message.http_response?.$case) {
      ...
      case "ok_response":
        ...
        break;
      case "error_response":
        DeniedHttpResponse.encode(message.http_response.error_response, writer.uint32(42).fork()).join();
        break;
    }
    if (message.dynamic_metadata !== undefined) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 5: {
          ...
          message.http_response = {
            $case: "error_response",
            error_response: DeniedHttpResponse.decode(reader, reader.uint32()),
          };
          continue;
        }
        case 4: {
  ...
  fromJSON(object: any): CheckResponse {
    return {
      ...
      http_response: isSet(object.denied_response)
        ...
        : isSet(object.error_response)
        ? { $case: "error_response", error_response: DeniedHttpResponse.fromJSON(object.error_response) }
        : undefined,
      dynamic_metadata: isObject(object.dynamic_metadata) ? object.dynamic_metadata : undefined,
    };
  },
  ...
  toJSON(message: CheckResponse): unknown {
    ...
    if (message.http_response?.$case === "error_response") {
      obj.error_response = DeniedHttpResponse.toJSON(message.http_response.error_response);
    }
    if (message.dynamic_metadata !== undefined) {
      obj.dynamic_metadata = message.dynamic_metadata;
    }
  ...
  fromPartial<I extends Exact<DeepPartial<CheckResponse>, I>>(object: I): CheckResponse {
    ...
    if (
      object.http_response?.$case === "error_response" &&
      object.http_response?.error_response !== undefined &&
      object.http_response?.error_response !== null
    ) {
      message.http_response = {
        $case: "error_response",
        error_response: DeniedHttpResponse.fromPartial(object.http_response.error_response),
      };
    }
    message.dynamic_metadata = object.dynamic_metadata ?? undefined;
    return message;
