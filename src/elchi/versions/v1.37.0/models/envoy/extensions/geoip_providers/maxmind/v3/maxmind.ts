...
export const MaxMindConfig: MessageFns<MaxMindConfig, "envoy.extensions.geoip_providers.maxmind.v3.MaxMindConfig"> = {
  ...
  encode(message: MaxMindConfig, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.country_db_path !== undefined && message.country_db_path !== "") {
      writer.uint32(50).string(message.country_db_path);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.country_db_path = reader.string();
          continue;
        }
        case 4: {
          if (tag !== 34) {
  ...
  fromJSON(object: any): MaxMindConfig {
    return {
      ...
      country_db_path: isSet(object.country_db_path) ? globalThis.String(object.country_db_path) : undefined,
  ...
  toJSON(message: MaxMindConfig): unknown {
    ...
    if (message.country_db_path !== undefined) {
      obj.country_db_path = message.country_db_path;
    }
    if (message.common_provider_config !== undefined) {
  ...
  fromPartial<I extends Exact<DeepPartial<MaxMindConfig>, I>>(object: I): MaxMindConfig {
    ...
    message.country_db_path = object.country_db_path ?? undefined;
