...
export const protobufPackage = "envoy.extensions.filters.http.cache_v2.v3";
...
export interface CacheV2Config {
  $type: "envoy.extensions.filters.http.cache_v2.v3.CacheV2Config";
  /**
   ...
   */
  override_upstream_cluster?: string | undefined;
}
 ...
 * Modifies cache key creation by restricting which parts of the URL are included.
 */
export interface CacheV2Config_KeyCreatorParams {
  $type: "envoy.extensions.filters.http.cache_v2.v3.CacheV2Config.KeyCreatorParams";
  /**
...
function createBaseCacheV2Config(): CacheV2Config {
  return { $type: "envoy.extensions.filters.http.cache_v2.v3.CacheV2Config" };
}

export const CacheV2Config: MessageFns<CacheV2Config, "envoy.extensions.filters.http.cache_v2.v3.CacheV2Config"> = {
  $type: "envoy.extensions.filters.http.cache_v2.v3.CacheV2Config" as const,

  encode(message: CacheV2Config, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.key_creator_params !== undefined) {
      CacheV2Config_KeyCreatorParams.encode(message.key_creator_params, writer.uint32(26).fork()).join();
    }
    ...
    if (message.override_upstream_cluster !== undefined && message.override_upstream_cluster !== "") {
      writer.uint32(58).string(message.override_upstream_cluster);
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CacheV2Config {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCacheV2Config();
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.key_creator_params = CacheV2Config_KeyCreatorParams.decode(reader, reader.uint32());
          continue;
        }
        case 4: {
          if (tag !== 32) {
        ...
        case 7: {
          ...
          message.override_upstream_cluster = reader.string();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): CacheV2Config {
    return {
      $type: CacheV2Config.$type,
      ...
      key_creator_params: isSet(object.key_creator_params)
        ? CacheV2Config_KeyCreatorParams.fromJSON(object.key_creator_params)
        : undefined,
      ...
      ignore_request_cache_control_header: isSet(object.ignore_request_cache_control_header)
        ...
        : undefined,
      override_upstream_cluster: isSet(object.override_upstream_cluster)
        ? globalThis.String(object.override_upstream_cluster)
        : undefined,
    };
  },

  toJSON(message: CacheV2Config): unknown {
    const obj: any = {};
    if (message.typed_config !== undefined) {
    ...
    if (message.key_creator_params !== undefined) {
      obj.key_creator_params = CacheV2Config_KeyCreatorParams.toJSON(message.key_creator_params);
    }
    ...
    if (message.override_upstream_cluster !== undefined) {
      obj.override_upstream_cluster = message.override_upstream_cluster;
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<CacheV2Config>, I>>(base?: I): CacheV2Config {
    return CacheV2Config.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CacheV2Config>, I>>(object: I): CacheV2Config {
    const message = createBaseCacheV2Config();
    ...
    message.key_creator_params = (object.key_creator_params !== undefined && object.key_creator_params !== null)
      ? CacheV2Config_KeyCreatorParams.fromPartial(object.key_creator_params)
      : undefined;
    ...
    message.override_upstream_cluster = object.override_upstream_cluster ?? undefined;
    return message;
  },
};

messageTypeRegistry.set(CacheV2Config.$type, CacheV2Config);

function createBaseCacheV2Config_KeyCreatorParams(): CacheV2Config_KeyCreatorParams {
  return { $type: "envoy.extensions.filters.http.cache_v2.v3.CacheV2Config.KeyCreatorParams" };
}

export const CacheV2Config_KeyCreatorParams: MessageFns<
  CacheV2Config_KeyCreatorParams,
  "envoy.extensions.filters.http.cache_v2.v3.CacheV2Config.KeyCreatorParams"
> = {
  $type: "envoy.extensions.filters.http.cache_v2.v3.CacheV2Config.KeyCreatorParams" as const,

  encode(message: CacheV2Config_KeyCreatorParams, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CacheV2Config_KeyCreatorParams {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCacheV2Config_KeyCreatorParams();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CacheV2Config_KeyCreatorParams {
    return {
      $type: CacheV2Config_KeyCreatorParams.$type,
  ...
  toJSON(message: CacheV2Config_KeyCreatorParams): unknown {
    const obj: any = {};
  ...
  create<I extends Exact<DeepPartial<CacheV2Config_KeyCreatorParams>, I>>(base?: I): CacheV2Config_KeyCreatorParams {
    return CacheV2Config_KeyCreatorParams.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CacheV2Config_KeyCreatorParams>, I>>(
    object: I,
  ): CacheV2Config_KeyCreatorParams {
    const message = createBaseCacheV2Config_KeyCreatorParams();
...
messageTypeRegistry.set(CacheV2Config_KeyCreatorParams.$type, CacheV2Config_KeyCreatorParams);
