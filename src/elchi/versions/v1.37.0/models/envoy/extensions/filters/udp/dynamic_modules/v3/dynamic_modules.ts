...
export const protobufPackage = "envoy.extensions.filters.udp.dynamic_modules.v3";
 ...
 */
export interface DynamicModuleUdpListenerFilter {
  $type: "envoy.extensions.filters.udp.dynamic_modules.v3.DynamicModuleUdpListenerFilter";
...
function createBaseDynamicModuleUdpListenerFilter(): DynamicModuleUdpListenerFilter {
  return { $type: "envoy.extensions.filters.udp.dynamic_modules.v3.DynamicModuleUdpListenerFilter" };
}

export const DynamicModuleUdpListenerFilter: MessageFns<
  DynamicModuleUdpListenerFilter,
  "envoy.extensions.filters.udp.dynamic_modules.v3.DynamicModuleUdpListenerFilter"
> = {
  $type: "envoy.extensions.filters.udp.dynamic_modules.v3.DynamicModuleUdpListenerFilter" as const,

  encode(message: DynamicModuleUdpListenerFilter, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DynamicModuleUdpListenerFilter {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDynamicModuleUdpListenerFilter();
  ...
  fromJSON(object: any): DynamicModuleUdpListenerFilter {
    return {
      $type: DynamicModuleUdpListenerFilter.$type,
  ...
  toJSON(message: DynamicModuleUdpListenerFilter): unknown {
    const obj: any = {};
    if (message.dynamic_module_config !== undefined) {
  ...
  create<I extends Exact<DeepPartial<DynamicModuleUdpListenerFilter>, I>>(base?: I): DynamicModuleUdpListenerFilter {
    return DynamicModuleUdpListenerFilter.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DynamicModuleUdpListenerFilter>, I>>(
    object: I,
  ): DynamicModuleUdpListenerFilter {
    const message = createBaseDynamicModuleUdpListenerFilter();
...
messageTypeRegistry.set(DynamicModuleUdpListenerFilter.$type, DynamicModuleUdpListenerFilter);
