...
export interface QuicProtocolOptions {
   ...
   */
  max_sessions_per_event_loop?: number | undefined;
}
...
export const QuicProtocolOptions: MessageFns<QuicProtocolOptions, "envoy.config.listener.v3.QuicProtocolOptions"> = {
  ...
  encode(message: QuicProtocolOptions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.max_sessions_per_event_loop !== undefined) {
      UInt32Value.encode(
        { $type: "google.protobuf.UInt32Value", value: message.max_sessions_per_event_loop! },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 14: {
          ...
          message.max_sessions_per_event_loop = UInt32Value.decode(reader, reader.uint32()).value;
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): QuicProtocolOptions {
    return {
      ...
      reject_new_connections: isSet(object.reject_new_connections)
        ...
        : undefined,
      max_sessions_per_event_loop: isSet(object.max_sessions_per_event_loop)
        ? Number(object.max_sessions_per_event_loop)
        : undefined,
    };
  },
  ...
  toJSON(message: QuicProtocolOptions): unknown {
    ...
    if (message.max_sessions_per_event_loop !== undefined) {
      obj.max_sessions_per_event_loop = message.max_sessions_per_event_loop;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<QuicProtocolOptions>, I>>(object: I): QuicProtocolOptions {
    ...
    message.max_sessions_per_event_loop = object.max_sessions_per_event_loop ?? undefined;
    return message;
  },
};
