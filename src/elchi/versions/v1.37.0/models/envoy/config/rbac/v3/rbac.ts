...
import { CelExpressionConfig } from "../../core/v3/cel";
...
export enum MetadataSource {
  ...
  DYNAMIC = "DYNAMIC",
  /** ROUTE - Query :ref:`route metadata <envoy_v3_api_field_config.route.v3.Route.metadata>` */
  ROUTE = "ROUTE",
}

export function metadataSourceFromJSON(object: any): MetadataSource {
  switch (object) {
    case 0:
    case "DYNAMIC":
      return MetadataSource.DYNAMIC;
    case 1:
    case "ROUTE":
      return MetadataSource.ROUTE;
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum MetadataSource");
  }
}

export function metadataSourceToJSON(object: MetadataSource): string {
  switch (object) {
    case MetadataSource.DYNAMIC:
      return "DYNAMIC";
    case MetadataSource.ROUTE:
      return "ROUTE";
    default:
      throw new globalThis.Error("Unrecognized enum value " + object + " for enum MetadataSource");
  }
...
export function metadataSourceToNumber(object: MetadataSource): number {
  switch (object) {
    case MetadataSource.DYNAMIC:
      return 0;
    case MetadataSource.ROUTE:
 ...
 */
export interface SourcedMetadata {
...
export interface Permission {
  ...
  rule?:
     ...
     */
    { $case: "sourced_metadata"; sourced_metadata: SourcedMetadata }
    | undefined;
}
...
export const Policy: MessageFns<Policy, "envoy.config.rbac.v3.Policy"> = {
  ...
  encode(message: Policy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.cel_config !== undefined) {
      CelExpressionConfig.encode(message.cel_config, writer.uint32(42).fork()).join();
    }
    return writer;
  },
...
function createBaseSourcedMetadata(): SourcedMetadata {
  return { $type: "envoy.config.rbac.v3.SourcedMetadata" };
}

export const SourcedMetadata: MessageFns<SourcedMetadata, "envoy.config.rbac.v3.SourcedMetadata"> = {
  $type: "envoy.config.rbac.v3.SourcedMetadata" as const,

  encode(message: SourcedMetadata, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.metadata_matcher !== undefined) {
      MetadataMatcher.encode(message.metadata_matcher, writer.uint32(10).fork()).join();
    }
    if (message.metadata_source !== undefined && message.metadata_source !== MetadataSource.DYNAMIC) {
      writer.uint32(16).int32(metadataSourceToNumber(message.metadata_source));
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SourcedMetadata {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSourcedMetadata();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.metadata_matcher = MetadataMatcher.decode(reader, reader.uint32());
          continue;
        }
        case 2: {
          if (tag !== 16) {
          ...
          message.metadata_source = metadataSourceFromJSON(reader.int32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): SourcedMetadata {
    return {
      $type: SourcedMetadata.$type,
      metadata_matcher: isSet(object.metadata_matcher) ? MetadataMatcher.fromJSON(object.metadata_matcher) : undefined,
      metadata_source: isSet(object.metadata_source) ? metadataSourceFromJSON(object.metadata_source) : undefined,
    };
  },

  toJSON(message: SourcedMetadata): unknown {
    const obj: any = {};
    if (message.metadata_matcher !== undefined) {
      obj.metadata_matcher = MetadataMatcher.toJSON(message.metadata_matcher);
    }
    if (message.metadata_source !== undefined) {
      obj.metadata_source = metadataSourceToJSON(message.metadata_source);
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<SourcedMetadata>, I>>(base?: I): SourcedMetadata {
    return SourcedMetadata.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SourcedMetadata>, I>>(object: I): SourcedMetadata {
    const message = createBaseSourcedMetadata();
    message.metadata_matcher = (object.metadata_matcher !== undefined && object.metadata_matcher !== null)
      ? MetadataMatcher.fromPartial(object.metadata_matcher)
      : undefined;
    message.metadata_source = object.metadata_source ?? undefined;
    return message;
  },
};

messageTypeRegistry.set(SourcedMetadata.$type, SourcedMetadata);
...
export const Permission: MessageFns<Permission, "envoy.config.rbac.v3.Permission"> = {
  ...
  encode(message: Permission, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    switch (message.rule?.$case) {
      ...
      case "uri_template":
        ...
        break;
      case "sourced_metadata":
        SourcedMetadata.encode(message.rule.sourced_metadata, writer.uint32(114).fork()).join();
        break;
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 14: {
          ...
          message.rule = {
            $case: "sourced_metadata",
            sourced_metadata: SourcedMetadata.decode(reader, reader.uint32()),
          };
          continue;
        }
      }
  ...
  fromJSON(object: any): Permission {
    return {
      ...
      rule: isSet(object.and_rules)
        ...
        : isSet(object.sourced_metadata)
        ? { $case: "sourced_metadata", sourced_metadata: SourcedMetadata.fromJSON(object.sourced_metadata) }
        : undefined,
    };
  },
  ...
  toJSON(message: Permission): unknown {
    ...
    if (message.rule?.$case === "sourced_metadata") {
      obj.sourced_metadata = SourcedMetadata.toJSON(message.rule.sourced_metadata);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Permission>, I>>(object: I): Permission {
    ...
    if (
      object.rule?.$case === "sourced_metadata" &&
      object.rule?.sourced_metadata !== undefined &&
      object.rule?.sourced_metadata !== null
    ) {
      message.rule = {
        $case: "sourced_metadata",
        sourced_metadata: SourcedMetadata.fromPartial(object.rule.sourced_metadata),
      };
    }
    return message;
  },
...
export const Principal: MessageFns<Principal, "envoy.config.rbac.v3.Principal"> = {
  ...
  encode(message: Principal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    switch (message.identifier?.$case) {
      ...
      case "not_id":
        ...
        break;
      case "sourced_metadata":
        SourcedMetadata.encode(message.identifier.sourced_metadata, writer.uint32(106).fork()).join();
        break;
      case "custom":
        TypedExtensionConfig.encode(message.identifier.custom, writer.uint32(114).fork()).join();
        break;
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 14: {
          ...
          message.identifier = { $case: "custom", custom: TypedExtensionConfig.decode(reader, reader.uint32()) };
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  toJSON(message: Principal): unknown {
    ...
    if (message.identifier?.$case === "sourced_metadata") {
      obj.sourced_metadata = SourcedMetadata.toJSON(message.identifier.sourced_metadata);
    }
    if (message.identifier?.$case === "custom") {
      obj.custom = TypedExtensionConfig.toJSON(message.identifier.custom);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Principal>, I>>(object: I): Principal {
    ...
    if (
      object.identifier?.$case === "sourced_metadata" &&
      object.identifier?.sourced_metadata !== undefined &&
      object.identifier?.sourced_metadata !== null
    ) {
      message.identifier = {
        $case: "sourced_metadata",
        sourced_metadata: SourcedMetadata.fromPartial(object.identifier.sourced_metadata),
      };
    }
    if (
      object.identifier?.$case === "custom" &&
      object.identifier?.custom !== undefined &&
      object.identifier?.custom !== null
    ) {
      message.identifier = { $case: "custom", custom: TypedExtensionConfig.fromPartial(object.identifier.custom) };
    }
    return message;
  },
};
