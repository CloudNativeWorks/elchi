...
export const LocalityLbConfig_ZoneAwareLbConfig_ForceLocalZone: OutType = { "LocalityLbConfig_ZoneAwareLbConfig_ForceLocalZone": [
  {
    "name": "min_size",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "number",
    "enums": null,
    "comment": "Configures the minimum number of upstream hosts in the local zone required when force_local_zone is enabled. If the number of upstream hosts in the local zone is less than the specified value, Envoy will fall back to the default proportional-based distribution across localities. If not specified, the default is 1. * `runtime values`. * `Zone aware routing support`.",
    "notImp": false
  }
] };

export const LocalityLbConfig_ZoneAwareLbConfig_ForceLocalZone_SingleFields = [
  "min_size"
];
...
export const LocalityLbConfig_ZoneAwareLbConfig: OutType = { "LocalityLbConfig_ZoneAwareLbConfig": [
  ...
  {
    "name": "force_locality_direct_routing",
    "isUnion": false,
    "isDeprecated": true,
    "fieldType": "boolean",
    "enums": null,
    "comment": "If set to true, Envoy will force LocalityDirect routing if a local locality exists.",
    "notImp": false
  },
  {
    "name": "force_local_zone",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "LocalityLbConfig_ZoneAwareLbConfig_ForceLocalZone",
    "enums": null,
    "comment": "",
    "notImp": false
  },
  {
    ...
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "LocalityLbConfig_ZoneAwareLbConfig_LocalityBasis",
    "enums": [
      "HEALTHY_HOSTS_NUM",
      "HEALTHY_HOSTS_WEIGHT"
    ],
    "comment": "Determines how locality percentages are computed: - HEALTHY_HOSTS_NUM: proportional to the count of healthy hosts. - HEALTHY_HOSTS_WEIGHT: proportional to the weights of healthy hosts. Default value is HEALTHY_HOSTS_NUM if unset.",
    "notImp": false
  }
] };
...
export const ConsistentHashingLbConfig: OutType = { "ConsistentHashingLbConfig": [
  ...
  },
  {
    ...
    "enums": null,
    "comment": "Specifies a list of hash policies to use for ring hash load balancing. If ``hash_policy`` is set, then `route level hash policy` will be ignored.",
    "notImp": false
  }
] };
