...
export const ProcessingMode: OutType = { "ProcessingMode": [
  {
    ...
    "comment": "How to handle the request header. Default is \"SEND\". Note this field is ignored in `mode_override`, since mode overrides can only affect messages exchanged after the request header is processed.",
    "notImp": false
  },
  {
