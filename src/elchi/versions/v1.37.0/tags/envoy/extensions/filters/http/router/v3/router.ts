...
export const Router: OutType = { "Router": [
  ...
  {
    "name": "reject_connect_request_early_data",
    "isUnion": false,
    "isDeprecated": false,
    "fieldType": "boolean",
    "enums": null,
    "comment": "If set to true, Envoy will reject ``CONNECT`` requests that send data before receiving a ``200`` response from the upstream. This early data behavior is common for latency reduction but can cause issues with some upstreams. Defaults to false to allow early data and be compatible with common behavior.",
    "notImp": false
  }
] };
...
export const Router_SingleFields = [
  ...
  "reject_connect_request_early_data"
];