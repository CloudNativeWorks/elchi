...
export const RouteConfiguration: OutType = { "RouteConfiguration": [
  ...
  },
  {
    ...
    "fieldType": "boolean",
    "enums": null,
    "comment": "By default, port in `:authority` header (if any) is used in host matching. With this option enabled, Envoy will ignore the port number in the `:authority` header (if any) when picking VirtualHost.\n\n:::note\nThis option will not strip the port number (if any) contained in route config `envoy_v3_api_msg_config.route.v3.VirtualHost`.domains field.",
    "notImp": false
  },
  {
    "name": "vhost_header",
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "Normally, virtual host matching is done using the `:authority` (or Host: in HTTP < 2) HTTP header. Setting this will instead, use a different HTTP header for this purpose.",
    "notImp": false
  },
  {
