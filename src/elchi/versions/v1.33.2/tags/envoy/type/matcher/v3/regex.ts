...
export const RegexMatcher: OutType = { "RegexMatcher": [
  ...
  },
  {
    ...
    "fieldType": "string",
    "enums": null,
    "comment": "The regex match string. The string must be supported by the configured engine. The regex is matched against the full string, not as a partial match.",
    "notImp": false
  }
] };
